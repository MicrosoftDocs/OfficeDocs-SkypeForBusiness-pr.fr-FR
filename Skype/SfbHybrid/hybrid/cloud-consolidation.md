...
- Les deux organisations sont synchronisées via AAD Connect, de sorte qu’AAD a désormais tous les utilisateurs des deux déploiements locaux.
...
- AcquiredCompany. <span> com est un [domaine](/powershell/module/skype/disable-csonlinesipdomain) SIP en ligne désactivé. Tous les utilisateurs sont locaux. S’ils utilisent Teams, ils n’ont pas de fédération ou d’interopérabilité. Pendant cette phase, Microsoft recommande d’utiliser Teams uniquement pour les canaux.
