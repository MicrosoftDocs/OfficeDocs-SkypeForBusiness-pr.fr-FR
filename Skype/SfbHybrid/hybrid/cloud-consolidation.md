...
- Il doit y avoir au plus un Microsoft 365'organisation impliquée. La consolidation dans les scénarios avec plusieurs organisations n’est pas prise en charge.
- Une seule forêt Skype Entreprise local peut être en mode hybride (espace d’adressas SIP partagé) à la fois. Toutes les autres forêts de Skype Entreprise sur site doivent rester purement en local et être fédérées entre elles et avec l Microsoft 365'organisation.
