...
Lorsque quelqu'un appelle à un numéro de téléphone qui a d’une file d’attente de l’appel, ils entendra un message d’accueil premier (si une est définie), puis il est placé dans la file d’attente et attend l’agent d’appel disponible suivant. La personne l’appel va écouter de la musique pendant qu’ils sont bloqués en attente, et les appels seront proposés pour les agents de l’appel de la manière *First In, First Out* (FIFO).
...
- Lorsque vous distribuez les appels entrants à partir d’une file d’attente des appels système téléphonique, ces clients sont pris en charge pour les agents d’appel :
  ...
  - Tous les modèles de téléphone IP pris en charge par Skype pour les entreprises en ligne. Reportez-vous à la section [mise en route des téléphones pour Skype pour l’activité en ligne](getting-phones-for-skype-for-business-online/getting-phones-for-skype-for-business-online.md).
...
***
![Numéro 2](../images/sfbcallout2.png)<br/>**Numéro de téléphone** Sélectionnez un numéro de service ou le numéro d’appel gratuit de la file d’attente d’appel. Cette option est facultative. <br/> Si il n’existe pas dans la liste, vous devez obtenir les numéros de service avant de pouvoir créer cette file d’attente d’appel. Pour obtenir vos numéros de service, voir [numéros de téléphone de service de mise en route pour Skype pour les entreprises et les équipes de Microsoft](getting-service-phone-numbers.md)
***
...
***
![Numéro 1](../images/sfbcallout1.png)<br/>**Message d’accueil** est facultative. C’est le message d’accueil qui est lu pour les personnes qui appellent dans le nombre de file d’attente d’appel. <br/> Vous pouvez télécharger un fichier audio (.wma, .mp3 ou .wav formats).
***
...
***
![Numéro 1](../images/sfbcallout1.png)<br/><br/>**Maximum appelle dans la file d’attente** Permet de définir les appels maximales qui peuvent attendre dans la file d’attente en même temps. La valeur par défaut est de 50, mais elle peut varier de 0 à 200. Lorsque cette limite est atteinte, l’appel sera traité de façon que vous avez défini sur le paramètre **lorsque le nombre maximal d’appels est atteinte** ci-dessous.
***
