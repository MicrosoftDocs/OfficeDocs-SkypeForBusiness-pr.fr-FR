...
---
# <a name="availability-in-hong-kong"></a>Disponibilité de Hong-Kong
...
Voici les services Office 365 pour Skype pour les entreprises et les Teams Microsoft disponible pour Hong Kong.
  
## <a name="audio-conferencing"></a>Audioconférence

|**Fonctionnalité**|**Détails**|
|:-----|:-----|
|Les conférences Audio n’est disponible à l’achat ?  <br/> |Non  <br/> |
|Numéros de téléphone sont automatiquement affectées pour les conférences Audio ?  <br/> |Oui, pour Hong Kong. Si vous voulez que les numéros de téléphone dédiés, voir [numéros de téléphone de service de mise en route pour Skype pour les entreprises et les équipes de Microsoft](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md).  <br/> |
...
|**Fonctionnalité**|**Détails**|
|:-----|:-----|
|Les majuscules ou les grandes villes, vous obtenez les numéros payants pour ?  <br/> |Hong Kong  <br/> |
...
|**Fonctionnalité**|**Détails**|
|:-----|:-----|
|Crédits de Communications ne sont disponibles ?  <br/> |Non  <br/> |
