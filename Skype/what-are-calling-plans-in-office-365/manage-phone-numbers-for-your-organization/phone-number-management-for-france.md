...
- Calling Plans
- Strat_SB_PSTN
description: "Utilisez ce tableau pour rechercher des informations sur l'obtention et la gestion de numéros de téléphone en France pour Skype Entreprise Online."
...
Utilisez ce tableau pour rechercher des informations sur l'obtention et la gestion de numéros de téléphone en France pour Skype Entreprise Online. 
...
|Vous devez obtenir des numéros de téléphone qui nous sont transférés.  <br/> |Téléchargez un des formulaires suivants : <br/> [Courrier d'autorisation (LOA) pour la France (numéros gratuits) (v.2.0)(fr.fr)](../../downloads/LOA-forms/letter-of-authorization-(loa)-for-france-(freephone-numbers)-(v.2.0)-(fr.fr).pdf) <br/> [Courrier d'autorisation (LOA) pour la France (numéros géographiques) (v.2.0)(fr.fr)](../../downloads/LOA-forms/letter-of-authorization-(loa)-for-france-(geographic-numbers)-(v.2.0)-(fr.fr).pdf) <br/>  Remplissez-le et [envoyez-le-nous](mailto:ptneu@microsoft.com).  <br/> |
