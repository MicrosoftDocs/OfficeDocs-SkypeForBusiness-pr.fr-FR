...
- Calling Plans
- Strat_SB_PSTN
description: "Lorsque vous recherchez et l’obtention des numéros de téléphone pour votre organisation, vous pouvez obtenir plusieurs numéros de téléphone que vous avez attribué les licences. Mais cela dépend sur les types de numéros de téléphone et les types de licences que vous avez achetées et affecté. Vous pouvez cliquer sur les différents types de numéros de téléphone utilisés pour les Plans d’appel pour savoir comment les numéros de téléphone utilisés dans Skype pour l’activité en ligne."
