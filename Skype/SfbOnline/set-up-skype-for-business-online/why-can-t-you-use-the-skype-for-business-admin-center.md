...
Tout d’abord, voici l’explication technique :
  
Nous sommes en train de migrer votre service Skype Entreprise Online (c’est-à-dire vos utilisateurs et vos paramètres d’organisation) vers un autre centre de données Microsoft plus proche de vous. Cela permettra d’améliorer votre service et de réduire les temps d’attente. 
...
## <a name="ok-so-what-does-that-mean"></a>Qu’est-ce que cela signifie ?
