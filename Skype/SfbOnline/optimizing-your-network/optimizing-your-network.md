...
Le système audio de Skype Entreprise doit être déployé dans la file d'attente Acheminement accéléré (Expedited Forwarding ou EF - DSCP 46) et le système vidéo de Skype Entreprise doit être déployé dans la file d'attente Acheminement assuré 41 (Assured Forwarding ou AF - DSCP 34). Cela s’applique même au trafic d’égal à égal et de conférence, que Phone System dans Microsoft 365, Office 365 ou d’autres fonctionnalités téléphoniques soient déployés.
...
Pour plus d’informations sur la configuration et la gestion de la qualité de service, voir [Gestion de la qualité de service.](https://technet.microsoft.com/library/gg425841.aspx)
...
Tout Microsoft 365 ou Office 365, y compris Skype Entreprise Online, est chiffré et ne peut généralement pas être contrôlé par des périphériques proxy. Pour ces raisons, nous vous recommandons de contourner les périphériques proxy pour l’ensemble du trafic réseau de Microsoft 365 et Office 365, tel que défini en tant que connexions que vos utilisateurs connectent aux URL et [plages d’adresses IP Office 365.](https://support.office.com/article/8548a211-3fe7-47cb-abb1-355ea5aa88a2) Les périphériques proxy sont susceptibles d'introduire un retard dans les flux multimédia Skype Entreprise Online en temps réel, nous recommandons donc d'utiliser le moins de périphériques proxy possible pour ce trafic.

Microsoft recommande d’exclure les URL Microsoft 365 et Office 365 utilisant des fichiers PAC pour envoyer le trafic De Microsoft 365 et Office 365 à un pare-feu.

Voici quelques ressources supplémentaires qui peuvent également être utiles :

- [Optimisation des performances de Microsoft 365 ou Office 365 à l’aide de lignes de référence et de l’historique des performances](https://support.office.com/article/1492cb94-bd62-43e6-b8d0-2a61ed88ebae)
...
- [Utilisation d’un contrôleur d’optimisation WAN ou d’appareils de trafic/inspection avec Microsoft 365 ou Office 365](https://aka.ms/kb2690045)
...
> [!NOTE]
> Cette fonction est uniquement requise pour les charges de travail multimédia de Skype Entreprise et n’est pas applicable aux autres services Microsoft 365 ou Office 365.
