...
En travaillant avec un [partenaire Microsoft](https://partnercenter.microsoft.com/pcv/search), vous pouvez connecter une variété de logiciels Microsoft 365 ou Office 365, notamment Skype entreprise Online dans le Cloud à votre réseau et des fonctionnalités de communication audio et vidéo en temps réel pour Skype entreprise, les services réseau doivent être spécifiquement configurés pour prendre en charge ces charges en temps réel Microsoft 365 et Office 365. Cela comprend un réseau disposant de suffisamment de bande passante pour exécuter le volume de trafic nécessaire et prendre en charge la qualité de service (QoS) afin d'offrir à vos utilisateurs une expérience de qualité professionnelle.
...
Le système audio de Skype Entreprise doit être déployé dans la file d'attente Acheminement accéléré (Expedited Forwarding ou EF - DSCP 46) et le système vidéo de Skype Entreprise doit être déployé dans la file d'attente Acheminement assuré 41 (Assured Forwarding ou AF - DSCP 34). C’est vrai même pour le trafic d’égal à égal et de conférence, qu’il s’agisse de système téléphonique dans Microsoft 365 ou Office 365 ou d’autres fonctionnalités de téléphonie.
...
Pour plus d’informations sur la configuration et la gestion de QoS, voir [gestion de la qualité de service](https://technet.microsoft.com/library/gg425841.aspx).
...
Tout Microsoft 365 ou Office 365, notamment Skype entreprise Online, est chiffré et ne peut généralement pas être inspecté par des périphériques proxy. C’est pourquoi nous vous conseillons de contourner les périphériques proxy pour l’ensemble du trafic réseau Microsoft 365 et Office 365, comme défini en tant que connexion des utilisateurs aux [URL et plages d’adresses IP d’office 365](https://support.office.com/article/8548a211-3fe7-47cb-abb1-355ea5aa88a2). Les périphériques proxy sont susceptibles d'introduire un retard dans les flux multimédia Skype Entreprise Online en temps réel, nous recommandons donc d'utiliser le moins de périphériques proxy possible pour ce trafic.

Microsoft recommande d’exclure les URL Microsoft 365 et Office 365 à l’aide de fichiers PAC pour envoyer du trafic Microsoft 365 et Office 365 à un pare-feu.

Voici quelques ressources supplémentaires qui peuvent également être utiles :

- [Optimisation des performances de Microsoft 365 ou d’Office 365 à l’aide des plannings de référence et de l’historique des performances](https://support.office.com/article/1492cb94-bd62-43e6-b8d0-2a61ed88ebae)
...
> [!NOTE]
> Cette opération est uniquement requise pour les charges de travail multimédia de Skype entreprise et n’est pas applicable aux autres services Microsoft 365 ou Office 365.
...
Dans une session mutlimédia en temps réel, les périphériques de média utilisés par tous les participants, tels que des casques et des webcams, ont un fort impact sur la qualité audio et vidéo globale. Les appareils ou périphériques de faible qualité dotés de pilotes de périphériques inappropriés produiront une qualité audio globale inférieure pour les appels audio et vidéo. Les périphériques certifiés ou de bonne qualité, en revanche, améliorent l'annulation d'écho, le filtrage du bruit et la résolution vidéo, et réduisent les temps de latence.
...
- [Téléphones et de périphériques optimisés pour Skype Entreprise](https://technet.microsoft.com/office/dn947482.aspx)
...
- [Téléphones et de périphériques certifiés pour Microsoft Lync](https://technet.microsoft.com/office/dn788944.aspx)
