...
ms.custom:
- Phone System
description: 'Découvrez comment configurer et tester les standards automatiques de système téléphonique (Cloud PBX) pour un traitement efficace des appels pour votre entreprise. '
ms.openlocfilehash: 13b6c5f81907beff54f2becfab0e399de0508ade
ms.sourcegitcommit: 2a6e499165424fe2d189ad140951e222c8ba9c81
ms.translationtype: HT
ms.contentlocale: fr-FR
ms.lasthandoff: 09/07/2018
ms.locfileid: "23850240"
---
...
- Avant de pouvoir créer et configurer vos standards automatiques, vous devrez transférer vos numéros payants et gratuits existants. Une fois que vous aurez obtenu les numéros de service payants ou gratuits, ils s’afficheront sur la page **Numéros de téléphone** > **vocaux** > du**Centre d’administration de Skype Entreprise**. Pour obtenir vos numéros de service, voir [mise en route des numéros de téléphone de service pour Skype Entreprise et Microsoft Teams](getting-service-phone-numbers.md), ou si vous souhaitez transférer un numéro de service existant, voir [transférer des numéros de téléphone vers Office 365](/microsoftteams/transfer-phone-numbers-to-office-365). **Les numéros d'utilisateurs (abonnés)** ne peuvent pas être attribués à des standards automatiques. Si vous êtes basé hors des États-Unis, vous ne pourrez pas utiliser le centre d'administration de Skype Entreprise pour obtenir des numéros de service ; accédez [ici](/microsoftteams/manage-phone-numbers-for-your-organization) le cas échéant.
...
***
![Numéro 1](../images/sfbcallout1.png)<br/>**Nom** Entrez un nom d'affichage descriptif pour votre standard automatique. Le nom est obligatoire et peut contenir jusqu'à 64 caractères, espaces compris. Il sera répertorié dans la colonne **Nom** de l'onglet **Standards automatiques**.
***

![Numéro 2](../images/sfbcallout2.png)<br/>**Numéro de téléphone** Ce paramètre est facultatif. Si vous le souhaitez, sélectionnez un numéro de téléphone pour le standard automatique. Vous pouvez choisir n’importe quel numéro de téléphone service payant ou gratuit disponible pour votre organisation. Si aucune numéro n'est répertorié, vous devrez obtenir un numéro de service gratuit ou payant. Aller [ici](getting-service-phone-numbers.md) pour en obtenir. <br/> <br/>

> [!NOTE]
> **Les numéros d'utilisateurs (abonnés)** ne peuvent pas être attribués à des standards automatiques.
...
***
![14](../images/sfbcallout4.png)<br/>**Langue** Sélectionnez la langue que vous souhaitez utiliser pour votre standard automatique parmi les langues disponibles répertoriées. La langue définie ici sera utilisée par le standard automatique pour interagir avec les personnes appelant ce standard automatique, et toutes les invites système seront lues dans cette langue.
***
!["Nombre 5"](../images/sfbcallout5.png)<br/>**Reconnaissance vocale** La reconnaissance vocale est disponible et si cette option est sélectionnée. Les personnes qui appellent peuvent utiliser une entrée vocale dans la langue définie. Vous pouvez désactiver la reconnaissance vocale en la désactivant si vous souhaitez que les appelants utilisent uniquement leur clavier téléphonique.
***
...
*    **Se déconnecter** Si vous l’activez, la personne qui appel sera déconnectée après l'écoute d'un message d'accueil d'heures d'ouverture.
...
*    **Charger un fichier audio** Si vous choisissez cette option, vous devrez enregistrer le message d'accueil, puis charger votre fichier audio (au format .wav, .mp3 ou .wma).  
***
![Nombre 3](../images/sfbcallout3.png)<br/>**Que se passe-t-il pour les appels après le message d’accueil ?** Vous pouvez sélectionner ce qui se passe pour les appels qui arrivent pendant cette période de congé. Vous pouvez choisir parmi les options suivantes :
...
*    **Personnaliser** Si vous utilisez cette option, vous pouvez rechercher une liste de distribution ou un groupe de sécurité créé dans votre organisation, et toutes les personnes ajoutées à cette liste ou ce groupe seront exclues de la recherche de l'annuaire. Vous pouvez ajouter plusieurs groupes d’Office 365, de listes de distribution et de groupes de sécurité. <br/><br/> 
