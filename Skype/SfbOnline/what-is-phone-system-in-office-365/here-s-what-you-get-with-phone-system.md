...
Avec le module complémentaire système téléphonique, vous pouvez utiliser Skype pour les entreprises pour effectuer des tâches de base telles que l’émission et réception d’appels, de transfert d’appels et les appels silence ou unmuting, à partir de presque n’importe où avec accès à Internet. Il est disponible dans le monde entier ! 
  
Pour plus d’informations, voir [tarification pour le système téléphonique](https://products.office.com/en-us/skype-for-business/cloud-pbx#requirements).
  
## <a name="phone-system-in-office-365-features"></a>Système téléphonique dans les fonctionnalités d’Office 365

À l’aide de système téléphonique, votre Skype pour les utilisateurs professionnels obtenez les fonctionnalités suivantes :
...
|[Consultation de la messagerie vocale et des options de Skype Entreprise](https://support.office.com/en-us/article/2deea7f8-831f-4e85-a0d4-b34da55945a8) <br/> |Voici comment fonctionne la messagerie vocale système téléphonique : lorsqu’un utilisateur reçoit un message vocal, il est remis à leur boîte aux lettres en tant qu’un message électronique avec le message vocal en pièce jointe. Ils peuvent également écouter leurs messages sur leur Skype certifié téléphone de bureau, tous les Skype pour les applications métier ou Lync pour Mac 2011.  <br/> Messagerie vocale du système téléphonique inclut le message d’accueil personnalisé, indicateur de message en attente et répondre par un appel. Vous pouvez configurer votre messagerie vocale pour que tous les messages soient stockés dans des boîtes aux lettres et disponibles via Skype Entreprise sur votre ordinateur, appareil mobile ou téléphone IP.  <br/> |
...
- Vous pouvez utiliser le module complémentaire système téléphonique avec des lignes téléphoniques existantes de votre société, ou le [Quels sont les Plans de l’appel dans Office 365 ?](../what-are-calling-plans-in-office-365/what-are-calling-plans-in-office-365.md) service pour les appels entrants et sortants.
