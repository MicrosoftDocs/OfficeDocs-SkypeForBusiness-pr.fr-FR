...
BToE est un téléphone paining le mécanisme de téléphones IP du partenaire qui associe le téléphone de l’utilisateur avec leur Skype Windows pour l’application d’entreprise. BToE permet aux utilisateurs d'effectuer les actions suivantes :
