...
La première chose à faire est de confirmer que vous avez :
 ...
 - mis à jour le microprogramme de vos téléphones (voir les microprogrammes pris en charge [dans ce sujet](getting-phones-for-skype-for-business-online.md)).  Vous pouvez vérifier le microprogramme de votre téléphone de cette manière :       
    - **Téléphones Polycom VVX** : Aller aux **Paramètres** > **Statut** > **Plateforme** > **Application** > **Principale**.
    - **Téléphones Yealink** : Aller à **Statut** sur l’écran principal du téléphone.
    - **Téléphones AudioCodes** : Aller au **Menu** > **Statut de l’appareil** > **Version du microprogramme** à partir de l’écran de démarrage. 
    - **Téléphones Lync Phone Edition (LPE)**  : Aller au **Menu** > **Informations système** à partir de l’écran de démarrage.

    Les mises à jour de microprogrammes sont gérées par le service Skype Entreprise. Chaque microprogramme de téléphone certifié Skype Entreprise est chargé vers le serveur de mise à jour Skype Entreprise et la mise à jour de l'appareil est activée par défaut sur tous les téléphones. 

    En fonction de la durée d’inactivité et des intervalles d’interrogation, les téléphones téléchargeront automatiquement les dernières versions certifiées. Vous pouvez désactiver les réglages de mise à jour de l’appareil en utilisant le paramètre [Set-CsIPPhonePolicy](https://docs.microsoft.com/powershell/module/skype/set-csipphonepolicy) et en réglant le paramètre *EnableDeviceUpdate* sur `false`.
...
3. Cliquez pour développer **Abonnements supplémentaires** puis cliquez pour acheter un Forfait d’appels. Choisissez soit le **Forfait d’appels nationaux** ou le **Forfait d’appels nationaux et internationaux**.
...
Sachez que vous pouvez également prendre le numéro de téléphone que vous avez avec un autre opérateur et le « *Porter* » ou le transférer sur Office 365. Voir [Transférer des numéros de téléphone vers Office 365](../../what-are-calling-plans-in-office-365/transfer-phone-numbers-to-office-365.md).
...
- [Obtenir des téléphones pour Skype Entreprise Online](getting-phones-for-skype-for-business-online.md)
