...
> [!NOTE]
> Si la boîte aux lettres est plein ou l’administrateur du client a configuré MaxSendSize est inférieure à 39 Mo, téléchargé le fichier de données ne sont pas conservées tout. La valeur par défaut MaxSendSize est de 150 Mo, mais les administrateurs de clients peuvent configurer MaxSendSize pour être aussi faible que 1 Mo. 
