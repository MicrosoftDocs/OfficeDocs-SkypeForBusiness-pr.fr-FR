...
- [Erreur le Module d’importation a provoqué par la stratégie d’exécution de Windows PowerShell](diagnose-problems-with-the-skype-for-business-online-connector.md#BKMKPowerShellExecutionPolicy)
    
- [Erreur le Module d’importation provoqué par une version incorrecte de Windows PowerShell](diagnose-problems-with-the-skype-for-business-online-connector.md#BKMKIncorrectVersion)
...
- [Impossible de charger le module de Live ID](diagnose-problems-with-the-skype-for-business-online-connector.md#BKMKFailedLoad)
...
- [L’utilisateur n’a pas l’autorisation de gérer ce client](diagnose-problems-with-the-skype-for-business-online-connector.md#BKMKUserPermission)
    
- [Possibilité de se connecter à des clients a été désactivée dans Skype pour professionnels en ligne](diagnose-problems-with-the-skype-for-business-online-connector.md#BKMKAbilityConnect)
    
- [Le nombre maximal de shells simultanées de cet utilisateur dans Skype pour Business Online a été dépassé.](diagnose-problems-with-the-skype-for-business-online-connector.md#BKMK_MaxNumberShellsUser)
    
- [Le nombre maximal de shells simultanées pour ce client dans Skype pour Business Online a été dépassé.](diagnose-problems-with-the-skype-for-business-online-connector.md#BKMK_MaxNumberShellsTenant)
