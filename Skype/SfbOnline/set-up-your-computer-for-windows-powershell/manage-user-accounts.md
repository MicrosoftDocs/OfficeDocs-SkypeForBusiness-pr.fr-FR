...
- [Retourner des informations pour un utilisateur spécifique Skype pour Business Online](manage-user-accounts.md#BKMKReturnInfoSpecificUser)

- [Retourner des informations spécifiques pour des utilisateurs spécifiques Skype pour Business Online](manage-user-accounts.md#BKMKReturninfoSpecificUsers)

- [Renvoyer la liste filtrée des utilisateurs dans Skype pour Business Online](manage-user-accounts.md#BKMKReturnFilteredListofUsers)
