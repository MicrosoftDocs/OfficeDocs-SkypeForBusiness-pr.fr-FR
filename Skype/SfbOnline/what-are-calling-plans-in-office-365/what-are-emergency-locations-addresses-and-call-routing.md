...
2. **Création et validation de vos emplacements d'urgence** L'étape suivante consiste à créer et à valider vos adresses de secours. Lorsque vous créez une adresse de secours, vous pouvez la valider. Pour créer une adresse d’urgence, voir [Ajouter ou supprimer une situation d’urgence d’adresses pour votre organisation](add-or-remove-an-emergency-address-for-your-organization.md).
