...
La validation des adresses est une partie importante des forfaits d'appels dans Office 365. Si pour une raison quelconque, un numéro de téléphone n’est pas activé et est répertorié comme étant **en attente** en raison de la validation de l’adresse, vous devez créer et soumettre une demande de service. La procédure dépend de la taille de votre organisation.
