...
---
# <a name="toll-free-dialing-limitations-and-restrictions"></a><span data-ttu-id="e59c7-105">Restrictions et limitations de numérotation gratuit</span><span class="sxs-lookup"><span data-stu-id="e59c7-105">Toll-free dialing limitations and restrictions</span></span>

<span data-ttu-id="e59c7-106">Cela vous permettra de savoir comment composer les numéros gratuits dans chaque pays ou région.</span><span class="sxs-lookup"><span data-stu-id="e59c7-106">This will help you find out how to dial toll free numbers in each country or region.</span></span> <span data-ttu-id="e59c7-107">Après avoir sélectionné le pays ou la région, il vous permettra une page qui contient le service gratuit de péage étant disponible, notamment les limites et restrictions des détails spécifiques.</span><span class="sxs-lookup"><span data-stu-id="e59c7-107">After you select the country/region, it will take you to a page that contains where toll free service is available including specific details, restrictions, and limits.</span></span> <span data-ttu-id="e59c7-108">Les formats ou le format de la numérotation affiche les codes d’accès requis au sein de chaque pays/région pour composer le numéro d’appel gratuit.</span><span class="sxs-lookup"><span data-stu-id="e59c7-108">The dialing format or formats will show you the required access codes within each country/region to dial the toll-free number.</span></span>
  
<span data-ttu-id="e59c7-109">Si vous êtes prêt, sélectionnez un pays ou une région :</span><span class="sxs-lookup"><span data-stu-id="e59c7-109">If you're ready, select a country or region:</span></span>
  
## <a name="select-your-country-or-region-to-see-the-dialing-codes-limitations-and-restrictions"></a><span data-ttu-id="e59c7-110">Sélectionnez votre pays ou votre région pour afficher les codes de numérotation, les limites et les restrictions.</span><span class="sxs-lookup"><span data-stu-id="e59c7-110">Select your country or region to see the dialing codes, limitations and restrictions.</span></span>
...
## <a name="here-are-some-important-things-for-you-to-remember-about-toll-free-numbers"></a><span data-ttu-id="e59c7-172">Voici quelques éléments importants à retenir à propos des numéros gratuits :</span><span class="sxs-lookup"><span data-stu-id="e59c7-172">Here are some important things for you to remember about toll free numbers:</span></span>

- <span data-ttu-id="e59c7-173">**Numéros gratuits ne fonctionnent que dans chaque pays/région.**</span><span class="sxs-lookup"><span data-stu-id="e59c7-173">**Toll free numbers only operate within each country/region.**</span></span> <span data-ttu-id="e59c7-174">Par exemple, vos utilisateurs ne pourront appeler un numéro gratuit australien à l’extérieur de l’Australie.</span><span class="sxs-lookup"><span data-stu-id="e59c7-174">For example, your users won't be able to call an Australian toll-free number outside of Australia.</span></span>
    
- <span data-ttu-id="e59c7-175">**Acquisition ou portage universel International gratuit numéros (numéros UIFN) n’est pas pris en charge.**</span><span class="sxs-lookup"><span data-stu-id="e59c7-175">**Acquiring or porting Universal International Freephone Numbers (UIFN) isn't supported.**</span></span>
    
- <span data-ttu-id="e59c7-176">**Dans de nombreux pays/régions, l’agence de régulation/télécommunications dans le pays ou la région nécessite chaque numéro gratuit de maintenir au moins 100 minutes d’utilisation par mois afin de conserver le nombre.**</span><span class="sxs-lookup"><span data-stu-id="e59c7-176">**In many countries/regions, the regulator/telecommunication agency in the country/region requires each toll free phone number to maintain at least 100 minutes of usage per month in order to retain the number.**</span></span>
...
- <span data-ttu-id="e59c7-178">**Filaire, ligne fixe et accès mobile aux numéros verts peuvent être partiellement ou totalement restreints.**</span><span class="sxs-lookup"><span data-stu-id="e59c7-178">**Wireline, fixed line, and mobile network access to toll-free numbers may be fully or partially restricted.**</span></span> <span data-ttu-id="e59c7-179">Le format de numérotation décrit les codes d'accès requis dans chaque pays/région pour passer des appels via le numéro gratuit.</span><span class="sxs-lookup"><span data-stu-id="e59c7-179">The dialing format describes the required access codes within each country/region to place calls using the toll free number.</span></span>
    
- <span data-ttu-id="e59c7-180">**Amérique du Nord de numérotation payant des numéros d’appel gratuit :** Taux par minute pour le Plan de numérotation en Amérique du Nord numéros gratuits sont déterminées par le pays d’origine.</span><span class="sxs-lookup"><span data-stu-id="e59c7-180">**North America Numbering Plan Toll Free Numbers:** Per-minute rates for North America Numbering Plan toll free numbers are determined by the originating country.</span></span> <span data-ttu-id="e59c7-181">Le taux de par minute de libre appel payant pour les appels qui sont issus de la carte des États-Unis d’Amérique au taux défini en tant que « Amérique du Nord. »</span><span class="sxs-lookup"><span data-stu-id="e59c7-181">The toll free per-minute rate for calls that originate from the United States map to the rate defined as "North America."</span></span> <span data-ttu-id="e59c7-182">Toutefois, les appels provenant d’autres pays d’Amérique du Nord Canada, Porto Rico, etc. ont des taux de libre appel spécifique.</span><span class="sxs-lookup"><span data-stu-id="e59c7-182">However, calls that originate from other North American countries such as Canada, Puerto Rico, etc. have specific toll free rates.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e59c7-184">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="e59c7-184">Related topics</span></span>
[<span data-ttu-id="e59c7-185">Obtenir des numéros de téléphone de service pour Skype Entreprise et Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="e59c7-185">Getting service phone numbers for Skype for Business and Microsoft Teams</span></span>](../what-is-phone-system-in-office-365/getting-service-phone-numbers.md)
