---
title: 'Programme de fin de vie pour l’intégration Skype Entreprise de services d’audioconférence tiers '
ms.author: tonysmit
author: tonysmit
manager: serdars
...
ms.locfileid: "58609991"
---
# <a name="end-of-life-program-for-the-integration-of-skype-for-business-with-third-party-audio-conferencing-providers"></a>Programme de fin de vie pour l’intégration Skype Entreprise de services d’audioconférence tiers 
...
- Les informations de connexion des utilisateurs activés pour un service d’acp tiers ne seront plus incluses automatiquement dans les nouvelles invitations aux réunions Skype Entreprise réunion.
...
- Les clients sans Skype Entreprise d’utilisateurs configurés pour utiliser un service ACP tiers ne pourront pas configurer les utilisateurs de manière à utiliser un service d’ACP tiers.

- Les clients existants Skype Entreprise utilisateurs configurés pour utiliser un service ACP tiers pourront toujours ajouter de nouveaux utilisateurs pendant la durée de la période de fin de vie. Notez qu’il n’est pas recommandé de mettre en place des utilisateurs de Skype Entreprise supplémentaires de telles personnes, car les modifications qui entreront en vigueur le 31 juillet 2021 s’appliqueront également à ces utilisateurs.
