...
Vous pouvez obtenir un aperçu des conférences Skype entreprise organisées en consultant les graphiques **activité**, **utilisateurs**et **minutes** .
...
* **Appels entrants/sortants-** tierces indique le nombre total de conférences rendez-vous de la Conférence rendez-vous en fonction de votre fournisseur de services d’audioconférence tiers. 
* **Appels entrants/sortants de Microsoft** indique le nombre total de conférences rendez-vous et audio organisées. 
...
***
![Nombre 10](../images/sfbcallout10.png)<br/>Cliquez ou appuyez sur l’icône **colonnes** dans une des colonnes pour ajouter ou supprimer des colonnes dans le rapport.           <br/> ![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)
