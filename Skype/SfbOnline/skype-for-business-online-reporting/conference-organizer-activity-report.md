...
* **Les minutes en** appels sortants avec Microsoft indiquent le nombre total de minutes d’appels sortants utilisés lors de réunions organisées avec Microsoft comme fournisseur de services d’audioconférence. 
