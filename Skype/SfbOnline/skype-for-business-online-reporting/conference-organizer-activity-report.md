...
Ce rapport, ainsi que l’autres Skype pour les rapports d’entreprise, vous donne plus d’informations sur l’activité de conférences organisées au sein de votre organisation. Ces informations détaillées sont très utiles pour analyser, planifier et prendre des décisions pour votre entreprise. 
...
2. Dans la page de **l’utilisation** , cliquez sur **Skype pour l’activité d’organisateur de la conférence** sur **Sélectionner une liste de rapports** sur la gauche. Ou, cliquez sur le widget **Skype pour l’activité** , puis sur **Skype pour l’activité d’organisateur de la conférence** dans la liste **Skype pour l’activité** .
...
Vous pouvez obtenir une vue dans votre Skype pour des conférences qui ont été organisés en examinant les graphiques de **l’activité**, les **utilisateurs**et les **Minutes** .
...
*    Sur le graphique d’activités **Minutes** , l’axe des Y sont le nombre total de minutes audio/vidéo, rendez-vous Microsoft et rendez-vous Microsoft minutes pour les conférences organisées par vos utilisateurs dans votre organisation.  
...
***
![Numéro de 10](../images/sfbcallout10.png)<br/>Cliquez ou appuyez sur l’icône de **colonnes** dans les colonnes pour ajouter ou supprimer des colonnes du rapport.           <br/> ![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)
