...
Ce rapport, ainsi que les autres rapports Skype entreprise, vous fournissent des détails sur l’activité de conférences au sein de votre organisation. Ces informations détaillées sont très utiles pour analyser, planifier et prendre des décisions pour votre entreprise.
...
2. Sur la page **utilisation** , sélectionnez activité de participation à **des conférences Skype entreprise**  >  **Conference participant activity** dans la **liste Sélectionner un rapport** située sur la gauche. Ou cliquez sur le widget **activité Skype entreprise** , puis cliquez sur **activité de participation à des conférences Skype entreprise** dans la liste **activité Skype entreprise** .
...
***
![Nombre 7](../images/sfbcallout7.png)<br/>Chaque graphique a un axe « X » (horizontal) et « Y » (vertical).  
...
***
![Nombre 10](../images/sfbcallout10.png)<br/>Cliquez ou appuyez sur **Colonnes** pour ajouter ou supprimer des colonnes du rapport.           <br/> ![Skype for Business Online Reporting Manage Button.](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)
