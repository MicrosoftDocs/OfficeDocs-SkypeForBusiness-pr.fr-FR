...
En tant qu’administrateur de votre organisation, il est très pratique de disposer de la liste complète des différents rapports disponibles dans Skype entreprise online. Il inclut tous les différents rapports et informations que vous pouvez obtenir avec chaque rapport.
...
Dans les centres d’administration, vous pouvez utiliser différents types de rapports, dont Skype entreprise online.
  
 **Pour afficher les rapports**
  
1. Accédez au centre d’administration ou rapports du **Centre d’administration Skype entreprise**  >  **Reports**.
