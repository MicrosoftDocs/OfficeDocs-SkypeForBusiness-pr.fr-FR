...
***
![Nombre 3](../images/sfbcallout3.png)<br/>**Entrer l’heure de** fin vous permet de mettre la date de fin. Vous pouvez utiliser le calendrier pour sélectionner la date ou entrer la date manuellement. Si aucune date de fin n’est définie, la valeur par défaut est 30 jours à partir de la date de début.
***
