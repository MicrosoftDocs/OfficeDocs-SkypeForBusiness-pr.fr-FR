---
title: Configurer une audioconférence avec Skype Entreprise et Microsoft Teams
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.reviewer: oscarr
...
ms.locfileid: "19703483"
---
# <a name="set-up-audio-conferencing-for-skype-for-business-and-microsoft-teams"></a>Configurer une audioconférence avec Skype Entreprise et Microsoft Teams
...
Vous ne devez configurer les audioconférences que pour les personnes qui envisagent de planifier ou de mener des réunions. Les participants à la réunion qui se connectent n’ont pas besoin de licence ou de configuration particulière.
...
3. Nous vous recommandons également d’affecter des licences de crédits de communications (elles ne coûtent rien) aux mêmes personnes à qui vous avez attribué des licences à l’étape précédente. Pour savoir comment configurer les Crédits de communications, voir [Configurer les Crédits de communications pour votre entreprise](../skype-for-business-and-microsoft-teams-add-on-licensing/set-up-communications-credits-for-your-organization.md).
    
> [!NOTE]
> Vous pouvez également configurer les audioconférences en mode « payer à la minute ». Rendez-vous [ici](../skype-for-business-and-microsoft-teams-add-on-licensing/audio-conferencing-pay-per-minute.md) pour en savoir plus sur la façon de les utiliser.
...
Pour plus d’informations, voir [Attribution d’un nouveau numéro de téléphone à votre pont d’audioconférence](../audio-conferencing-in-office-365/change-the-phone-numbers-on-your-audio-conferencing-bridge.md).
...
Dans le tableau de bord, accédez à **Réunions** > **Ponts de conférence** > **Paramètres de pont**. Cela ouvrira le volet **Paramètres de pont**. Pour plus d’informations, voir [Changement des paramètres de pont d’audioconférence](../audio-conferencing-in-office-365/change-the-settings-for-an-audio-conferencing-bridge.md).

![sfb-logo-30x30.png](../images/sfb-logo-30x30.png) **Utilisation du centre d’administration de Skype Entreprise**

Accédez au **Centre d’administration de Office 365** > **Centres d’administration** > **Skype Entreprise** > **Audioconférence** > **Paramètres de pont Microsoft**. Cela ouvrira la page **Paramètres de pont Microsoft**. Pour plus d’informations, voir [Changement des paramètres de pont d’audioconférence](../audio-conferencing-in-office-365/change-the-settings-for-an-audio-conferencing-bridge.md).
