 ...
 **Cet article est réservé aux Skype Entreprise qui utilisent Microsoft comme fournisseur de services d’audioconférence. Elles ne s’appliquent pas aux clients qui utilisent un fournisseur de services d’audioconférence (ACP) tiers.**
