...
Parfois, les membres de votre organisation devront utiliser un téléphone pour composer le numéro de la réunion. Skype Entreprise inclut la fonction d'audioconférence pour cette situation ! Il est possible de rejoindre des réunions Skype Entreprise en utilisant un téléphone au lieu de l'application Skype Entreprise sur un appareil mobile ou un PC.

Vous ne devez installer l’audioconférence que pour les personnes qui envisagent de planifier ou d’animer des réunions. Les participants à la réunion qui se connectent par téléphone n’ont pas besoin de licence ou de configuration particulière.
...
Pour effectuer cette procédure, vous devez disposer du rôle administrateur. Voir [À propos des rôles d'administrateur Office 365](https://support.office.com/article/da585eea-f576-4f55-a1e0-87090b6aaa9d).
...
1. Déterminer si l’**audioconférence** est disponible dans votre pays/région. [Disponibilité des offres d’appels et d’audioconférence selon les régions et les pays](/microsoftteams/country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans). 
...
2. [Définir les numéros de téléphone inclus dans les invitations](set-the-phone-numbers-included-on-invites.md). Ce numéro de téléphone sera affiché dans la réunion planifiée par un utilisateur.
...
4. [Définir la longueur du code confidentiel pour les réunions en audioconférence](set-the-pin-length-for-audio-conferencing-meetings.md).
