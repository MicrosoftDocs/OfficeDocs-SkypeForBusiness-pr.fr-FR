...
---
# <a name="users-can-make-outbound-calls-to-these-countries-and-regions"></a>Les utilisateurs peuvent effectuer des appels sortants vers ces pays et les régions

### <a name="see-what-countriesregions-users-can-make-outbound-calls-to-if-the-user-has-a-domestic-or-domestic-and-international-calling-plan-license"></a>Voir ce que les utilisateurs de pays/régions peuvent appeler sortants si l’utilisateur possède un domestiques ou domestiques et envisagez d’appel International de licence
