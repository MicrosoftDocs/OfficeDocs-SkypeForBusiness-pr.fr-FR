...
ms.locfileid: "54302128"
---
# <a name="technical-diagrams-for-skype-for-business-server"></a>Diagrammes techniques pour Skype Entreprise Server

**Résumé :** Examinez ces affiches selon vos besoins lors de la planification, de l’implémentation ou de la gestion des Skype Entreprise Server.
...
|**Skype Entreprise Méthodologie de qualité des appels** <br/> ![Version PDF de l’affiche](media/69d33707-8dc4-446a-8d72-0a77be59a64a.png)[de](https://go.microsoft.com/fwlink/p/?LinkId=617899) méthodologie de qualité des appels (préférable pour les appareils mobiles ou les tablettes) <br/> [Visio version](https://go.microsoft.com/fwlink/p/?LinkId=617900) (la meilleure pour les utilisateurs Visio) |Téléchargez cette affiche pour en savoir plus sur CQM, la méthodologie de qualité des appels pour Skype Entreprise Server 2015 qui vous permet de rechercher et d’éliminer les problèmes affectant la qualité des appels et l’expérience utilisateur pour les implémentations qui incluent des fonctionnalités vocales d’entreprise. <br/> <br/> Utilisez la [page de détails de téléchargement](https://go.microsoft.com/fwlink/p/?LinkId=617898) pour obtenir les cartes et les règles imprimables si vous souhaitez l’utiliser en tant que jeu de société. Utilisez cette affiche avec la [carte de performance CQM.](https://go.microsoft.com/fwlink/p/?LinkId=617904) <br/><br/> Taille : 34 par 44 pouces <br/> <br/> Cette affiche a été créée à l Visio 2015. Aucune modification ne doit être nécessaire pour un environnement spécifique. |
