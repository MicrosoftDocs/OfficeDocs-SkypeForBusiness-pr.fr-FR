...
Sur la page d’accueil, le concepteur choisit **Démarrer,** **Concevoir des sites** ou **Afficher.** Pour plus d’informations, voir [Create the initial topology design for Skype for Business Server 2015](create-the-initial-design.md).
