...
1. Connectez-vous à l’ordinateur sur lequel l’Assistant Déploiement de Skype Entreprise Server est installé en tant que membre du groupe Administrateurs du domaine et du groupe RTCUniversalServerAdmins.
...
**Pour ouvrir le Générateur de topologies Skype Entreprise Server pour concevoir la topologie**
...
**Pour ouvrir le Panneau de contrôle Skype Entreprise Server sur un ordinateur exécutant Skype Entreprise Server**

1. À partir d’un compte d’utilisateur membre du rôle CsAdministrator ou d’un autre rôle qui dispose des droits et autorisations d’utilisateur appropriés pour la tâche à effectuer, connectez-vous à un ordinateur sur lequel vous avez installé Skype Entreprise Server ou, au minimum, aux outils d’administration de Skype Entreprise Server. Pour configurer les paramètres, l’ordinateur doit avoir une résolution d’écran minimale de 1 024 x 768.
2. Démarrez le Panneau de contrôle Skype Entreprise Server : cliquez sur **Démarrer,** sur Tous les **programmes,** pointez sur Outils d’administration, pointez sur Skype Entreprise **Server,** puis cliquez sur Panneau de contrôle Skype Entreprise **Server.**
...
Si vous ouvrez une fenêtre Windows PowerShell plutôt que Skype Entreprise Server Management Shell, par défaut vous ne pouvez pas exécuter les cmdlets Skype Entreprise Server. Pour exécuter les cmdlets Skype Entreprise Server à partir de Windows PowerShell, tapez ce qui suit à l’invite Windows PowerShell commande suivante :
