...
Le tableau de bord Skype Entreprise Server qualité des appels (CQD) est une couche de rapports qui se trouve au-dessus de la base de données de qualité de l’expérience dans le serveur de surveillance dans Skype Entreprise Server et Lync Server 2013. Le CQD utilise Microsoft SQL Server Analysis Services pour fournir des informations agrégées sur l’utilisation et la qualité des appels, ainsi que le filtrage et la pivotation sur le jeu de données.
