...
Dans les versions précédentes, OCSLogger.exe était fourni pour permettre aux administrateurs et au personnel de support technique de collecter des fichiers de suivi à partir d’ordinateurs dans le déploiement. OCSLogger, pour tous ses points forts, a connu un raccourci. Vous ne pouviez collecter des journaux que sur un seul ordinateur à la fois. Vous pouvez vous connecter à plusieurs ordinateurs à l’aide de copies distinctes d’OCSLogger, mais vous avez fini par avoir plusieurs journaux et aucun moyen simple d’agréger les résultats.
