...
4.  Dans la page **Stratégie d’accès externe**, effectuez l’une des opérations suivantes :
      ...
      - Pour configurer la stratégie globale pour prendre en charge l’accès des utilisateurs fédérés, cliquez sur la stratégie globale, sur **Modifier, puis** sur Afficher **les détails**.
