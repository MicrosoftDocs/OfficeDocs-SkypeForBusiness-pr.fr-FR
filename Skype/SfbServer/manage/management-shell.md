...
Skype Entreprise Server Management Shell fournit l’interface de ligne de commande pour l’administration et la gestion du serveur. Il s’Windows PowerShell et inclut un ensemble complet d’cmdlets de gestion et d’administration spécifiques à Skype et aux produits serveur Lync hérités.
...
> [!NOTE]
> La référence de cmdlet Skype Entreprise a été déplacée vers docs.microsoft.com. Un clic sur les liens ci-dessous vous permettra d’docs.microsoft.com page. Le contenu est désormais open source et disponible pour les contributions de la communauté via GitHub. Vous souhaitez contribuer ? Consultez le readme dans le repo ici : [https://github.com/MicrosoftDocs/office-docs-powershell](https://github.com/MicrosoftDocs/office-docs-powershell)
