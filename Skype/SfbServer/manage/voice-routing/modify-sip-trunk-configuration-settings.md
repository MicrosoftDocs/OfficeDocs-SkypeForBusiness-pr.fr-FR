---
title: Skype Entreprise paramètres de configuration de la trunk SIP ServerModify
ms.reviewer: ''
ms.author: serdars
author: SerdarSoysal
manager: serdars
...
ms.locfileid: "62386602"
---
# <a name="skype-for-business-servermodify-sip-trunk-configuration-settings"></a>Skype Entreprise paramètres de configuration de la trunk SIP ServerModify
...
3. Dans la **boîte de dialogue Modifier la configuration** de la trunk, sélectionnez les sélections appropriées, puis cliquez sur **OK**.
...
5. Dans la **boîte de dialogue Paramètres de configuration** de la voix noncommand, cliquez sur **OK**.
