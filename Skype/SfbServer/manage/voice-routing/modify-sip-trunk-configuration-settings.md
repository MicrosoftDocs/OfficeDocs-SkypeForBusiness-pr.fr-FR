---
title: Modifier les paramètres de configuration de jonction SIP dans Skype entreprise Server
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
manager: serdars
...
ms.locfileid: "42036242"
---
# <a name="modify-sip-trunk-configuration-settings-in-skype-for-business-server"></a>Modifier les paramètres de configuration de jonction SIP dans Skype entreprise Server
...
> [!Note]
> Les applets de commande Skype entreprise Server applet cstrunkconfiguration prennent en charge les propriétés supplémentaires qui ne figurent pas dans le panneau de configuration de Skype entreprise Server. Pour plus d’informations, consultez la rubrique d’aide relative à l’applet de commande [Set-applet cstrunkconfiguration](https://docs.microsoft.com/powershell/module/skype/Set-CsTrunkConfiguration) . 

**Pour modifier les paramètres de configuration de jonction SIP à l’aide du panneau de configuration de Skype entreprise Server**
...
3. Dans la boîte de dialogue **modifier la configuration** de la jonction, effectuez les sélections appropriées, puis cliquez sur **OK**.
...
6. Dans la boîte de dialogue **panneau de configuration de Skype entreprise Server** , cliquez sur **OK**.
