...
**Résumé :** Apprendre à affecter des stratégies de conférence dans Skype pour Business Server 2015.
  
Vous pouvez affecter des stratégies de conférence aux utilisateurs à l’aide de Skype pour Business Server Management Shell et l’applet de commande **Grant-CsConferencingPolicy** .
  
## <a name="assign-conferencing-policies-by-using-skype-for-business-server-management-shell"></a>Affecter des stratégies de la conférence à l’aide de Skype pour Business Server Management Shell
...
Pour plus d’informations, y compris la syntaxe complète et une liste de paramètres, consultez [Grant-CsConferencingPolicy](https://docs.microsoft.com/powershell/module/skype/grant-csconferencingpolicy?view=skype-ps).
