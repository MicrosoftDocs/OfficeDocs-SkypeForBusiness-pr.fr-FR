...
**Résumé :** Découvrez le rapport d’emplacement dans Skype pour Business Server.
...
|**Pourcentage d’appels médiocres** <br/> |Oui  <br/> |Pourcentage d’appels classé comme médiocres appels. Un appel médiocre désigne un appel dont l’une des valeurs mesurées est supérieure à la valeur autorisée (par exemple, un appel soumis à un phénomène de gigue excessive).  <br/> |
