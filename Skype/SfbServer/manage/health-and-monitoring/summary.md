---
title: Rapport de synthèse de la qualité des médias dans Skype Entreprise Server 2015
ms.author: jambirk
author: jambirk
manager: serdars
ms.date: 6/29/2016
...
description: 'Résumé : Découvrez la qualité rapport sommaire bande dans Skype pour Business Server 2015.'
...
---
# <a name="media-quality-summary-report-in-skype-for-business-server-2015"></a>Rapport de synthèse de la qualité des médias dans Skype Entreprise Server 2015
 
**Résumé :** Obtenir des informations sur le média qualité rapport récapitulatif dans Skype pour Business Server 2015.
...
- Communications unifiées les appels de poste à poste (par exemple un Skype pour entreprise Skype pour l’appel de l’entreprise)
...
Quand vous ouvrez le rapport pour la première fois, une synthèse des informations pour chaque catégorie s’affiche. Sans quitter l’état, vous pouvez développer chaque catégorie à examiner des sous-catégories telles que les appels effectués à partir d’Office Communicator 2007 R2 à Skype pour les entreprises. Vous pouvez développer également ces sous-catégories pour afficher des détails sur chaque appel passé dans cette sous-catégorie.
  
Dans Skype pour Business Server 2015 davantage le rapport de synthèse de qualité Media divise les données en trois types d’appel : appels audio, appels vidéo, partage d’applications et les appels. Chaque type d’appel correspond à une section du rapport, et dispose d’un ensemble personnalisé de mesures des appels.
...
Le rapport de synthèse de la qualité des médias est accessible à partir de la page d’accueil Rapports de surveillance. Vous pouvez accéder à l' [Appel de rapport liste dans Skype pour Business Server 2015](call-list-report-0.md) en cliquant sur une des mesures suivantes :
...
**Filtres de rapport de synthèse de qualité multimédia**
...
**Mesures de rapport de synthèse de qualité multimédia : Résumé appel Audio**
...
**Mesures de rapport de synthèse de qualité multimédia : Résumé appel vidéo**
...
**Mesures de rapport de synthèse de qualité multimédia : Application partage de synthèse des appels**
