...
---
# <a name="monitor-for-server-memory-capacity-limits-in-skype-for-business-server"></a>Surveiller les limites de capacité de mémoire des serveurs dans Skype Entreprise Server
