...
---
# <a name="conference-join-time-report-in-skype-for-business-server"></a>Rapport de temps d’accès aux conférences dans Skype Entreprise Server
 
**Résumé :** Découvrez le rapport de synthèse des heures d’accès aux conférences dans Skype Entreprise Server.
