...
---
# <a name="server-performance-report-in-skype-for-business-server-2015"></a>Rapport de performances du serveur dans Skype Entreprise Server 2015
 
**Résumé :** Obtenir des informations sur le rapport de performances du serveur dans Skype pour Business Server 2015.
  
Le rapport de performances de serveur fournit une liste de Skype pour les serveurs Business Server 2015 qui ont rencontré le plus fort pourcentage d’appels médiocres. Ce rapport est décomposé en fonction des types de serveur, et propose des statistiques distinctes pour les types suivants :
...
Il est important de noter que le classement indiqué dans cet état en tant que classement respectif. Par exemple, supposons que le serveur ayant les pires performances a reçu un appel médiocre sur les 1 000 passés. Ce pourcentage de 0,1 est plus qu’acceptable. Cependant, s’il s’agit du serveur ayant les pires performances (c’est-à-dire que les autres serveurs ont un pourcentage d’appels médiocres inférieur à 0,1 %), ce serveur s’affichera dans le rapport de performances du serveur.
  
## <a name="accessing-the-server-performance-report"></a>Accès au rapport de performances du serveur

Le rapport de performances du serveur est accessible à partir de la page d’accueil Rapports de surveillance. Vous pouvez accéder à l' [Appel de rapport liste dans Skype pour Business Server 2015](call-list-report-0.md) en cliquant sur une des mesures suivantes :
...
**Filtres de rapport de performances de serveur**
...
|**Type de serveur** <br/> |Indique le type de serveur dont les performances doivent être rapportées. Sélectionnez l’une des options suivantes :  <br/> [All] Le serveur de médiation A / V Conferencing Server A / V Edge Server |
|**N premiers** <br/> |Indique le nombre de serveurs (sur la base du pourcentage d’appels médiocres) à afficher dans chaque catégorie. Par exemple, si vous sélectionnez **5**, les cinq serveurs ayant les performances les plus médiocres sont affichés. Sélectionnez l’une des options suivantes :<br/> [All] 5 10 |
...
**Mesures d’état des performances du serveur : Synthèse des appels Audio**

|**Nom**|**Pouvez trier sur**|**Description**|
|:-----|:-----|:-----|
...
|**Gigue (ms)** <br/> |Oui  <br/> |Gigue moyenne détectée entre les arrivées de paquets RTP. (La gigue permet de mesurer les fluctuations d’un appel.) Les valeurs de gigue élevées peuvent provenir d’une congestion ou d’un serveur multimédia surchargé, ce qui se traduit par une distorsion ou une perte de l’audio.  <br/> |
...
**Mesures d’état des performances du serveur : Synthèse des appels vidéo**
...
|**Image figée (%)** <br/> |Non  <br/> |Pourcentage de trames « figés ». Dans une image figée, la vidéo cesse d’avancer tandis que la partie audio de l’appel continue.  <br/> |
...
**Mesures d’état des performances du serveur : Application partage de synthèse des appels**
