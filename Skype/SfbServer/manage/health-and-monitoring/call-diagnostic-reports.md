...
**Résumé :** Découvrez les rapports de diagnostic des appels multi-utilisateurs utilisés dans Skype Entreprise Server.
...
- [Rapport des listes d’échecs dans Skype Entreprise Server](failure-list-report.md) Fournit des informations détaillées sur les participants individuels impliqués dans une conférence qui a échoué.
    
- [Rapport de diagnostic dans Skype Entreprise Server](diagnostic-report.md) Fournit des informations de diagnostic et de dépannage (notamment des codes de réponse SIP, des en-têtes et des ID de diagnostic) pour les sessions qui ont échoué.
