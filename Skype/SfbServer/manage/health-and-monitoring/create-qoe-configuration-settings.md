...
Les paramètres de configuration QoE peuvent être créés à l’aide Skype Entreprise Server panneau de configuration ou de l’cmdlet [New-CsQoEConfiguration](/powershell/module/skype/new-csqoeconfiguration?view=skype-ps). Si vous utilisez Skype Entreprise Server panneau de configuration pour créer de nouveaux paramètres, les options suivantes sont disponibles :
