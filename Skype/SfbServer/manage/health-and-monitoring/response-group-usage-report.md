...
Le rapport d’utilisation de Response Group est accessible depuis la page d’accueil Rapports de surveillance. Vous pouvez descendre dans le rapport des listes d’appels [Response Group](call-list-report.md) dans Skype Entreprise Server en cliquant sur l’une des mesures suivantes :
