...
1. Dans Skype Entreprise Server, cliquez sur **Surveillance et archivage**.
...
Pour plus d’informations, voir la rubrique d’aide pour l';cmdlet [Get-CsCdrConfiguration](/powershell/module/skype/get-cscdrconfiguration?view=skype-ps) .
