...
## <a name="view-the-status-of-services-running-on-a-skype-for-business-server"></a>Afficher l’état des services en cours d’exécution sur un serveur Skype Entreprise
