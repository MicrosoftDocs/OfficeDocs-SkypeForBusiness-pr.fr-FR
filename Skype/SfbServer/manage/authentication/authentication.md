...
ms.locfileid: "60772140"
---
# <a name="manage-authentication-in-skype-for-business-server"></a>Gérer l’authentification dans Skype Entreprise Server
 
**Résumé :** Utilisez les procédures suivantes pour gérer la sécurité Skype Entreprise Server et l’authentification.
...
- [Stage AV and OAuth certificates in Skype Entreprise Server using -Roll in Set-CsCertificate](stage-av-and-oauth-certificates.md)
...
- [Configurez l’authentification de serveur à serveur pour un environnement Skype Entreprise Server hybride.](configure-a-hybrid-environment.md)

- [Configurer une application partenaire sur site pour Skype Entreprise Server](configure-an-on-premises-partner-app.md)
    
- [Gérer les paramètres de configuration du bureau d’enregistrement d’inscriptions Skype Entreprise Server](registrar-configuration-settings.md)
    
- [Gérer les paramètres de configuration du service Web dans Skype Entreprise Server](web-service-configuration-settings.md)
