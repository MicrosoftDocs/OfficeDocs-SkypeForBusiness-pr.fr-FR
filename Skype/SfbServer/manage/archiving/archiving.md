...
Avant de lire cette rubrique, assurez-vous que vous connaissez les informations de [la rubrique Planifier](../../plan-your-deployment/archiving/archiving.md) l’archivage dans Skype Entreprise Server et Déployer l’archivage [pour Skype Entreprise Server](../../deploy/deploy-archiving/deploy-archiving.md).
...
- Utiliser l’intégration Exchange de données
...
|:-----|:-----|
|Export-CsArchivingData  <br/> |Exporte les enregistrements qui ont été stockés dans la base Skype Entreprise Server d’archivage.  <br/> |
