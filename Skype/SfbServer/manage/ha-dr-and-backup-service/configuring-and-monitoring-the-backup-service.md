...
Par exemple, l’exemple suivant définit l’intervalle sur trois minutes.
...
Supposons que Pool1 est couplé à Pool2 et que les données de conférence de Pool1 sont perdues. Vous pouvez utiliser l’cmdlet suivante pour appeler le service de sauvegarde afin de restaurer le contenu :
