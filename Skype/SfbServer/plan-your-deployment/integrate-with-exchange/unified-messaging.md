...
Pour plus d’informations sur les composants de messagerie unifiée Exchange dans Microsoft Exchange Server 2010, voir [Déploiement local la messagerie unifiée Exchange pour fournir la messagerie vocale Lync Server 2013 Preview](http://technet.microsoft.com/library/9673bd73-a3a3-425d-870f-04d801c6d0d5.aspx) .
