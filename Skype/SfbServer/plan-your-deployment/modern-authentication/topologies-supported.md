...
Il ressemble donc un peu à ceci, avec EXO et SFBO dans le cloud avec Azure AD, et Exchange Server (EXCH) et le serveur Skype Entreprise (SFB) sur site.
