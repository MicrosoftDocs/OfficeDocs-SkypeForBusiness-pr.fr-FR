...
|:-----|:-----|
|Décodage matériel accéléré H.264 à l’aide de l’accélération vidéo DirectX (DXVA)  <br/> |• La carte graphique doit prendre en charge DirectX 9,0 et exposer le mode de décodage DXVA2_ModeH264_VLD_NoFGT et l’API DirectX 9.  <br/> • Le pilote le plus récent pour la carte graphique doit être installé.  <br/> |
