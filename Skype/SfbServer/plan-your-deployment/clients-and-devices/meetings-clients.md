...
| Système d’exploitation | Edge | Internet Explorer 11 ou version ultérieure 32 et 64 bits | Internet Explorer 10 ou une version ultérieure 32 et 64 bits | Internet Explorer 9 ou version ultérieure 32 et 64 bits | 32 et 64 bits Version de Firefox 12.X ou ultérieur | Version de Chrome 32 et 64 bits 18.X ou version ultérieure |
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
| Fonctionnalité | Skype pour client d’entreprise 2016 | Skype pour le commerce sur le client Mac | Application Réunions Skype | Application web Skype Entreprise | Lync Web App |
|:-----|:-----|:-----|:-----|:-----|:-----|
...
|Commutateur audio pour un téléphone pour que les participants authentifiés  <br/> |& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|
|Commutateur audio pour un téléphone pour les participants de l’invité  <br/> |& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|||
...
|Partager un programme (si option activée)  <br/> |& #x 2714 ;||& #x 2714 ; (sous Windows uniquement ; nécessite le plug-in)  <br/> |& #x 2714 ; (sous Windows uniquement ; nécessite le plug-in)  <br/> |& #x 2714 ; (sous Windows uniquement ; nécessite le plug-in)  <br/> |
|Prendre le contrôle d’un bureau partagé d’un autre utilisateur ou un programme  <br/> |& #x 2714 ;||& #x 2714 ; (sous Windows uniquement ; nécessite le plug-in)  <br/> |& #x 2714 ; (sous Windows uniquement ; nécessite le plug-in)  <br/> |& #x 2714 ; (sous Windows uniquement ; nécessite le plug-in)  <br/> |
|Autoriser un autre utilisateur de prendre le contrôle de votre programme ou votre bureau partagé  <br/> |& #x 2714 ;|||||
|Ajouter des participants anonymes (si option activée)  <br/> |& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|
|Inviter des participants par nom  <br/> |& #x 2714 ;|& #x 2714 ;||||
...
|Ajouter et télécharger les pièces jointes  <br/> |& #x 2714 ;||& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|
...
|Q&amp;un gestionnaire  <br/> |& #x 2714 ;||& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|
...
|Public muet  <br/> |& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|& #x 2714 ;|
|Inviter tout le monde à participer  <br/> |& #x 2714 ;|||||
|Produire une diffusion de réunion Skype  <br/> |& #x 2714 ;|||||
   
 & #x 2776 ;  Les participants ne peuvent pas contrôler les postes de travail qui sont partagés par Lync pour Mac 2011 ou Communicator pour Mac 2011 utilisateurs. Les utilisateurs Lync pour Mac 2011 et Communicator pour Mac 2011 peuvent contrôler les bureaux partagés par les utilisateurs Windows. Cela ne peut fonctionner pour lʼapplication Skype Entreprise Web sur Max OSX.
  
 & #x 2777 ;  Pour Skype pour professionnels en ligne, cette fonctionnalité requiert Microsoft RTPC Conferencing, la messagerie unifiée Exchange, ou une 3ème partie fournisseur de conférence audio.
  
 & #x 2778 ;  Le Lync pour Mac 2011 client ne peut pas afficher des présentations PowerPoint de Microsoft Office 2013 lorsqu’ils ont été partagées dans une conférence par le Skype pour Business Web App.
