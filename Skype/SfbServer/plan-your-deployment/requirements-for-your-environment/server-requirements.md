...
Vous pouvez utiliser la mise en SQL ou SQL clustering avec Skype Entreprise Server 2015, elle est prise en charge. SQL mise en miroir est définie par le biais du Générateur de topologies Skype Entreprise Server. Si vous avez l’intention de SQL clustering de clustering, cette configuration est effectuée SQL Server.
...
- Microsoft SQL Server Entreprise 2016 (édition 64 bits) avec Service Pack 1 ou version ultérieure. Nous vous recommandons d’être en cours d’exécution avec le dernier Service Pack.
