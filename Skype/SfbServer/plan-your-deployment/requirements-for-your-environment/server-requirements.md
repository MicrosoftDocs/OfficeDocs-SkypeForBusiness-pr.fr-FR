...
|:-----|:-----|
|UC   |Bi-processeur 64 bits, hex-core, 2,26 gigahertz (GHz) ou supérieur.  <br/> Les processeurs Intel Itanium ne sont pas pris en charge pour Skype Entreprise Server 2015.   |
...
|Composant matériel|Recommandé|
|:-----|:-----|
|UC   |Double processeur 64 bits, quadruple cœur, 2,26 gigahertz (GHz) ou supérieur.  <br/> Les processeurs Intel Itanium ne sont pas pris en charge pour Skype Entreprise Server 2015.   |
...
|Windows Server 2012 Système d’exploitation du centre de données R2 avec toutes les mises à jour requises installées.   |Windows Server 2012 Système d’exploitation R2 Standard avec toutes les mises à jour requises installées.   |
...
- Si vous avez Windows Server 2012 R2, installez l’article de la 2982006 avant la mise à niveau. [Elle est trouvée ici.](https://support.microsoft.com/kb/2982006/)
...
Vous devrez configurer l’infrastructure pour le stockage d’archivage. Cela inclut le choix entre Exchange stockage d’archivage à l’aide SQL Server.   Skype Entreprise Server Les conditions requises pour l’infrastructure d’archivage sont les mêmes que pour le déploiement de Skype Entreprise Server. Pour plus d’informations, [voir Requirements for your Skype Entreprise environment.](../../plan-your-deployment/requirements-for-your-environment/requirements-for-your-environment.md) 
...
### <a name="sql-mirroring-sql-clustering-and-sql-always-on"></a>SQL Mise en miroir, SQL clustering et SQL Always On

Vous pouvez utiliser la mise en SQL ou SQL clustering avec Skype Entreprise Server 2015, elle est prise en charge. SQL La mise en miroir est définie par le biais Skype Entreprise Server de topologie. Si vous avez l’intention de SQL clustering de clustering, cette mise à jour est effectuée SQL Server.
...
- Microsoft SQL Server 2016 Enterprise (édition 64 bits) avec Service Pack 1 ou version ultérieure. Nous vous recommandons d’être en cours d’exécution avec le service pack le plus récent.
...
Vous devrez installer ou configurer certains éléments pour n’importe quel serveur exécutant Skype Entreprise Server 2015, et ils sont répertoriés ci-dessous. Après cela, il existe des exigences supplémentaires pour des rôles serveur spécifiques.
