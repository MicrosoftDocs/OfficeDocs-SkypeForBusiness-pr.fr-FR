...
> [!NOTE]
> Vous avez remarqué que Windows Server 2008 R2 ne figure pas dans cette liste. C’est parce que nous vous recommandons de Windows Server 2012 R2 pour tous les nouveaux serveurs à utiliser pour SFB. Vous devez uniquement utiliser Windows Server 2008 R2 lorsque vous avez des serveurs existants avec Lync Server 2013 est déjà installé, et que vous avez l’intention d’effectuer une mise à niveau sur place de leur. Windows Server 2008 R2 atteint la fin du cycle de vie du support général sur 13/1/2015. 
