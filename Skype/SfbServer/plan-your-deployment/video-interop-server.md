...
description: 'Résumé : Examinez cette rubrique lors de la planification de l Skype Entreprise Server des périphériques de téléconférence tiers.'
...
- Conversion d’un flux vidéo unique à une résolution donnée d’un VTC en plusieurs flux de diffusion simulcast de différentes résolutions à utiliser dans le déploiement Skype Entreprise Server vidéo. Ces flux peuvent être envoyés à l’AVMCU, puis Skype Entreprise Server points de terminaison et autres systèmes vidéo qui ont demandé différentes résolutions. Cette conversion est également utilisée lorsque le système vidéo tiers est impliqué dans une conférence Skype Entreprise A/V. Une fois la limite de transcodage atteinte sur un serveur VIS particulier, les demandes suivantes pour différentes résolutions reçoivent uniquement un flux avec la résolution la plus faible. 
...
- Les nouveaux appels du déploiement Skype Entreprise vers les VTC via la trunk SIP vidéo ne sont pas pris en charge. . Cela signifie que seuls les nouveaux appels des VTC vers le déploiement Skype Entreprise sont pris en charge via la trunk SIP vidéo. La présence du système vidéo pris en charge ne sera pas disponible sur la trunk SIP vidéo vers le VIS. 
...
Pour que Lync 2013 fonctionne correctement avec le vis qui fait partie d’un déploiement Skype Entreprise, Lync 2013 a besoin de la mise à jour de mise à jour client Lync 2013, caA et AVMCU pour fonctionner avec le VIS.
