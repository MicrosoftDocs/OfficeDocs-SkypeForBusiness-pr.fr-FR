...
Skype pour Business Server ne gère pas la personnalisation des invites vocales et de musique pour les conférences rendez-vous. Toutefois, si vous avez besoin de forte activité nécessitant vous permet de modifier les fichiers audio par défaut, voir l’article 961177, [comment personnaliser les invites vocales ou fichiers de musique pour les services d’audioconférence rendez-vous](http://go.microsoft.com/fwlink/p/?linkid=3052&amp;kbid=961177)de la Base de connaissances Microsoft.
