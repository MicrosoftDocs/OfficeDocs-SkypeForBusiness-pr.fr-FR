...
- Exchange pour les utilisateurs distants utilisant **Exchange de la** Exchange 2013.
...
Nous avons abordé la cocation du serveur Edge dans notre documentation de base sur la [topologie Skype Entreprise Server](../../plan-your-deployment/topology-basics/topology-basics.md) documentation.
