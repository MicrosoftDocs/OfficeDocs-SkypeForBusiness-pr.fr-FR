...
- **Panneau de contrôle Skype Entreprise Server.** Vous pouvez utiliser l’interface utilisateur du Panneau de contrôle Skype Entreprise Server pour gérer les tâches les plus courantes dans votre déploiement.
