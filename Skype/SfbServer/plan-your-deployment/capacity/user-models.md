...
## <a name="skype-for-business-server-user-models"></a>Skype Entreprise Server utilisateurs
...
|Répartition des clients inscrits  <br/> |65 % des clients exécutent Skype Entreprise logiciels, notamment Skype Entreprise Lync Téléphone Edition.  <br/> 30 % des clients exécutant un logiciel client à partir d’une version antérieure de Lync.  <br/> 5 % des clients utilisant Application Web Skype Entreprise.  <br/> Si la mobilité est activée, nous partons du principe que 40 % des utilisateurs utilisent la mobilité simultanément avec les autres options clientes inscrites mentionnées précédemment. Dans ce cas, le rapport client de point de présence multiple (MPOP) est de 1:1,9. Si la mobilité est désactivée, le rapport de MPOP est de 1/1,5.  <br/> |
...
|**Catégorie**|**Description**|
|:-----|:-----|
|Réunions planifiées/réunions immédiates  <br/> |60 % des réunions sont planifiées, 40 % ne le sont pas.  <br/> Des réunions prévues, nous partons du principe que 80 % des conférences sont affectées, qui sont des occurrences de conférences périodiques ; 10 % sont des réunions ouvertes à une seule fois ; 8 % sont des réunions anonymes à une seule fois et 2 % sont des réunions fermées à une seule heure.  <br/> |
...
Les hypothèses suivantes s’appliquent aux Voix Entreprise suivants :
