...
## <a name="skype-for-business-server-user-models"></a>Modèles utilisateur Skype Entreprise Server
...
|Utilisateurs VoIP (Voix sur IP)  <br/> |60 % des utilisateurs de Skype Entreprise Server sont activés pour les communications unifiées (autrement dit, leurs numéros de téléphone sont la propriété de Skype Entreprise Server).  <br/> |
|Répartition des clients inscrits  <br/> |65 % des clients exécutent le logiciel Skype Entreprise, y compris Skype Entreprise et Lync Phone Edition.  <br/> 30 % des clients exécutant un logiciel client à partir d’une version précédente de Lync.  <br/> 5 % des clients utilisent Skype Entreprise Web App.  <br/> Si la mobilité est activée, nous partons du principe que 40 % des utilisateurs utilisent la mobilité simultanément avec les autres options clientes inscrites mentionnées précédemment. Dans ce cas, le rapport client multi-points de présence (MPOP) est de 1:1,9. Si la mobilité est désactivée, le rapport de MPOP est de 1/1,5.  <br/> |
