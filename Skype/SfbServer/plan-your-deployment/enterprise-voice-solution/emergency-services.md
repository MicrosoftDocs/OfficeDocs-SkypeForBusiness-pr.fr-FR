...
2. Skype Entreprise Server correspond au numéro d’urgence, puis route l’appel (en fonction de la valeur d’utilisation **PSTN** définie dans la stratégie d’emplacement applicable) vers un serveur de médiation, puis à partir de là vers une passerelle ELIN.
