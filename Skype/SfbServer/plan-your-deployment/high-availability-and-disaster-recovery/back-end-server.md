...
L’utilisation de l’une de ces solutions est facultative, mais est recommandée pour maintenir la continuité des activités de votre organisation. Sinon, la panne d’un serveur de base de données unique peut entraîner la perte de données Skype Entreprise Server importantes. 
...
- SQL Server 2019, Enterprise Edition et Standard Edition
...
- SQL Server Standard Edition 2017 avec des limitations, voir la remarque ci-dessous
