 ...
 **Utiliser une stratégie de code confidentiel pour les téléphones IP** La stratégie code confidentiel (PIN) prend en charge l’authentification pour les utilisateurs qui se connectent à Skype entreprise Server à l’aide d’un téléphone IP.
