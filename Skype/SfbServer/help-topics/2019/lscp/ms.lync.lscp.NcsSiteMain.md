...
ms.locfileid: "54335614"
---
# <a name="configure-a-network-site"></a>Configurer un site réseau

Que voulez-vous faire ? Cliquez sur le lien correspondant à la tâche que vous voulez effectuer.

- [Configuration des sites réseau](/previous-versions/office/lync-server-2013/lync-server-2013-creating-or-modifying-network-sites)