...
La boîte de dialogue **Sélectionner les règles de traduction du numéro d’appel** affiche les règles de conversion configurées pour votre déploiement. Pour plus d’informations sur les règles de traduction, reportez-vous aux rubriques suivantes :
...
3. [Création ou modification d’une règle de traduction pour appeler une présentation dans Skype entreprise Server](../../../deploy/deploy-enterprise-voice/called-id-presentation-rules.md)
