...
- **Agent utilisateur** Vous pouvez sélectionner un type de client dans la liste. Le tableau suivant définit les codes d’agent utilisateur. Cette liste inclut les types de clients hérités, dont certains ne sont plus pris en charge.
