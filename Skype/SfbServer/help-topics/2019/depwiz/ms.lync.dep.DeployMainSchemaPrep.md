...
Les classes et attributs sont ajoutés pour étendre le schéma des services de domaine Active Directory pour prendre en charge les objets serveur, service et utilisateur de Skype entreprise Server. Avant d’étendre le schéma, effectuez une sauvegarde de l’état du système du contrôleur de domaine qui contient le rôle de contrôleur de schéma. 
