...
5. Sous la colonne **Action** , développez Préparation du **domaine,** recherchez un résultat d’exécution à la fin de chaque tâche pour vérifier que la préparation du domaine s’est **\<Success\>** correctement terminée, fermez le journal, puis cliquez sur **Terminer**.
