...
ms.locfileid: "20995180"
---
# <a name="certificate-request-intro"></a>Demande de certificat (introduction)
 
Pour poursuivre le processus de demande de certificat, cliquez sur **suivant**. Pour quitter le processus sans apporter de modifications au système, cliquez sur **Annuler**.
