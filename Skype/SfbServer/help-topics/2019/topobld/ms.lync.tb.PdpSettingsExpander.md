...
- **Activer le contrôle d’admission des appels** Sélectionnez ce paramètre pour activer CAC. Désactivez ce paramètre pour désactiver CAC pour votre réseau. Pour activer CAC, vous devez configuré votre réseau pour CAC. Pour plus d’informations, voir [déployer le contrôle d’admission des appels dans Skype pour Business Server](../../../deploy/deploy-enterprise-voice/deploy-call-admission-control.md) dans la documentation de déploiement.
