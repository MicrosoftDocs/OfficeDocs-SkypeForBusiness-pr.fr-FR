...
- **Magasin SQL Server de surveillance**: sélectionnez un nom de domaine complet du serveur SQL (et éventuellement une instance) dans la liste.
...
[Associer un magasin de surveillance à un pool frontal dans Skype pour Business Server 2015](../../../deploy/deploy-monitoring/associate-a-monitoring-store.md)
