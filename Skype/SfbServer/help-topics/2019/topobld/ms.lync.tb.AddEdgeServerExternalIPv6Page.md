...
ms.locfileid: "41798221"
---
# <a name="add-edge-server-external-ipv6"></a>Ajouter l’adresse IPv6 externe du serveur Edge
 
Dans **adresse IPv6 externe**, entrez l’adresse IP externe qui pointe vers le service Edge d’accès, le service Edge de conférence Web et le service Edge A/V.
