...
Pour plus d’informations sur le déplacement du magasin Central Management Server, voir [Move-CsManagementServer](/powershell/module/skype/move-csmanagementserver?view=skype-ps) dans la Windows PowerShell cmdlet.
