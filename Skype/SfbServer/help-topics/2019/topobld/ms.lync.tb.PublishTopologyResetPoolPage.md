...
Pour ajouter de nouveaux ordinateurs à un pool existant, vous devez réinitialiser le pool afin de permettre la redéfinition des connexions entre les membres du pool par Windows Fabric. À cet effet, sélectionnez le pool auquel vous avez ajouté des serveurs, puis cliquez sur **Suivant**.
