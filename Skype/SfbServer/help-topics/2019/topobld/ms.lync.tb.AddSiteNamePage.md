...
ms.locfileid: "41689023"
---
# <a name="add-site-name"></a>Ajouter le nom du site
 
Pour définir le premier site dans votre déploiement, spécifiez le nom du premier site. Vous pouvez également spécifier une description pour le premier site.
