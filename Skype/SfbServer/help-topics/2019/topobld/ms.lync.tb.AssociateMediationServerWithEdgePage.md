...
> [!NOTE]
> Si vous n’avez pas encore défini de serveur Edge ou de pool de serveurs Edge dans votre déploiement, la liste déroulante ne contiendra pas d’entrées. Vous pouvez cliquer sur **suivant** pour continuer et modifier les paramètres du serveur de médiation après avoir ajouté un serveur Edge ou un pool à votre déploiement.
  
Pour plus d’informations, reportez-vous à [la rubrique déploiement d’un serveur de médiation dans le générateur de topologie de Skype entreprise Server](../../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md).
