...
---
# <a name="mediation-next-hop-settings-expander"></a>Expanseur des paramètres du tronçon suivant du serveur de médiation
...
Pour plus d’informations sur les paramètres pour le pool de serveur de médiation ou un serveur de médiation, voir [déployer un serveur de médiation dans le Générateur de topologie dans Skype pour Business Server 2015](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) dans la documentation de déploiement.
