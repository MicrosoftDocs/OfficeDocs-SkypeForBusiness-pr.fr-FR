...
> [!NOTE]
> Si vous souhaitez activer le cac dans votre déploiement, vous devez activer le cac dans exactement un pool par site central. Nous vous recommandons de le faire si vous déployez des fonctionnalités vocales ou une conférence A/V.
