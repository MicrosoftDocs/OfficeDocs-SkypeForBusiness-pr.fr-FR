...
Mettez à jour le nom de domaine complet (FQDN) du pool de serveurs de conférence A/V en entrant le nom du pool tel qu’il est défini dans le DNS (Domain Name System).
