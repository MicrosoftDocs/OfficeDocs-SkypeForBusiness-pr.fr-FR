...
- **Nouveau pool de médiation**. Lance l’assistant **Définir un nouveau pool de médiation** qui permet d’ajouter un nouveau pool de médiation à la topologie.
