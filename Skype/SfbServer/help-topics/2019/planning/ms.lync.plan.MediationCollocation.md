...
description: 'Le serveur de médiation est coqueté avec le serveur frontal par défaut. Le serveur de médiation peut également être déployé dans un pool autonome pour des raisons de performances, ou si vous déployez une trunking SIP, auquel cas le pool autonome est vivement recommandé. La cocation Skype Entreprise Server fonctionne comme dans Lync Server 2013. Pour plus de détails, consultez les rubriques suivantes :'
ms.openlocfilehash: 7899d15384a093c37701f977a12e08bbc1636406
ms.sourcegitcommit: 65a10f80e5dfd67b2778e09f5f92c21ef09ce36a
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 11/04/2021
ms.locfileid: "60742470"
---
...
- [Composant serveur de médiation dans Skype Entreprise Server](../../../plan-your-deployment/enterprise-voice-solution/mediation-server.md)
