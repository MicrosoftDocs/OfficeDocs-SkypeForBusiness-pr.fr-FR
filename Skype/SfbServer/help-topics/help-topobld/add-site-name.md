...
---
# <a name="add-site-name"></a><span data-ttu-id="8cdd0-104">Ajouter le nom du site</span><span class="sxs-lookup"><span data-stu-id="8cdd0-104">Add Site Name</span></span>
 
<span data-ttu-id="8cdd0-p102">Pour définir le premier site dans votre déploiement, spécifiez son nom. Vous pouvez éventuellement ajouter une description du premier site.</span><span class="sxs-lookup"><span data-stu-id="8cdd0-p102">To define the first site in your deployment, specify the name of the first site. Optionally, you can specify a description for the first site.</span></span>
