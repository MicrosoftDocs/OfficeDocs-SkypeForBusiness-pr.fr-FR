...
Pour plus d’informations sur la spécification de fonctionnalités pour un serveur Édition Standard ou un pool Êdition Entreprise, voir Définir et configurer un pool frontal ou un serveur [Édition Standard dans](/previous-versions/office/lync-server-2013/lync-server-2013-define-and-configure-a-front-end-pool-or-standard-edition-server) la documentation de déploiement.