...
Pour plus d’informations sur le déplacement du magasin Central Management Server, voir [Move-CsManagementServer](https://docs.microsoft.com/powershell/module/skype/move-csmanagementserver?view=skype-ps) dans la référence Windows PowerShell cmdlet.
