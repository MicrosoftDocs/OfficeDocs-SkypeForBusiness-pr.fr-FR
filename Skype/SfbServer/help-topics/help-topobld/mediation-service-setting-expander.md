...
---
# <a name="mediation-service-setting-expander"></a><span data-ttu-id="54533-103">Expanseur des paramètres du service de médiation</span><span class="sxs-lookup"><span data-stu-id="54533-103">Mediation Service Setting Expander</span></span>
 
<span data-ttu-id="54533-104">Utilisez cette page pour configurer les ports d’écoute pour ce serveur de médiation, et configurez ses associations avec les passerelles PSTN.</span><span class="sxs-lookup"><span data-stu-id="54533-104">Use this page to set the listening ports for this Mediation Server, and set its associations with public switched telephone network (PSTN) gateways.</span></span> 
