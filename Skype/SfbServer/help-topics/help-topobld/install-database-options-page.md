...
---
# <a name="install-database-options-page"></a>Installer la Page Options de base de données
...
> [!IMPORTANT]
> Les chemins d’accès que vous entrez peuvent être modifiés en fonction des algorithmes d’optimisation de performances de l’installation. Pour plus d’informations, voir la [Base de données Installation à l’aide de Lync Server Management Shell](http://technet.microsoft.com/library/c90a6449-4dd5-4b18-b21c-ea2c2a64dc3c.aspx). 
...
[Emplacement des fichiers journaux et données SQL Server](http://technet.microsoft.com/library/67aa525b-8aa3-474f-827e-8e1d4697f30f.aspx)