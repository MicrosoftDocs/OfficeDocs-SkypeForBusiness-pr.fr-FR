...
Pour définir la passerelle de réseau téléphonique public commuté pour un Survivable Branch Appliance à un site de la succursale, vous devez spécifier les éléments suivants : 
  
- Un nom de domaine complet (FQDN) ou l’adresse IP de l’homologue de la passerelle que le Survivable Branch Appliance ou le serveur Survivable Branch Server associé pour le routage entrant et sortant RTC appelle.
    
    > [!IMPORTANT]
    > Si vous définissez un Survivable Branch Appliance, il s’agit de la passerelle à laquelle le serveur de médiation à l’intérieur de la Survivable Branch Appliance se connectera pour connectivité RTPC. 
