---
title: "Expanseur des paramètres de l’ordinateur Edge pour Lync Server\_2010"
ms.reviewer: null
ms.author: serdars
author: SerdarSoysal
manager: serdars
...
- Vous configurez l’adresse **IPv4** externe du **service Edge** d’accès associée à cet ordinateur
    ...
    > [!IMPORTANT]
    > Si vous avez choisi d’utiliser une seule adresse IP pour la configuration du serveur Edge, vous ne pourrez modifier que l’adresse IPv4 externe du service Edge d’accès. Les autres services Edge partagent la même adresse IPv4 que le service Edge d’accès. 
