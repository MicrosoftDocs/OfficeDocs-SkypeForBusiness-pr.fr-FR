...
La valeur **5061** du **Port d’accès SIP interne** correspond au port SIP TCP par défaut utilisé pour communiquer avec des clients, des pools et des serveurs frontaux hérités. Si la valeur par défaut n’est pas utilisée, mettez à jour la valeur **Port d’accès SIP interne** .
