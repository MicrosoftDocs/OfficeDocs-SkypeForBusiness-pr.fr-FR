...
Pour plus d’informations sur les paramètres du pool de serveurs de médiation ou du serveur de médiation, voir [déploiement d’un serveur de médiation dans le générateur de topologie de Skype entreprise Server 2015](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) dans la documentation de déploiement.
