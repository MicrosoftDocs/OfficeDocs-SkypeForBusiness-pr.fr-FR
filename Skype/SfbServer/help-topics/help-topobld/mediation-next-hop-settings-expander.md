...
Pour plus d’informations sur les paramètres du pool de serveurs de médiation ou du serveur de médiation, voir [Deploy a Mediation Server in Topology Builder in Skype for Business server 2015](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md) dans la documentation de déploiement.
