...
Activez la case à cocher Activer la fédération pour ce **pool Edge (port 5061)** si vous souhaitez configurer la fédération avec un partenaire approuvé Lync Server 2013, Microsoft Lync Server 2010 ou Microsoft Office Communications Server 2007 R2.
