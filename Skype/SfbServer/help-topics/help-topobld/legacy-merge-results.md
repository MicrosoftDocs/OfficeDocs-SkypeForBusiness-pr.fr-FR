...
ms.locfileid: "33888561"
---
# <a name="legacy-merge-results"></a>Fusion héritée : résultats

Pour commencer à fusionner un déploiement hérité avec Skype pour Business Server, cliquez sur **suivant**. Pour plus d’informations sur l’exécution de l’Assistant Fusion du générateur de topologie, reportez-vous à la rubrique [Merge Using Topology Builder Merge Wizard](https://technet.microsoft.com/library/c3f3c425-dab6-4dcd-bf0e-d7fde05f2ebf.aspx) de la documentation de migration.
