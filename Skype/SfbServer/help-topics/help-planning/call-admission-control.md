...
---
# <a name="call-admission-control-planning-tool"></a>Contrôle d’admission des appels (outil de planification)
...
Pour plus d’informations sur la planification du contrôle d’admission des appels, voir [Plan for call admission control in Skype for Business Server 2015](../../plan-your-deployment/enterprise-voice-solution/call-admission-control.md).
