...
- [Création ou modification d’un itinéraire des Skype Entreprise 2015](../../deploy/deploy-enterprise-voice/create-or-modify-a-voice-route.md)

- [Modifier un itinéraire de communications vocales](/previous-versions/office/lync-server-2013/lync-server-2013-modify-a-voice-route)
