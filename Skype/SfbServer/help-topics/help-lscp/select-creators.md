...
Vous pouvez effectuer les tâches suivantes dans la page **Sélectionner les créateurs** :
...
[Utilisation de catégories pour administrer le serveur de conversation permanente](/previous-versions/office/lync-server-2013/using-categories-to-administer-persistent-chat-server)

[Déplacement d’une salle de conversation d’une catégorie vers une autre](/previous-versions/office/lync-server-2013/lync-server-2013-moving-a-chat-room-from-one-category-to-another)

[Création ou modification d’une salle](/previous-versions/office/lync-server-2013/lync-server-2013-creating-or-editing-a-new-room)