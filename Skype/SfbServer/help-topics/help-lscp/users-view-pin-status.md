...
- [Définir le code confidentiel de conférence d’un utilisateur dans Skype Entreprise Server 2015](../../manage/authentication/set-a-user-s-dial-in-conferencing-pin.md)
