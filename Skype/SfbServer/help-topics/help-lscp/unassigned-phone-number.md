...
- **Modifier** Ouvre la plage de numéros non attribuée sélectionnée pour modification, sélectionne toutes les plages de numéros non attribués dans la liste ou supprime la plage sélectionnée de numéros non attribuée.
    
- **Déplacer vers le haut** Déplace la plage sélectionnée de numéros non attribuée dans la liste afin que Skype pour Business Server trouve plus tôt et applique l’action spécifiée avant d’appliquer les actions spécifiées pour les autres plages de la liste.
    
    > [!NOTE]
    > Skype pour Business Server recherche dans la table numérique non affectée de haut en bas et utilise la première plage qui correspond au numéro non affecté. Par exemple, si une plage spécifie une action de dernier recours, assurez-vous qu’elle se trouve en bas de la liste. 
  
- **Déplacer vers le bas** Déplace la plage de numéros non attribuée sélectionnée vers le bas dans la liste.
    
- **Valider toutes les** Enregistre toutes les modifications apportées à des plages de numéros non attribués.
...
- **Nom** Le nom unique qui identifie la plage de numéros non attribuée.
    
- **État** Indique quelle nombre de plages ont été enregistrées dans la base de données et qui n’ont pas.
    
- **Plage de début** Le numéro de début de la plage de numéros non attribué.
    
- **Plage de fin** Le numéro de fin de la plage de numéros non attribué.
    
- **Destination** L’ID de service du service d’Application qui héberge l’application de l’annonce qui doit gérer les appels entrants sur cette plage de numéros non attribués.
