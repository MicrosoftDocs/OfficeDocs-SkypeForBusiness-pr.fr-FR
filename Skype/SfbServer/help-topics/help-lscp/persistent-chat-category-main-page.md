...
Les catégories de salles de conversation peuvent contenir des salles de conversation, mais pas d’autres catégories. Chaque catégorie décrit son contenu avec des métadonnées, telles que  _Nom_ et _Description_. En outre, la catégorie possède des propriétés qui peuvent être définies pour contrôler le comportement des salles de conversation qui lui appartiennent, par exemple si les _salles_ de conversation autorisent les _invitations ou les téléchargements_ de fichiers, ou contiennent l’historique des _conversation._
