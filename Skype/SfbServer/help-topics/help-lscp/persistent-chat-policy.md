...
Si un utilisateur a été activé pour Skype pour Business Server, vous pouvez appliquer les stratégies appropriées à des utilisateurs spécifiques pour les activer ou les désactiver pour serveur de Chat persistant.
