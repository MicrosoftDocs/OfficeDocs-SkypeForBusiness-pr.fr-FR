...
Vous pouvez effectuer les tâches suivantes dans la page **Configuration de Chat persistant** : configurer les options de serveur de Chat persistant globalement ou pour un pool donné
