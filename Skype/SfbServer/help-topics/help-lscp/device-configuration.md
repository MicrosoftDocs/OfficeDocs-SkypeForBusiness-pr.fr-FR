...
[Configuration du périphérique : création d’un périphérique ou modification d’un périphérique existant](device-configuration-create-new-or-edit-existing.md)
