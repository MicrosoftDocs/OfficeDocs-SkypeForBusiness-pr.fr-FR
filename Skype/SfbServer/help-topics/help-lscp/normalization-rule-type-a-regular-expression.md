...
ms.locfileid: "41822587"
---
# <a name="normalization-rule-type-a-regular-expression"></a>Règle de normalisation : saisir une expression régulière
 
Entrez une expression régulière .NET Framework pour spécifier le modèle correspondant aux numéros de téléphone de destination auxquels l’itinéraire est appliqué. 
