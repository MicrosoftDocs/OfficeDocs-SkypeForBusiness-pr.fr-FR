...
- Modifier les options d’un périphérique de test existant.
...
- **Modifier** Vous pouvez modifier les options d’un périphérique de test dans la liste. Utilisez cette option, vous pouvez procédez comme suit :

  - **Afficher les détails** Cette option ouvre une boîte de dialogue dans laquelle vous pouvez modifier les options pour un périphérique de test.
...
[View Software Updates for Devices dans votre organisation](https://technet.microsoft.com/library/d2cca12b-ed43-4e1f-90ab-d14bca8b482c.aspx)
