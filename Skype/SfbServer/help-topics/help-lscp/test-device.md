...
---
# <a name="test-device"></a>Dispositif de test
...
- **Nouveau** Vous pouvez ajouter un nouveau périphérique de test avec la portée suivante :
    
  - Globale
    
  - Site
    
- **Modifier** Vous pouvez modifier les options d’un dispositif de test dans la liste. À l’aide de cette option, vous pouvez effectuer les opérations suivantes :
    
  - **Afficher les détails** Cette option ouvre une boîte de dialogue dans laquelle vous pouvez modifier les options pour un dispositif de test.
    
  - **Sélectionner tout** Cette option sélectionne tous les périphériques de test dans la liste.
    
  - **Supprimer** Cette option supprime tous les périphériques de test sélectionné.
    
- **Actualiser** Vous pouvez actualiser la liste de périphériques de test pour vérifier l’état des options de tous les périphériques de test.
    
Pour plus d’informations sur le test des périphériques, voir [Ajouter un périphérique au Test des fonctionnalités de mise à jour](http://technet.microsoft.com/library/ce509fd1-17b3-4b78-b269-fe5d06fe2e1d.aspx) de la documentation sur les opérations.
## <a name="see-also"></a>Voir aussi

#### 

[Dispositif de test : Créer ou modifier une existante](test-device-create-new-or-edit-existing.md)
#### 

[Nouvelle-CsTestDevice](https://docs.microsoft.com/powershell/module/skype/new-cstestdevice?view=skype-ps)
  
[Ensemble-CsTestDevice](https://docs.microsoft.com/powershell/module/skype/set-cstestdevice?view=skype-ps)
  
[Mises à jour logicielles de vue pour les périphériques de votre organisation](http://technet.microsoft.com/library/d2cca12b-ed43-4e1f-90ab-d14bca8b482c.aspx)
