...
ms.locfileid: "60764112"
---
# <a name="move-user"></a>Déplacer un utilisateur

Dans la page **Déplacer des** utilisateurs, vous pouvez sélectionner un pool de destination vers qui déplacer l’utilisateur sélectionné.
