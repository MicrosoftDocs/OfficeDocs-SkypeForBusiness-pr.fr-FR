...
Vous pouvez effectuer les tâches suivantes dans la page **Sélectionner un service** :

- [Configurer des catégories](/previous-versions/office/lync-server-2013/lync-server-2013-configure-categories)

- [Configuration de compléments pour les salles](/previous-versions/office/lync-server-2013/lync-server-2013-configure-add-ins-for-rooms)
