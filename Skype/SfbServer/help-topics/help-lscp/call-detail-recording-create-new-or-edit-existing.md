...
- [Activer l’enregistrement des détails des appels Skype Entreprise Server 2015](../../manage/health-and-monitoring/enable-cdr.md)
    
- [Spécifier la conservation des données d’Skype Entreprise Server 2015](../../manage/health-and-monitoring/specify-retention-of-data.md)
