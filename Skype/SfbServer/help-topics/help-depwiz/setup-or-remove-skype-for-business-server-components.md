...
> [!NOTE]
> Si vous avez déjà installé des composants Skype Entreprise Server 2015 sur cet ordinateur, l’Assistant Déploiement le reconnaîtra et le bouton de l’étape 2 s’affichera en tant que Exécuter à **nouveau.** Cela vous permet d’exécuter l’étape autant de fois que nécessaire afin de configurer ou modifier correctement le serveur. 
