...
Cette section décrit comment configurer ces fonctionnalités de gestion des appels au cours d’un déploiement Voix Entreprise déploiement.
...
- [Processus de déploiement de Response Group dans Skype Entreprise](deployment-process-for-response-group.md)
    
- [Processus de déploiement de l’application Annonce dans Skype Entreprise Server](deployment-process-for-the-announcement-application.md)
