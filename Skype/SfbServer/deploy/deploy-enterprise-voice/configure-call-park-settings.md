...
Modifier les paramètres d’appel Park dans Skype pour Business Server Voix Entreprise.
  
Si vous ne souhaitez pas utiliser les paramètres par défaut de parc d’appel, vous pouvez les personnaliser. Lorsque vous installez l’application d’appel Park, paramètres globaux sont configurés par défaut. Vous pouvez modifier les paramètres généraux et définir également des paramètres spécifiques à un site. Utilisez l’applet de commande **New-CsCpsConfiguration** pour créer des paramètres spécifiques au site. L’applet de commande **Set-CsCpsConfiguration** permet de modifier les paramètres existants.
...
### <a name="to-configure-call-park-settings"></a>Pour configurer les paramètres d’appel Park
...
2. Exécutez :
   ...
   > [!TIP]
   > Utilisez l’applet de commande **Get-CsSite** pour identifier le site. Pour plus d’informations, consultez la documentation de Communications Server Management Shell.
...
[Personnaliser des morceaux musicaux d’appel Park sur inSkype de blocage pour Business 2015](customize-call-park-music-on-hold.md)
#### 

[Nouvelle-CsCpsConfiguration](https://docs.microsoft.com/powershell/module/skype/new-cscpsconfiguration?view=skype-ps)
  
[Ensemble-CsCpsConfiguration](https://docs.microsoft.com/powershell/module/skype/set-cscpsconfiguration?view=skype-ps)
