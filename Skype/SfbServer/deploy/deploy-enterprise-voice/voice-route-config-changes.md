...
**Résumé :** Découvrez comment réviser, publier ou annuler les modifications de configuration de routage de voix dans Skype pour Business Server 2015 à l’aide de la Skype pour le panneau de configuration de Business Server.
...
8. Dans la boîte de dialogue **Paramètres de configuration de la voix non validés** qui contient la liste de toutes les modifications en attente, cliquez sur **OK**. 
    ...
    Skype pour le panneau de configuration de Business Server a validé les modifications, le message **publié avec succès la configuration de routage voix** s’affiche.
