...
Lorsque vous modifiez les paramètres de configuration de la Skype Entreprise Server sip à l’aide du Panneau de configuration, les options suivantes sont disponibles.
