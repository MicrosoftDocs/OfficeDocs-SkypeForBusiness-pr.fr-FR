...
> [!NOTE]
> Vous pouvez également créer des politiques vocales avec l’étendue des *utilisateurs* et les affecter à des utilisateurs ou groupes individuels.
...
- [Exporter ou importer un fichier de configuration de l’itinéraire vocal dans Skype entreprise](voice-route-configuration-import-export.md)
