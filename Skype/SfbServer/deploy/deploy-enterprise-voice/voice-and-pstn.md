...
---
# <a name="configure-voice-policies-pstn-usage-records-and-voice-routes-in-skype-for-business"></a>Configurer des stratégies de voix, des enregistrements d’utilisation PSTN et des itinéraires de voix dans Skype Entreprise
...
- [Exporter ou importer un fichier de configuration d’itinéraire de voix dans Skype Entreprise](voice-route-configuration-import-export.md)
