...
2. Pour commencer à définir une règle de traduction, suivez les étapes de la procédure de configuration d’une trunk avec déviation du média à [l’Skype Entreprise Server](configure-trunk-with-media-bypass.md) jusqu’à l’étape 10 ou configurez une trunk sans déviation du média dans [Skype Entreprise Server](configure-trunk-without-media-bypass.md) à l’étape 9.
