...
8. Définissez le magasin SQL de conversation permanente pour le serveur principal de conversation **permanente (où** le contenu de la salle de conversation est stocké) en faisant l’une des opérations suivantes :
   ...
   - Dans **SQL Server FQDN**, spécifiez le FQDN du SQL Server sur lequel vous souhaitez créer la base de données SQL Server données.
...
3. Dans l’arborescence de la console, cliquez **avec le bouton Skype Entreprise Server 2015,** puis cliquez sur Publier la **topologie.**
