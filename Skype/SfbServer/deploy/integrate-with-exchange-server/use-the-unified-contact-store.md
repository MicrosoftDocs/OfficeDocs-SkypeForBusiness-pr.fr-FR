...
Vous pouvez vérifier que les contacts d’un utilisateur ont été correctement migrés vers le magasin de contacts unifié en exécutant l’cmdlet [Test-CsUnifiedContactStore](/powershell/module/skype/test-csunifiedcontactstore?view=skype-ps) à partir de Skype Entreprise Server Management Shell :
...
Cela signifie également qu’après avoir attribué à l’utilisateur une nouvelle stratégie de services d’utilisateurs, vous devez exécuter l’cmdlet [Invoke-CsUcsRollback](/powershell/module/skype/invoke-csucsrollback?view=skype-ps) pour déplacer les contacts de l’utilisateur hors de Exchange Server et revenir à Skype Entreprise Server. Par exemple, après avoir affecté une nouvelle stratégie de services d’utilisateurs à Ken Myer, vous pouvez déplacer ses contacts hors du magasin de contacts unifié à l’aide de la commande suivante :
