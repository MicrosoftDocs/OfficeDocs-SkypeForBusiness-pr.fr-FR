...
> [!NOTE]
> Fonctionnalité tactile et le tableau blanc n’est pas encore pris en charge dans le système de salle Skype v2. Prise en charge tactile et tableau blanc est actuellement planifiée pour le système de salle Skype v2 et est ajouté dans 2019.

> [!NOTE]
> Logiciel Skype salle système V2 prend en charge le protocole TLS 1.2 à compter du 14 décembre 2018 avec la version de l’application 4.0.64.0. Pour les clients sur site, permettant la communication via TLS 1.2 Skype salle système v2 requiert Skype pour Business Server 2015 Cumulative Update 9 (cumulative 9) ou Skype pour Business Server 2019 Cumulative Update 1 (CU1). La modification ne devrait pas affecter Skype pour les clients professionnels en ligne comme client change avant et arrière conforme.
