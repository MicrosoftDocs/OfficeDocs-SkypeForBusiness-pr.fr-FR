---
title: Scripts v2 sur les systèmes de salle de Skype
ms.author: jambirk
author: jambirk
manager: serdars
ms.date: 5/10/2018
...
description: Utilisez cette rubrique pour obtenir des scripts utilisés avec les systèmes de salle Skype v2.
...
---
# <a name="skype-room-systems-v2-scripts"></a><span data-ttu-id="e3254-103">Skype salle systèmes v2 Scripts</span><span class="sxs-lookup"><span data-stu-id="e3254-103">Skype Room Systems v2 Scripts</span></span>
 
<span data-ttu-id="e3254-104">Copiez chacune des sections de cet article dans un fichier texte nommé dans l’en-tête de section.</span><span class="sxs-lookup"><span data-stu-id="e3254-104">Copy each of the sections in this article into a text file named in the section heading.</span></span> <span data-ttu-id="e3254-105">Ces fichiers sont utilisés dans le déploiement de systèmes de salle Skype v2 :</span><span class="sxs-lookup"><span data-stu-id="e3254-105">These files are used in deploying Skype Room Systems v2:</span></span> 
* <span data-ttu-id="e3254-106">[CreateSrsMedia.ps1](#createsrsmediaps1) est un script Powershell permet de créer une image du logiciel du périphérique de la console.</span><span class="sxs-lookup"><span data-stu-id="e3254-106">[CreateSrsMedia.ps1](#createsrsmediaps1) is a Powershell script used to create a software image for the console device.</span></span>  
* <span data-ttu-id="e3254-107">[SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) est un Powershell script permet de définir Skype pour les comptes d’entreprise et Exchange les périphériques utilisera.</span><span class="sxs-lookup"><span data-stu-id="e3254-107">[SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) is a Powershell script used to set up Skype for Business and Exchange accounts the devices will use.</span></span>  
* <span data-ttu-id="e3254-108">[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) est utilisé lors de la définition de la gestion de systèmes de salle Skype v2 utiliser OMS.</span><span class="sxs-lookup"><span data-stu-id="e3254-108">[SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview)  is used when setting up management of Skype Room Systems v2 using OMS.</span></span>
  
<a name="CreateSrs"></a>
## <a name="createsrsmediaps1"></a><span data-ttu-id="e3254-109">CreateSrsMedia.ps1</span><span class="sxs-lookup"><span data-stu-id="e3254-109">CreateSrsMedia.ps1</span></span>
...
<a name="CreateRoom"></a>
## <a name="skyperoomprovisioningscriptps1"></a><span data-ttu-id="e3254-110">SkypeRoomProvisioningScript.ps1</span><span class="sxs-lookup"><span data-stu-id="e3254-110">SkypeRoomProvisioningScript.ps1</span></span>
...
```
<a name="OMSVIEW"></a>
## <a name="skyperoomsystemsv2omsview"></a><span data-ttu-id="e3254-111">SkypeRoomSystems_v2.omsview</span><span class="sxs-lookup"><span data-stu-id="e3254-111">SkypeRoomSystems_v2.omsview</span></span>
...
## <a name="see-also"></a><span data-ttu-id="e3254-112">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="e3254-112">See also</span></span>

#### 

[<span data-ttu-id="e3254-113">Planifier la salle Skype systèmes v2</span><span class="sxs-lookup"><span data-stu-id="e3254-113">Plan for Skype Room Systems v2</span></span>](../../plan-your-deployment/clients-and-devices/skype-room-systems-v2-0.md)
  
[<span data-ttu-id="e3254-114">Configurer une console v2 de systèmes de salle de Skype</span><span class="sxs-lookup"><span data-stu-id="e3254-114">Configure a Skype Room Systems v2 console</span></span>](console.md)
  
[<span data-ttu-id="e3254-115">Gérer les salles Skype systèmes v2</span><span class="sxs-lookup"><span data-stu-id="e3254-115">Manage Skype Room Systems v2</span></span>](../../manage/skype-room-systems-v2/skype-room-systems-v2.md)
