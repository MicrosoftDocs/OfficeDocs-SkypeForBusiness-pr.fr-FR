...
---
# <a name="skype-room-systems-v2-scripts"></a>Skype salle systèmes v2 Scripts
 
Copiez chacune des sections de cet article dans un fichier texte nommé dans l’en-tête de section. Ces fichiers sont utilisés dans le déploiement de systèmes de salle Skype v2 : 
* [CreateSrsMedia.ps1](#createsrsmediaps1) est un script Powershell permet de créer une image du logiciel du périphérique de la console.  
* [SkypeRoomProvisioningScript.ps1](#skyperoomprovisioningscriptps1) est un Powershell script permet de définir Skype pour les comptes d’entreprise et Exchange les périphériques utilisera.  
* [SkypeRoomSystems_v2.omsview](#skyperoomsystemsv2omsview) est utilisé lors de la définition de la gestion de systèmes de salle Skype v2 utiliser OMS.
