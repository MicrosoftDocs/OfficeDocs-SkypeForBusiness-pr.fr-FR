...
> [!NOTE]
> Si vous avez Skype Entreprise Online au lieu de Skype Entreprise Server dans le scénario ci-dessus, une fois la boîte aux lettres de ressources Exchange mise en service, vous devez mettre en service un compte Skype Entreprise comme décrit dans Skype Entreprise Online Provisioning. 
