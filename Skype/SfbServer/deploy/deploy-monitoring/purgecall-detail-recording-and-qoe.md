...
**Résumé :** Apprenez à vider manuellement les enregistrements à partir de la détails des appels et les bases de données QoE utilisés par Skype pour Business Server 2015.
