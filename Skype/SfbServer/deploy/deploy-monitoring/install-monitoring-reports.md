...
description: 'Résumé : Apprenez à installer un service qui génère des rapports de surveillance dans Skype pour Business Server 2015.'
...
Skype pour les rapports de surveillance Business Server 2015 vous fournir une mine d’informations sur la qualité et la quantité des sessions de communication qui prennent place dans votre organisation. 
  
## <a name="install-monitoring-reports"></a>Installer des rapports de surveillance

Rapports de surveillance ne sont pas installés automatiquement lorsque vous installez Skype pour 2015 de serveur d’entreprise ; au lieu de cela, vous devez installer séparément les rapports de surveillance, et uniquement après avoir Skype pour Business Server a été installé sur l’ordinateur.
...
Skype pour les rapports de surveillance Business Server comprennent plus de 30 rapports conçus pour fournir des informations détaillées sur les conférences, les sessions de messagerie instantanée de peer-to-peer, les enregistrements d’utilisateur, l’application Response Group et bien plus encore. Pour la version 2013, Skype pour les rapports de surveillance Business Server inclut un certain nombre d’améliorations :
  
- **Nouveaux rapports de qualité de la voix**. Ces rapports incluent le [Rapport de comparaison de qualité Media dans Skype pour Business Server 2015](../../manage/health-and-monitoring/comparison.md), qui permet de comparer la qualité entre différents types d’appels (par exemple, entre les appels filaires et sans fil appels) ; et le [Rapport de temps de jointure de conférence dans Skype pour Business Server 2015](../../manage/health-and-monitoring/join-time-report.md), qui fournit des informations sur la quantité de temps requiert pour les utilisateurs de participer à une conférence. 
    
- **Rapports améliorés pour l’analyse et la résolution des problèmes des sessions de partage vidéo et d’application.** le [Rapport de synthèse de qualité Media dans Skype pour Business Server 2015](../../manage/health-and-monitoring/summary.md) permet d’analyser la vidéo et le partage des appels, tandis que le [Rapport de performances de serveur dans Skype pour Business Server 2015](../../manage/health-and-monitoring/server-performance.md) décrit en détail les performances des serveurs d’applications génération de ces appels. Vidéo et partage des mesures d’application sont également signalés par le [rapport de détails de Session de Peer-to-Peer dans Skype pour Business Server 2015](../../manage/health-and-monitoring/peer-to-peer-session-detail-report.md) et le [Rapport de détails de conférence dans Skype pour Business Server 2015](../../manage/health-and-monitoring/detail-report.md).
...
Il existe deux manières d’installer Skype pour les rapports de surveillance de serveur Business : vous pouvez utiliser le Skype pour l’Assistant de déploiement de Business Server ou vous pouvez utiliser un script Windows PowerShell inclus avec le Skype pour les fichiers d’installation Business Server 2015. Quelle que doit la méthode utilisée pour installer les rapports, vous devez d’abord vous assurer que vous :
...
1. Cliquez sur **Démarrer**, sur **Tous les programmes**, cliquez sur **Skype pour Business Server**, puis cliquez sur **Skype pour l’Assistant de déploiement de Business Server**.
...
Rapports d’analyse peuvent également être installé à partir de la Skype pour Business Server Management Shell en exécutant le script DeployReports.ps1 ; Ce script Windows PowerShell se trouve dans le \<l’emplacement d’installation\>\Skype pour le dossier de 2015\Deployment\Setup Business Server. Pour installer le rapports de surveillance à l’aide de DeployReports.ps1, tapez une commande semblable à la suivante à l’invite du Shell de gestion :
...
|:-----|:-----|:-----|
|storedUserName  <br/> |Oui  <br/> |Compte d’utilisateur (au format domaine\nomUtilisateur) utilisé pour accéder au magasin d’analyse ; par exemple :  <br/> ```-storedUserName "litwareinc\kenmyer"```Ce compte doit avoir les autorisations précédemment spécifiée de SQL Server et SQL Server Reporting Services ou le script échouera.  <br/> |
...
Une fois les rapports de surveillance installés, vous devez utiliser l’applet de commande Set-CsReportingConfiguration pour configurer l’URL utilisée pour accéder à ces rapports. Cette tâche peut effectuée à partir de la Skype pour Business Server Management Shell en exécutant la commande suivante de Windows PowerShell. Notez qu’il est recommandé, mais pas obligatoire, d’utiliser le protocole HTTPS pour configurer l’URL des rapports :
