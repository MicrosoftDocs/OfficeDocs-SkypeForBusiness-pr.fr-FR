...
## <a name="skype-connectivity-overview-for-it-professionals"></a>Vue Skype la connectivité des professionnels de l’informatique

Skype connectivity offre aux Skype Entreprise la possibilité de rechercher et d’ajouter des Skype utilisateurs. Skype connectivité est une fonctionnalité de Skype Entreprise qui vous permet d’activer la fédération et la recherche dans l’annuaire avec Skype utilisateurs. Une fois que vous avez Skype la connectivité Skype Entreprise utilisateurs pourront rechercher et ajouter des Skype utilisateurs.
  
## <a name="skype-directory-search"></a>Skype recherche dans l’annuaire

Skype fonctionnalité de recherche dans l’annuaire Skype Entreprise aux utilisateurs la possibilité de rechercher Skype contacts. La fonctionnalité de recherche permet aux utilisateurs d’effectuer des recherches à l’aide des fonctionnalités suivantes :
...
- **Recherchez par Skype, par exemple « JohnDoe1456** » : si une correspondance exacte est trouvée, elle sera renvoyée en tant que premier résultat. D’autres correspondances de « nom » possibles peuvent être renvoyées.
    ...
    > [!NOTE]
    > Skype recherche dans l’annuaire doit pouvoir communiquer avec les adresses IP suivantes sur le port 443 : 104.40.75.246, 23.101.135.34 et 40.113.86.19. 
...
Skype connectivity est également une fonctionnalité de Skype Entreprise Online, qui fait partie de Microsoft 365 et Office 365. Vous pouvez activer la fonctionnalité Skype connectivité à partir du centre d Skype Entreprise’administration dans le Centre d'administration Microsoft 365.
  
Pour Microsoft 365 moyenne entreprise, Office 365 Entreprise, Microsoft 365 Éducation et Office 365 pour le gouvernement : connectez-vous au Centre d'administration Microsoft 365 et accédez à centre Skype Entreprise’administration centrale. Go to External Communications. Sous Fournisseurs de services de messagerie instantanée publics, cliquez sur Activer. Si vous souhaitez contrôler l’accès des utilisateurs individuels à Skype connectivité, vous pouvez le faire en éditant les paramètres de communications externes des utilisateurs individuels.
...
Skype Entreprise Server utilise l’architecture d’accès de fédération pour prendre en charge la connectivité avec Skype. Cette connectivité permet à vos utilisateurs Skype Entreprise Server d’ajouter des Skype. Skype clients peuvent également ajouter Skype Entreprise utilisateurs à leur liste de contacts. En fonction des stratégies définies administrativement dans Skype Entreprise Server les utilisateurs pourront communiquer à l’aide de la messagerie instantanée, voir la présence des autres utilisateurs et lancer des appels audio et vidéo. Skype est également une fonctionnalité de Skype Entreprise Online et peut être activée pour les clients Skype Entreprise Online à partir du Centre d’administration Skype Entreprise dans le centre d’administration Skype Entreprise Centre d'administration Microsoft 365.
...
Vous pouvez obtenir des instructions supplémentaires concernant les certificats externes dans [la planification des certificats](../plan-your-deployment/edge-server-deployments/edge-environmental-requirements.md#certificate-planning).
...
À l’aide Skype Entreprise Server Management Shell, un administrateur doit configurer la stratégie de client Skype Entreprise pour afficher les Skype en tant que fournisseur PIC supplémentaire. 
...
> [!NOTE]
> Pour configurer la Skype lors de la mise à niveau vers Skype Entreprise Server vous devez supprimer et rajouter le fournisseur Skype existant. 
...
2. Exécutez les deux commandes suivantes :
   ...
   ```
    ...
    > [!NOTE]
    > Si vous n’avez pas encore de fournisseur PIC dans votre environnement et que vous créez un fournisseur PIC, vous n’avez pas besoin d’exécuter l'Remove-CsPublicProvider de messagerie. 
   ...
   - NameDecorationRoutingDomain et NameDecorationExcludedDomainList : la définition de ces paramètres permet aux utilisateurs d’entrer les MSA des utilisateurs de Skype sans avoir à connaître la « décoration » des domaines non Microsoft avec « msn.com ». Cela élimine la nécessité de taper « user(contoso.com)@msn.com » pour tous les domaines qui ne sont PAS dans excludedDomainList. Le client SfB formate automatiquement le compte MSA si le domaine n’est PAS dans la liste des domaines exclus. Nous avons ajouté les domaines de compte Microsoft les plus courants à la liste des domaines exclus.
     ...
     > [!NOTE]
     > Ajouté dans le client de bureau Lync Lync 2013 CU5 &amp; dans Office 2013 SP1, nameDecorationRoutingDomain et NameDecorationExcludedDomainList améliorent la situation dans laquelle les utilisateurs Lync ajoutent des contacts Skype nécessaires à la « décoration » des domaines non-Microsoft pour les identifier et les router vers Skype (format : user(contoso.com)@msn.com). Ces nouveaux paramètres autorisent la mise en forme automatique de l’entrée de l’utilisateur d’adresse dans la boîte de dialogue « Ajouter un contact de Skype » avec nameDecorationRoutingDomain (qui doit être définie sur msn.com) s’il ne contient pas les domaines dans nameDecorationExcludedDomainList (nous pouvons actuellement prendre en charge msn.com, live.com, Hotmail.com, outlook.com). 
...
|Skype Mac   |7.19 ou supérieur, sur Mac OS X 10.9 (Contrôles) ou supérieur   |Nécessite Mac OSX 10.9 ou supérieur   |
|Skype Universal Windows App (Windows 10) Desktop et Mobile   |Windows 10 (mise à jour de Redstone 1 ou version ultérieure)   |Windows application universelle recevra la mise à jour à l’automne 2016, ce qui ajoutera la prise en charge de l’interop.   |
...
|Client|Skype de recherche dans l’annuaire et ajouter des contacts|Skype A/V, iop de messagerie instantanée|
|:-----|:-----|:-----|
