...
5. Les Skype Entreprise Server principaux composants seront installés sur le serveur. 
   ...
   - **Skype Entreprise Server l’Assistant** Déploiement Un programme de déploiement qui fournit un pavé de lancement pour l’installation des différents composants de Skype Entreprise Server.
...
8. Une fois l’installation terminée, cliquez sur **Terminer**. Les outils d’administration sont désormais ajoutés au serveur, comme illustré dans la figure.
   ...
   - **Skype Entreprise Server de topologie A** utilisé pour créer, déployer et gérer des topologies.
    
   - **Skype Entreprise Server panneau de bord** A utilisé pour administrer l’installation.
