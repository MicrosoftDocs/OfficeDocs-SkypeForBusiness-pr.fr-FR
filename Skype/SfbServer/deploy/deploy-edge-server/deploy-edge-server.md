...
- [Configuration requise pour le serveur Edge dans Skype entreprise Server](../../plan-your-deployment/edge-server-deployments/system-requirements.md)
    
- [Configuration requise pour l’environnement du serveur Edge dans Skype entreprise Server](../../plan-your-deployment/edge-server-deployments/edge-environmental-requirements.md)
    
- [Créer votre topologie Edge pour Skype entreprise Server](create-your-edge-topology.md)
    
- [Déploiement de serveurs Edge dans Skype entreprise Server](deploy-edge-servers.md)
