...
11. Dans **l’écran Définir l’adresse IP** externe, vous avez plusieurs options en fonction de vos choix précédents :
    ...
    - Vous utilisez peut-être un seul FQDN pour tous les services. Si c’est le cas, tapez votre adresse IPv4 ou IPv6 externe (quelle que soit votre utilisation) dans la zone de texte **Accès SIP** , puis cliquez sur **Suivant**.
...
13. L’écran suivant consiste **à définir le saut suivant**. Dans la **zone Pool du saut** suivant, sélectionnez le nom de votre pool interne, qui peut être un pool frontal ou un pool autonome. Si vous avez un directeur dans votre environnement, vous devez le choisir. Cliquez ensuite sur **Next (Suivant)**.
...
10. Vous avez maintenant atteint **l’écran Définir les ordinateurs de ce pool** . Cliquez sur le bouton **Ajouter**.
...
16. L’écran suivant consiste **à définir le saut suivant**. Dans la **zone Pool du saut** suivant, sélectionnez le nom de votre pool interne, qui peut être un pool frontal ou un pool autonome. Si vous avez un directeur dans votre environnement, vous devez le choisir. Cliquez ensuite sur **Next (Suivant)**.
...
15. L’écran suivant consiste **à définir le saut suivant**. Dans la **zone Pool du saut** suivant, sélectionnez le nom de votre pool interne, qui peut être un pool frontal ou un pool autonome. Si vous avez un directeur dans votre environnement, vous devez le choisir. Cliquez ensuite sur **Next (Suivant)**.
...
2. Dans **le Générateur de topologies**, dans l’arborescence de la console, cliquez avec le bouton **Skype Entreprise Server** puis cliquez sur **Skype Entreprise Server Générateur de topologies**.
