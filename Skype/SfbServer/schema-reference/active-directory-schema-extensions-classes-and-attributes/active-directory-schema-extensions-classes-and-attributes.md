...
- Toutes les classes utilisées par Skype Entreprise Server, avec une description de chacune d’elles
...
- Modifications effectuées dans une unité d’organisation (OU) Active Directory par l’applet de commande Grant_CsOUPermission
