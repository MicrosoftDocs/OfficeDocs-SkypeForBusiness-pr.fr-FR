...
|**PacketUtilization** <br/> |entier  <br/> ||Nombre de paquets envoyés.  <br/> |
|**BandwidthEst** <br/> |entier  <br/> ||Estimation de la quantité de bande passante unidirectionnelle disponible à la fin de la session. Indiquée en bits par seconde.  <br/> |
|**AppSharingPayloadDescription** <br/> |entier  <br/> ||Description de la charge utile du partage d’application.  <br/> |
...
|**RelativeOneWayBurstOccurrences** <br/> |entier  <br/> ||Nombre total d’occurrences de rafales unidirectionnelles. Une transmission « par rafales » est une transmission dans laquelle les données sont diffusées en rafales imprévisibles par opposition à un flux régulier. Cette valeur mesure le flux de données entre le client et le serveur.  <br/> |
...
|**RDPTileProcessingLatencyBurstOccurrences** <br/> |entier  <br/> ||Occurrences de rafales dans le temps de traitement des mosaïques RDP (Remote Desktop Protocol). Une transmission « par rafales » est une transmission dans laquelle les données sont diffusées en rafales imprévisibles par opposition à un flux régulier.  <br/> |
...
|**RDPTileProcessingLatencyGapOccurrences** <br/> |entier  <br/> ||Occurrences d’intervalles dans le temps de traitement des mosaïques RDP (Remote Desktop Protocol).  <br/> |
...
|**CaptureTileRateGapOccurrences** <br/> |entier  <br/> ||Occurrences d’intervalles dans le taux de mosaïques capturées (en mosaïques par seconde).  <br/> |
...
|**SpoiledTilePercentBurstOccurrences** <br/> |entier  <br/> ||Occurrences de rafales pour le contenu qui n’a pas atteint le spectateur mais qui a été ignoré et remplacé par du contenu récent.  <br/> |
...
|**SpoiledTilePercentGapOccurrences** <br/> |entier  <br/> ||Occurrences d’intervalles pour le contenu qui n’a pas atteint le spectateur mais qui a été ignoré et remplacé par du contenu récent.  <br/> |
...
|**ScrapingFrameRateBurstOccurrences** <br/> |entier  <br/> ||Occurrences de rafales dans les images récupérées à partir de la source graphique.  <br/> |
...
|**ScrapingFrameRateGapOccurrences** <br/> |entier  <br/> ||Occurrences d’intervalles dans les images récupérées à partir de la source graphique.  <br/> |
...
|**IncomingTileRateBurstOccurrences** <br/> |entier  <br/> ||Occurrences de rafales dans la fréquence de mosaïques entrantes reçues par la visionneuse.  <br/> |
...
|**IncomingTileRateGapOccurrences** <br/> |entier  <br/> ||Occurrences d’intervalles dans la fréquence de mosaïques entrantes reçues par la visionneuse.  <br/> |
...
|**IncomingFrameRateBurstOccurrences** <br/> |entier  <br/> ||Occurrences de rafales dans la fréquence d’images entrantes reçues par la visionneuse.  <br/> |
...
|**IncomingFrameRateGapOccurrences** <br/> |entier  <br/> ||Occurrences d’intervalles dans la fréquence d’images entrantes reçues par la visionneuse.  <br/> |
...
|**OutgoingTileRateBurstOccurrences** <br/> |entier  <br/> ||Occurrences de rafales dans la fréquence de mosaïques sortantes pour l’expéditeur.  <br/> |
...
|**OutgoingTileRateGapOccurrences** <br/> |entier  <br/> ||Occurrences d’intervalles dans la fréquence de mosaïques sortantes pour l’expéditeur.  <br/> |
...
|**OutgoingFrameRateBurstOccurrences** <br/> |entier  <br/> ||Occurrences de rafales dans la fréquence d’images sortantes pour l’expéditeur.  <br/> |
...
|**OutgoingFrameRateGapOccurrences** <br/> |entier  <br/> ||Occurrences d’intervalles dans la fréquence d’images sortantes pour l’expéditeur.  <br/> |
...
|**AverageRectangleHeight** <br/> |entier  <br/> ||Hauteur moyenne de résolution vidéo, en pixels.  <br/> |
|**AverageRectangleWidth** <br/> |entier  <br/> ||Largeur moyenne de résolution vidéo, en pixels.  <br/> |
