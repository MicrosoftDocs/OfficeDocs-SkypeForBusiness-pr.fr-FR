...
|AppliedBandwidthSource  <br/> |varchar(256)  <br/> |Source de la capacité de bande passante imposée. Il décrit d’où vient la limite de bande passante (par exemple, « Serveur de stratégie », « SERVEUR TURN » ou « Modalité »).  <br/> |
