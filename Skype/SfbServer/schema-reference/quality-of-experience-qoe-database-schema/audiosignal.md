...
|**AudioTimestampErrorSpkMs** <br/> |decimal(9,2)  <br/> | <br/> |Erreur moyenne d’horodat de flux de rendu du haut-parleur, en millisecondes, au cours des 20 dernières secondes de l’appel.  <br/> |
...
|**EchoPercentMicIn** <br/> |décimal(5,2)  <br/> | <br/> |Pourcentage du temps où un écho a été détecté dans le flux de capture du microphone. En règle générale, les valeurs sont faibles pour les casques ou les combinés, et plus élevées pour les téléphones mains libres ou les haut-parleurs autonomes. Pour les appareils qui supportent l’annulation de l’écho sonore à l’aide de l’appareil, des valeurs élevées indiquent une fuite d’écho. Pour les autres appareils, cette mesure ne doit pas être utilisée pour évaluer la qualité de l’appareil.  <br/> |
