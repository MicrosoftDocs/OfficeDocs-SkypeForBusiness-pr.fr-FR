...
ms.locfileid: "32212255"
---
# <a name="devicedriver-table"></a>Table DeviceDriver
 
La DeviceDriver table est une table de prise en charge. Chaque enregistrement représente un pilote utilisé par un périphérique de capture ou périphérique de rendu.
