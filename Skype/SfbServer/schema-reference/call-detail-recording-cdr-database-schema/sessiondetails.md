...
|**User1Id** <br/> |int  <br/> |Étranger  <br/> |ID d’un utilisateur dans la session. Pour plus [d’informations, voir la table](users.md) Utilisateurs. <br/> |
|**User2Id** <br/> |int  <br/> |Étranger  <br/> |ID de l’autre utilisateur dans la session. Pour plus [d’informations, voir la table](users.md) Utilisateurs. <br/> |
...
|**TargetUserId** <br/> |int  <br/> |Étranger  <br/> |URI de l’utilisateur « À » d’origine dans la demande SIP. pour plus [d’informations, voir la table](users.md) Utilisateurs. <br/> |
|**SessionStartedById** <br/> |int  <br/> |Étranger  <br/> |ID de l’utilisateur ayant démarré la session. Pour plus [d’informations, voir la table](users.md) Utilisateurs. <br/> |
|**OnBehalfOfId** <br/> |int  <br/> |Étranger  <br/> |Indique l’ID de l’utilisateur pour le compte duquel l’appelant appelle. Pour plus [d’informations, voir la table](users.md) Utilisateurs. <br/> |
|**ReferredById** <br/> |int  <br/> |Étranger  <br/> |ID de l’utilisateur faisant référence à l’appel. Pour plus [d’informations, voir la table](users.md) Utilisateurs. <br/> |
|**ServerId** <br/> |int  <br/> |Étranger  <br/> |ID du serveur frontal utilisé pour cette session. Pour plus [d’informations, voir la table](servers.md) Servers. <br/> |
|**PoolId** <br/> |int  <br/> |Étranger  <br/> |ID du pool dans lequel la session a été capturée. Pour plus [d’informations, voir la table Pools](pools.md) . <br/> |
