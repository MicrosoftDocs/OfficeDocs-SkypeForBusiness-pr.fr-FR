...
|**UserId** <br/> |int  <br/> |Étranger  <br/> |ID d’un utilisateur dans la session de conférence. Pour plus [d’informations, voir la table](users.md) Utilisateurs. <br/> |
...
|**UriTypeId** <br/> |tinyint  <br/> |Étranger  <br/> |Contient la valeur du type d’URI MCU de la [table UriTypes](uritypes.md). Ce champ sert à améliorer les performances des requêtes.  <br/> Ce champ a été introduit dans Microsoft Lync Server 2013.  <br/> |
