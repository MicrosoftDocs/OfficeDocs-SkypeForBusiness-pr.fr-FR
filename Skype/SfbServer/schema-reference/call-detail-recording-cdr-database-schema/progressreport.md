...
|**SourceId** <br/> |int  <br/> |Étranger  <br/> |Serveur qui a envoyé le rapport d’erreurs (si le rapport a été envoyé à partir d’un composant serveur). Pour plus [d’informations, voir la table](servers.md) Servers. Ce champ a été introduit dans Microsoft Lync Server 2013. <br/> |
