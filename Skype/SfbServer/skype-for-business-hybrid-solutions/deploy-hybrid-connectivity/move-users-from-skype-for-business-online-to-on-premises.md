...
- Votre environnement local doit être déployé et validé complètement. Pour plus d’informations, voir [déploiement de Lync Server 2013](https://technet.microsoft.com/library/b76795a4-4e71-4c70-a5c0-d1197fa8028c.aspx) ou [Déployer de Skype pour Business Server 2015](../../deploy/deploy.md), selon la version que vous utilisez le localement.
