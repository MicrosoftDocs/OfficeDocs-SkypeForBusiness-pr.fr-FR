...
## <a name="how-media-bypass-affects-media-and-signaling-pathways"></a>Impact du contournement de média sur les médias et les voies de signalisation
...
Un appel entrant en provenance du réseau téléphonique sortant utilise le même chemin de signalisation dans le sens inverse. Pour les utilisateurs internes, les médias continuent de circuler entre le client Skype Entreprise et le serveur de médiation Cloud Connector, puis le SBC ou la passerelle.
...
> [!NOTE]
> Si vous utilisez une solution VPN cliente en combinaison avec le client Skype Entreprise, la déviation du média est prise en charge uniquement avec une configuration VPN en tunnel partagé. 
...
Pour la version actuelle des clients dans différents canaux, consultez les informations de publication pour les mises à jour de [Microsoft 365 Apps pour entreprise.](https://docs.microsoft.com/officeupdates/release-notes-office365-proplus) 
...
Pour plus d’informations, [voir Plan for Skype for Business Cloud Connector Edition](https://technet.microsoft.com/library/mt605227.aspx). 
