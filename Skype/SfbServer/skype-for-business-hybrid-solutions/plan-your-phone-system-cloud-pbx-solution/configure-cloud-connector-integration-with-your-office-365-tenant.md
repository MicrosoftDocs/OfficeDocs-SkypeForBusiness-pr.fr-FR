...
2. Les enregistrements SRV seront automatiquement créés par Office 365 et les scripts de déploiement. Vérifiez que vous pouvez rechercher les deux services SIP suivants sur le serveur Edge : _sip et _sipfederationtls.
