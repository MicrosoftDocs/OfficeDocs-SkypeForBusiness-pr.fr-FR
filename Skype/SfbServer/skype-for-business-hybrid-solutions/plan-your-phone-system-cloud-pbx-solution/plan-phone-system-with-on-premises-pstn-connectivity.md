...
Ce contenu est pertinent si Skype Entreprise Server ou Lync Server 2013 sont déjà déployés en local. Pour d'autres scénarios, voir [solutions de téléphonie Microsoft.](/microsoftteams/cloud-voice-landing-page)
...
- **Connexion PSTN Entreprise/Cloud** Il s'agit du réseau qui connecte votre entreprise au cloud. Ce n'est pas nécessairement le même que votre connexion Internet générique.
