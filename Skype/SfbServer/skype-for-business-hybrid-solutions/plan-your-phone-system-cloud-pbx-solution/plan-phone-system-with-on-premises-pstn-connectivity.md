...
Ce contenu est pertinent si vous avez déjà Skype Entreprise Server ou Lync Server 2013 déployé en local. Pour d’autres scénarios, voir [solutions de téléphonie Microsoft.](/microsoftteams/cloud-voice-landing-page)

 Système téléphonique avec une connectivité PSTN sur site vous permet de tirer parti des fonctionnalités Système téléphonique (Cloud PBX) pour vos utilisateurs. Cela peut vous aider dans les scénarios suivants :

- Certains de vos utilisateurs Skype Entreprise sont en local et d’autres sont Skype Entreprise Online. Vous pouvez désormais activer Système téléphonique fonctionnalités et fonctionnalités pour vos utilisateurs Skype Entreprise Online, mais continuer à utiliser la connectivité PSTN sur site.
...
- **Synchronisation Active Directory** Vous devez configurer la synchronisation Active Directory à l’aide d’Azure AD Connecter. Pour plus d’informations, voir [Gestion d’Azure AD Connecter](https://azure.microsoft.com/documentation/articles/active-directory-aadconnect-whats-next/).
