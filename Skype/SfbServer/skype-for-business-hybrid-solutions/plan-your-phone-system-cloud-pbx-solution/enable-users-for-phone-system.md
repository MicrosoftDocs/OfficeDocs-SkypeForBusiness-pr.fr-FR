...
- [Permettre aux utilisateurs d’utiliser la voix entreprise en local](enable-the-users-for-enterprise-voice-on-premises.md) (exécutée lorsque les utilisateurs sont hébergés sur site).
    
- [Assign a Voice Routing Policy](assign-a-voice-routing-policy.md) (lorsque les utilisateurs sont hébergés en local).
    
- [Synchroniser les utilisateurs avec le Cloud et affecter des licences](synchronize-users-to-the-cloud-and-assign-licenses.md) (exécuté à l’aide d’Office 365).
    
- [Déplacer des utilisateurs locaux vers Skype entreprise Online](https://docs.microsoft.com/en-us/SkypeForBusiness/hybrid/move-users-from-on-premises-to-skype-for-business-online) (exécutée à l’aide de Windows PowerShell en local, mais à l’aide de vos informations d’identification d’administrateur 365 Office).
    
- [Activer les utilisateurs d’Enterprise Voice Online et du système téléphonique dans Office 365 boîte vocale](enable-users-for-enterprise-voice-online-and-phone-system-voicemail.md) (exécuté à l’aide de Remote PowerShell.
