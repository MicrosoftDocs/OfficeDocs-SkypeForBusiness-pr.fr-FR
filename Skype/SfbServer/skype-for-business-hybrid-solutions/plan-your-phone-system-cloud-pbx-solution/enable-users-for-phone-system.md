...
- [Affecter une stratégie de routage de voix](assign-a-voice-routing-policy.md) (opération réalisée alors que les utilisateurs sont hébergés sur un système local).
