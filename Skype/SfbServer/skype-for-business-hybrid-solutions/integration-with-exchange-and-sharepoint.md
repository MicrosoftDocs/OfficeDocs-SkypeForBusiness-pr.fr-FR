...
|Délégation de réunion  <br/> |Pris en charge uniquement lorsque les deux utilisateurs sont en ligne dans la même forêt, ou que les deux sont tous deux locaux. Pour plus d’informations, [voir Skype Entreprise solutions hybrides.](https://docs.microsoft.com/skypeforbusiness/skype-for-business-hybrid-solutions/skype-for-business-hybrid-solutions) <br/> |
 ...
 **Skype Entreprise En ligne et Exchange local**


|**Fonctionnalité**|**Notes**|
|:-----|:-----|
|Présence dans Outlook  <br/> ||
|Répondre par messagerie instantanée, appel PSTN, appel Skype ou appel vidéo à partir d’un Outlook électronique  <br/> ||
...
|Publier l’état en fonction Outlook informations de libre/occupé du calendrier  <br/> ||
|L’historique des conversations manquées et les journaux des appels sont écrits dans la boîte aux lettres Exchange de l’utilisateur  <br/> ||
|Photo de contact haute résolution dans Lync 2013 ou Skype Entreprise client.  <br/> |Nécessite Exchange 2016 ou Exchange 2013. Cela n’est pas pris en charge dans Lync Web App lorsque les utilisateurs sont Skype Entreprise Online.  <br/> |
|Délégation de réunion  <br/> |Pris en charge uniquement lorsque les deux utilisateurs sont en ligne dans la même forêt, ou que les deux sont tous deux locaux. Pour plus d’informations, [voir Skype Entreprise solutions hybrides.](https://docs.microsoft.com/skypeforbusiness/skype-for-business-hybrid-solutions/skype-for-business-hybrid-solutions) <br/> |
|L’historique des conversations manquées et les journaux des appels sont écrits dans la boîte aux lettres Exchange’utilisateur  <br/> ||
|Historique des conversations côté serveur  <br/> ||

 **Skype Entreprise En ligne et Exchange Online**
...
|Planifier et participer à une réunion en ligne à partir Outlook Web App  <br/> ||
|Messagerie instantanée/présence dans les clients mobiles  <br/> ||
|Rejoindre une réunion en ligne dans des clients mobiles  <br/> ||
|Publier l’état en fonction Outlook informations de libre/occupé du calendrier  <br/> ||
|L’historique des conversations manquées et les journaux des appels sont écrits dans la boîte aux lettres Exchange de l’utilisateur  <br/> ||
|Liste des contacts (via le magasin de contacts unifié)  <br/> |Client Lync Server 2013 Skype Entreprise requis  <br/> |
|Photo de contact haute résolution dans Lync 2013, Skype Entreprise client et Lync Web App  <br/> ||
|Délégation de réunion  <br/> |Pris en charge uniquement lorsque les deux utilisateurs sont en ligne dans la même forêt, ou que les deux sont tous deux locaux. Pour plus d’informations, [voir Skype Entreprise solutions hybrides.](https://docs.microsoft.com/skypeforbusiness/skype-for-business-hybrid-solutions/skype-for-business-hybrid-solutions) <br/> |
