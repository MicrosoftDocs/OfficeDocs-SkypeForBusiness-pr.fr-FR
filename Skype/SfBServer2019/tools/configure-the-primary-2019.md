...
Le pack d’administration Des composants et des utilisateurs est utilisé pour surveiller uniquement Skype Entreprise Server 2019. Si vous êtes dans un scénario de coexistence où Skype Entreprise Server 2019 et Skype Entreprise Server 2015 sont installés, vous devez continuer à utiliser les packs d’administration Skype Entreprise Server 2015 pour votre Skype Entreprise Server  Ordinateurs 2015.
...
- **interpréteur de commandes d'Operations Manager** Vous pouvez utiliser l’interpréteur de commandes d'Operations Manager pour importer directement ou pour résoudre les problèmes que vous rencontrez lorsque vous importez des packs d’administration à l’aide des opérations System Center Console du gestionnaire.
