...
Tout autre que les systèmes d’exploitation répertoriés ici ne fonctionnera pas correctement ; n’essayez il pour les installations de Skype pour Business Server 2019. Par exemple, option Server Core n’est pas répertoriée et n’est donc pas pris en charge.

> [!NOTE]
> 
> Si vous installez sur votre ordinateur Windows Server 2019 2019 de centre d’administration de Windows, il vous invite à vous pour écouter sur un port. Il existe un a de chances que vous pouvez choisir le port 443, mais si cet ordinateur a Skype pour Business Server 2019 est installé ou est sur le point d’avoir Skype pour Business Server 2019 est installé, vous devez choisir un autre numéro de port.
> 
>Pourquoi est-ce le cas ? Si Windows Admin Center 2019 s’exécute sur le port 443, vous ne serez pas en mesure de se connecter au serveur à l’aide de la Skype pour Business le panneau de configuration, ni vous sera en mesure de se connecter à tous les services web internes en cours d’exécution sur le serveur (Web Service de carnet d' Autodiscover Service WebTicket Service, etc.).  En fait, vous ne serez pas en mesure de se connecter à n’importe quel URL interne du Service Web. Choisissez un autre port, vous devez ou souhaitez placer 2019 de centre d’administration de Windows sur un serveur avec Skype pour Business Server 2019.
> 
...
||||
|:-----|:-----|:-----|
|Microsoft SQL Server 2016 (Édition 64 bits) et que vous devez exécuter avec les dernières mises à jour.  <br/> |
Microsoft SQL Server 2017 (Édition 64 bits) et que vous devez exécuter avec les dernières mises à jour.|
 |
...
- Microsoft SQL Server 2016 Standard (Édition 64 bits) et nous vous recommandons de s’exécuter avec le service pack le plus récent.
...
- Microsoft SQL Server 2016 Enterprise (Édition 64 bits) et nous vous recommandons de s’exécuter avec le service pack le plus récent.
