...
Vous pouvez déplacer des utilisateurs à Skype pour Business Server 2019 en suivant les procédures décrites dans [Phase 4 : test de déplacer les utilisateurs vers le pool pilote](phase-4-move-test-users-to-the-pilot-pool.md).
  
Après avoir vérifié que tous les utilisateurs ont été supprimés des pools restants, le serveur de désactivation et supprimer des rôles. Une date, mais pertinents, exemple est « Désinstallation de Microsoft Lync Server et suppression de rôles de serveur, » qui peut être téléchargé à [https://go.microsoft.com/fwlink/p/?linkId=246227](https://go.microsoft.com/fwlink/p/?linkId=246227).
