...
6. Après avoir vérifié que le pool hérité est vide, vous pouvez désactiver le pool. 
    ...
    Pour plus d’informations sur la façon de désactiver le pool hérité et les serveurs, voir [phase 8:](phase-8-decommission-legacy-pools.md)déclasser les pools hérités.
