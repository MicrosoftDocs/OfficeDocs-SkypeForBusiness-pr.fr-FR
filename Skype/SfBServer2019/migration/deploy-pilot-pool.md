...
9. Dans la page Définir le magasin **d’archivage SQL Server,** lors de la définition du magasin SQL Server pour l’archivage et la surveillance de Skype Entreprise Server, sélectionnez l’instance SQL Server créée précédemment pour Skype Entreprise Server 2019. 
  
10. Pour publier votre topologie, cliquez avec le bouton droit sur le nœud Skype Entreprise **Server,** puis cliquez sur **Publier la topologie.**
