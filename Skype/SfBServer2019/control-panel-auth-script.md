...
ms.locfileid: "41887723"
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="6f882-103">Script d’authentification du panneau de configuration Skype entreprise Server 2019</span><span class="sxs-lookup"><span data-stu-id="6f882-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="6f882-104">Ce script doit être exécuté après l’installation de Skype entreprise Server 2019 cumulative 1, dans le cadre de la configuration du nouveau panneau de configuration.</span><span class="sxs-lookup"><span data-stu-id="6f882-104">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1, as part of the set-up for the new Control Panel.</span></span> <span data-ttu-id="6f882-105">Ce script crée une application Azure AD sur Azure.</span><span class="sxs-lookup"><span data-stu-id="6f882-105">This script will create an Azure AD Application on Azure.</span></span> <span data-ttu-id="6f882-106">Cela vous permettra de vous connecter à Office 365 à l’aide de OAuth dans le nouveau panneau de configuration.</span><span class="sxs-lookup"><span data-stu-id="6f882-106">This will help in signing into Office 365 using OAuth in the new Control Panel.</span></span>
