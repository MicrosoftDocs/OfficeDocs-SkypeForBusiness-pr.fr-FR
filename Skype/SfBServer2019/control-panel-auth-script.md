...
ms.locfileid: "50756220"
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="7d8fa-103">Script d’authentification du panneau de contrôle Skype Entreprise Server 2019</span><span class="sxs-lookup"><span data-stu-id="7d8fa-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="7d8fa-104">Voici les scripts d’aide associés à l’authentification pour le Panneau de contrôle d’administration moderne (MACP).</span><span class="sxs-lookup"><span data-stu-id="7d8fa-104">Following are the authentication related helper scripts for Modern Admin Control Panel (MACP).</span></span>

## <a name="configure-macp-authentication-with-microsoft-365-or-office-365"></a><span data-ttu-id="7d8fa-105">Configurer l’authentification MACP avec Microsoft 365 ou Office 365</span><span class="sxs-lookup"><span data-stu-id="7d8fa-105">Configure MACP authentication with Microsoft 365 or Office 365</span></span>

<span data-ttu-id="7d8fa-106">Ce script doit être exécuté après l’installation de la mise à jour cumulative 1 ou ultérieure de Skype Entreprise Server 2019, dans le cadre de la mise en place du nouveau Panneau de contrôle.</span><span class="sxs-lookup"><span data-stu-id="7d8fa-106">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1 or later, as part of the set-up for the new Control Panel.</span></span> 
...
```
## <a name="configure-macp-application-in-adfs-farm"></a><span data-ttu-id="7d8fa-107">Configurer l’application MACP dans la batterie de serveurs ADFS</span><span class="sxs-lookup"><span data-stu-id="7d8fa-107">Configure MACP application in ADFS Farm</span></span>

<span data-ttu-id="7d8fa-108">Ce script doit être exécuté après l’installation de la dernière mise à jour cumulative de Skype Entreprise Server 2019, dans le cadre de la mise en place du nouveau Panneau de contrôle.</span><span class="sxs-lookup"><span data-stu-id="7d8fa-108">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
...
```
## <a name="configure-oauth-for-macp"></a><span data-ttu-id="7d8fa-109">Configurer OAuth pour MACP</span><span class="sxs-lookup"><span data-stu-id="7d8fa-109">Configure OAuth for MACP</span></span>

<span data-ttu-id="7d8fa-110">Ce script doit être exécuté après l’installation de la dernière mise à jour cumulative de Skype Entreprise Server 2019, dans le cadre de la mise en place du nouveau Panneau de contrôle.</span><span class="sxs-lookup"><span data-stu-id="7d8fa-110">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
