---
title: "Appels RTC Skype Entreprise - Code de pratique pour le Royaume-Uni"
ms.author: tonysmit
author: tonysmit
ms.date: 9/21/2017
ms.audience: Admin
...
# Appels RTC Skype Entreprise - Code de pratique pour le Royaume-Uni

Ce Code s'applique aux petites entreprises (organisations ne comportant pas plus de 10 employés) du Royaume-Uni dans le cadre du service d'appels RTC Skype Entreprise (le « Service ») et conformément à la législation sur les communications du Royaume-Uni. D'autres services Skype Entreprise sont régis par votre accord de service avec Microsoft et toutes autres conditions applicables à votre utilisation du service particulier.
  
## 1. À propos de Skype Entreprise
...
Vous trouverez peut-être la réponse à certaines de vos questions en visitant le site Web de [Skype Entreprise](http://go.microsoft.com/fwlink/?LinkID=820709&amp;clcid=0x809).
  
## 3. Résolution des réclamations et des litiges

Nos priorités numéro sont la satisfaction du client et l'excellence de nos services. Toutefois, si vous avez une réclamation, nous agirons rapidement pour vous aider à résoudre le problème. Notre page [Appels RTC Skype Entreprise - Code de traitement des réclamations pour le Royaume-Uni](calling-plans-in-office-365complaint-handling-code-for-the-united-kingdom-u-k.md) détaille la procédure que les petites entreprises doivent suivre pour porter réclamation auprès de nos services, ainsi que notre méthode indépendante de résolution des litiges.
  
## 4. Transfert de numéro
...
## 5. Fiabilité du Service

Le service d'appels RTC Skype Entreprise repose sur votre connexion haut débit. Si celle-ci est interrompue ou subit une panne de courant, vous n'êtes pas en mesure d'effectuer des appels téléphoniques. Les causes de ces pannes peuvent être hors de notre contrôle.
  
## 6. Appels d'urgence

Skype Entreprise fournit un accès aux services d'appels d'urgence publics du 999/112 pour les clients situés en Angleterre, au Pays de Galles, en Écosse et en Irlande du Nord. Cependant, avec les services d'appels RTC Skype Entreprise, les appels d'urgence vers le 999 ou le 112 n'opèrent pas de la même manière que les services téléphoniques traditionnels. Les clients doivent informer chaque utilisateur des services d'appels RTC Skype Entreprise de ces différences.
  
Les différences incluent les éléments suivants : (i) Skype Entreprise peut ne pas connaître l'emplacement réel d'un appelant, ce qui pourrait entraîner l'envoi de services d'urgence vers le mauvais emplacement ; (ii) lorsqu'un utilisateur de Skype Entreprise compose un numéro d'urgence, l'utilisateur peut être invité par un opérateur à indiquer son emplacement actuel pour aider au routage correct de l'appel d'urgence et à l'envoi des services d'urgence ; (iii) si l'appareil de l'utilisateur n'est plus alimenté ou pour une raison quelconque ne peut pas accéder à Internet, l'utilisateur ne peut pas effectuer d'appel d'urgence via les services d'appels RTC Skype Entreprise Online ; et (iv) bien que les services d'appels RTC Skype Entreprise Online peuvent être utilisés n'importe où dans le monde où une connexion Internet est disponible, les utilisateurs ne doivent pas composer le 999 ou le 112 depuis un emplacement situé en dehors de l'Angleterre, du Pays de Galles, de l'Écosse ou de l'Irlande du Nord, car l'appel ne serait vraisemblablement pas acheminé vers le service d'urgence approprié.
...
## 9. Frais et tarifs d'abonnement

Vous trouverez des informations sur les abonnements et les frais d'utilisation (y compris les frais liés aux Services à tarif surtaxé et aux Services de traduction nationaux) sur le site Web de [Skype Entreprise](http://go.microsoft.com/fwlink/?LinkID=820709&amp;clcid=0x809).
  
## 10. Inscription dans l'annuaire
...
### Comment fonctionnent les Services à tarif surtaxé ?
...
### Service de préférence téléphonique et service de préférence de télécopie
...
### Protection contre les numéroteurs Internet
...
Pour trouver les coordonnées d'un Fournisseur de services, vous pouvez utiliser l'outil #NumberChecker de PhonepayPlus, disponible sur le site [https://www.phonepayplus.org.uk/for-consumers/making-an-enquiry/submit-an-online-enquiry](https://www.phonepayplus.org.uk/for-consumers/making-an-enquiry/submit-an-online-enquiry). Si vous pensez qu'un Service à tarif surtaxé vous a été facturé à tort, contactez le Fournisseur de services directement.
...
- Demande en ligne : [https://www.phonepayplus.org.uk/for-consumers/making-an-enquiry/submit-an-online-enquiry](https://www.phonepayplus.org.uk/for-consumers/making-an-enquiry/submit-an-online-enquiry)
...
## 13. Services de traduction nationaux, numéros personnels et numéros 0870
...
Les tarifs des Services de traduction nationaux, des Numéros personnels et des numéros 0870 sont spécifiés sur notre [site Web](http://go.microsoft.com/fwlink/?LinkID=820709&amp;clcid=0x809) et peuvent varier selon l'heure de la journée et le jour de la semaine où votre appel est effectué. Les appels vers le 0800 sont gratuits.
