...
# Test de votre installation de Skype Entreprise Online
...
- Un compte avec un fournisseur de services d'audioconférence pour Skype Entreprise Online. Pour en savoir plus, consultez la rubrique [Configurer la conférence Audio pour Skype entreprise et Teams Microsoft](../audio-conferencing-in-office-365/set-up-audio-conferencing-for-skype-for-business-and-microsoft-teams.md).
...
## Configurer des ordinateurs test
<a name="__toc328126910"> </a>
...
Pour plus d'informations, consultez la rubrique [Configurer la conférence Audio pour Skype entreprise et Teams Microsoft](../audio-conferencing-in-office-365/set-up-audio-conferencing-for-skype-for-business-and-microsoft-teams.md). 
...
## Tester les fonctionnalités et les périphériques de Skype Entreprise Online
<a name="__toc328126910"> </a>
...
|:-----|:-----|
|[Se connecter et se déconnecter de Lync Online](https://support.office.com/article/1f0fb5f3-102e-4397-a5c4-f878cc0009d6) <br/> |La fenêtre principale Skype Entreprise s'affiche et indique l'état de présence que vous avez spécifié lors de la connexion.  <br/> |
...
|[FAQ sur Lync pour Office 365](https://support.office.com/article/29fa2061-f679-4e0d-902d-736b67774c8b#BKMK_ContactsFAQ) <br/> |Le contact que vous avez ajouté apparaît dans le groupe de contacts que vous avez choisi.  <br/> |
...
|**Tâche**|**Résultat attendu**|
|:-----|:-----|
|[Émettre et recevoir un appel audio Lync](https://support.office.com/article/39342f16-4d16-44de-a806-0b2b566f3886) <br/> |La fenêtre de conversation apparaît, et vous entendez la sonnerie de votre appel. La personne que vous appelez reçoit une alerte sur son bureau, puis accepte l'appel. La fenêtre de conversation est mise à jour quand l'autre personne se connecte.  <br/> |
|[Ajout de son à une conversation de messagerie instantanée Skype Entreprise (Lync)](https://support.office.com/article/21a098b2-63f1-4205-a9aa-532b6a67ea92) <br/> |L'appel est effectué, et vous pouvez envoyer des messages instantanés et parler avec l'autre personne.  <br/> |
|[Partager votre Bureau ou un programme dans Lync](https://support.office.com/article/33aaa965-eb32-42a9-8a9b-cdfffa364842) <br/> |Le programme ou le bureau partagé est visible par l'autre personne.  <br/> |
   
 **Conférence**
  
|**Tâche**|**Résultat attendu**|
|:-----|:-----|
|[Configurer une réunion Lync](https://support.office.com/article/258f9d20-f06c-49a4-a77f-7f5ac635bb5d) <br/> |Une invitation à une réunion est envoyée aux personnes spécifiées.  <br/> |
|[Modification des paramètres des participants pour les réunions Skype Entreprise (Lync)](https://support.office.com/article/cee2aa78-d878-4a63-ad33-9c249fceced9) <br/> |Varie selon l'option.  <br/> **CONSEIL :** sous **Accès et présentateurs**, vous pouvez tester les différents paramètres de l'option **Qui évite la salle d'attente**.  <br/> |
|[Participer à une réunion Skype Entreprise (Lync)](https://support.office.com/article/538716dc-f4f2-48c2-af96-587c62387b87) <br/> |La fenêtre de conversation apparaît et votre nom s'affiche dans la liste des participants une fois que vous êtes connecté.  <br/> |
|[Activer ou désactiver le son de votre micro lors d'un appel ou d'une réunion Skype Entreprise](https://support.office.com/article/47399948-db7f-4ee5-8e61-53a94bb97704) <br/> |L'icône Muet activé apparaît à côté du nom de tous les participants dans la liste. Vous êtes la seule personne à être entendue quand vous parlez.  <br/> |
