...
Vous pouvez obtenir des réponses à la plupart de vos Skype pour les questions commerciales en ligne en [Rechercher les causes courantes de Skype pour les erreurs de connexion en ligne Business](troubleshooting-sign-in-errors-for-admins.md#toc323194094). Cet article inclut également de nombreuses ressources de résolution des problèmes et erreur références de code : [Comment faire pour résoudre les problèmes de connexion dans Skype pour l’activité en ligne](https://go.microsoft.com/fwlink/p/?LinkId=747952).
