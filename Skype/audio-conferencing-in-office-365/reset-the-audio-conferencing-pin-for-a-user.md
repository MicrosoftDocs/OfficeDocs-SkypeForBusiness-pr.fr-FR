...
Réunions peuvent démarrer lorsqu’un utilisateur authentifié de jointures utilisant un Skype pour application métier ou Teams de Microsoft, ou lorsque l’organisateur de jointures avec son code confidentiel par téléphone. Lorsqu’une réunion exige un code confidentiel pour démarrer, les utilisateurs de jointure par téléphone est placé dans la salle d’attente et écouter de la musique en attente jusqu'à ce que la réunion commence. Si l’organisateur d’une réunion ne nécessite pas un code confidentiel pour démarrer la conférence par téléphone, puis les appelants ne vous demandera de fournir un code confidentiel lorsqu’ils joignent la réunion.
...
[Réinitialiser un ID de conférence pour un utilisateur](reset-a-conference-id-for-a-user.md)
