...
---
# <a name="see-change-and-reset-a-conference-id-assigned-to-a-user"></a>Afficher, modifier et réinitialiser un ID de conférence attribué à un utilisateur
...
4. Dans le **Réinitialiser l’ID de conférence ?** la fenêtre, cliquez sur **Oui**. Une conférence QU'ID sera créé automatiquement et un message électronique envoyé à l’utilisateur avec le nouvel ID de conférence.
