...
Des applets de commande de mobilité ont été introduites pour gérer la fonctionnalité de mobilité ajoutée dans la mise à jour cumulative de Lync Server 2010 : novembre 2011. Utilisez ces applets de commande pour gérer les paramètres des fonctionnalités de mobilité, tels que les stratégies utilisateur et la configuration du service de mobilité.

<div>

## <a name="mobility-cmdlets"></a>Applets de commande de mobilité

Les cmdlets qui configurent les fonctionnalités de mobilité vous permettent d’exécuter des commandes à partir de Lync Server Management Shell ou d’écrire des scripts pour configurer et tester différents paramètres de mobilité.
