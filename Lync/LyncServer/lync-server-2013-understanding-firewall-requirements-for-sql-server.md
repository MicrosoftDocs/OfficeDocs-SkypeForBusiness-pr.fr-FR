...
La documentation Microsoft SQL Server 2012 fournit des instructions détaillées sur la configuration de l’accès au pare-feu pour les bases de données. Pour plus d’informations sur Microsoft SQL Server 2012, reportez-vous à la section « Configuration du pare-feu Windows pour autoriser l’accès à SQL Server » à l’adresse [https://go.microsoft.com/fwlink/p/?linkId=218031](https://go.microsoft.com/fwlink/p/?linkid=218031) .
