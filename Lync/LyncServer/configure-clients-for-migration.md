...
description: Configurez les clients pour la migration.
ms.reviewer: ''
ms.author: serdars
author: serdarsoysal
audience: Admin
...
1.  Déployez les mises à jour les plus récentes du serveur, du client et du périphérique (correctifs) pour Lync Server 2010. Pour obtenir les informations les plus à jour sur Lync Server 2010, consultez la rubrique mises à jour du centre de ressources pour Lync à l’adresse <https://go.microsoft.com/fwlink/p/?linkid=232630> .
