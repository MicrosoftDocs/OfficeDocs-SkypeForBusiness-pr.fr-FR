...
1.  À partir de la ligne de commande Lync Server Management Shell, créez une configuration de proxy pour chaque Lync Server 2013 avec des mises à jour cumulatives : le pool de serveurs Edge de juillet 2013, le pool d’entreprise et le serveur Standard Edition Server qui seront activés pour l’authentification passive en exécutant le commandes suivantes :
