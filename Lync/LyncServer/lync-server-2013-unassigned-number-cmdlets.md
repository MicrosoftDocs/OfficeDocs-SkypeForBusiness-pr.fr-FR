...
# <a name="unassigned-number-cmdlets-in-lync-server-2013"></a>Cmdlets de numérotation non affectées dans Lync Server 2013
...
## <a name="unassigned-number-cmdlets"></a>Cmdlets de numérotation non affectées

Les applets de commande suivantes peuvent être utilisés pour gérer les numéros non attribués.
