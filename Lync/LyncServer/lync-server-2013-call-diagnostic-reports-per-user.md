...
Les rapports de diagnostic des appels fournissent des informations par utilisateur concernant les sessions de conférence et d’égal à égal ayant échoué.

<div>

## <a name="in-this-section"></a>Dans cette section

  - [Le rapport d’activité de l’utilisateur dans Lync Server 2013](lync-server-2013-user-activity-report.md)   fournit des informations sur les activités de conférence et d’égal à égal pour chacun de vos utilisateurs.
