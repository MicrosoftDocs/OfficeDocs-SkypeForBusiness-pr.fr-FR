...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dn720911(v=OCS.15)
ms:contentKeyID: 62240056
ms.date: 05/20/2016
...
[Configuration des utilisateurs de test d’un nœud observateur et paramètres de configuration](lync-server-2013-configuring-watcher-node-test-users-and-configuration-settings.md)  
[Instructions d’installation spéciales pour les transactions synthétiques](lync-server-2013-special-setup-instructions-for-synthetic-transactions.md)
