...
# <a name="media-configuration-cmdlets-in-lync-server-2013"></a>Applets de commande de configuration multimédia dans Lync Server 2013
...
## <a name="media-configuration-cmdlets"></a>Applets de commande de configuration multimédia
