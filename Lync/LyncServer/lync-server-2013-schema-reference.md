...
description: 'Lync Server 2013 : référence de schéma.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Schéma de la base de données de qualité de l’expérience (QoE) dans Lync Server 2013](lync-server-2013-quality-of-experience-qoe-database-schema.md)

  - [Schéma de la base de données de conversation permanente dans Lync Server 2013](lync-server-2013-persistent-chat-database-schema.md)
