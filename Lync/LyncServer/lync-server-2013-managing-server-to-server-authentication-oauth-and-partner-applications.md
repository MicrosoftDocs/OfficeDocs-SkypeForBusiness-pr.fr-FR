...
Lync Server 2013 prend en charge trois scénarios d’authentification de serveur à serveur. Avec Lync Server 2013, vous pouvez :
  ...
  - Configurez l’authentification de serveur à serveur entre une paire de composants 365 Office (par exemple, entre Microsoft Exchange et Microsoft Lync Server, ou entre Microsoft Lync Server et Microsoft SharePoint).
