...
## <a name="assigning-a-per-user-persistent-chat-policy-by-using-windows-powershell-cmdlets"></a>Affectation d’une stratégie de conversation permanente Per-User à l’aide des applets de commande Windows PowerShell
