...
description: 'Lync Server 2013 : réinitialisation ou suppression des stratégies d’accès des utilisateurs externes.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Supprimer une stratégie d’utilisateur ou de site pour l’accès des utilisateurs externes dans Lync Server 2013](lync-server-2013-delete-a-site-or-user-policy-for-external-user-access.md)

  - [Réinitialiser la stratégie globale pour l’accès des utilisateurs externes dans Lync Server 2013](lync-server-2013-reset-the-global-policy-for-external-user-access.md)
