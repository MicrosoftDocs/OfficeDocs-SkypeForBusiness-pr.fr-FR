...
description: 'Lync Online : applets de commande Lync Online.'
ms.reviewer: ''
ms.author: serdars
author: serdarsoysal
f1.keywords:
...
Cette page répertorie toutes les applets de commande Windows PowerShell disponibles pour les administrateurs de clients Microsoft Lync Online.

<div>

## <a name="cmdlets-available-only-to-lync-online-administrators"></a>Applets de commande disponibles uniquement pour les administrateurs Lync Online
...
Pour plus d’informations sur la configuration de votre ordinateur afin d’utiliser Windows PowerShell pour gérer avec Lync Online, voir la rubrique d’aide [Using Windows PowerShell to Manage Lync Online](https://technet.microsoft.com/library/Dn362831(v=OCS.15)).

</div>

<div>

## <a name="other-cmdlets-available-to-lync-online-administrators"></a>Autres cmdlets disponibles pour les administrateurs Lync Online

Ces applets de commande peuvent être utilisées avec Lync Online ou avec la version locale de Lync Server 2013 :
