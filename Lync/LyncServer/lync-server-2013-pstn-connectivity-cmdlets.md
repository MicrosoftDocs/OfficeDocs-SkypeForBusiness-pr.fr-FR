...
---
# <a name="pstn-connectivity-cmdlets-in-lync-server-2013"></a>Applets de commande de connectivité PSTN dans Lync Server 2013
...
Voix Entreprise fournit des paramètres permettant d’assurer l’acheminement des appels depuis et vers le réseau téléphonique commuté (PSTN) sans jamais altérer la qualité du service. Vous pouvez configurer ces paramètres par le biais d’applets de commande disponibles dans Lync Server Management Shell.

<div>

## <a name="pstn-connectivity-cmdlets"></a>Applets de commande de connectivité PSTN

Utilisez les applets de commande suivantes pour configurer différents aspects de la connectivité PSTN.

**[Applets de commande de passerelles PSTN dans Lync Server 2013](lync-server-2013-pstn-gateways-cmdlets.md)**
...
**[Applets de commande de configuration de jonction dans Lync Server 2013](lync-server-2013-trunking-configuration-cmdlets.md)**
