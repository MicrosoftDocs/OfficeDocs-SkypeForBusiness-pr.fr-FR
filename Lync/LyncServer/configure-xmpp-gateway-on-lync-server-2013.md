...
4.  <span data-ttu-id="c6e81-139">Définissez les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="c6e81-139">Define the following settings:</span></span>
