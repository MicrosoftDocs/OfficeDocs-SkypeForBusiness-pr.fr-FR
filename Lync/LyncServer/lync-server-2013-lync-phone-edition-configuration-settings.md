...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Afficher les informations des paramètres de configuration de Lync Phone Edition dans Lync Server 2013](lync-server-2013-view-lync-phone-edition-configuration-settings-information.md)
