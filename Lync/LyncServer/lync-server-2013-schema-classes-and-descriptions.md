---
title: Classes et descriptions de schéma dans Lync Server 2013
TOCTitle: Classes et descriptions de schéma dans Lync Server 2013
ms:assetid: 7d43b920-ac37-40cc-adfe-be289bda6e9e
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Gg398625(v=OCS.15)
ms:contentKeyID: 49297846
ms.date: 05/20/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Classes et descriptions de schéma dans Lync Server 2013
...
## Classes et descriptions de schéma
...
<td><p>Destinataire de courrier de messagerie unifiée Exchange.</p></td>
...
<td><p>Cette classe auxiliaire de msRTCSIP-ApplicationServer contient des attributs représentant des paramètres réservés aux instances du service d’application.</p></td>
<td><p>Nouveauté de Communications Server 2007 R2.</p></td>
</tr>
<tr class="even">
...
<td><p>Ce conteneur de classe représente un service Edge d’accès unique. Un service Edge d’accès est déployé dans le réseau de périmètre, mais les clients n’autorisent généralement pas l’accès aux services de domaine Active Directory à partir de ce réseau. Les instances de service Edge d’accès ne sont donc pas reliées au réseau Active Directory de l’intranet. Par conséquent, les proxys d’accès ne sont pas automatiquement inscrits dans AD DS. L’administrateur doit configurer manuellement l’existence de chaque instance de service Edge d’accès dans AD DS.</p></td>
<td><p>-</p></td>
</tr>
<tr class="even">
...
<td><p>Cette classe contient tous les paramètres qui s’appliquent tout au long d’un déploiement de Lync Server.</p></td>
<td><p>-</p></td>
</tr>
<tr class="odd">
...
<td><p>Cette classe est créée par l’application Intendant Conférence et contient les attributs servant à classer les numéros de téléphone de conférence par région.</p></td>
<td><p>Nouveauté de Communications Server 2007 R2.</p></td>
</tr>
<tr class="even">
...
<td><p>Cette classe contient des attributs représentant les paramètres d’un serveur de surveillance unique.</p></td>
<td><p>Nouveauté de Communications Server 2007 R2.</p></td>
</tr>
<tr class="even">
...
<td><p>Cette classe contient des classes de stratégie Lync Server et ne possède pas d’attributs propres.</p></td>
<td><p>Obsolète dans Lync Server 2010.</p></td>
</tr>
<tr class="odd">
<td><p>msRTCSIP-Pool</p></td>
<td><p>Cette classe représente un Lync Server unique.</p></td>
<td><p>-</p></td>
</tr>
<tr class="even">
<td><p>msRTCSIP-Pools</p></td>
<td><p>Cette classe contient des pools Lync Server et ne possède pas d’attributs propres.</p></td>
<td><p>-</p></td>
</tr>
<tr class="odd">
...
<td><p>Cette classe est un conteneur représentant un service approuvé routable à l’aide d’une adresse d’URI d’agent utilisateur de routage global (GRUU). Une instance de cette classe est créée lors de l’activation d’un nouveau serveur approuvé par Lync Server. Ce serveur approuvé doit être associé à un domaine Active Directory.</p></td>
<td><p>Nouveauté de Communications Server 2007.</p></td>
</tr>
<tr class="odd">
