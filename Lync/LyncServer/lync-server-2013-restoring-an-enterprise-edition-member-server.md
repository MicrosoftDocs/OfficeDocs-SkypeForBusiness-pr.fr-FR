...
3.  Accédez au dossier ou au support d’installation de Lync Server et démarrez l’Assistant Déploiement de Lync Server situé lors de l' \\ installation de \\ amd64 \\Setup.exe.
