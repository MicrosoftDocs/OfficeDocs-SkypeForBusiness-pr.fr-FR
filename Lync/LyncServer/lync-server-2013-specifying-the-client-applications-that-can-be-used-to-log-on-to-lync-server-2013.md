...
# <a name="specifying-the-client-applications-that-can-be-used-to-log-on-to-lync-server-2013"></a>Spécification des applications clientes qui peuvent être utilisées pour se connecter à Lync Server 2013
...
Il existe trois composants de contrôle de version des clients :
  ...
  - Les stratégies de version du client sont utilisées pour affecter un ensemble de règles globalement, ou pour un site, un pool ou un groupe d’utilisateurs particulier.

  - Les règles de stratégie de version des clients constituent une stratégie de version de client et sont utilisées pour définir les actions à effectuer lorsque les utilisateurs tentent de se connecter avec des clients et des versions de client spécifiques.
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Stratégies de version du client dans Lync Server 2013](lync-server-2013-client-version-policies.md)

  - [Règles de version du client dans Lync Server 2013](lync-server-2013-client-version-rules.md)
