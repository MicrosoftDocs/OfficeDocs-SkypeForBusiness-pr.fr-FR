...
---
# <a name="voice-policy-cmdlets-in-lync-server-2013"></a>Applets de commande de stratégie de voix dans Lync Server 2013
...
## <a name="voice-policy-cmdlets"></a>Applets de commande de stratégie vocale
