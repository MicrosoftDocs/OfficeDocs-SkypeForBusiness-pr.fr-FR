...
description: Planification réseau de Lync Server 2013.
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48561490"
---
# <a name="network-planning-for-lync-server-2013"></a>Planification réseau pour Lync Server 2013
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Exigences en matière d’équilibrage de charge pour Lync Server 2013](lync-server-2013-load-balancing-requirements.md)

  - [Configuration requise pour le système DNS (Domain Name System) pour Lync Server 2013](lync-server-2013-domain-name-system-dns-requirements.md)
