...
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a><span data-ttu-id="29a51-102">Tester un serveur de conversation permanente avec une transaction synthétique</span><span class="sxs-lookup"><span data-stu-id="29a51-102">Test Persistent Chat Server with a synthetic transaction</span></span>
...
<span data-ttu-id="29a51-103">_**Dernière modification de la rubrique :** 2012-09-21_</span><span class="sxs-lookup"><span data-stu-id="29a51-103">_**Topic Last Modified:** 2012-09-21_</span></span>

<span data-ttu-id="29a51-104">Pour tester le serveur de conversation permanente pour l’envoi et la réception de messages dans une salle de conversation entre deux utilisateurs</span><span class="sxs-lookup"><span data-stu-id="29a51-104">To test Persistent Chat Server for sending and receiving messages in a chat room between two users</span></span>
...
<span data-ttu-id="29a51-105">ou</span><span class="sxs-lookup"><span data-stu-id="29a51-105">or</span></span>
...
<span data-ttu-id="29a51-106">ou</span><span class="sxs-lookup"><span data-stu-id="29a51-106">or</span></span>
