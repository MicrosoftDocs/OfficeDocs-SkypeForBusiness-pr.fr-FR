...
Ces options de configuration de l’archivage Lync Server 2013 sont décrites plus loin dans cette section. Pour plus d’informations sur la configuration des stratégies et des paramètres de conservation inaltérable Exchange pour la prise en charge de l’archivage, voir la documentation du produit Exchange 2013.
