...
Établissez la session de mise en miroir SQL Server entre la base de données de conversation permanente principale et son miroir. Pour plus d’informations sur le déploiement de la mise en miroir SQL Server, voir [Deploying SQL Mirroring for back end Server High Availability in Lync Server 2013](lync-server-2013-deploying-sql-mirroring-for-back-end-server-high-availability.md).
