...
Les rubriques de cette section comportent des procédures détaillées pour les tâches que vous pouvez effectuer à l’aide du groupe de **messagerie instantanée et de présence** dans le panneau de configuration Lync Server 2013.
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Affectation de stratégies de présence par utilisateur dans Lync Server 2013](lync-server-2013-assigning-per-user-presence-policies.md)
