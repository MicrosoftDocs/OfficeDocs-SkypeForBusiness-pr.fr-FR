...
Utilisez les procédures de cette section pour gérer la stratégie d’emplacement Lync Server 2013 à partir du groupe de **Configuration réseau** dans le panneau de configuration Lync Server.
