...
# <a name="scaled-director-pool-in-lync-server-2013"></a>Pool directeur mis à l’ampleur dans Lync Server 2013
...
Le directeur peut être déployé dans une configuration à directeur unique ou en tant que pool directeur. Cette section définit une topologie et une configuration pour deux topologies de directeurs regroupées. Si vous envisagez de déployer un seul directeur, reportez-vous à la rubrique [Single Director in Lync Server 2013](lync-server-2013-single-director.md) pour obtenir des considérations sur la planification de cette topologie.
