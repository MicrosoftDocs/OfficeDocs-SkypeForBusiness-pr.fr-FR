...
# <a name="view-details-about-a-service-in-lync-server-2013"></a>Afficher les détails relatifs à un service dans Lync Server 2013
...
Vous pouvez utiliser le panneau de configuration Lync Server pour afficher des détails sur chaque service en cours d’exécution sur un ordinateur spécifique dans votre topologie. Vous pouvez consulter le statut de chaque service, ainsi que des données détaillées relatives aux bases de données associées, aux ports et aux services dépendants.
