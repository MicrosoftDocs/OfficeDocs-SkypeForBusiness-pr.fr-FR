...
La configuration matérielle requise pour Lync Server 2013 varie en fonction du rôle du serveur, de la topologie, des besoins en matière de stockage et du scénario de déploiement spécifique.
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Prise en charge du stockage de fichiers dans Lync Server 2013](lync-server-2013-file-storage-support.md)
