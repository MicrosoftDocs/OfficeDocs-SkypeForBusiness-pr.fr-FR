---
title: Rapport de comparaison de la qualité des médias dans Lync Server 2013
TOCTitle: Rapport de comparaison de la qualité des médias
ms:assetid: c1d0b5a8-98ff-455a-b78b-a05a21cf066d
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205236(v=OCS.15)
ms:contentKeyID: 49298732
ms.date: 05/20/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Rapport de comparaison de la qualité des médias dans Lync Server 2013
...
## Accès au rapport comparatif de la qualité des médias
...
<td><p>Non</p></td>
<td><p>Taux moyen de pertes de paquets RTP. (La perte de paquets survient lorsque des paquets RTP, protocole employé pour la transmission audio et vidéo sur Internet, n’atteignent pas leur point de destination.) Les valeurs de perte élevées ont généralement l’une des causes suivantes : une congestion, un dépassement de la bande passante disponible, une congestion/interférence dans la liaison sans fil ou la surcharge d’un serveur multimédia. Ces valeurs se traduisent par une distorsion ou une perte de l’audio.</p></td>
</tr>
<tr class="even">
<td><p><strong>Gigue (ms)</strong></p></td>
<td><p>Non</p></td>
<td><p>Gigue moyenne détectée entre les arrivées de paquets RTP. (La gigue permet de mesurer les fluctuations d’un appel.) Les valeurs de gigue élevées peuvent provenir d’une congestion ou de la surcharge d’un serveur multimédia, ce qui se traduit par une distorsion ou une perte de l’audio.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Taux de masquage de la réparation</strong></p></td>
<td><p>Non</p></td>
<td><p>Ratio moyen d’échantillons audio masqués par rapport au nombre total d’échantillons. (Un échantillon audio masqué est une technique employée pour atténuer les effets de transition brusque généralement causés par la perte de paquets réseau.) Des valeurs élevées indiquent des niveaux importants de masquage des pertes appliqués suite à la perte de paquets ou au phénomène de gigue. Elles se traduisent par une distorsion ou une perte de l’audio.</p></td>
</tr>
<tr class="even">
