...
# <a name="web-conferencing-cmdlets-in-lync-server-2013"></a>Applets de commande de conférence Web dans Lync Server 2013
...
Les réunions et les conférences en ligne sont des éléments importants dans Microsoft Lync Server 2013. Les applets de commande CsConferencingConfiguration et CsConferencingPolicy sont les principaux outils d’administration pour la gestion des conférences à l’aide de Windows PowerShell.

<div>

## <a name="web-conferencing-cmdlets"></a>Web Conferencing Cmdlets

Les cmdlets [New-CsClientPolicy](https://technet.microsoft.com/library/Gg425949(v=OCS.15)) et [Set-CsClientPolicy](https://technet.microsoft.com/library/Gg398300(v=OCS.15)) fournissent des méthodes supplémentaires pour configurer et gérer Lync Server 2013.
