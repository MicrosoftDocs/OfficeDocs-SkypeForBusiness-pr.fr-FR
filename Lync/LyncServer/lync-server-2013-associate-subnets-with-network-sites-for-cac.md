...
---
# <a name="associate-subnets-with-network-sites-for-cac-in-lync-server-2013"></a>Associer des sous-réseaux à des sites réseau pour le contrôle d’admission des serveurs dans Lync Server 2013
