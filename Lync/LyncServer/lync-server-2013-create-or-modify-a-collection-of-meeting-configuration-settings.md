...
## <a name="to-create-new-meeting-join-settings"></a>Pour créer des paramètres de participation aux réunions
...
4.  Dans la liste des configurations de réunion, cliquez sur la configuration que vous souhaitez modifier, cliquez sur **modifier**, puis sur **afficher les détails**.
...
## <a name="to-change-multiple-property-values-when-creating-meeting-configuration-settings"></a>Pour modifier plusieurs valeurs de propriété lors de la création de paramètres de configuration de réunion
...
Pour plus d’informations, consultez la rubrique d’aide relative à la cmdlet [New-CsMeetingConfiguration](https://technet.microsoft.com/library/Gg398065(v=OCS.15)) .
