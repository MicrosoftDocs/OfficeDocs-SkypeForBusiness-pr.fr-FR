...
# <a name="persistent-chat-server-table-details-in-lync-server-2013"></a>Détails de la table du serveur de conversation permanente dans Lync Server 2013
...
Les rubriques suivantes détaillent les colonnes de chacune des tables de schéma de la base de données de conversation permanente.
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [tblSkippedAffiliations dans Lync Server 2013](lync-server-2013-tblskippedaffiliations.md)
