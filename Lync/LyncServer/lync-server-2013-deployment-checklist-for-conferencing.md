...
description: Liste de vérification du déploiement de Lync Server 2013 pour les conférences.
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
Les rubriques suivantes fournissent une liste de vérification pour le déploiement et la configuration de la conférence Web, de la conférence A/V et de la Conférence rendez-vous.
