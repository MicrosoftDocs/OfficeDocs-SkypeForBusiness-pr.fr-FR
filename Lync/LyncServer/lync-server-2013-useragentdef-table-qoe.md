...
---
# <a name="useragentdef-table-qoe-in-lync-server-2013"></a>Table useragentdef table (QoE) dans Lync Server 2013
...
Le tableau table useragentdef mappe les identificateurs de l’agent utilisateur aux noms descriptifs de l’agent. Les agents utilisateurs sont des clients logiciels utilisés pour se connecter à Microsoft Lync Server 2013.
