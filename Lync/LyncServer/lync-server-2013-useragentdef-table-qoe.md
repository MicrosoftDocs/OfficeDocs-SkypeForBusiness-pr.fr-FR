---
title: Table UserAgentDef (QoE) dans Lync Server 2013
TOCTitle: Table UserAgentDef (QoE) dans Lync Server 2013
ms:assetid: cfd8e3e0-4076-4162-9381-5276da8316d9
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ205259(v=OCS.15)
ms:contentKeyID: 49298889
ms.date: 05/20/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Table UserAgentDef (QoE) dans Lync Server 2013

 

_**Dernière rubrique modifiée :** 2015-03-09_

La table UserAgentDef met en correspondance les identificateurs d’agents utilisateurs aux noms descriptifs de l’agent. Les agents utilisateurs sont des clients logiciels utilisés pour se connecter à Microsoft Lync Server 2013.
