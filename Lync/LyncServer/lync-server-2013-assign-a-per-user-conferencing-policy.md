...
## <a name="assigning-a-per-user-conferencing-policy-by-using-windows-powershell-cmdlets"></a>Affectation d’une stratégie de conférence Per-User à l’aide d’applets de commande Windows PowerShell
