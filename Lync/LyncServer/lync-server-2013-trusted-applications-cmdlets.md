...
description: 'Lync Server 2013 : applets de commande d’applications approuvées.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48548860"
---
# <a name="trusted-applications-cmdlets-in-lync-server-2013"></a>Applets de commande d’applications approuvées dans Lync Server 2013
...
Une application approuvée est une application développée par une tierce partie à laquelle est attribué un État approuvé à exécuter dans le cadre de Microsoft Lync Server 2013, mais qui n’est pas intégré au produit. Lync Server 2013 fournit des applets de commande qui peuvent être utilisées pour configurer et gérer des applications approuvées.

<div>

## <a name="trusted-applications-cmdlets"></a>Applets de commande des applications approuvées
