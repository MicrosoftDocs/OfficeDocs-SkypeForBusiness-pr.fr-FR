...
Le contrôle d’admission des appels (CAC) détermine s’il y a suffisamment de bande passante réseau pour établir une session audio ou vidéo en temps réel de qualité acceptable. Vous pouvez gérer le contrôle d’admission des adresses par des limitations et des paramètres configuraing pour les réseaux, les sites et les sous-réseaux et les interactions entre eux.

<div>

## <a name="call-admission-control-cmdlets"></a>Call Admission Control Cmdlets

Utilisez les applets de commande suivantes pour gérer le contrôle d’admission des opérations à partir de Lync Server Management Shell.
