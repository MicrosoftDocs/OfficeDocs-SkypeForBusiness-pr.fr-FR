...
TOCTitle: Vue AudioStreamDetail
ms:assetid: b6a435b3-103c-41c4-96ed-33c3784534c0
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/JJ721859(v=OCS.15)
ms:contentKeyID: 49891505
ms.date: 05/20/2016
mtps_version: v=OCS.15
ms.translationtype: HT
---

# Vue AudioStreamDetail

 

_**Dernière rubrique modifiée :** 2015-03-09_

L’affichage AudioStreamDetail stocke les informations relatives à chaque flux audio dans la base de données. Cette vue est une nouveauté de Microsoft Lync Server 2013.
...
<td><p>bit</p></td>
<td><p>Catégorie de dialogue : 0 correspond au segment Lync Server vers Serveur de médiation ; 1 correspond au segment Serveur de médiation vers Passerelle PSTN.</p></td>
</tr>
<tr class="odd">
...
<td><p>tinyint</p></td>
<td><p>Indique si le système de l’appelé s’exécute dans un environnement virtualisé. Pour plus d’informations, voir la <a href="lync-server-2013-endpoint-table.md">Table Endpoint dans Lync Server 2013</a>.</p></td>
</tr>
<tr class="even">
...
<td><p>tinyint</p></td>
<td><p>Informations de connexion sur le chemin d’accès des médias : directe ou mise en attente, par exemple. Pour plus d’informations, voir la <a href="lync-server-2013-medialine-table.md">Table MediaLine dans Lync Server 2013</a>.</p></td>
</tr>
<tr class="even">
...
<td><p>smallint</p></td>
<td><p>Un commutateur vocal est un mode semi-duplex avec une capacité d’interruption limitée. Pour plus d’informations, voir la <a href="lync-server-2013-medialine-table.md">Table MediaLine dans Lync Server 2013</a>.</p></td>
</tr>
<tr class="odd">
<td><p>CallerEchoEventCauses</p></td>
<td><p>tinyint</p></td>
<td><p>Causes d’un événement d’écho pour l’appelant. Pour plus d’informations, voir la <a href="lync-server-2013-medialine-table.md">Table MediaLine dans Lync Server 2013</a>.</p></td>
</tr>
<tr class="even">
...
<td><p>tinyint</p></td>
<td><p>Causes d’un événement d’écho pour l’appelé. Pour plus d’informations, voir la <a href="lync-server-2013-medialine-table.md">Table MediaLine dans Lync Server 2013</a>.</p></td>
</tr>
<tr class="odd">
