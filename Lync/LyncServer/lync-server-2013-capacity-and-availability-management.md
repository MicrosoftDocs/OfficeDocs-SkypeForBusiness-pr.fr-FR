...
ms:mtpsurl: https://technet.microsoft.com/fr-fr/library/Dn720325(v=OCS.15)
ms:contentKeyID: 62221576
ms.date: 05/20/2016
...
Capacity and availability measurements are repetitive tasks that are ideally suited to automated tools and scripts such as Microsoft System Center Operations Manager (anciennement Microsoft Operations Manager), which is discussed later in this document.
