...
---
# <a name="delete-a-group-call-pickup-number-range-in-lync-server-2013"></a>Supprimer une plage de numéros de prise d’appel de groupe dans Lync Server 2013
...
Utilisez la procédure suivante pour supprimer une plage de numéros de prise d’appel de groupe.

<div>

## <a name="to-delete-a-call-pickup-group-number-range"></a>Pour supprimer une plage de numéros de groupe de prise d’appel
