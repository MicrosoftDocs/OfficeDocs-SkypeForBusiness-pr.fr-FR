...
---
# <a name="add-lync-server-2010-survivable-branch-appliance-branch-site-to-your-topology"></a>Ajouter le site de succursale Survivable Branch Appliance Lync Server 2010 à votre topologie
...
Microsoft Lync Server 2010 Survivable Branch Appliances (SBA) peuvent être associés à un pool frontal Microsoft Lync Server 2013 comme serveur d’inscriptions de sauvegarde. Reportez-vous à la section migration, [Connect a Survivable Branch Appliance](connect-a-survivable-branch-appliance.md), pour obtenir des procédures détaillées sur la façon de connecter votre Microsoft lync Server 2010 SBA à un pool frontal Microsoft lync Server 2013.
