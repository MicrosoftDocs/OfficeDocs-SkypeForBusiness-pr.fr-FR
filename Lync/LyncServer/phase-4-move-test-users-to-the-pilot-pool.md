...
# <a name="phase-4-move-test-users-to-the-pilot-pool"></a>Phase 4 : déplacer les utilisateurs test vers le pool pilote
...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Afficher les utilisateurs actuels dans le pool Lync Server 2010](view-current-users-in-lync-server-2010-pool.md)
