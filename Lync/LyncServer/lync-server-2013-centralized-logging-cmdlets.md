...
description: 'Lync Server 2013 : cmdlets de journalisation centralisée.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48544340"
---
# <a name="centralized-logging-cmdlets-in-lync-server-2013"></a>Cmdlets de journalisation centralisée dans Lync Server 2013
...
Les cmdlets de journalisation centralisée permettent aux administrateurs de gérer et de configurer les fonctionnalités de journalisation centralisée introduites dans Microsoft Lync Server 2013. La journalisation centralisée permet aux administrateurs d’activer ou de désactiver simultanément le suivi des événements sur plusieurs ordinateurs.

<div>

## <a name="centralized-logging-cmdlets"></a>Applets de commande de journalisation centralisée

Les cmdlets de journalisation centralisée vous permettent de gérer le service de journalisation centralisée introduit dans Lync Server 2013 :
