...
3.  Dans le volet de navigation, cliquez sur **Topology**, puis, dans la colonne **statut** , vérifiez qu’il existe un serveur vert doté d’une flèche (c’est-à-dire, l’icône du serveur et l’icône du serveur de ![flèche verte](images/Gg398767.2263cdb7-7e60-457a-a528-a3a082bd051b(OCS.15).jpg "avec flèche verte")) pour votre directeur ou pool de réalisateur.
...
5.  Sur l’un des ordinateurs clients, cliquez sur le menu **options** , sélectionnez le groupe paramètres **personnels** , cliquez sur **avancé**, sur **configuration manuelle**, puis définissez le **nom du serveur interne ou l’adresse IP** sur le nom complet. nom de domaine (FQDN) du nouveau directeur ou du pool de réalisateurs.
