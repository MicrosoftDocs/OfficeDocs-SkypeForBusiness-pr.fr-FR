...
<span data-ttu-id="f9dac-104">Les tableaux suivants comparent les fonctionnalités entre les clients mobiles Lync 2013 et le client de bureau Lync 2013 dans les catégories suivantes :</span><span class="sxs-lookup"><span data-stu-id="f9dac-104">The following tables compare the features and capabilities among Lync 2013 mobile clients and the Lync 2013 desktop client in the following categories:</span></span>
  ...
  - <span data-ttu-id="f9dac-105">Connexion, notifications de transmission et fonctionnalités générales</span><span class="sxs-lookup"><span data-stu-id="f9dac-105">Sign-in, push notifications, and general features</span></span>
...
<td></td>
<td><p><span data-ttu-id="f9dac-136">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-136">●</span></span></p></td>
...
<tr class="odd">
<td><p><span data-ttu-id="f9dac-157">Prise en charge des certificats et de l’authentification passive pour les clients mobiles (Lync Server uniquement)</span><span class="sxs-lookup"><span data-stu-id="f9dac-157">Certificate and passive authentication support for mobile clients (Lync Server only)</span></span></p></td>
<td></td>
...
<span data-ttu-id="f9dac-172">2 dans l’application uniquement.</span><span class="sxs-lookup"><span data-stu-id="f9dac-172">2 In app only.</span></span>
...
<td><p><span data-ttu-id="f9dac-189">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-189">●</span></span></p></td>
...
<tr class="odd">
<td><p><span data-ttu-id="f9dac-210">Définir l’état de présence manuel (par exemple, occupé, ne pas déranger, etc.)</span><span class="sxs-lookup"><span data-stu-id="f9dac-210">Set manual presence state (such as Busy, Do Not Disturb, and so on)</span></span></p></td>
...
<th><span data-ttu-id="f9dac-225">Android</span><span class="sxs-lookup"><span data-stu-id="f9dac-225">Android</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<tr class="odd">
<td><p><span data-ttu-id="f9dac-266">Rechercher des groupes Response Group</span><span class="sxs-lookup"><span data-stu-id="f9dac-266">Search for Response Groups</span></span></p></td>
...
<td><p><span data-ttu-id="f9dac-302">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-302">●</span></span></p></td>
...
<tr class="even">
<td><p><span data-ttu-id="f9dac-325">Écrire un courrier électronique à un contact</span><span class="sxs-lookup"><span data-stu-id="f9dac-325">Initiate an email to a contact</span></span></p></td>
...
## <a name="lync-to-lync-audio-and-video"></a><span data-ttu-id="f9dac-343">Audio et vidéo Lync à Lync</span><span class="sxs-lookup"><span data-stu-id="f9dac-343">Lync-to-Lync Audio and Video</span></span>
...
<td><p><span data-ttu-id="f9dac-379">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-379">●</span></span></p></td>
...
<td><p><span data-ttu-id="f9dac-402">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-402">●</span></span></p></td>
<td></td>
<td></td>
...
<tr class="even">
<td><p><span data-ttu-id="f9dac-424">Partager le Bureau ou un programme</span><span class="sxs-lookup"><span data-stu-id="f9dac-424">Share desktop or program</span></span></p></td>
...
<tr class="odd">
<td><p><span data-ttu-id="f9dac-444">Participer à une réunion même si vous n’avez pas de compte Lync</span><span class="sxs-lookup"><span data-stu-id="f9dac-444">Join a meeting even if you don’t have a Lync account</span></span></p></td>
...
<span data-ttu-id="f9dac-460">2 non disponible pour les utilisateurs de Microsoft 365 ou Office 365.</span><span class="sxs-lookup"><span data-stu-id="f9dac-460">2 Not available to Microsoft 365 or Office 365 users.</span></span>
...
<td><p><span data-ttu-id="f9dac-475">● 2</span><span class="sxs-lookup"><span data-stu-id="f9dac-475">●2</span></span></p></td>
...
<tr class="odd">
<td><p><span data-ttu-id="f9dac-494">Prise en charge des services d’urgence</span><span class="sxs-lookup"><span data-stu-id="f9dac-494">Support emergency services</span></span></p></td>
...
<tr class="even">
<td><p><span data-ttu-id="f9dac-540">Démarrer une conversation par messagerie instantanée avec un contact fédéré</span><span class="sxs-lookup"><span data-stu-id="f9dac-540">Initiate IM with a federated contact</span></span></p></td>
<td><p><span data-ttu-id="f9dac-541">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-541">●</span></span></p></td>
<td><p><span data-ttu-id="f9dac-542">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-542">●</span></span></p></td>
<td><p><span data-ttu-id="f9dac-543">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-543">●</span></span></p></td>
<td><p><span data-ttu-id="f9dac-544">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-544">●</span></span></p></td>
<td><p><span data-ttu-id="f9dac-545">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-545">●</span></span></p></td>
</tr>
<tr class="odd">
<td><p><span data-ttu-id="f9dac-546">Mener des appels à deux avec des utilisateurs externes</span><span class="sxs-lookup"><span data-stu-id="f9dac-546">Conduct two-party calls with external users</span></span></p></td>
<td><p><span data-ttu-id="f9dac-547">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-547">●</span></span></p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="even">
<td><p><span data-ttu-id="f9dac-548">Mener des appels à plusieurs avec des utilisateurs externes</span><span class="sxs-lookup"><span data-stu-id="f9dac-548">Conduct multiparty calls with external users</span></span></p></td>
<td><p><span data-ttu-id="f9dac-549">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-549">●</span></span></p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="odd">
<td><p><span data-ttu-id="f9dac-550">Utiliser l’appel via le Bureau pour joindre un contact fédéré sur son téléphone mobile en appelant leur travail publié Numéro1</span><span class="sxs-lookup"><span data-stu-id="f9dac-550">Use Call via Work to reach a federated contact on their mobile phone by calling their published work number1</span></span></p></td>
<td></td>
<td><p><span data-ttu-id="f9dac-551">● 2</span><span class="sxs-lookup"><span data-stu-id="f9dac-551">●2</span></span></p></td>
<td><p><span data-ttu-id="f9dac-552">● 2</span><span class="sxs-lookup"><span data-stu-id="f9dac-552">●2</span></span></p></td>
<td><p><span data-ttu-id="f9dac-553">● 2</span><span class="sxs-lookup"><span data-stu-id="f9dac-553">●2</span></span></p></td>
<td><p><span data-ttu-id="f9dac-554">● 2</span><span class="sxs-lookup"><span data-stu-id="f9dac-554">●2</span></span></p></td>
</tr>
</tbody>
</table>


<span data-ttu-id="f9dac-555">1 par défaut, la relation de confidentialité des contacts externes est attribuée aux utilisateurs fédérés.</span><span class="sxs-lookup"><span data-stu-id="f9dac-555">1 By default, federated users are assigned the External Contacts privacy relationship.</span></span> <span data-ttu-id="f9dac-556">Pour pouvoir joindre un contact fédéré sur son téléphone mobile en appelant son numéro professionnel publié, le contact fédéré doit vous affecter manuellement la relation de confidentialité des collègues.</span><span class="sxs-lookup"><span data-stu-id="f9dac-556">To be able to reach a federated contact on their mobile phone by calling their published work number, the federated contact must manually assign you the Colleagues privacy relationship.</span></span>

<span data-ttu-id="f9dac-557">2 non disponible pour les utilisateurs de Microsoft 365 ou Office 365.</span><span class="sxs-lookup"><span data-stu-id="f9dac-557">2 Not available to Microsoft 365 or Office 365 users.</span></span>

</div>

<div>

## <a name="address-book-integration"></a><span data-ttu-id="f9dac-558">Intégration du carnet d’adresses</span><span class="sxs-lookup"><span data-stu-id="f9dac-558">Address Book Integration</span></span>
...
<thead>
<tr class="header">
<th><span data-ttu-id="f9dac-559">Fonctionnalité/capacité</span><span class="sxs-lookup"><span data-stu-id="f9dac-559">Feature/Capability</span></span></th>
<th><span data-ttu-id="f9dac-560">Client de bureau Lync 2013</span><span class="sxs-lookup"><span data-stu-id="f9dac-560">Lync 2013 desktop client</span></span></th>
<th><span data-ttu-id="f9dac-561">Windows Phone</span><span class="sxs-lookup"><span data-stu-id="f9dac-561">Windows Phone</span></span></th>
<th><span data-ttu-id="f9dac-562">iPhone</span><span class="sxs-lookup"><span data-stu-id="f9dac-562">iPhone</span></span></th>
<th><span data-ttu-id="f9dac-563">iPad</span><span class="sxs-lookup"><span data-stu-id="f9dac-563">iPad</span></span></th>
<th><span data-ttu-id="f9dac-564">Android</span><span class="sxs-lookup"><span data-stu-id="f9dac-564">Android</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p><span data-ttu-id="f9dac-565">Contacts du carnet d’adresses d’appels</span><span class="sxs-lookup"><span data-stu-id="f9dac-565">Call address book contacts</span></span></p></td>
<td></td>
<td></td>
<td></td>
<td></td>
<td><p><span data-ttu-id="f9dac-566">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-566">●</span></span></p></td>
</tr>
<tr class="even">
<td><p><span data-ttu-id="f9dac-567">Effectuer des appels Lync vers les contacts directement à partir du carnet d’adresses</span><span class="sxs-lookup"><span data-stu-id="f9dac-567">Make Lync calls to contacts directly from address book</span></span></p></td>
<td></td>
<td></td>
<td></td>
<td></td>
<td><p><span data-ttu-id="f9dac-568">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-568">●</span></span></p></td>
</tr>
</tbody>
</table>
...
## <a name="archiving-and-compliance-support-in-lync-mobile-clients"></a><span data-ttu-id="f9dac-569">Prise en charge de l’archivage et de la conformité dans les clients mobiles Lync</span><span class="sxs-lookup"><span data-stu-id="f9dac-569">Archiving and Compliance Support in Lync Mobile Clients</span></span>
...
<thead>
<tr class="header">
<th><span data-ttu-id="f9dac-570">Fonctionnalité/capacité</span><span class="sxs-lookup"><span data-stu-id="f9dac-570">Feature/Capability</span></span></th>
<th><span data-ttu-id="f9dac-571">Client de bureau Lync 2013</span><span class="sxs-lookup"><span data-stu-id="f9dac-571">Lync 2013 desktop client</span></span></th>
<th><span data-ttu-id="f9dac-572">Windows Phone</span><span class="sxs-lookup"><span data-stu-id="f9dac-572">Windows Phone</span></span></th>
<th><span data-ttu-id="f9dac-573">iPhone</span><span class="sxs-lookup"><span data-stu-id="f9dac-573">iPhone</span></span></th>
<th><span data-ttu-id="f9dac-574">iPad</span><span class="sxs-lookup"><span data-stu-id="f9dac-574">iPad</span></span></th>
<th><span data-ttu-id="f9dac-575">Android</span><span class="sxs-lookup"><span data-stu-id="f9dac-575">Android</span></span></th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td><p><span data-ttu-id="f9dac-576">Fournir l’archivage côté client</span><span class="sxs-lookup"><span data-stu-id="f9dac-576">Provide client-side archiving</span></span></p></td>
<td><p><span data-ttu-id="f9dac-577">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-577">●</span></span></p></td>
<td></td>
<td></td>
<td></td>
<td></td>
...
<tr class="even">
<td><p><span data-ttu-id="f9dac-578">Fournir l’enregistrement côté client</span><span class="sxs-lookup"><span data-stu-id="f9dac-578">Provide client-side recording</span></span></p></td>
<td><p><span data-ttu-id="f9dac-579">●</span><span class="sxs-lookup"><span data-stu-id="f9dac-579">●</span></span></p></td>
<td></td>
<td></td>
<td></td>
<td></td>
