...
Les utilisateurs sont toujours hébergés dans Lync Server. Si l’intégration de Microsoft Exchange est activée, les utilisateurs dont les boîtes aux lettres sont dans Microsoft Exchange Server 2013 n’ont pas besoin de gérer les stratégies d’archivage dans Lync Server. Ces utilisateurs disposant d’un archivage seront gérés par Exchange In-Place conservation.
