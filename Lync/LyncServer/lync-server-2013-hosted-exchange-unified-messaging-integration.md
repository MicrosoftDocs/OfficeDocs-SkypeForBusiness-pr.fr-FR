...
En plus de la prise en charge que les précédentes versions de Lync Server 2013 ont fournies pour l’intégration avec des déploiements *locaux* de la messagerie unifiée Exchange, Lync Server 2013 introduit la prise en charge de l’intégration à la messagerie unifiée Exchange *hébergée* . La messagerie unifiée Exchange hébergée permet à Lync Server 2013 de fournir des messages vocaux à vos utilisateurs si vous en transférez une partie ou la totalité vers un fournisseur de services Exchange hébergé tel que Microsoft Exchange Online.

Lync Server 2013 Enterprise Voice utilise l’infrastructure de messagerie unifiée Exchange pour fournir des services de répondeur automatique, de notification d’appel, d’accès vocal (y compris la messagerie vocale) et de standard automatique. Pour plus d’informations, reportez-vous à la rubrique [fonctionnalités de la messagerie unifiée intégrée et Lync Server 2013](lync-server-2013-features-of-integrated-unified-messaging.md).
