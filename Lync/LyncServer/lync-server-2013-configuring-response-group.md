...
> [!TIP]  
> Pour plus d’informations sur la création d’un groupe Response Group à l’aide de Lync Server Management Shell, notamment un exemple de script, reportez-vous à la rubrique « Creating Your First Response Group using Lync Server Management Shell » à l’adresse <A href="https://go.microsoft.com/fwlink/p/?linkid=204108">https://go.microsoft.com/fwlink/p/?linkId=204108</A> .
