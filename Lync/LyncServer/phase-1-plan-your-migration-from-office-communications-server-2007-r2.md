...
description: 'Phase 1 : planification de la migration à partir d’Office Communications Server 2007 R2.'
ms.reviewer: ''
ms.author: serdars
author: serdarsoysal
f1.keywords:
...
ms.locfileid: "48571210"
---
# <a name="phase-1-plan-your-migration-from-office-communications-server-2007-r2"></a>Phase 1 : planifier votre migration à partir d’Office Communications Server 2007 R2
...
Cette section traite de la planification des rubriques relatives à la migration d’Office Communications Server 2007 R2 vers Lync Server 2013.
