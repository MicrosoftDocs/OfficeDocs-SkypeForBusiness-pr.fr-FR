...
# <a name="enabling-and-disabling-media-bypass-in-lync-server-2013"></a>Activation et désactivation de la déviation du trafic multimédia dans Lync Server 2013
...
Utilisez les procédures de cette section pour activer ou désactiver la déviation du trafic multimédia à l’aide du panneau de configuration Lync Server. Pour plus d’informations sur l’utilisation de la déviation du trafic multimédia, voir [Planning for Media Bypass in Lync Server 2013](lync-server-2013-planning-for-media-bypass.md).
