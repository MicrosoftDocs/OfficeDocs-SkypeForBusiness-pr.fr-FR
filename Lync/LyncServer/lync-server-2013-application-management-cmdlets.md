...
description: 'Lync Server 2013 : applets de commande de gestion des applications.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48568890"
---
# <a name="application-management-cmdlets-in-lync-server-2013"></a>Applets de commande de gestion des applications dans Lync Server 2013
...
Microsoft Lync Server 2013 fournit des applets de commande qui vous permettent de gérer les applications Lync Server et les applications tierces approuvées.

<div>

## <a name="application-management-cmdlets"></a>Applets de commande de gestion d’applications

Les applets de commande des catégories suivantes permettent de gérer les applications.

**[Applets de commande pour les points de terminaison d’application dans Lync Server 2013](lync-server-2013-application-endpoints-cmdlets.md)**
...
**[Applets de commande des serveurs d’applications et des services dans Lync Server 2013](lync-server-2013-application-server-and-services-cmdlets.md)**
...
**[Applets de commande d’applications approuvées dans Lync Server 2013](lync-server-2013-trusted-applications-cmdlets.md)**
