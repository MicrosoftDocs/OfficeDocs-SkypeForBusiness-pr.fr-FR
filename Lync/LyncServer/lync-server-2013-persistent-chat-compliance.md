...
description: 'Lync Server 2013 : conformité de la conversation permanente.'
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
Pour créer une nouvelle configuration de la conformité de conversation permanente
...
Pour obtenir la configuration de la conformité de conversation permanente

    Get-CsPersistentChatComplianceConfiguration [-Identity <XdsIdentity>] [-LocalStore <Switch Parameter>]

Pour définir la configuration de la conformité de conversation permanente
...
Pour supprimer la configuration de la conformité de conversation permanente
