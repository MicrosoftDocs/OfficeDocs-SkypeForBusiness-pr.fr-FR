...
## <a name="in-this-section"></a>Dans cette section
  ...
  - [Définition de votre topologie Edge dans Lync Server 2013](lync-server-2013-define-your-edge-topology.md)

  - [Définir des topologies facultatives de directeur dans votre topologie pour Lync Server 2013](lync-server-2013-define-optional-director-topologies-in-your-topology.md)

  - [Publier votre topologie dans Lync Server 2013](lync-server-2013-publish-your-topology.md)
