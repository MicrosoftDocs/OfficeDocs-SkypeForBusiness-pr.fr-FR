...
Vous utilisez l’outil de configuration Response Group pour créer des flux de travail. Vous pouvez accéder à l’outil de configuration Response Group à partir de la page Response Group du panneau de configuration Lync Server.
