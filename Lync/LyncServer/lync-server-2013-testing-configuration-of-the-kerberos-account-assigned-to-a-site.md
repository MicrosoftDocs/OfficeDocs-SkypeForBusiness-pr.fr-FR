...
<p>Lorsqu’ils sont exécutés à l’aide d’une instance distante de Windows PowerShell, un rôle RBAC doit être attribué aux utilisateurs qui sont autorisés à exécuter l’applet de commande Test-CsKerberosAccountAssignment. Pour afficher la liste de tous les rôles RBAC pouvant utiliser cette cmdlet, exécutez la commande suivante à partir de l’invite Windows PowerShell :</p>
...
L’applet de commande Test-CsKerberosAccountAssignment ne renvoie pas une simple indication de succès ou d’échec. Au lieu de cela, vous devez afficher le fichier HTML généré à l’aide d’Internet Explorer.
...
Voici quelques raisons courantes pour lesquelles Test-CsKerberosAccountAssignment peut échouer :
