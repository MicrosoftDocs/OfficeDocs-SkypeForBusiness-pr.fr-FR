...
Pour plus d’informations, reportez-vous à la documentation de l’aide relative à l’applet de commande [test-CsClientAuth](http://technet.microsoft.com/library/gg398712\(v=ocs.14\).aspx) .
