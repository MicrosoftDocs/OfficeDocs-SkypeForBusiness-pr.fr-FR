...
1.  Copiez le dossier qui contient les dossiers et les fichiers de configuration dans le répertoire qui contient LyncStressTool. exe sur chaque ordinateur client. (Par exemple, si vous avez généré les fichiers de configuration dans le dossier\_nommé 1,28 13.16.16, copiez ce dossier dans le dossier qui contient LyncPerfTool. exe sur chaque client.)
