...
Exécutez le fichier Windows Installer, **CapacityPlanningTool.msi**, sur chaque ordinateur client que vous utiliserez pour simuler le trafic utilisateur. Ces ordinateurs clients ne doivent pas exécuter de composants Lync Server.
