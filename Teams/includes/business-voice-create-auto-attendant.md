...
Un utilisateur virtuel doit avoir une licence Système téléphonique chaque employé. Lorsque vous avez acheté Teams Téléphone avec forfait d’appels, vous recevez également un certain nombre de licences Système téléphonique - Utilisateur virtuel, aussi n’avez-vous probablement pas besoin d’en demander davantage. Toutefois, si vous en avez besoin à l’avenir, vous pouvez les obtenir en suivant les instructions de Système téléphonique - Licence utilisateur [virtuel.](../teams-add-on-licensing/virtual-user.md)
