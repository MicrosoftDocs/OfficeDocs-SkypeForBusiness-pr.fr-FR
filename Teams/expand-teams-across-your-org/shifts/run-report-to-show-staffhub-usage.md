...
Pour pouvoir effectuer les étapes décrites dans cet article, vous devez disposer d’Azure AD Premium.

1. Connectez-vous au portail Azure.
2. Dans le volet de gauche, cliquez sur la ressource **Azure Active Directory** .
3. Sous **analyse**, cliquez sur **Sign-ins**.
4. Sous **application**, tapez **Microsoft StaffHub**.
5. Définissez la plage de dates souhaitée pour le rapport, puis cliquez sur **appliquer**. 
