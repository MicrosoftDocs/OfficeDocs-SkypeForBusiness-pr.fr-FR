...
Ces informations de présence basées sur un shift &mdash; ![ sont des coches verts pleins qui indiquent Les shifts.](../../media/flw-presence-on-shift.png) **Sur shift,** ![ cercle gris avec x, indique Shift off.](../../media/flw-presence-off-shift.png) **Décalé,** cercle rouge plein, indique que Occupé(se) est séparé du jeu par défaut d’états de présence ![ ](../../media/flw-presence-busy.png)  &mdash; dans Teams. [](../../presence-admins.md) Avec ces deux ensembles d’états de présence, vous pouvez configurer des expériences différentes pour les membres de votre organisation en fonction de leur rôle.
