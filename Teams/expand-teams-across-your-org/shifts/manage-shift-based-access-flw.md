...
Ces signes de présence basés sur un shift sont une coche verte pleine, indiquent Sur shift, Cercle gris avec x, indique Décalage décalé, Cercle rouge plein, indique Occupé(nt) être séparé du jeu d’états de présence par défaut dans &mdash; ![ ](../../media/flw-presence-on-shift.png)  ![ ](../../media/flw-presence-off-shift.png)  ![ ](../../media/flw-presence-busy.png)  &mdash; Teams. [](../../presence-admins.md) Ces deux ensembles d’états de présence vous permet de configurer des expériences différentes pour les membres de votre organisation en fonction de leur rôle.
