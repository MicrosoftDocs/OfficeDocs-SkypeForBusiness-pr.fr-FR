...
Les tâches et activités de ces listes de vérification sont les principales « choses à faire » qui s’appliquent à chaque déploiement de collaboration et de fonctionnalités vocales avec Teams. Vous pouvez personnaliser les listes de vérification pour inclure les activités et tâches spécifiques à votre parcours teams.
...
>[!NOTE]
>La plupart des paramètres de configuration sont communs entre Teams et Skype Entreprise Online. Le Centre d’administration Microsoft Teams vous permet de configurer ces paramètres.

<table>
<tr><td><img src="media/audio_conferencing_image7.png" alt="An icon depicting a decision point"/> <br/>Point de décision</td><td><ul><li>Qui sera responsable de la supervision de l’achèvement des listes de vérification d’intégration ?</li></ul></td></tr>
...
Une fois que vous avez terminé cette liste de vérification, passer à l’étape suivante : [conduire un pilote d’utilisateur](pilot-essentials.md)
