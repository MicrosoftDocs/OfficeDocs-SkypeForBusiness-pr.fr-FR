...
## <a name="onboarding-checklists-and-landing-pages-for-microsoft-teams-rollout"></a>Listes de contrôle d’intégration et pages d’accueil pour Microsoft Teams déploiement

Les listes de vérification et pages d’accueil suivantes vous aideront à suivre les étapes de déploiement de Microsoft Teams votre organisation :
...
- [Système téléphonique options de connectivité PSTN](cloud-voice-landing-page.md)
