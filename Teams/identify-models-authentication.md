...
Pour plus d’informations, voir [les modèles d’identité Microsoft 365 et Azure AD.](https://docs.microsoft.com/microsoft-365/enterprise/about-microsoft-365-identity)
...
|Identité hybride     |<ol type="1"><li>Installez Azure AD Connect.</li><li>Configurez la synchronisation d’annuaires.</li><li>Gérez les utilisateurs et les groupes à l’aide d’outils AD DS.</li></ol> |<ul style="list-style-type:none"><li>[Configurer la synchronisation d’annuaires](https://docs.microsoft.com/microsoft-365/enterprise/set-up-directory-synchronization)</li></ul> |
...
Pour plus d’informations, [voir Authentification multifacteur pour Microsoft 365.](https://docs.microsoft.com/microsoft-365/admin/security-and-compliance/multi-factor-authentication-microsoft-365)
