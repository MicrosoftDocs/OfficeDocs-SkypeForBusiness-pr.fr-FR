...
- Les **canaux** sont des sections dédiées dans une équipe pour stocker des conversations organisées par sujets, projets et disciplines spécifiques ; à votre équipe de décider ! Les fichiers que vous partagez dans un canal (sous l’onglet Fichiers) sont stockés dans SharePoint. Si vous souhaitez en savoir plus, consultez l’article [Interaction entre SharePoint Online et OneDrive Entreprise  et Teams](SharePoint-OneDrive-interact.md).
    ...
    - Les canaux sont les endroits où les conversations ont lieu et où le travail se fait réellement. Les canaux sont ouverts à tous les membres d’une équipe mais si vous souhaitez une audience plus restreinte, ils peuvent être privés. Les canaux standard sont destinés aux conversations auxquelles tous les membres d’une équipe peuvent participer et les [canaux privés](private-channels.md) limitent la communication à un sous-ensemble de personnes dans une équipe.
    - Les canaux sont particulièrement utiles lorsque des applications incluant des onglets, des connecteurs et des robots y sont ajoutés, qui apportent une valeur ajoutée pour les membres de l’équipe. Si vous souhaitez en savoir plus, consultez l’article [Applications, robots, & connecteurs dans Teams](deploy-apps-microsoft-teams-landing-page.md).
...
Lorsque Teams est activé pour l’ensemble de votre organisation, les propriétaires d’équipe peuvent inviter tous les membres de l’organisation avec qui ils travaillent à rejoindre leur équipe. Teams permet aux propriétaires d’équipe d’ajouter facilement des personnes de l’organisation en fonction de leur nom. Selon les paramètres de votre organisation, des personnes extérieures à votre organisation peuvent être ajoutées à vos équipes en tant qu’invités. Reportez-vous à la rubrique [Accès invité dans Microsoft Teams](guest-access.md) pour plus d’informations. 

Les propriétaires d’équipe peuvent également créer une équipe basée sur un groupe Microsoft 365 existant. Les modifications apportées à l’appartenance au groupe sont synchronisées Teams automatiquement.

**Rôles de l’équipe**

Il existe deux rôles principaux dans Teams : 

- **Propriétaire d’équipe** : la personne qui crée l’équipe. Les propriétaires d’équipe peuvent définir n’importe quel membre de leur équipe comme copropriétaire lorsqu'ils 'l’invitent à rejoindre l'équipe ou à n’importe quel moment une fois qu'il a rejoint l’équipe. Avoir plusieurs propriétaires pour une équipe vous permet de partager les responsabilités de gestion des paramètres et d’appartenance, y compris les invitations.
...
Vous trouverez ci-dessous quelques exemples fonctionnels sur la façon dont les différents types d'utilisateurs abordent la configuration de leurs équipes, canaux et applications (onglets/connecteurs/robots). Cela peut être utile pour lancer une conversation sur Teams avec la communauté des utilisateurs. Lorsque vous réfléchissez à la façon d’implémenter des Teams dans votre organisation, n’oubliez pas que vous pouvez fournir des instructions sur la structure de leurs équipes. toutefois, les utilisateurs contrôlent la façon dont ils peuvent s’organiser eux-mêmes. Ce ne sont que des exemples pour aider les équipes à commencer à réfléchir aux possibilités.

Teams pour la rupture des silos d’organisation et la promotion d’équipes fonctionnelles croisées, encouragez vos utilisateurs à réfléchir aux équipes fonctionnelles plutôt qu’aux limites de l’organisation.
...
|Logistique     |Opérations d'entrepôt<br></br>Maintenance des véhicules<br></br>Registre des conducteurs         |Service météo<br></br>Perturbations de déplacement / trafic<br></br>Planificateur<br></br>UPS Bot         |
...
Il est possible de créer des équipes qui correspondent à la structure organisationnelle. Cette option convient surtout aux responsables qui souhaitent encourager l’état d’esprit, avoir des évaluations spécifiques aux équipes, clarifier le processus d'intégration des employés, discuter des plans de gestion du personnel et accroître la visibilité auprès d'une main-d'œuvre diversifiée.  
...
Lisez [conversation, équipes, canaux et &](deploy-chat-teams-channels-microsoft-teams-landing-page.md) dans Teams pour parcourir la liste des décisions importantes pour votre déploiement Teams’équipe.
