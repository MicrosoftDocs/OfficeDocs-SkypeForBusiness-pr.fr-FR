---
title: Utiliser Power BI pour analyser les données de CQD pour Microsoft Teams
author: CarolynRowe
ms.author: crowe
manager: serdars
ms.reviewer: siunies
...
description: Utilisez Power BI pour analyser les données de CQD pour Microsoft Teams.
...
---
# <a name="use-power-bi-to-analyze-cqd-data-for-microsoft-teams"></a>Utiliser Power BI pour analyser les données de CQD pour Microsoft Teams

Nouveauté de juillet 2022 : Le nouveau modèle QER (Quality of Experience) a été ajouté aux modèles de [requête Power BI pour le téléchargement de CQD](https://www.microsoft.com/download/details.aspx?id=102291). Le QER est un modèle de création de rapports puissant qui supercede les modèles de requête Power BI CQD d’origine publiés en 2020. Bien que les modèles d’origine restent disponibles à des fins de démonstration, ils ne sont plus pris en charge ou mis à jour et nous recommandons aux clients de basculer vers le modèle QER qui continuera à recevoir des mises à jour. Notez que cela ne s’applique pas au rapport historique de file d’attente d’appels & du standard automatique CQD Teams.

Pour les rapports CQD (Call Quality Dashboard) dans Teams, si vous préférez utiliser Power BI pour interroger et signaler vos données, téléchargez nos modèles Power BI CQD. Lorsque vous ouvrez les modèles dans Power BI, vous êtes invité à vous connecter avec vos informations d’identification d’administrateur CQD. Vous pouvez personnaliser ces modèles de requête et les distribuer à toute personne de votre organisation disposant d’une licence Power BI et d’autorisations d’administrateur CQD.
