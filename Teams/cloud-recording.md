...
- L’utilisateur doit disposer d’une licence Microsoft Stream <sup>2</sup> 
...
Pour activer les enregistrements dans une région, la stratégie Générale utilise la cmdlet suivante :
