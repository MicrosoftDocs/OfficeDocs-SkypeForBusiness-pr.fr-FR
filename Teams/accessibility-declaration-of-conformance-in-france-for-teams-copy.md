...
> 
> [4.2.10 Utilisation avec cognitive limitée](http://mandate376.standards.eu/standard/technical-requirements?functional_statements=48&functional_statements_submitted=true)
> 
...
<p>Dans le cas où la CELLES-ci présente des fonctionnalités d’accessibilité documentées, il est possible d’activer les fonctionnalités qui sont requises pour répondre à un besoin spécifique sans faire appel à une méthode qui ne prend pas en charge ce besoin.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
<td><h3 id="biométrie">5.3 Biométrie</h3>
<p>Dans le cas où la CES fait appel à des caractéristiques biologiques, elle ne fait pas de l’utilisation d’une caractéristique biologique le seul moyen d’identification de l’utilisateur ou de contrôle de la PREMIÈRE.</p></td>
<td>Non applicable</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où la DOMAINE présente des éléments actionnables qui doivent être actionnés en les prenant, en les pinçant ou en comportant une comportant du poignet, un autre mode de fonctionnement accessible qui ne nécessite pas ces gestes est proposé.</p></td>
<td>Non applicable</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où laNT nécessite, pour fonctionner, plusieurs actions simultanées de l’utilisateur, cette PREMIÈRE propose au moins un mode de fonctionnement qui ne nécessite pas plusieurs actions simultanées de la part de l’utilisateur pour fonctionner.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
</tbody>
...
<p>Dans le cas où laNT est dotée de capacités d’envoi et de réception en RTT, la direction (envoi/réception) du texte transmis est déterminable par un programme informatique, à moins que le RTT n’ait une fonctionnalité fermée.</p></td>
<td>Pas pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="interopérabilité">6.2.3 Vous ne pourz pas vous en faire une.</h3>
...
<tr class="even">
<td><h3 id="réactivité-de-la-rtt">6.2.4 Première de la RTT</h3>
<p>Dans le cas où la SAISIE RTT utilise la saisie RTT, cette saisie RTT est transmise au réseau au JOURNAL compatible RTT dans la seconde qui suit sa saisie.</p></td>
<td>Pas pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="identification-de-lappelant">6.3 Identification de l’appelant</h3>
<p>Dans le cas où la CES propose l’identification de l’appelant et où des fonctions de télécommunications similaires sont proposées, l’identification de l’appelant et les fonctions de t appelant similaires sont disponibles sous forme de texte et via au moins une autre modalité.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
...
<p>Lorqu’une ANNEE qui permet la communication voix bidirectionnelle est également dotée d’une fonctionnalité vidéo en temps réel, cette DOSSIER :</p>
<p>a) est compatible au moins avec la résolution « CONTRÔLE.SI » ;</p>
...
<p>Lorsqu’une INFORMATION qui propose la communication voix bidirectionnelle est dotée d’une fonctionnalité de vidéo en temps réel, cette DOSSIER :</p>
...
<p>Lorsqu’une INFORMATION qui permet la communication voix bidirectionnelle est dotée d’une fonctionnalité de vidéo en temps réel, cette doit AVOIR garantir un écart de temps de 100 ms maximum entre la voix et les images présentées à l’utilisateur.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
<td><h3 id="alternatives-aux-services-vidéo">6.6 Alternatives aux services vidéo</h3>
<p>Dans le cas où la CES propose la communication vidéo en temps réel et propose également des fonctions de répondeur, de réception automatique ou de réponse interactive, la JOURNAL doit proposer aux utilisateurs un moyen d’accéder aux informations et d’accomplir les tâches associées à ces fonctions :</p>
...
### <a name="section-7-tic-avec-fonctions-vido"></a>Section 7 FONCTIONS avec fonctions vidéo
...
<p>Dans le cas où la CLAUSE est un logiciel non-web qui est doté d’une interface utilisateur et qui prend en charge l’accès aux technologies d’assistance pour la lecture d’écran, elle remplit les Critères de Succès indiqués dans le Tableau 11.1 : Contenu non textuel :</p>
...
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.3 : Sous-titres (préenregistrés) :</p>
...
<p>Dans le cas où la CLAUSE EST un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.6 : Audio-description (préenregistrée) :</p>
...
<p>Dans le cas où la CLAUSE est un logiciel non-web qui est doté d’une interface utilisateur et qui prend en charge l’accès aux technologies d’assistance pour la lecture d’écran, elle remplit les Critères de Succès indiqués dans le Tableau 11.7 : Informations et relations :</p>
...
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.9 : Caractéristiques sensorielles :</p>
...
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.10 : Utilisation de la couleur :</p>
...
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.12 : Contraste (minimum) :</p>
...
<p>Dans le cas où la MACHINE est un logiciel non-web qui est doté d’une interface utilisateur et qui permet l’accès aux fonctions d’agrandissement de la plate-forme ou de la technologie d’assistance, elle remplit les Critères de Succès indiqués dans le Tableau 11.13 : Redimensionner le texte :</p>
...
<p>Dans le cas où la CLAUSE est un logiciel non-web qui est doté d’une interface utilisateur et qui prend en charge l’accès aux technologies d’assistance pour la lecture d’écran, elle remplit les Critères de Succès indiqués dans le tableau 11.14 : Images de texte :</p>
...
<p>Personnel : L’image de texte peut être visuellement adaptée aux besoins de l’utilisateur.</p>
...
<p>Dans le cas où la CLAUSE est un logiciel non-web qui est doté d’une interface utilisateur et qui permet l’accès aux claviers ou à une interface clavier, elle remplit les Critères de Succès indiqués dans le Tableau 11.1 : Clavier :</p>
...
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.16 : Pas de piège au clavier :</p>
<p>Si le focus du clavier peut être position sur un composant du logiciel à l’aide d’une <a href="https://www.w3.org/Translations/NOTE-UNDERSTANDING-WCAG20-fr/keyboard-operation-trapping.html#keybrd-interfacedef">interface clavier,</a>réciproquement, il peut être déplacé hors de ce même composant simplement à l’aide d’une interface clavier et, si ce déplacement exige plus que l’utilisation d’une simple touche flèche ou tabulation ou toute autre méthode standard de sortie, l’utilisateur est informé de la méthode permettant de déplacer le focus hors de ce composant.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
<td><h3 id="réglage-du-délai">11.2.1.17 Réglage du délai</h3>
<p>Dans le cas où la CLAUSE EST un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le tableau 11.17 : Réglage du délai :</p>
...
<p>L’exception du temps réel : la limite de temps est une partie contrôletive d’un événement en temps réel (par exemple, une contrôle) et aucune alternative n’est possible ; ou</p>
<p>L’exception de la limite essentielle : la limite de temps est essentielle et la prolonger invalidrait alors l’activité ; ou</p>
...
<p>Dans le cas où la CLAUSE EST un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.23 : Fonction du lien (selon le contexte) :</p>
<p>La fonction de chaque lien peut être déterminée par le texte du lien ou par le texte du lien associé à un contexte du lien déterminé par un programme informatique, sauf si la fonction du lien est ambiguë pour tout utilisateur.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
<td><h3 id="en-têtes-et-étiquettes">11.2.1.25 En-têtes et étiquettes</h3>
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.25 : En-têtes et étiquettes :</p>
...
<p>Dans le cas où la CLAUSE EST un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le 11.26 : Visibilité du focus :</p>
...
<p>Dans le cas où la CLAUSE est un logiciel non-web qui est doté d’une interface utilisateur et qui prend en charge l’accès aux technologies d’assistance pour la lecture d’écran, elle remplit les Critères de Succès indiqués dans le Tableau 11.27 : Langue du logiciel :</p>
...
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.29 : Au focus :</p>
...
<p>Dans le cas où la CLAUSE est un logiciel non-web qui est doté d’une interface utilisateur et qui prend en charge l’accès aux technologies d’assistance pour la lecture d’écran, elle remplit les Critères de Succès indiqués dans le Tableau 11.33 : Identification des erreurs :</p>
...
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.34 : Étiquettes ou instructions :</p>
...
<p>Dans le cas où la CHERCHE est un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le Tableau 11.35 : Suggestion après une erreur :</p>
...
<p>Dans le cas où la CLAUSE EST un logiciel non-web qui est doté d’une interface utilisateur, elle remplit les critères de Succès indiqués dans le tableau 11.36 : Prévention des erreurs (juridiques, financières, de données) :</p>
<p>Pour les logiciels qui entraînent des obligations légales ou des transactions financières de la partie de l’utilisateur, qui modifient ou effacent des données contrôlables par l’utilisateur dans des systèmes de stockages de données ou qui enregistrent les réponses de l’utilisateur à des tests, au moins l’une des conditions suivantes est vraie :</p>
...
<h3 id="dans-le-cas-où-la-tic-est-une-technologie-dassistance-elle-utilise-les-services-documentés-daccessibilité-de-la-plate-forme.">Dans le cas où laNT est une technologie d’assistance, elle utilise les services documentés d’accessibilité de la plate-forme.</h3></td>
<td>Non applicable</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Dans le cas où le logiciel est doté d’une interface utilisateur, il utilisera, à l’aide des services décrits dans la 11.3.2.3, les technologies d’assistance de toute modification des attributs de l’interface utilisateur déterminables par un programme informatique qui sont font partie des exigences 11.3.2.5 à 11.3.2.11 et 11.3.2.13.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="even">
<td><h3 id="modifications-de-létat-et-des-propriétés">11.3.2.16 Modifications de l’état et des propriétés</h3>
<p>Si les exigences de sécurité l’autorisent, un logiciel qui est doté d’une interface utilisateur autorise les technologies d’assistance, en utilisant les services décrits dans la clause 11.3.2.3, à modifier par un programme informatique l’état et les propriétés des éléments de l’interface utilisateur, dans la mesure l’utilisateur peut les modifier.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Si le système auteur assure des transformations de contrôle ou des transformations de recodage, alors les informations sur l’accessibilité sont préservées dans le résultat s’il existe des mécanismes équivalents dans la technologie du contenu du résultat.</p></td>
<td>Non applicable</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Quand un système auteur propose des modèles, au moins un modèle prenant en charge la création de contenu conforme aux exigences des clauses 9 (Contenu web) ou 10 (Documents), selon le cas, est disponible et identifié comme tel.</p></td>
<td>Non applicable</td>
<td></td>
</tr>
</tbody>
...
<p>La documentation produit fournie avec la LIST, qu’elle soit fournie séparément ou intégrée dans la PREMIÈRE, dresse la liste des caractéristiques d’accessibilité et de compatibilité de la LIST et explique comment les utiliser.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
<p>Les services d’assistance de laNB communiquent des informations sur les caractéristiques d’accessibilité et de compatibilité qui sont mentionnées dans la documentation produit.</p></td>
<td>Pris en charge</td>
<td></td>
</tr>
<tr class="odd">
...
### <a name="section-13-tic-assurant-le-relais-ou-laccs--des-services-durgence"></a>Section 13 CALLED assurant le relais ou l’accès à des services d’urgence
...
Le présent document n’est pas la norme EN 301 549 v 1.1.2 (2015-04) et ne doit pas être utilisé en remplacement de celle-ci. Les extraits de la norme EN 301 549 v 1.1.2 qu’il contient ne sont référenceencés que pour décrire la conformité de Microsoft avec certaines de ses dispositions. Un exemplaire complet de la norme EN 301 549 v 1.1.2 (2015-04) est disponible dans ce PDF émanant de l’European Telecommunications Standards Institute, du Comité Européen de Normalisation et du Comité Européen de Normalisation Qutechtechnique.
