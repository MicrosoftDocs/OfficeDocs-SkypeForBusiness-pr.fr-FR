...
> [!NOTE]
> Si votre organisation a déjà satisfait aux conditions d’éligibilité Microsoft 365 Administration - Cloud de la communauté du secteur public et Cloud de la communauté du secteur public accepté le programme, vous pouvez ignorer les étapes 1 et 2 et passer directement à l’étape 3. 

## <a name="step-1-determine-whether-your-organization-needs-microsoft-365-government---gcc-and-meets-eligibility-requirements"></a>Étape 1. Déterminez si votre organisation a besoin Microsoft 365 administration - Cloud de la communauté du secteur public et répond aux conditions d’éligibilité. 

L’environnement Microsoft 365 Government - Cloud de la communauté du secteur public fournit la conformité avec les exigences du gouvernement américain pour les services cloud, notamment FedRAMP Modéré, et des exigences de justice pénale et de systèmes d’information fiscales fédéraux (types de données CJI et FTI).

En plus de profiter des fonctionnalités de Microsoft 365, les organisations bénéficient des fonctionnalités suivantes qui sont propres au secteur Microsoft 365 - Cloud de la communauté du secteur public :
...
-   Microsoft 365 Secteur public - Cloud de la communauté du secteur public conformes aux certifications et aux entreprises requises pour les clients du secteur public américain.
...
La [Microsoft 365 description du service public](/office365/servicedescriptions/office-365-platform-service-description/office-365-us-government/office-365-us-government) américain décrit les avantages de la plateforme, qui sont centrés autour des conditions de conformité requises aux États-Unis.
...
## <a name="step-2-apply-for-microsoft-365-government---gcc"></a>Étape 2. Appliquer une demande Microsoft 365 administration publique - Cloud de la communauté du secteur public
...
Pour répondre aux besoins de nos clients cloud du gouvernement, il existe certaines différences entre Microsoft 365 - Administration publique - Administration Cloud de la communauté du secteur public et Enterprise projet. Consultez le tableau suivant pour voir quelles fonctionnalités sont disponibles.

[Microsoft Teams description du service](/office365/servicedescriptions/teams-service-description)

> [!Note]
> Une fois que d’autres charges de travail sont entièrement disponibles dans le cloud Cloud de la communauté du secteur public, elles deviennent disponibles dans Teams une fois le travail d’intégration supplémentaire terminé.
...
|    |     |
|-----------|------------|
| ![Icône montrant les points de décision](media/audio_conferencing_image7.png) <br/>Point de décision|<ul><li>Déterminez et consignez vos besoins de gouvernance, en suivant les recommandations du Plan de [gouvernance dans Teams.](plan-teams-governance.md)</li></ul> |
