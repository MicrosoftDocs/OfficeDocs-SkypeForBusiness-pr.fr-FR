...
| Teams Administrateur de périphériques              | Gérez les appareils configurés pour une utilisation avec le service Teams service.                    | Gérez la configuration et les mises à jour des appareils, examinez l’état et l’état des périphériques connectés, définissez et appliquez des profils de configuration, et redémarrez des appareils.<p>Le Teams administrateur de périphérique ne permet pas d’accéder aux données de qualité des appels ni à l’analyse des appels. Pour afficher les données de qualité des appels ou l’analyse des appels, vous devez avoir le rôle Teams de l’administrateur des communications. |

<sup>1</sup> [PowerShell - Microsoft Teams (la](https://www.powershellgallery.com/packages/MicrosoftTeams/) version publique 1.1.6 ou ultérieure est intégrée à Skype Entreprise Online Connector.)<br>
<sup>2 Microsoft Teams</sup> [d’administration](./manage-teams-skypeforbusiness-admin-center.md)
...
-->
Pour plus d’informations sur les outils d’administration disponibles pour la gestion des Microsoft Teams, voir [Gestion Microsoft Teams.](./manage-teams-skypeforbusiness-admin-center.md)
...
La plupart des outils PowerShell pour ces rôles d’administrateur sont accessibles dans le module Teams PowerShell. Il est également important de noter que certains des cmdlets dont les rôles d’administrateur ont accès aux paramètres partagés qui sont également utilisés pour Skype Entreprise Online. 
