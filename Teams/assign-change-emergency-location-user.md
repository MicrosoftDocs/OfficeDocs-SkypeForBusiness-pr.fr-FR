...
Pour plus d’informations sur la façon d’obtenir des offres d’appels et leur coût, voir [licences de complément d’équipes](teams-add-on-licensing/microsoft-teams-add-on-licensing.md).
