...
1. Si la fonctionnalité Système téléphonique n’est pas incluse dans votre offre Microsoft 365 ou Office 365, vous devrez peut-être acheter des licences de modules ajoutés **Phone System.** Une fois que **vous avez des licences Phone System,** achetez des forfaits d’appels pour [Microsoft 365 ou Office 365.](calling-plans-for-office-365.md) Consultez [la gestion des licences des modules add-on Microsoft Teams,](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md)et achetez les licences et un plan. 
    
    > [!TIP]
    > Les licences phone **system** et les forfaits d’appels dans Microsoft 365 ou Office 365 sont réunis. Par donc, pour voir l’option d’achat de forfaits d’appels, vous devez tout d’abord avoir les licences **Système** téléphonique.
  
2. Attribuez tout d’abord les licences, puis affectez un plan d’appels aux membres de votre organisation. Voir [Attribuer des licences de modules add-on Microsoft Teams.](./teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
...
- **Portage de vos numéros existants.** Vous pouvez transférer des numéros existants de votre fournisseur de services ou de votre opérateur de téléphonie actuel vers Microsoft 365 ou Office 365. Pour plus d’informations, voir [Transférer des numéros de téléphone dans Teams](phone-number-calling-plans/transfer-phone-numbers-to-teams.md) ou Gérer les numéros de téléphone pour votre [organisation.](manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) 
