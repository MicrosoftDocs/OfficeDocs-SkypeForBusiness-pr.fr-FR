...
![Capture d’écran de la mise à niveau de blocs de construction de Skype entreprise vers teams](media/upgrade_journeys_building_block.png "Capture d’écran de la mise à niveau de blocs de Skype entreprise vers équipes, composée de Skype entreprise avec la collaboration en équipe&ndash ; uniquement mode, Skype entreprise avec le mode de collaboration et les réunions en mode équipe Mode Business&ndash ;")
