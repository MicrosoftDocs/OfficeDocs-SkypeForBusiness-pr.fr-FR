...
Si l’une des étapes de ce processus d’installation n’était pas totalement claire, une explication plus détaillée du processus est possible dans le démarrage rapide : Se connecter aux données dans [Power BI Desktop.](https://docs.microsoft.com/power-bi/desktop-quickstart-connect-to-data)
...
6. **Support cloud de la communauté du gouvernement (GCC) –** Pour les clients dans l’environnement GCC, power BI Connector du CQD fonctionne lorsque vous utilisez Power BI Desktop. Le connecteur Power BI du CQD n’est actuellement pas compatible avec le service Power BI pour les clients gcc.
