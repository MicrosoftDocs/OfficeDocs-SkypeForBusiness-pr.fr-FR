...
- **Les utilisateurs peuvent modifier les messages envoyés** Utilisez ce paramètre pour permettre aux utilisateurs de modifier leurs messages qu’ils envoient dans la conversation.
...
- **Évaluation du contenu Giphy** 
    - **Aucune restriction** Cela signifie que vos utilisateurs seront en mesure d’insérer tous les Giphys dans les salles de conversation.
    - **Modéré**  Cela signifie que vos utilisateurs seront en mesure d’insérer uniquement 
    - **Strict**
