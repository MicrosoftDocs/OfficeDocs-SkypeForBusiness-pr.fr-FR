...
---
# <a name="add-change-or-remove-a-place-for-an-emergency-location-in-your-organization"></a>Ajout, modification ou suppression d’un emplacement d’urgence dans votre organisation

En fonction du nombre d’emplacements physiques au sein de votre organisation, vous pouvez ajouter des emplacements pour les bâtiments, planchers et bureaux pour créer un emplacement d’urgence plus précis. Pour plus d’informations [, consultez que sont les emplacements d’urgence, les lieux et le routage des appels ?](/microsoftteams/what-are-emergency-locations-addresses-and-call-routing) .
...
3. Dans l’onglet **emplacements** , cliquez sur **Ajouter un emplacement**.
