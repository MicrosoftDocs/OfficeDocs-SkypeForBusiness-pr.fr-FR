---
title: Mise en route Microsoft Teams
description: Utilisez ce guide pour vous aider à déployer votre première deux équipes afin de pouvoir à l’aide de conversation Teams Microsoft, les équipes, les canaux et les réunions.
layout: LandingPage
...
ms.locfileid: "26519797"
---
# <a name="get-started-with-microsoft-teams"></a>Mise en route Microsoft Teams
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Vous guide dans un déploiement d’équipes à petite échelle afin que vous pouvez en savoir plus sur les équipes et planifier votre déploiement à l’échelle de l’organisation</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Créer votre première équipes et canaux</h3>
                        <p>Meilleures pratiques pour la configuration de votre premier équipes et les canaux</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Premiers intégrés</h3>
                        <p>Obtenez vos utilisateurs des premier et en cours d’exécution dans les équipes de nouveau que vous venez de créer</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Surveiller l’utilisation et les commentaires</h3>
                        <p>Découvrez comment vos premiers utilisent les équipes</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Lorsque vous êtes prêt à déployer les équipes à votre société entière, nous allons vous montrer comment</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Comment trouver dont vous avez besoin lorsque vous utilisez des équipes</p>
                    </div>
                </div>
            </div>
        </div>
