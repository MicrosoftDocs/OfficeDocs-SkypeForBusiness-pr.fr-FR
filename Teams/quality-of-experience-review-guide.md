...
Nous vous conseillons vivement d’utiliser le planificateur réseau lors du déploiement de charges de travail multimédia sur votre réseau pour évaluer l’impact global. Pour plus d’informations sur le planificateur de réseaux, visitez la page [MyAdvisor](https://myadvisor.fasttrack.microsoft.com/CloudVoice/NetworkPlanner).
...
Les rapports d’appareil sont utilisés pour évaluer l’utilisation de l’appareil par volume et par score MOS (audio uniquement), et sont accessibles dans les modèles associés sous clients & appareils. 
...
-   [Catalogue de solutions Skype entreprise-périphériques & PC](http://partnersolutions.skypeforbusiness.com/solutionscatalog/personal-peripherals-pcs)
