...
> [!NOTE]
> L’une des fonctionnalités décrites dans cet article, [packages de stratégie personnalisés](#custom-policy-packages), n’a pas encore été publiée. Il est bientôt disponible en version préliminaire privée.
