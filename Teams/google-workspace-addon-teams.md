...
Pour plus d’informations, [voir Créer un principal de service Azure avec Azure PowerShell.](https://docs.microsoft.com/powershell/azure/create-azure-service-principal-azureps?view=azps-5.0.0)
