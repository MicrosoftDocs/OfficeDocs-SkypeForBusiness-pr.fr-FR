...
L’exemple de questionnaire ci-dessous vous aide à vous poser différentes questions pour confirmer que votre organisation est prête à déployer efficacement l’Audioconférence et le système téléphonique avec les fonctionnalités De plans d’appel dans Teams.

Toutes les questions relatives à votre infrastructure de collaboration existante et à l’organisation Microsoft 365 ou Office 365, la mise en réseau, les points de terminaison, les opérations, l’adoption et la préparation sont incluses dans le questionnaire de détection de l’environnement.

Le questionnaire est divisé en plusieurs sections pour confirmer que votre organisation est prête pour le déploiement de Teams dans plusieurs domaines importants. Travaillez avec votre équipe de projet pour fournir les informations demandées avec autant de détails que possible afin de faciliter vos activités de planification.

> [!TIP]
> Vous pouvez commencer par copier le questionnaire dans un document Microsoft Word. Essayez de répondre à toutes les questions et capturez tous les détails à mesure que vous vous déplacez.

<a name="project-team"></a>Équipe de projet
---

Capturez des informations détaillées sur les principales parties prenantes de votre projet de déploiement Teams. Notez qu’une seule personne peut jouer plusieurs rôles tout au long du projet.
...
> |---|---|---|
> | Remarque de la production Microsoft 365<br/>ou le nom et l’ID de l’organisation Office 365<br/>dans la colonne Answer. Si vous avez plus<br/>plusieurs locataires associés<br/>votre organisation, notez tous les ID. | Nom du client : <br/>ID de locataire :| |
> | Dans quelles régions les locataires sont-ils déployés ?| | |
> | Notez le type de ces Microsoft 365 ou <br/>Les locataires Office 365. Sont-elles multitenantes ? <br/>ou dédié ? | <input type="checkbox"> Multitenant<br/> <input type="checkbox"> Dédié | |
...
> | Quel niveau de licence est activé pour Skype pour ? <br/>Utilisateurs Business Online ? | <input type="checkbox"> E1/G1 <br/> <input type="checkbox"> E2/G2 <br/> <input type="checkbox"> E3/G3 <br/> <input type="checkbox"> E4/G4 E5 | Nombre d’utilisateurs <br/>pour chaque référence SKU : |
...
> | Si vous conservez actuellement un Microsoft 365 actif<br/>ou client Office 365, est le domaine SMTP/SIP de <br/>vos utilisateurs ciblés associés au client ? | <input type="checkbox"> N/A – Pas de Microsoft 365 ou<br/>&nbsp;&nbsp; &nbsp; Client Office 365 sur place <br/> <input type="checkbox"> Non, smTP/SIP des utilisateurs <br/>&nbsp;&nbsp; &nbsp; domaine n’est pas associé <br/>&nbsp;&nbsp; &nbsp; avec n’importe quel client dans <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 ou Office 365<br/> <input type="checkbox"> Oui, le SMTP/SIP des utilisateurs <br/>&nbsp;&nbsp; &nbsp; domaine est associé <br/>&nbsp;&nbsp; &nbsp; avec un client existant dans <br/>&nbsp;&nbsp; &nbsp; Microsoft 365 ou Office 365 | |
...
> | OneDrive Entreprise est-il déployé ? | <input type="checkbox"> Oui <br/> <input type="checkbox"> Non | |
...
Le cas échéant, capturez les détails de votre déploiement de Teams à l’aide de l’exemple de tableau ci-dessous. Si vous n’avez pas déployé Teams, ignorez cette section.
...
### <a name="skype-for-business-on-premises-if-applicable"></a>Skype Entreprise en local (le cas échéant)

Le cas échéant, capturez les détails de votre déploiement de Skype Entreprise à l’aide du tableau ci-dessous. Si vous n’avez pas déployé Skype Entreprise en local, ignorez cette section.

> | Question | Réponse | Commentaires |
> |---|---|---|
> | Quelles versions de Lync ou de Skype Entreprise <br/> sont actuellement déployés sur site ? | <input type="checkbox"> Lync Server 2010 <br/> <input type="checkbox"> Lync Server 2013 <br/> <input type="checkbox"> Skype Entreprise Server 2015 <br/> <input type="checkbox"> Skype Entreprise Server 2019 <br/><input type="checkbox"> Skype Entreprise Cloud Connector <br/>&nbsp;&nbsp; &nbsp; Édition | |
...
<a name="networking-and-access-to-microsoft-365-and-office-365-services"></a>Réseau et accès aux services Microsoft 365 et Office 365
---

Utilisez le tableau suivant pour capturer les détails réseau de votre organisation et la manière dont vos utilisateurs sont (ou seront) connectés aux services Microsoft 365 et Office 365.

> | Question | Réponse | Commentaires |
> |---|---|---|
> | Comment (ou comment) les utilisateurs dans l’étendue de la migration <br/>accéder à Teams au bureau ? <br/>Sélectionnez toutes les sélections applicables. | <input type="checkbox"> Connexion NAT acheminée <br/> <input type="checkbox"> Serveur proxy <br/> <input type="checkbox"> Public Wi-Fi <br/> <input type="checkbox"> Gestion (non publique) Wi-Fi <br/> <input type="checkbox"> ExpressRoute <br/>&nbsp;&nbsp; &nbsp; (Peering Microsoft) ||
> | Si l’accès à Microsoft 365 ou Office 365 est via un<br/>serveur proxy, existe-t-il un moyen d’ignorer le proxy ? | <input type="checkbox"> Oui <br/> <input type="checkbox"> Non | |
...
> | En cas d’utilisation d’un vpn, le trafic de Teams peut-il être exclu <br/>le VPN pour accéder directement à Microsoft 365 et aux services Office 365 ? | <input type="checkbox"> Oui <br/> <input type="checkbox"> Non | |
...
> | Quelle version du Microsoft Office est déployée <br/>à ces appareils ? | <input type="checkbox"> Office 2003 <br/> <input type="checkbox"> Office 2007 <br/> <input type="checkbox"> Office 2010 <br/> <input type="checkbox"> Office 2013 <br/> <input type="checkbox"> Office 2016 <br/> <input type="checkbox"> Office pour Mac 2011 <br/> <input type="checkbox"> Office pour Mac 2016 <br/> <input type="checkbox"> Autre (Notez les détails dans la colonne Commentaires.) | |
...
> | Question | Réponse | Commentaires |
> |---|---|---|
> | Quel est votre modèle d’opérations pour votre serveur Lync ? <br/>Déploiement de Skype Entreprise Server, Microsoft 365, <br/>ou le déploiement d’Office 365 dès aujourd’hui ? | | |
...
> | Comment contrôler votre serveur Lync, Skype pour <br/>Business Server, le déploiement de Microsoft 365 ou <br/>Déploiement d’Office 365 ? | | |
...
> | Laquelle des descriptions suivantes décrit le mieux le déploiement <br/>stratégie utilisée pour votre application Skype Entreprise <br/>déploiement ? | <input type="checkbox"> Grande portée : campagne par courrier électronique avec <br/>&nbsp;&nbsp; &nbsp; Liens vers la formation <br/> <input type="checkbox"> Développé : large portée plus une grande variété <br/>&nbsp;&nbsp; &nbsp; de campagnes de sensibilisation (posters, <br/>&nbsp;&nbsp; &nbsp; épreuves, champions) et formation <br/>&nbsp;&nbsp; &nbsp; (vidéos, guides de l’utilisateur, en personne) <br/> <input type="checkbox"> Adapté : étendu, plus ciblé <br/>&nbsp;&nbsp; &nbsp; Messagerie et formation par personnage <br/> <input type="checkbox"> Autre <br/>&nbsp;&nbsp; &nbsp; (Notez les détails dans la colonne Commentaires.) | |
