...
Toutes les questions relatives à votre infrastructure de collaboration existante et à votre organisation Microsoft 365 ou Office 365, à la mise en réseau, aux points de terminaison, aux opérations, à l’adoption et à la préparation sont incluses dans le questionnaire de détection de l’environnement.
...
> |---|---|---|
> | Notez le niveau de production Microsoft 365<br/>ou Office 365 nom et ID de votre organisation<br/>dans la colonne Answer. Si vous avez plus<br/>plusieurs locataires associés<br/>votre organisation, notez tous les ID. | Nom du client : <br/>ID de locataire :| |
...
> | Question | Réponse | Commentaires |
> |---|---|---|
> | Types d’utilisateurs activés pour l’Skype <br/>Pour Les Entreprises Online ? | <input type="checkbox"> Tous les utilisateurs de l’organisation <br/> <input type="checkbox"> Utilisateurs/groupes d’utilisateurs spécifiques <br/>&nbsp;&nbsp; &nbsp; (Spécifiez-le dans la colonne Commentaires.) | |
...
> | Si l’accès à Microsoft 365 ou Office 365 passe par un<br/>serveur proxy, existe-t-il un moyen d’ignorer le proxy ? | <input type="checkbox"> Oui <br/> <input type="checkbox"> Non | |
