...
2. Dans le Centre d'administration Microsoft 365, choisissez **Paramètres** >  **Org settingsOrganization** >  **profile**.
...
L’administrateur client peut spécifier le message d’accueil de synthèse vocale personnalisé et la langue d’invite d’un utilisateur à l’aide de l’applet de commande [Set-CsOnlineVoicemailUserSettings](/powershell/module/skype/set-csonlinevoicemailusersettings) .
