...
Voici les paramètres d’Azure AD qui prennent en charge l’accès invité dans Teams. Une fois ces paramètres configurés, vous pouvez [Ajouter](add-guests.md) et gérer des [invités](manage-guests.md) dans Teams.
...
1. Dans le centre d’administration 365 Microsoft, accédez à**paramètres**des **paramètres** > , cliquez sur **services**, puis sélectionnez **groupes Office 365**.
...
1. Dans le centre d’administration Microsoft 365, accédez à**paramètres**des **paramètres** > , cliquez sur **sécurité & confidentialité**, puis sélectionnez **partage**.
...
2. Cochez la case **autoriser les utilisateurs à ajouter de nouveaux invités à cette organisation** , puis cliquez sur **enregistrer les modifications**.
