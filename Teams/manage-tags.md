...
> [!NOTE]
> Les balises ne sont pas encore pris en charge dans les canaux privés. Les balises ne sont pas Cloud de la communauté du secteur public haute ou du département de la défense (DoD). 
...
Le marquage par shift permet à vos utilisateurs d’accéder aux personnes qui s’y déplacent en temps réel. Teams affecte automatiquement les utilisateurs avec des balises correspondant à leur planning et au nom du groupe de shifts à partir de l’application Shifts, ce qui permet d’activer la messagerie dynamique basée sur les rôles. Les notifications sont envoyées uniquement aux personnes qui sont en shift au moment où une balise est utilisée pour démarrer une conversation ou une publication de canal. 
