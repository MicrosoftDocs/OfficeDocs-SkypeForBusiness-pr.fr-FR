...
Comme mentionné précédemment, il existe deux types d’balises dans Teams.
...
### <a name="set-up-tagging-by-shift-coming-soon"></a>Configurer le marquage par shift (bientôt disponible)
