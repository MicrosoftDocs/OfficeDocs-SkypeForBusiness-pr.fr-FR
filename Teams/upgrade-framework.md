...
> [!NOTE]
> Nous comprenons que votre parcours vers Teams peut impliquer de tirer parti de plusieurs [modes](./teams-and-skypeforbusiness-coexistence-and-interoperability.md)et de mettre à niveau des groupes d’utilisateurs à différents moments, ce qui vous permet de contrôler l’expérience de mise à niveau des utilisateurs tout en maintenant une bonne dynamique avec   Teams.  

Pour vous aider à montrer comment votre voyage de mise à niveau peut être érossé, nous vous avons fourni un exemple de plan ci-dessous qui définit le voyage de Skype Entreprise Online vers le mode Îles uniquement vers Teams. En outre, l’exemple de plan décrit une organisation qui a divisé ses utilisateurs en quatre groupes de mise à niveau, ou des clients. En utilisant ce modèle, personnalisez le plan afin d’inclure votre parcours spécifique vers Teams, en incorporant les différents [modes](./teams-and-skypeforbusiness-coexistence-and-interoperability.md)que vous utiliserez et le nombre de groupes de mise à niveau que vous segmentez vos   utilisateurs. 

## <a name="pre-upgrade"></a>Avant la mise à niveau

**Préparez votre organisation pour Teams.** Pour garantir la réussite d’une mise à niveau vers Teams, il est important d’allouer un temps approprié pour la préparation. Non seulement votre organisation sera en mesure de commencer rapidement à réaliser la valeur de Teams, vous serez en mesure d’accélérer votre mise à niveau à partir de Skype Entreprise dès que Teams est prêt à vous. Si vous avez déjà activé Teams en même temps que Skype Entreprise, utilisez ces activités de pré-mise à niveau comme point de contrôle pour vérifier la disponibilité de votre organisation avant de mettre à niveau les utilisateurs vers Teams. 
...
| **2** | **Définir la vision et l’étendue de votre projet** | Concevez votre vision d’ensemble et l’étendue du projet en cours afin de créer un plan pour votre voyage de mise à niveau. | [Vision du projet](upgrade-define-project-scope.md#project-vision) <br> <br>[Étendue du projet](upgrade-define-project-scope.md#project-scope) |
| **3** | **Définir vos objectifs de projet** | Définissez des objectifs ciblés qui vous permettent de mesurer l’avancement et de réussir le projet. | [Objectifs du projet](upgrade-define-project-scope.md#project-goals) |
...
| **3** | **Restez informé de la feuille de route Teams** | Surveillez la feuille de route De Teams pour identifier le moment exact où votre organisation doit se déplacer vers Teams. | [Feuille de route Teams](https://aka.ms/teamsroadmap) |
