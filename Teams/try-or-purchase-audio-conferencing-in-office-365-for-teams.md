...
### <a name="to-buy-and-assign-user-audio-conferencing-licenses"></a>Pour acheter et affecter des licences de conférence rendez-vous des utilisateurs
...
2. Obtenir vos licences d’**Audioconférence**. Si vous souhaitez :
   ...
   - **Acheter**: consultez la rubrique [licences de compléments Microsoft teams](https://docs.microsoft.com/microsoftteams/teams-add-on-licensing/microsoft-teams-add-on-licensing).
...
4. Si vous avez acheté des licences additionnelles d’audioconférence et des licences de crédits de communication, attribuez-les aussi. Pour obtenir des instructions, consultez [attribuer des licences de compléments Microsoft teams](https://docs.microsoft.com/microsoftteams/teams-add-on-licensing/microsoft-teams-add-on-licensing).

### <a name="to-buy-and-assign-pay-per-minute-audio-conferencing-licenses"></a>Pour acheter et affecter des licences de conférence audio par minute
...
4. [Définissez la longueur du code confidentiel pour les réunions de conférence audio](set-the-pin-length-for-audio-conferencing-meetings-in-teams.md).
