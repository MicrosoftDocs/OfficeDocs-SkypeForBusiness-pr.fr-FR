...
> [!Important]
> Les modes de coexistence continuent d’exister après la mise Skype Entreprise Online, mais les utilisateurs qui débutent en ligne ne peuvent avoir qu’un mode TeamsOnly. Il n’est plus possible d’attribuer un mode autre que TeamsOnly à un utilisateur homed online.  Comme c’était le cas avant la mise à la retraite d’Skype Entreprise Online, les utilisateurs homed sur site peuvent se voir attribuer n’importe quel mode autre *que TeamsOnly.*
...
Dans ce mode de coexistence appelé **Îles,** chacune des applications clientes fonctionne comme une île distincte. Skype Entreprise les négociations Skype Entreprise et Teams les négociations Teams. Les utilisateurs sont censés exécuter les deux clients à tout moment et peuvent communiquer en natif dans le client à partir duquel la communication a commencé. Ainsi, l’interopérabilité n’est pas nécessaire en mode **Îles.**
...
![Capture d’écran Teams message de confirmation.](media/teams-and-skypeforbusiness-coexistence-and-interop-image1.png "Skype Entreprise client en cours d’exécution dans un mode spécial après la mise à niveau de l’utilisateur en tant Teams utilisateur seul")
...
Ce mode de coexistence est particulièrement utile pour les organisations qui Skype Entreprise déploiements sur site avec Voix Entreprise. Ces organisations prennent probablement un certain temps pour passer à Teams et souhaitent tirer parti de l’expérience Teams réunions dans les plus brefs délais.
...
> [!Note]
> **Pour avoir la dernière expérience de coexistence, la version du client doit être la dernière disponible dans le canal de déploiement Office l’utilisateur.**
...
Skype Entreprise peuvent discuter en privé avec d’Teams utilisateurs, et inversement. Une conversation interop doit passer par une passerelle interop qui fait partie de Teams cloud (et existe par conséquent uniquement en ligne). Les conversations Interop sont en texte intégral : le texte enrichi et les émoticônes ne sont pas pris en charge. Les utilisateurs Teams et Skype Entreprise sont avertis que la conversation est une conversation interop.
...
> [!Important]
> Les expériences Interop avec un déploiement d’environnement Skype Entreprise nécessitent que l’environnement local soit en mode hybride avec une Teams. Pour plus d’informations, configurez la connectivité hybride entre les [Skype Entreprise Server et Microsoft 365 ou Office 365.](/SkypeForBusiness/hybrid/configure-hybrid-connectivity)

Ces expériences interop sont disponibles pour et entre les **utilisateurs** qui disposent de l’un des modes de coexistence suivants : Skype Entreprise avec collaboration **Teams,** Skype Entreprise avec Teams Collaboration et réunions, **Skype Entreprise Uniquement** ou **Teams Uniquement**. Les utilisateurs n’ont pas accès à l’interopérabilité en mode **Îles.**
...
- La escalade d’un appel vocal ou vidéo d’égal à égal en appel plusieurs parties impliquant à la fois des Teams et des Skype Entreprise n’est pas prise en charge.
...
L’autre partie reçoit le lien de participer à la réunion via une conversation interop et des joints en cliquant sur ce lien. Si l Skype Entreprise un utilisateur dispose d’Teams compte et est invité par l’Teams utilisateur, il participera à la réunion authentifiée. Sinon, il rejoint la groupe en tant que participant anonyme. À l’inverse, les utilisateurs Teams ont presque toujours un compte Skype Entreprise et un client Skype Entreprise qu’ils peuvent utiliser pour participer à une réunion Skype Entreprise en tant que participant authentifié, mais ils peuvent également la rejoindre en tant que participant anonyme, par exemple en utilisant le Réunion Skype Application.
...
Escalade interop et interop depuis Skype Entreprise mise à jour dans la build de juillet 2019 de la mise à jour mensuelle C2R. Auparavant, les Skype Entreprise n’avaient pas conscience que la partie distante utilisait Teams. Il a seulement fait part de l’hypothèse que le signal reçu après l’ouverture d’une session était déjà en cours.
...
![Capture d’écran Teams d’un message pour démarrer une réunion avec Teams utilisateur.](media/teams-and-skypeforbusiness-coexistence-and-interop-start-meeting-with-teams-user.png)
...
- Si la réunion est Teams, tous les participants (qu’il s’agit d’utilisateurs de TeamsOnly, d’îles ou de Skype Entreprise) utilisent le client Teams pour participer à la réunion. Si Teams n’est pas installé, l’utilisateur est dirigé vers le web lorsqu’il tente de rejoindre une réunion.
...
### <a name="interop-versus-native-conversation-threads"></a>Interop et threads de conversation natifs
...
![Diagramme montrant une conversation Teams-à-Teams.](media/teams-upgrade-native-thread.png)
...
Pour plus d’informations, voir Gérer l’accès externe dans les Microsoft Teams et [les](manage-external-access.md) discussions natives pour les utilisateurs externes [(fédérés) Teams.](native-chat-for-external-users.md)
...
- Pour les Skype Entreprise Online, lors de leur première connexion à Teams, les contacts d’Skype Entreprise sont copiés dans le Teams.  Ce comportement n’est pas disponible pour les utilisateurs avec un compte local dans Skype Entreprise Server.  
