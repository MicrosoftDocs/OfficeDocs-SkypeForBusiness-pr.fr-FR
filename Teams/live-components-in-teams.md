...
Les composants Live Sont conçus avec des Infrastructure Microsoft Fluid pris en charge dans Microsoft 365 suite et contrôlés à partir d’SharePoint Online et non à partir du Teams d’administration.
...
2. Activer le fluidité à l’aide de l'Set-SPOTenant-IsIlidEnabled $true 
   ...
   L’application de la modification à votre locataire prend un peu de temps. 
...
2. Désactivez le fluid à l’aide Set-SPOTenant'Set-SPOTenant de la cmdlet -IsIlidEnabled $false. 
...
- Les autres membres de la conversation recevront une notification par courrier électronique lorsqu’ils sont mentionnés avec le symbole @ (@). (Les notifications à mentions dans le Teams d’activités seront bientôt disponibles.)

- La recherche de composants en direct Teams recherche a pour effet de renvoyer un lien vers le composant dans office.com et non le message de conversation proprement dit.
...
- Bien que vous pouvez partager un composant dans Teams et d’autres Microsoft 365, les destinataires obtiennent un lien dans la plupart des lieux à ce moment-là. La modification en ligne est prévue pour d’autres expériences à l’avenir.
...
[OneDrive stratégies de rétention](/microsoft-365/compliance/retention-policies-sharepoint?view=o365-worldwide#when-a-user-leaves-the-organization) s’appliquent aux fichiers comme à d’autres `.fluid` contenus créés par l’utilisateur.
