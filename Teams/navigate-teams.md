...
audience: admin
ms.reviewer: ''
description: Cet article explique comment Kaizala utilisateurs peuvent naviguer dans Microsoft Teams.
f1.keywords: ''
...
### <a name="conversations-in-teams-chat-vs-team-channel"></a>Conversations dans Teams Conversation ou Team Channel
...
![Configurer Teams modération de canal](media/kaizala-to-teams-image8.png)
...
## <a name="getting-work-done-in-teams"></a>Travail effectué dans Teams
...
### <a name="training-in-teams"></a>Formation en Teams
...
![Créer une formation en mode Teams](media/training-app-template-compose-view.gif)
...
### <a name="to-switch-to-kaizala-group-to-read-only"></a>Pour basculer vers Kaizala groupe en **lecture seule**
...
## <a name="export-kaizala-tenant-data"></a>Exporter des données de locataire Kaizala
...
## <a name="kaizala-tenant-data-export"></a>Kaizala l’exportation des données client
