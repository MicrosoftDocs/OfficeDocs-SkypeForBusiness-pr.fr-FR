...
Si vous tirez parti de System Center pour surveiller l’état du service Teams (et les services dépendants), vous pouvez personnaliser le pack de gestion pour alerter ou avertir des groupes spécifiques ou des personnes identifiées pour réagir aux incidents.
...
Vous pouvez surveiller l’état du service et les modifications à venir en tirant parti de l’API de communications de service pour accéder à l’état du service et aux modifications par programme. Utilisez cette API pour créer votre propre outil de surveillance ou connecter vos outils de surveillance existants aux communications du service Microsoft 365 ou Office 365, ce qui simplifie potentiellement la façon dont vous surveillez votre environnement. Pour plus d’informations, voir [Microsoft 365 ou Office 365 pour les développeurs d’entreprise.](/office/developer-program/microsoft-365-developer-program-faq)
...
| Activité | Description | Cadence | Équipe affectée |
|---|---|---|---|
| Surveiller les adresses IPS et URL Microsoft 365 ou Office 365 | Surveillez les modifications apportées aux URL et [plages d’adresses IP Office 365](/microsoft-365/enterprise/urls-and-ip-address-ranges) à l’aide du flux [RSS](https://go.microsoft.com/fwlink/p/?linkid=236301) fourni et lancez une demande de modification pour les groupes de réseaux applicables. | Jour | |
...
| Activité | Description | Cadence | Équipe affectée |
|---|---|---|---|
| Des champions de la qualité des train et des personnes désignées pour vous-même | Désignez un champion de la qualité. | Selon les besoins | |
...
| Mettre à jour les données bâtiment dans le CQD | Mettez à jour ou ajoutez de nouvelles définitions de bâtiment dans le DQD lorsque des modifications sont apportées au réseau (voir [Télécharger les informations sur le bâtiment).](/SkypeForBusiness/using-call-quality-in-your-organization/turning-on-and-using-call-quality-dashboard#upload-building-information) | Selon les besoins | |
...
[Télécharger les informations sur le bâtiment](/SkypeForBusiness/using-call-quality-in-your-organization/turning-on-and-using-call-quality-dashboard#upload-building-information)
...
Les pare-feu côté client peuvent affecter la qualité des appels et même empêcher l’établi. Une fois les exclusions appropriées configurées sur le pare-feu du client, vous devez les garder à jour en fonction des informations des URL et [plages d’adresses IP Office 365.](/microsoft-365/enterprise/urls-and-ip-address-ranges) Votre fournisseur tiers pourra vous donner des conseils spécifiques sur la façon de mettre à jour les exclusions.

### <a name="wi-fi-drivers"></a>Pilotes Wi-Fi

Wi-Fi pilotes peuvent être problématiques. Par exemple, un pilote peut avoir des comportements d’itinérance très agressives entre les points d’accès qui peuvent déclencher un basculement inutile de point d’accès, ce qui peut entraîner une mauvaise qualité de l’appel. Il est possible qu’un pilote dWi-Fi médiocre soit détecté via une révision de la qualité de l’expérience (voir Améliorer et surveiller la qualité des appels pour [Teams](monitor-call-quality-qos.md) pour plus de détails). Il est essentiel d’implémenter un processus piloté par la qualité qui surveille les nouveaux pilotes Wi-Fi et s’assure qu’ils sont testés avant d’être déployés vers la population générale des utilisateurs.
