...
| Application Microsoft 365 Admin | Fournit des notifications Push à votre appareil mobile. | Utilisez cette fonction lorsque vous devez être informé des incidents de service lorsque vous êtes en cours. |
...
|---|---|---|---|
| Surveiller l’état du service | Surveillez de façon proactive l’état du service (et des services dépendants) de Microsoft Teams à l’aide des outils disponibles. Les services dépendants sont : Exchange Online, SharePoint Online, OneDrive Entreprise, Azure Active Directory. | En temps réel | |
...
| Activité | Description | Cadence | Équipe affectée |
|---|---|---|---|
| Conditions requises pour les points de terminaison | Assurez-vous que le point de terminaison Teams continue à répondre à toutes les exigences logicielles pour Les équipes répertoriées dans [Obtenir des clients pour Microsoft Teams.](get-clients.md) | Mois | |
