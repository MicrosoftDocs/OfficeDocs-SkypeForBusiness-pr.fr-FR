...
2. Suivre les tendances
    ...
    :::image type="content" source="media/CQD-PSTN-report9.png" alt-text="Capture d’écran des graphiques de tendances dans le rapport de routage direct RQD PSTN.":::
...
3. Drill through to SBC or user level
   ...
   :::image type="content" source="media/CQD-PSTN-report10.png" alt-text="Capture d’écran montrant la fonctionnalité d’analyse par le biais d’un point de données.":::
...
![Capture d’écran : Rapport du CQD PSTN.](media/CQD-PSTN-report1.png)
...
![Capture d’écran : Rapport du CQD PSTN.](media/CQD-PSTN-report2.png)
...
> ![Capture d’écran : Rapport du CQD PSTN.](media/CQD-PSTN-report3.png)
> 
Par exemple :

![Capture d’écran : Rapport du CQD PSTN.](media/CQD-PSTN-report4.png)
...
![Capture d’écran : Rapport du CQD PSTN.](media/CQD-PSTN-report5.png)
...
> ![Capture d’écran : Rapport du CQD PSTN.](media/CQD-PSTN-report6.png)
...
![Capture d’écran : Rapport du CQD PSTN.](media/CQD-PSTN-report7.png)
