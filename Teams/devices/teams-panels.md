...
Les panneaux Microsoft Teams sont les appareils à écran tactile compact qui sont placés directement en dehors de vos espaces de réunion, généralement à côté des entrées. Les panneaux Teams vous permettent d’afficher rapidement l’emplacement et les détails des réunions et de réserver un espace de réunion disponible sur place. Grâce aux indicateurs enrichis et de grands codes de couleur, vous pouvez voir la disponibilité de l’espace de réunion à distance.

Les panneaux Teams sont des appareils Microsoft Teams dédiés qui affichent les détails des réunions programmés via les applications de calendrier Teams ou Outlook 365. Les détails de la réunion sont bien visibles et les participants peuvent vérifier qu’ils se trouver dans l’espace de réunion qui leur est exact, au bon moment et pour la réunion.
...
- **Réserver des espaces de réunion disponibles pour les réunions ad hoc.** À l’aide du panneau à écran tactile, vous pouvez réserver un  espace de réunion disponible sur place pour une réunion ad hoc et rejoindre cette réunion Teams à partir des salles Microsoft Teams en salle ou des appareils Surface Hub.
...
## <a name="teams-panels-requirements"></a>Panneaux Teams requis
...
> - Vous aurez besoin de la licence Salles Microsoft Teams Premium pour utiliser des panneaux Teams avancés supplémentaires qui seront bientôt disponibles.

## <a name="deploy-teams-panels-devices"></a>Déployer des panneaux Teams

Si vous participez à la planification, au déploiement et à la gestion des panneaux Teams, cette section est pour vous. Cette section n’est pas destinée aux utilisateurs finaux des panneaux Teams.

Le déploiement des panneaux Teams peut être ventilé selon les tâches suivantes :

- [Inventaire de l’espace](#inventory-sites-and-meeting-spaces)de réunion et planification des fonctionnalités : créez un inventaire des sites et des espaces de réunion de votre organisation pour le déploiement des périphériques de panneaux Teams.
...
Nos recommandations pour les sites des panneaux Teams sont les suivantes :
...
- Qualité de service (QoS) activée sur le réseau pour Microsoft Teams
...
Pour configurer un compte de ressource Microsoft 365 pour les panneaux Teams, vous devez acheter une licence [Microsoft Teams Rooms Standard.](#license-requirement) Cette licence inclut une boîte aux lettres de ressources qui permet aux membres de votre organisation de réserver l’espace de réunion via Outlook ou Teams.

Pour plus d’informations sur la création d’un compte de ressource et l’attribution d’une licence, voir Créer un compte de ressource à l’aide du Centre d’administration [Microsoft 365.](resource-account-ui.md)
...
>
>- Si vous avez déjà déployé des salles Microsoft Teams dans l’espace de réunion où vous installez des volets Teams, le compte de ressource dispose déjà de la [licence Salles Microsoft Teams.](../rooms/rooms-licensing.md) Dans ce cas, vous n’avez pas besoin d’acheter une licence Microsoft Teams Rooms Standard distincte pour le déploiement de panneaux. L’administrateur se signe sur l’appareil des panneaux avec les mêmes informations d’identification que les salles Microsoft Teams pour le même espace.
>
...
> Envisagez d’utiliser des conventions d’affectation de noms pour le compte de ressource des panneaux Teams. Rendez les noms d’affichage de vos comptes de ressources Microsoft 365 descriptifs et faciles à comprendre. Voici les noms que les utilisateurs voient lorsqu’ils recherchent des espaces de réunion lors de la planification de réunions dans les calendriers Outlook ou Teams.

### <a name="testing"></a> Tests

Une fois que vous avez déployé des panneaux, vous devez les tester. Vérifiez que les [fonctionnalités pris en charge par les panneaux Teams](#features-supported-by-teams-panels) fonctionnent sur le périphérique déployé. Essayez de créer plusieurs réunions pour différents créneaux horaires via Teams ou Outlook 365 sur votre ordinateur. Vérifiez si les panneaux affichent correctement les détails de la réunion et la disponibilité pour les réunions programmées. Essayez d’utiliser **le bouton** Réserver pour vérifier si vous pouvez réserver un espace de réunion disponible directement à partir de l’appareil.
...
[Appareils certifiés dans le programme de certification des panneaux De Microsoft Teams](teams-ip-phones.md#currently-certified-teams-panels)