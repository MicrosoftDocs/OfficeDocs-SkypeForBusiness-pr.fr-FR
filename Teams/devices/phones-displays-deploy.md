...
- **Licence Intune** L’utilisateur qui se connecté à l’appareil Teams doit avoir une licence pour Intune.  Tant que l’appareil Teams est connecté à un compte d’utilisateur dispose d’une licence Intune valide, l’appareil est automatiquement inscrit à Microsoft Intune dans le cadre du processus de inscription.
...
2. Activez l’inscription de l’administrateur d’appareils Android. Les appareils Teams android sont gérés en tant qu’appareils d’administrateur d’appareils avec Intune.  L’inscription de l’administrateur de périphérique est par défaut non créditée pour les nouveaux locataires.  Pour plus d’informations, consultez [l’inscription des administrateurs d’appareils Android.](/intune/enrollment/android-enroll-device-administrator)
