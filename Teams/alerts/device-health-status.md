...
Avant de commencer, vous avez besoin des autorisations de création d’équipes/canaux dans votre client. [En savoir plus.](https://docs.microsoft.com/microsoft-365/solutions/manage-creation-of-groups?view=o365-worldwide)
...
|Champ |Description  |
|--------|-------------|
|**Type de règle**   |La règle d’état de l’appareil vous aide à gérer efficacement. Appareils Teams et classés comme types de gestion des appareils. À l’avenir, d’autres règles de type de gestion des appareils seront disponibles pour surveiller d’autres fonctionnalités associées (par exemple, un appareil défectueux et l’état de la connectez-vous du périphérique).|
|**Condition**   |Vous pouvez surveiller l’état des appareils s’ils sont hors connexion. [En savoir plus sur](https://docs.microsoft.com/microsoftteams/devices/device-management) la gestion des appareils dans le Centre d’administration Teams. |
