...
Lorsque vous préparez évaluer les fonctionnalités d’audioconférence, créez une matrice des parties prenantes de prise en charge de test pour identifier les rôles requis pour prendre en charge de la phase de test.
...
| Membres du comité de direction    | <ul><li>Maintenir l’intérêt et fournissent des conseils pour la direction générale du déploiement du service d’audioconférence.<li>Aider à la conduite de vue stratégique, par le biais de conduite d’acheter de l’organisation.</li></ul>                                                                        | À DÉFINIR                                                  |
...
| Propriétaire de service                 | <ul><li>Être responsable de l’opération du service Conférence de données Audio, tout.</li><li>Servir en tant que propriétaire du service Conférence de données Audio.</li></ul>                                                                                                               | À DÉFINIR                                                  |
...
| Testeur de conférence audio     | <ul><li>Passez en revue le plan de test pour comprendre le test besoins, objectifs, planning, résolution des problèmes et des cas de test à exécuter.</li><li>Passez en revue et développer des exigences d’acceptation et de fonctionnalités de conférence audio de la prise en charge des cas de test.</li><li>Exécuter des cas de test et résultats des tests.</li><li>Défauts de documents lorsqu’ils surviendront et les remonter pour le responsable de Test pour l’ordre de priorité et de la résolution.</li><li>Tester les régressions de fermer les défauts après que la résolution de l’erreur a été confirmée.</li></ul>                                                                | À DÉFINIR                                                  |
...
| Test d’administration de conférence audio | <ul><li>Passez en revue le plan de test pour comprendre le test besoins, objectifs, planning, résolution des problèmes et des cas de test à exécuter.</li><li>Passez en revue et développer des exigences d’acceptation et de fonctionnalités d’administration audioconférence de prise en charge des cas de test.</li> <li>Exécuter des cas de test et documenter les résultats de cas de test.</li><li>Défauts de documents lorsqu’ils surviendront et les remonter pour le responsable de Test pour l’ordre de priorité et de la résolution.</li><li>Tester les régressions de fermer les défauts après que la résolution de l’erreur a été confirmée.</li></ul>                                                                | À DÉFINIR                                                  |
...
<a name="define-audio-conferencing-feature-requirements"></a>Définir les exigences de la fonction audioconférence 
-----------------------------------------------

Dans le cadre de la définition des spécifications de fonctionnalités de conférence Audio pour les utilisateurs dans la portée, une des premières étapes que vous devez avoir effectué au cours de la phase de Envision était [Personnage analyse](https://docs.microsoft.com/MicrosoftTeams/audio-conferencing#assess-environment-and-evaluate-adoption-readiness), dans laquelle vous avez défini votre conférence audio personnages et des scénarios. Avec cette configuration de référence identifiée, l’étape suivante consiste à évaluer l’équipes public actualisé pour déterminer :

-   Les fonctionnalités d’audioconférence que vous allez déployer pour les utilisateurs dans la portée.

-   Impératifs de fonctionnement de conférence audio utilisateur attendus, donnés votre Skype en cours pour le paysage de déploiement d’entreprise, Exchange et SharePoint.

-   Si vous pouvez confirmer que les fonctionnalités d’audioconférence décrites dans le dernier programme public répondent à votre utilisateur, la fonctionnalité et les exigences de portée dans la chronologie de votre déploiement

> [!TIP]
> L’équipes actualisé pour identifier les fonctionnalités de Audio conférence dans la portée de votre déploiement, consultez <https://aka.ms/skype2teamsroadmap>.

Maintenant que le personnage d’audioconférence et fonctionnalités ont été définies, les critères d’évaluation suivant sera l’expérience de l’interopérabilité avec les équipes. Pour plus d’informations sur l’expérience de l’interopérabilité avec les options de configuration disponibles, consultez [les équipes Microsoft et Skype pour assurer l’interopérabilité de l’entreprise](https://docs.microsoft.com/MicrosoftTeams/teams-and-skypeforbusiness-interoperability).

#### <a name="audio-conferencing-feature-definition"></a>Définition de la fonctionnalité conférence audio

> [!TIP]

> Voici un exemple d’un modèle de définition de conférence audio que vous pouvez utiliser l’administration de conférence Audio de document et des fonctionnalités de groupe utilisateur à évaluer.
...
|-------------------------------------------|----------------------------|------------------|------------------------|-------------------|-------------------|
| <ul><li>Planifier des réunions de conférence de données Audio via :<ul><li>Complément planification Outlook</li><li>Client Teams</li></ul></li><li>Hébergement de canal et les conférences privées</li><li>Hébergement de réunions avec des participants jusqu'à 80</li><li>Fonctionnalités de conférence audio</li><li>Jointure anonyme</li><li>Prise en charge de la salle d’attente</li><li>Gestion des participants</li><li>Désactiver les autres participants</li><li>Gestion des périphériques via le client des équipes</li></ul> |<ul><li>Réunion de pré/pendant/post réunion du cycle de vie gestion</li><li>Partage du bureau</li><li>Conversations</li><li>Expériences de mise en valeur de réunion</li><li>Partage d'application</li><li>Donner/prendre contrôle de partage d’application</li></ul> |<ul><li> Prise en charge des fonctionnalités de Windows, les réunions d’équipes de Mac clients</li><li>Fonctionnalité de réunions du client navigateur équipes prise en charge pour :<ul><li>Chrome</li><li>Microsoft Edge</li></ul></li><li>iOS et Android équipes client réunions fonctionnalité prise en charge</li></ul> | <ul><li>Appelez le portail de diagnostic de qualité</li><li>Stratégies d’audioconférence de clients</li><li>Activer l’appel de qualité analytique (CQD)</li></ul> | <ul><li>Valider des équipes de fonctionnalités basées sur l’image de l’ordinateur portable d’entreprise de la réunion</li><li>Prise en charge de la langue spécifique</li><li>Paramètres d’objet stratégie de groupe appliqués pour un scénario d’utilisateur donné ou d’un site spécifique</li></ul> | Oui  |

#### <a name="audio-conferencing-user-functionality-definition"></a>Définition de fonctionnalités audio conférence utilisateur

> [!TIP]
> Ci-dessous est un exemple d’un modèle de fonctionnalités utilisateur que vous pouvez utiliser pour documenter l’expérience utilisateur requise selon les fonctionnalités d’audioconférence à évaluer.
...
<table>
<tr><td>![](media/audio_conferencing_image7.png) <br/>Points de décision</td><td><ul><li> Choisir les fonctionnalités de catégorie de conférence de données Audio que vous allez déployer dans votre environnement.</li><li>Identifiez vos besoins de fonctionnalités de conférence audio utilisateur donnés votre Skype en cours pour le paysage de déploiement d’entreprise, Exchange et SharePoint.</li><li>Décider que vous allez déployer l’expérience interopérabilité équipes.</li><li>Passez en revue le public actualisé des équipes et décider si les capacités de charge de travail en cours répondent à votre barre de planning de déploiement.</li></ul></td></tr>
<tr><td>![](media/audio_conferencing_image9.png)<br/>Étapes suivantes</td><td><ul><li>Documenter les fonctionnalités de catégorie d’audioconférence requises pour prendre en charge votre déploiement d’audioconférence.</li><li>Document utilisateur audioconférence fonctionnalité et interopérabilité exigences votre Skype en cours pour le paysage de déploiement d’entreprise, Exchange et SharePoint.</li><li>Si l’équipes public actualisé qui représente les fonctionnalités de Audio conférence satisfait les besoins et les exigences de minutage de votre déploiement du document.</li></ul></td></tr>
</table>

<a name="define-and-document-your-audio-conferencing-test-plan"></a>Définissez et documentez votre plan de test d’audioconférence
-----------------------------------------------------

Une fois que vous avez défini les fonctions d’audioconférence dans la portée, l’étape suivante consiste à créer le plan de test. À un niveau élevé, le plan de test englobe la stratégie générale de test et de la méthodologie que vous allez utiliser pour prendre en charge la validation de la fonctionnalité de test.
...
-   **Cas de Test :** Le jeu de cas de test à valider pour les fonctionnalités d’audioconférence dans la portée
...
La portée pour correctement évaluer les fonctionnalités d’audioconférence généralement inclut :

-   Préparation de site de conférence audio

-   Expérience de l’utilisateur conférence audio

-   Administration de conférence audio

#### <a name="audio-conferencing-testing-scope"></a>Portée du test audio conférence

> [!TIP]
> Voici un exemple de modèle de champ d’application de test que vous pouvez utiliser pour l’administration d’audioconférence de document et des fonctionnalités de groupe utilisateur à évaluer.

| Préparation de site de conférence audio                                                                                                                                                                                                 | Expérience de l’utilisateur conférence audio                                                   | Expérience en administration de conférence audio                                                                                                  |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| <ul><li>La bande passante du module Planification (via MyAdvisor)</li><li>Validation de connectivité et les performances du réseau (via le Skype pour l’outil d’évaluation réseau professionnel)</li><li> Qualité de la validation de service (QoS)</li><li>Validation de split-tunnel d’accès à distance</li></ul> |<ul><li>Planification de conférences à distance</li><li> Joindre la réunion depuis PSTN</li><li>Ajouter des participants via un numéro RTC</li></ul> |<ul><li>Attribution de licence</li><li>Gestion des numéro de service</li><li>Numéro de service portage vers Office 365</li><li>Rapports de conférence audio</li><li>Appeler le rapport sur la qualité (CQD)</li></ul> |


<table>
<tr><td>![](media/audio_conferencing_image7.png) <br/>Points de décision</td><td><ul><li>Décider la conférence Audio test étendue en identifiant les fonctions doit être évaluée par centre d’intérêt.</li><li>Décider des objectifs supplémentaires et des objectifs d’évaluation.</li></ul></td></tr>
<tr><td>![](media/audio_conferencing_image9.png)<br/>Étapes suivantes</td><td><ul><li>Documenter les fonctionnalités d’audioconférence pour être évalués par centre d’intérêt.</li><li>Document supplémentaire des objectifs d’évaluation.</li></ul></td></tr>
</table>
 

### <a name="define-and-document-audio-conferencing-test-cases"></a>Définissez et documentez les cas de test d’audioconférence

Une fois que vous avez défini les fonctionnalités d’audioconférence, déploiement du client et les scénarios côte à côte avec Skype pour les entreprises (le cas échéant), l’étape suivante consiste à formuler les cas de test nécessaires pour évaluer les fonctionnalités d’audioconférence dans la portée. À un niveau élevé, cas de test sont regroupés par zone de focus en général et comprennent :

-   **Titre du cas de Test :** Centre d’intérêt de la fonctionnalité de test est évalué (par exemple, il s’agit d’audioconférence)
...
> [!TIP]
> Pour aider à la création de cas de test comme point de départ, consultez la liste d’informations utilisateur audioconférence à des [réunions d’équipes et d’appels](https://support.office.com/article/Meetings-and-calls-d92432d5-dd0f-4d17-8f69-06096b6b48a8).

#### <a name="audio-conferencing-test-case"></a>Cas de test de conférence audio

> [!TIP]
> Voici un exemple de modèle de cas de test que vous pouvez utiliser pour l’administration d’audioconférence de document et des fonctionnalités de groupe utilisateur à évaluer.

Validation de conférence audio
...
|--------------|---------------------------------------------|---------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------|
| 1            | Planifier une réunion de la conférence audio équipes | Planifier une réunion en ligne et vérifiez que le pont de conférence est affiché dans l’invitation. |<ul><li>Client d’équipes installé</li><li>Utilisateur activé avec les licences Office 365 suivantes affectées :<ul><li>E5 d’entreprise Office avec des conférences Audio et les équipes de Microsoft</li><li>E3 d’entreprise Office avec des conférences Audio et les équipes de Microsoft</li></ul></li></ul> |<ol><li>Connectez-vous au client d’équipes.</li><li>Ouvrez Outlook et planifier une nouvelle réunion d’équipes.</li><li>Vérifiez que la nouvelle invitation de réunion affiche le nombre de pont de Microsoft s’affiché dans le client.</li></ol>      | Testeur de conférence audio |
...
<table>
<tr><td>![](media/audio_conferencing_image7.png) <br/>Points de décision</td><td><ul><li>Décider quelles fonctionnalités d’administration et d’Audio conférence seront évaluées.</li><li>Décidez quel environnement de test est requis pour prendre en charge de l’exécution du cas de test.</li><li>Déterminer les étapes requises pour l’évaluation des cas de test.</li><li>Déterminer les ressources nécessaires à la bonne exécution de l’essai.</li></ul></td></tr>
...
| L’exécution de cas de test : Conférence Audio  | À DÉFINIR             | À DÉFINIR                                                                    | À DÉFINIR             | À DÉFINIR   | À DÉFINIR                | Heures à déterminer  |
...
|------------------------------------------|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|----------|--------|--------------|----------------|---------------------------------------------------|
| 1                                        | 1                     | Pour les utilisateurs qui sont activés pour les réunions régional hébergées (RHM), les coordonnées d’accès à distance ne sont pas remplies via Outlook équipes de planification de complément | Déplacer un compte d’essai dans une autre région RHM.<br/> Se connecter à Outlook et essayez de planifier une conférence audio d’équipes via Outlook équipes de planification de complément | Moyen   | Fermé | Louis Lahr   | Lisa gris      | Journal des équipes côté client<br/> Capture d’écran du client aux équipes     |
...
|------------------------------------------|-------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------|-----------------------|----------------------------------|-------------------------------------------------------------------|---------------|-----------------------------|-------------|
| 1    | Pour les utilisateurs qui sont activées par RHM, composez dans coordonnées ne sont pas remplies via Outlook équipes de planification de complément. | Moyen                                                               | Lisa gris             | Louis Lahr                       | E-mail de haute priorité Triage révision hebdomadaire pour les parties prenantes concernées | Ouvrir          | ASAP                        | 1/12/2018   |
...
> [!TIP]
> Ci-dessous est un exemple de test de modèle de rapport de synthèse que vous pouvez consulter lors de la prochaine réunion du comité de direction lorsque vous choisissez lors de services d’audioconférence intégrée dans la phase pilote.
...
Si vous devez transférer des nombres dans le cadre de la fourniture d’accès à des fonctionnalités dans les services d’audioconférence pris en charge par les équipes, vous devez effectuer un port partiel pour un numéro de service. Cela vous permettra de valider les attentes, les exigences et chronologie raisonnable que vous avez terminé la préparation de votre déploiement de services d’audioconférence dans votre environnement de production.

Pour terminer un port partiel d’un numéro de service à partir de votre fournisseur de services RTPC en cours aux équipes, passez en revue les étapes décrites ci-dessous.

#### <a name="step-1"></a>Étape 1

Identifier le nombre de tests que vous voulez au port vers Office 365 sous la forme d’un numéro d’appel entrant (numéro de service) pour les conférences Audio
...
> [!IMPORTANT]
> Si vous avez des numéros de service pour les ponts de conférence audio, des surveillances automatiques ou des autres numéros de service, le numéro d’appel gratuit, numéros de téléphone, ou plus de 999 numéros de téléphone utilisateur dont vous avez besoin de transférer aux équipes, vous devrez envoyer manuellement un ordre de port.<br/><br/>
...
Une fois que le nombre est confirmé comme ayant été portées comme un nouveau numéro de service dans Office 365, affecter le numéro au service de conférence de données Audio via le portail d’administration locataire \> **Skype pour le centre d’administration Business** \> **voix**. Sous l’onglet **Numéros de téléphone** , affectez le nouveau numéro de service pour le service d’audioconférence.

> [!NOTE]
> Bien que cette tâche affecte un nouveau numéro de service d’audioconférence, au moment de la rédaction de ce document, l’administration de cette tâche est effectuée à l’aide de la Skype pour le centre d’administration Business.

#### <a name="step-6"></a>Étape 6

Maintenant que vous avez affecté le nombre de ports de service pour le service d’audioconférence, composez le numéro et confirmez que vous entendez le message d’accueil service conférence suivante :

>   « Bienvenue dans le centre de conférence audio. Veuillez saisir une conférence suivi d’un dièse. »


<table>
<tr><td>![](media/audio_conferencing_image7.png)<br/>Points de décision</td><td><ul><li>Déterminer les numéros de service domestique vous devrez port, par pays/région.</li><li>Décidez si vous allez porter des numéros de téléphone.</li><li>Choisir le modèle de lettre d’accord que vous allez utiliser.</li><li>Déterminer si votre opérateur actuel (perte de porteuse) autorise la fragmentation de numéro de téléphone (c'est-à-dire permet d’ordres de voies partielles).</li></ul></td></tr>
<tr><td>![](media/audio_conferencing_image9.png)<br/>Étapes suivantes</td><td><ul><li>Collecter les informations requises et préparer la lettre d’accord.</li><li>Télécharger et exécuter les modèles LOA dont vous avez besoin.</li><li>Soumettre le service et/ou le nombre de requêtes portage gratuit.</li><li>Exécuter une validation de test pour les numéros de ports en leur affectant le service d’audioconférence pour l’accès à distance et vérifiez qu’elles fonctionnent, comme indiqué à l’étape 6, plus haut dans cette section.</li></ul></td></tr>
</table>
   

### <a name="document-service-number-porting-test-results"></a>Numéro de service portage des résultats des tests de document

Après avoir terminé les tests de portage des nombres, créer un rapport qui résume les résultats des tests à présenter au cours de l’examen du comité de direction suivant.

#### <a name="site-a-number-porting-test-summary-report"></a>Numéro du site a : porter le rapport récapitulatif des tests

> [!TIP]
> Voici un exemple de modèle de rapport Résumé du test que vous pouvez utiliser pour la révision au cours de la prochaine réunion du comité de direction lorsque vous choisissez lors de services d’audioconférence intégrée dans la phase pilote.
...
<table>
<tr><td>![](media/audio_conferencing_image7.png)<br/>Points de décision</td><td><ul><li>Déterminez si les numéros de service soumises à la migration ont été portées avec succès pour le service d’audioconférence.</li><li>Déterminez si vous avez pu affecter le nombre de ports de service pour le service d’audioconférence.</li></ul></td></tr>
...
Maintenant que vous avez défini votre plan de test, l’étape suivante consiste à les guider dans les cas de test, en mettant l’accent sur l’évaluation de la conférence Audio utilisateur et administration de bénéficier des fonctionnalités dans la portée. Avant de commencer effectivement les tests, vérifiez que les tests requis répertoriés ci-dessous sont en place.

### <a name="audio-conferencing-testing-prerequisites"></a>Conditions de test audio conférence

-   Exemples d’utilisation ont été définis pour le service d’audioconférence.

-   Les principales parties prenantes ont été identifiés.

-   Les licences requises pour les services d’audioconférence sont disponible et a été affecté au groupe d’utilisateurs dans la portée.

-   La liste des sites d’organisation et les groupes d’utilisateurs dans la portée ont été identifiés.

-   La liste des numéros d’appel entrant dédié et partagé de conférence audio, avec une préférence de langue pour les sites d’organisation et d’utilisateurs dans la portée, ont été identifiés et configuré.

-   [Crédits de communications](https://docs.microsoft.com/SkypeForBusiness/skype-for-business-and-microsoft-teams-add-on-licensing/what-are-communications-credits) (si nécessaire) ont été configurés pour votre organisation afin de fournir l’accès à la conférence gratuit pont téléphone numéros et prise en charge de la conférence internationales scénarios à distance.

-   Paramètres de pont de conférence conférence audio ont été identifiés et configurés pour tous les utilisateurs dans la portée (longueur du code confidentiel, notifications d’entrée et de sortie, préférence de notification d’activation).

-   Les paramètres de plan qui prennent en charge la conférence Audio scénarios à distance ont été identifiés, configurés et appliqués pour tous les utilisateurs dans la portée de numérotation du locataire.

-   Stratégies de conférence audio ont été identifiés et configurés pour tous les utilisateurs dans la portée.

-   Exigences de conformité de conférence audio ont été identifiés et configurés pour tous les utilisateurs dans la portée.

### <a name="document-audio-conferencing-test-case-passfail-status"></a>Documentez l’état de réussite ou d’échec de cas de test Audio conférence
...
#### <a name="audio-conferencing-test-case-status"></a>État de cas de test de conférence audio

> [!TIP]
> Voici un exemple de modèle de statut des cas de test que vous pouvez utiliser pour documenter les résultats de test de révision au cours de la prochaine réunion du comité de direction lorsque vous choisissez lors de services d’audioconférence intégrée dans la phase pilote.
...
|------------------------------------------|---------------------------------------------|---------------------------------------------------------|---------------------------|-------------------------------------------------------------------------------------------------------------|
| 1                                        | Planifier une réunion de la conférence audio équipes | Planifier une réunion en ligne et vérifiez que le pont de conférence est affiché dans l’invitation. |  & #, 9744 ; Passer<br/>& #, 9744 ; Partielle<br/> & #, 9744 ; Échec   | Pour connecter les utilisateurs qui sont activées par RHM, les coordonnées ne sont pas remplies via Outlook équipes de programmation de compléments |


<table>
<tr><td>![](media/audio_conferencing_image7.png)<br/>Points de décision</td><td><ul><li>Évaluer l’état de réussite ou d’échec de haut niveau de cas de test par site pour les fonctionnalités d’audioconférence dans la portée.</li></ul></td></tr>
...
Une fois que tous les cas de test prenant en charge les fonctionnalités d’audioconférence dans la portée ont été accomplies par site, documentez les résultats en revue lors d’une réunion du comité de direction lorsque vous décidez d’activer les services de conférence de données Audio lors de la phase pilote.

#### <a name="site-a-audio-conferencing-test-case-summary-report"></a>Rapport Résumé du site A: Audio conférence des cas de test :

> [!TIP]
> Voici un exemple de modèle de rapport Résumé du test que vous pouvez consulter lors de la prochaine réunion du comité de direction lorsque vous choisissez lors de services d’audioconférence intégrée dans la phase pilote.

**Conférence Audio des équipes**
...
<table>
<tr><td>![](media/audio_conferencing_image7.png)<br/>Points de décision</td><td><ul><li>Évaluer les résultats de synthèse de haut niveau test par site pour les fonctionnalités d’audioconférence dans la portée.</li></ul></td></tr>
...
<a name="present-and-report-audio-conferencing-test-findings"></a>Présenter et rapport des résultats de test d’audioconférence
---------------------------------------------------
