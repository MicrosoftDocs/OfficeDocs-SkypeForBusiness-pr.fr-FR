...
Il existe plusieurs composants clés qui sont utilisés avec les événements en direct.

### <a name="scheduling"></a>La planification
Les équipes offre la possibilité pour les organisateurs créer un événement avec le participant approprié des autorisations, désigner les événements membres de l’équipe, sélectionnez la méthode de production et inviter des participants. Si l’événement live a été créé à partir d’un groupe de Yammer, les participants direct sera en mesure d’utiliser Yammer conversation pour interagir avec l’équipe de l’événement. 
...
- Utilisateur a été affecté à une licence Office 365 entreprise E3 ou E5. 
...
*Invités et des utilisateurs fédérés peuvent rejoindre en tant que participants anonymes événement en direct.*
...
- **Accédez Local - Canada :** Au cours de cet aperçu offre vous pouvez créer des événements, mais leurs données seront hébergées dans la région Amérique du Nord.
...
#### <a name="step-1-set-up-skype-for-business-online"></a>Étape 1 : Configurer Skype pour Business Online
Si vous n’avez pas déjà fait, définir [Skype pour Business Online](https://docs.microsoft.com/en-us/SkypeForBusiness/set-up-skype-for-business-online/set-up-skype-for-business-online?redirectSourcePath=%252fen-us%252farticle%252fset-up-skype-for-business-online-40296968-e779-4259-980b-c2de1c044c6e) pour votre organisation.

#### <a name="step-2-setting-up-a-ecdn-provider"></a>Étape 2 : Configuration d’un fournisseur eCDN
Si vous avez des participants rejoignant à partir du réseau d’entreprise, tenez compte des embarquement et [la configuration d’un fournisseur eCDN - recommandés par Microsoft](#set-up-ecdn-provider-for-teams-live-events) pour optimiser la bande passante du réseau. 

#### <a name="step-3-getting-licenses"></a>Étape 3 : Obtention des licences
Vérifiez les attributions de licence approprié pour [qui peut créer des événements en direct](#who-can-create-live-events) et [qui peut surveiller les événements en direct](#who-can-watch-live-event). 

#### <a name="step-4-enable-live-event-scheduling"></a>Étape 4 : Activer la planification d’événements live
[Activer la planification d’événements live](#enable-live-event-scheduling-for-the-user) pour les utilisateurs qui doivent être en mesure de créer des événements en temps réel de votre société. Cela est nécessaire pour les événements de codage externe & démarrage rapide.

#### <a name="step-5-enable-users-for-microsoft-stream"></a>Étape 5 : Activer les utilisateurs pour Microsoft Stream
Pour les événements de codage externe, [Activer les utilisateurs pour la création d’événements en direct dans le portail d’administration de flux de données de Microsoft](#enable-microsoft-stream-for-users-in-the-organization).  

#### <a name="step-6-set-up-your-network-for-live-events-in-microsoft-teams"></a>Étape 6 : Configurer votre réseau pour les événements live dans Microsoft Teams
...
#### <a name="step-7-set-up-ecdn-provider-for-live-events-in-microsoft-teams"></a>Étape 7 : Configurer eCDN fournisseur pour les événements live dans Microsoft Teams 
...
Utilisez le paramètre AllowBroadcastScheduling dans TeamsMeetingBroadcastPolicy dans PowerShell équipes pour contrôler si l’utilisateur peut créer des événements en temps réel dans les équipes ou non. Vous pouvez en savoir plus sur la gestion des TeamsMeetingBroadcastPolicy avec Office 365 PowerShell [ici](https://docs.microsoft.com/office365/enterprise/powershell/manage-skype-for-business-online-with-office-365-powershell).
 ...
 Sauf si vous avez assigné une stratégie personnalisée pour les utilisateurs, les utilisateurs seront obtenir la stratégie globale, qui est activée par défaut de l’enregistrement. 
...
#### <a name="enable-external-encoder-based-live-events-for-users"></a>Activer les événements live encodeur externes pour les utilisateurs

**Activer les flux de Microsoft pour les utilisateurs dans l’organisation** Stream Microsoft est disponible dans le cadre des abonnements Office 365 éligibles ou en tant que service autonome. Pour plus d’informations, voir [Présentation des flux de licences](https://docs.microsoft.com/stream/license-overview) . Remarque Microsoft Stream n’est pas inclus dans les plans Business Essentials et entreprise Premium.  
