...
### [Créer un modèle à partir d’un modèle existant](create-template-from-existing-template.md)
### [Modèles Teams de catégories financières](financial-teams-templates-in-the-admin-console.md)
### [Modèles Teams de catégories générales](general-teams-templates-in-the-admin-console.md)
### [Modèles Teams de catégories de fabrication](manufacturing-teams-templates-in-the-admin-console.md)
...
#### [Liste de vérification pour l’accès des invités](https://docs.microsoft.com/microsoft-365/solutions/collaborate-as-team)
#### [Expérience des invités](guest-experience.md)
#### [Autoriser l’accès invité](teams-dependencies.md)
#### [Activer ou désactiver l’accès invité](set-up-guests.md)
...
#### [Rapport d’utilisation de l’application Teams](teams-analytics-and-reports/app-usage-report.md)
...
## [Afficher les autorisations des applications et accorder le consentement administrateur dans le Centre d’administration Microsoft Teams](app-permissions-admin-center.md)
...
### [Vue d’ensemble](rooms/index.md)
### Prévision
#### [Présentation de la planification des Salles Microsoft Teams](rooms/rooms-plan.md)
#### [Prise en charge de la version](rooms/rooms-lifecycle-support.md)
#### [Notes de publication](rooms/rooms-release-note.md)
#### [Préparer votre environnement](rooms/rooms-prep.md)
#### [Configuration requise](rooms/requirements.md)
#### [Gestion des licences en ligne](rooms/rooms-licensing.md)
#### [Planifier la gestion avec Azure Monitor](rooms/azure-monitor-plan.md)
#### Service géré de salles Microsoft Teams
##### [Planifier la gestion avec le service géré de salles Microsoft Teams](rooms/microsoft-teams-rooms-premium.md)
##### [Contrôle d’accès en fonction du rôle avec le service géré de salles Microsoft Teams](rooms/microsoft-teams-rooms-premium-rbac.md)
### Déployer
#### [Vue d’ensemble du déploiement](rooms/rooms-deploy.md)
#### [Configurer les comptes](rooms/rooms-configure-accounts.md)
#### Surface Hub
##### [Configurer Optimisation de réunion](rooms/coordinated-meetings.md)
##### [Gérer les paramètres de Microsoft Teams](rooms/surface-hub-manage-config.md)
#### [Avec Office 365](rooms/with-office-365.md)
#### [Avec Skype Entreprise Server](rooms/with-skype-for-business-server-2015.md)
#### [Avec Exchange Online (hybride)](rooms/with-exchange-online.md)
...
#### [Caméras de contenu](rooms/content-camera.md)
### Gestion
#### [Vue d’ensemble de la gestion](rooms/rooms-manage.md)
#### [Maintenance et opérations](rooms/rooms-operations.md)
#### [Support de Teams au sein de votre organisation](rooms/known-issues.md)
#### [Périphériques avec Azure Monitor](rooms/azure-monitor-manage.md)
#### [Paramètres avec un fichier XML](rooms/xml-config-file.md)
#### [Utiliser l’outil de récupération](rooms/recovery-tool.md)
...
## [Supprimer la stratégie de réunion RestrictedAnonymousAccess des utilisateurs](meeting-policies-restricted-anonymous-access.md)
...
## [Utiliser la technologie NDI® dans Teams](use-NDI-in-meetings.md)
...
### [Configurer l'audioconférence](set-up-audio-conferencing-in-teams.md)
### [Configurer l’Audioconférence : Démarrage rapide pour les petites et moyennes entreprises](audio-conferencing-smb.md)
...
#### [Appel sortant depuis une réunion pour permettre à d’autres personnes d’y participer](dialing-out-from-a-teams-meeting-so-other-people-can-join-it.md)
#### [Activer ou désactiver les annonces d’entrée et de sortie des réunions](turn-on-or-off-entry-and-exit-announcements-for-meetings-in-teams.md)
...
### [Minutes d’appels étendus pour les États-Unis et le Canada](dial-out-minutes-canada-us.md)
...
#### [Gestion des numéros de téléphone pour l’Austriche](manage-phone-numbers-for-your-organization/phone-number-management-for-austria.md)
...
#### [Gestion des numéros de téléphone pour le Danemark](manage-phone-numbers-for-your-organization/phone-number-management-for-denmark.md)
...
#### [Gestion des numéros de téléphone pour l’Italie](manage-phone-numbers-for-your-organization/phone-number-management-for-italy.md)
...
#### [Gestion des numéros de téléphone pour le Portugal](manage-phone-numbers-for-your-organization/phone-number-management-for-portugal.md)
...
#### [Gestion des numéros de téléphone pour le Suède](manage-phone-numbers-for-your-organization/phone-number-management-for-sweden.md)
#### [Gestion des numéros de téléphone pour le Suisse](manage-phone-numbers-for-your-organization/phone-number-management-for-switzerland.md)
...
#### [Autriche](toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-austria.md)
...
#### [Italie](toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-italy.md)
...
#### [Suisse](toll-free-dialing-limitations-and-restrictions/toll-free-dialing-restrictions-in-switzerland.md)
...
#### [Considérations pour les organisations disposant de Skype Entreprise dans leurs locaux](upgrade-to-teams-on-prem-considerations.md)
#### [Implémenter votre mise à niveau](upgrade-to-teams-on-prem-implement.md)
#### [Coexistence de Skype Entreprise et de Teams](upgrade-to-teams-on-prem-coexistence.md)
#### [Considérations PSTN](upgrade-to-teams-on-prem-pstn-considerations.md)
...
## [Déployer une topologie de forêt de ressources](https://docs.microsoft.com/SkypeForBusiness/hybrid/configure-a-multi-forest-environment-for-hybrid)
...
### [Gérer vos packages de stratégie](business-voice/policy-packages.md)
...
### [Démarrez Teams pour les organismes de santé](expand-teams-across-your-org/healthcare/teams-in-hc.md)
### Visites virtuelles
#### [Visites virtuelles avec Teams-Intégration dans DMI](expand-teams-across-your-org/healthcare/ehr-admin.md)
#### [Visites virtuelles avec Bookings et Teams](bookings-app-admin.md)
### [Créer des packages de stratégies Teams](policy-packages-healthcare.md)
### Messagerie sécurisée
#### [Messagerie sécurisée](expand-teams-across-your-org/healthcare/messaging-policies-hc.md)
#### [Délégation de messages](expand-teams-across-your-org/healthcare/hc-delegates.md)
### Modèles Teams
#### [Utilisez les modèles médicaux Teams](expand-teams-across-your-org/healthcare/healthcare-templates-admin-console.md)
#### [Modèles médicaux Teams](expand-teams-across-your-org/healthcare/healthcare-templates.md)
### [Gérer l’application Listes](manage-lists-app.md)
### [Gérer l’application Tâches](manage-tasks-app.md)
...
### [Démarrage avec les modèles Teams pour le secteur public](government-teams-templates-in-the-admin-console.md)
...
### [Azure Sentinel et Teams](teams-sentinel-guide.md)
...
### [Expériences connectées facultatives](teams-privacy-oce-overview.md)
...
#### [Utiliser des règles de flux de courrier avec Exchange](https://docs.microsoft.com/microsoft-365/security/office-365-security/create-safe-sender-lists-in-office-365)
### [Interaction de SharePoint Online et OneDrive Entreprise avec Microsoft Teams](sharepoint-onedrive-interact.md)
### [Expérience Teams dans une location compatible avec Multi-Geo Microsoft 365 ou Office 365](teams-experience-o365odb-spo-multi-geo.md)
...
### [Affichages Teams](devices/teams-displays.md)
### [Mettre à niveau les téléphones Teams vers Affichages Teams](devices/upgrade-phones-to-displays.md)
### [Déployer les téléphones Teams et Affichages Teams à l’aide de Intune](devices/phones-displays-deploy.md)
...
### [Passer du connecteur Skype Entreprise Online au module PowerShell Teams](teams-powershell-move-from-sfbo.md)
...
### [Albanie](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-albania.md)
...
### [Cameroun](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-cameroon.md)
...
### [Chili](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-chile.md)
...
### [Îles Mariannes du Nord](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-northern-mariana-islands.md)
...
### [Singapour](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-singapore.md)
...
### [Îles Turques-et-Caïques](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-turks-and-caicos-islands.md)
### [Ouganda](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-uganda.md)
