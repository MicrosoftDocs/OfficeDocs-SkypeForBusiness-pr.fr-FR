...
# [Comment les équipes de déploiement](How-to-roll-out-teams.md)
...
## [Étape 3 : Utilisation du moniteur et commentaires](get-started-with-teams-monitor-usage-and-feedback.md)
...
## [Modèles d’équipe pour le secteur de la santé](healthcare/healthcare-templates.md)
...
## [Applications, des robots, des connecteurs &](deploy-apps-microsoft-teams-landing-page.md)
### [Considérations et les autorisations des applications](app-permissions.md)
...
### [Les équipes analytique et création de rapports dans le centre d’administration Microsoft Teams](teams-analytics-and-reports/teams-reporting-reference.md)
...
### [Rapports sur les activités dans le centre d’administration Microsoft 365 équipes](teams-activity-reports.md)
...
#### [Gestion des licences de module complémentaire équipes](teams-add-on-licensing/microsoft-teams-add-on-licensing.md)
##### Options de licence en fonction de votre forfait
###### [Office 365 entreprise Premium](teams-add-on-licensing/office-365-business-premium.md)
###### [Office 365 ProPlus](teams-add-on-licensing/office-365-premium-pro-plus.md)
###### [E3 et office 365 entreprise E1](teams-add-on-licensing/office-365-enterprise-e1-e3.md)
###### [Office 365 Entreprise E5](teams-add-on-licensing/office-365-enterprise-e5-with-audio-conferencing.md)
###### [Office 365 entreprise E5 sans services d’audioconférence](teams-add-on-licensing/office-365-enterprise-e5-without-audio-conferencing.md)
###### [GOV, EDU et les organisations caritative](teams-add-on-licensing/gov-edu-and-nonprofit-organizations.md)
#### [Gérer l’offre de la version d’évaluation des équipes](iw-trial-teams.md)
#### [Équipes gratuits de mise à niveau vers la version d’abonnement Office 365](upgrade-freemium.md)
...
## [Configurer le partage du bureau dans les équipes](configure-desktop-sharing.md)
...
### [Période de numérotation gratuite pour l’audioconférence](complimentary-dial-out-period.md)


### [Configurer conférence Audio pour Skype pour les entreprises et Microsoft Teams](/SkypeForBusiness/audio-conferencing-in-office-365/set-up-audio-conferencing?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)
...
### Gérer votre pont de conférence audio
...
### [Gérer les paramètres de conférence Audio pour les utilisateurs](manage-the-audio-conferencing-settings-for-a-user-in-teams.md)
...
### Gérer les paramètres de réunions de conférence audio
...
##### [Macédoine](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-macedonia.md)
...
##### [Moldavie](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-moldova.md)
...
##### [Slovaquie](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-slovakia.md)
...
##### [Trinité & Tobago](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-trinidad-and-tobago.md)
...
### [Configuration des téléphones de zone commune](set-up-common-area-phones.md)
### Messagerie vocale
...
### Standards automatiques et files d’attente des appels 
...
#### [Créer une file d’attente appel système téléphonique](create-a-phone-system-call-queue.md)
...
## [Offres d'appels](calling-plan-landing-page.md)
...
### [Types de numéros de téléphone utilisés pour planifier l’appel](different-kinds-of-phone-numbers-used-for-calling-plans.md)
...
### [Questions fréquentes à propos du transfert de numéros](transferring-phone-numbers-common-questions.md)
...
## Référence
### [Disponibilité des pays et aux régions pour planifier l’appel](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)
#### [Argentine](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-argentina.md)
#### [Australie](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-australia.md)
#### [Autriche](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-austria.md)
#### [Bahreïn](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-bahrain.md)
...
#### [Venezuela](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-venezuela.md)
#### [Vietnam](country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-vietnam.md)
### Gestion de numéro de téléphone du pays 
...
### [Conseils de voix dans le nuage](cloud-voice-landing-page.md)
#### [Définir mon réussite](1-envision-define-my-success-cloud-voice.md)
#### [Décisions mon service - système téléphonique avec des Plans de l’appel](calling-plan-landing-page.md)
#### [Décisions mon service - Routage d’un système téléphonique Direct](direct-routing-landing-page.md)
...
## [Instructeur pour les équipes](instructor-led-training-teams-landing-page.md)
...
### [Gérer vos périphériques dans les équipes](device-management.md)
### [Téléphones pour les équipes](phones-for-teams.md)
...
### [Téléphones pour Skype pour les entreprises en ligne](/SkypeForBusiness/what-is-phone-system-in-office-365/getting-phones-for-skype-for-business-online/deploying-skype-for-business-online-phones?toc=/MicrosoftTeams/toc.json&bc=/microsoftteams/breadcrumb/toc.json)


## [Conformité & de sécurité](security-compliance-overview.md)
...
### [Stratégies de rétention dans les équipes](retention-policies.md)
#### [Forum aux questions sur les stratégies de rétention](retention-policies-FAQ.md)
#### [Problèmes connus de stratégies de rétention](retention-policies-known-issues.md)
...
###  [Plans d’appel dans Office 365 - Code pratique au Royaume-Uni](code-of-practice-for-the-united-kingdom-u-k.md)
###  [Plans d’appel dans Office 365 - gestion de réclamation de code pour le Royaume-Uni](complaint-handling-code-for-the-united-kingdom-u-k.md)
...
### [Restrictions de caractères spéciaux dans les stratégies d’équipes](special-character-restrictions-in-policy-names.md)
...
##### [Jeu de QoS sur les clients Windows](QoS-in-Teams-clients.md)
...
### [Planifier pour le gouvernement Microsoft 365 - DoD](plan-for-government-dod.md)
