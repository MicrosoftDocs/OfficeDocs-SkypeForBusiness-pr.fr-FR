...
2. Sélectionnez le type de votre établissement d’enseignement (**primaire** ou secondaire ou **supérieur**), puis **Suivant**.
...
|Stratégie attribuée au groupe : Oui<br/>Stratégie attribuée directement à l’utilisateur : Non     |Stratégie attribuée au groupe<br/><br/>Si l’utilisateur est membre de plusieurs groupes et qu’une stratégie de la même zone de stratégie est affectée à chaque groupe, la stratégie qui présente le classement d’affectation de groupe le plus [élevé prend effet](assign-policies-users-and-groups.md#group-assignment-ranking) .       |
