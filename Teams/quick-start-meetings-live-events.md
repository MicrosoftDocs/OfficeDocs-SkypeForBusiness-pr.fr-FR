...
| Article | Description |
|----------|--------|
| [Vue d’ensemble des applications Teams](deploy-apps-microsoft-teams-landing-page.md) | Présentation des applications et comment déployer des applications pour votre organisation. |
