...
Vous pouvez voir [Définir les numéros de téléphone inclus dans les invitations](set-the-phone-numbers-included-on-invites-in-teams.md) pour modifier le numéro de téléphone d’un seul utilisateur.
...
- Vous pouvez également afficher l’emplacement et la langue principale qui seront utilisés par le standard automatique de l’audioconférence.
