...
f1.keywords:
- NOCSH
description: Vue d’ensemble de la solution CCaaS (Centre de contacts en tant que service) intégrée pour Microsoft Teams
appliesto:
- Microsoft Teams
ms.collection:
- M365-voice
...
Les fournisseurs suivants proposent des solutions de centre de contacts intégrées à Teams à l’aide de l’un des modèles d’intégration Connect, Extend ou Power.
...
### <a name="solutions-currently-in-the-certification-process"></a>Solutions actuellement en cours de processus de certification
