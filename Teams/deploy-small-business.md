...
- [Charges de travail](#workloads)
  ...
  - [Téléphone Teams avec forfait d'appel](#teams-phone-with-calling-plan)
...
Les réunions sont activées par défaut dans Teams. Toutefois, vous pouvez contrôler l’expérience des organisateurs et des participants en matière de réunions. Vous pouvez également définir des stratégies sur ce que les personnes peuvent et ne peuvent pas faire avant et pendant les réunions. Pour plus d’informations, consultez l’article suivant :
...
Le téléphone Microsoft 365 Teams avec plan d'appel est une solution idéale pour les entreprises de moins de 300 utilisateurs qui vous offre toutes les fonctionnalités d'un système téléphonique de bureau. Teams Téléphone inclut la messagerie vocale, l’ID de l’appelant, les menus système téléphoniques, les numéros gratuits et bien plus encore, sans qu’il soit nécessaire de gérer un système téléphonique local complexe et coûteux.

Pour plus d'informations sur Teams Phone avec le plan d'appel pour les petites et moyennes entreprises, afficher [le guide Teams Phone pour les petites et moyennes entreprises](/microsoftteams/business-voice/whats-business-voice)
