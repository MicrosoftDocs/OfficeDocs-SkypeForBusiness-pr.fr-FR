...
Pour [plus d’informations, voir](get-started-with-teams-templates-in-the-admin-console.md) Commencer à utiliser les modèles Teams dans le Centre d’administration.
