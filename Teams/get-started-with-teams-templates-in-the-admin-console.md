...
- [Créer une équipe à partir d’un modèle d’équipe existant](modify-existing-team-template.md)
- [Créer un modèle à partir d’une équipe existante](create-team-from-existing-team.md)
