...
L’enregistrement de conformité peut être activé pour Microsoft 365 utilisateurs A3/A5/E3/E5/Business Premium et Office 365 A3/A5/E3/E5. 
...
<li><p>Surveillez et dépannage des problèmes liés à l’enregistrement des Teams et des réunions.</p></li>
...
> [!div class="mx-imgBorder"]
> ![Capture d’écran montrant le paramètre de l’application personnalisée d’équipe](media/hp-compliance-recording-for-teams-calling-and-meetings.jpg "Les images illustrent le flux lorsqu’une Teams un appel ou une réunion est envoyé et reçu.")
...
- Le robot enregistreur doit s’exécuter sur une Windows VM dans Azure
...
2. Créer une stratégie d’enregistrement de conformité.
   ...
   Voir [Set-CsTeamsComplianceRecordingPolicy.](/powershell/module/skype/set-csteamscompliancerecordingpolicy?view=skype-ps)
...
3. Attribuez la stratégie d’enregistrement de conformité à un utilisateur.
   ...
   Voir [Grant-CsTeamsComplianceRecordingPolicy.](/powershell/module/skype/grant-csteamscompliancerecordingpolicy?view=skype-ps)
...
La prise en charge des notifications est activée à l’aide de Teams client. Les expériences peuvent être visuelles ou audio.
...
Si vous êtes un fournisseur désireux de rejoindre le programme de certification, veuillez envoyer un <a href= "mailto:Teamscategorypartner@microsoft.com">e-mail Teamscategorypartner@microsoft.com.</a>
