...
Pour en savoir plus sur les modèles d’équipe en général, voir Commencer à utiliser les modèles d’équipe dans [le Teams d’administration.](get-started-with-teams-templates-in-the-admin-console.md)
