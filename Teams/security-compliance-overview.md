...
Pour plus d’informations sur la protection contre la perte de Teams données, consultez la protection contre la [perte de données pour Microsoft Teams.](/microsoft-365/compliance/dlp-microsoft-teams) Un bon article concernant les problèmes DLP d’O365 est une vue d’ensemble de [la protection contre la perte de données.](/microsoft-365/compliance/data-loss-prevention-policies)
...
Pour plus d’informations sur l’Microsoft 365 ou la découverte électronique Office 365 dans le centre de sécurité et le Centre de conformité et l’exécuter pour rechercher du contenu d’Teams, consultez les liens ci-dessous :
...
> [!div class="mx-imgBorder"]
> ![Diagramme du flux de travail de réunions Teams et d’appels de données à Exchange](media/Overview_of_security_and_compliance_in_Microsoft_Teams_image1a.png)
