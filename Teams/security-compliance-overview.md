...
Teams fonctionne en partenariat avec SharePoint, OneNote, Exchange et bien plus encore. Vous devez être à l’aise pour gérer la sécurité dans la suite Microsoft 365 ou Office 365. Pour en savoir plus, découvrez comment configurer votre organisation [Microsoft 365 ou Office 365](/office365/securitycompliance/tenant-wide-setup-for-increased-security)pour une sécurité accrue.
...
L’application de bureau Microsoft Teams prend en charge AppLocker.  Pour plus d’informations sur les conditions préalables pour AppLocker, voir : Conditions requises pour utiliser [AppLocker.](/windows/security/threat-protection/windows-defender-application-control/applocker/requirements-to-use-applocker)
...
Pour plus d’informations sur la protection contre la perte de données dans Teams, consultez [la DLP pour Microsoft Teams.](/microsoft-365/compliance/dlp-microsoft-teams) Un bon article concernant les problèmes DLP dans O365 est une vue d’ensemble de [la protection contre la perte de données.](/microsoft-365/compliance/data-loss-prevention-policies)
...
Les clients peuvent tirer parti d’eDiscovery ou [advanced eDiscovery](/microsoft-365/compliance/office-365-advanced-ediscovery) selon leurs besoins. Le tableau suivant présente les différences entre les deux options :
...
[Conformité à Microsoft 365](/microsoft-365/compliance/)
