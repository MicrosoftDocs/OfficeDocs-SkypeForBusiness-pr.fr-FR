...
La façon dont le contenu affecté est géré après la détection correspond aux paramètres que vous avez sélectionnés dans Office 365. Nous vous recommandons vivement de prendre en compte toutes les applications lorsque vous configurez ATP, et pour une lecture plus approfondie, l’article [Office 365 ATP pour SharePoint, OneDrive et Microsoft teams](https://docs.microsoft.com/microsoft-365/security/office-365-security/atp-for-spo-odb-and-teams) vous propose des informations détaillées sur la prise en main.
...
La protection contre la perte de données (DLP) dans Microsoft Teams, ainsi que l’histoire DLP plus grande pour Office 365, tourne autour de la préparation de l’entreprise en matière de protection des documents et des données sensibles dans Office 365. Que vous ayez des inquiétudes sur des informations sensibles dans des messages ou des documents, les stratégies DLP seront en mesure de garantir que vos utilisateurs ne partageront pas ces données sensibles avec les personnes inappropriées.
...
Pour plus d’informations sur la façon d’effectuer la découverte électronique d’Office 365 dans le centre de sécurité & conformité et de procéder à la recherche du contenu d’équipes, cliquez sur les liens ci-dessous :
...
Les données en équipe résident dans la zone géographique associée à votre organisation 365 Office. Pour connaître les régions prises en charge pour le moment, veuillez vérifier [l’emplacement des données dans Microsoft teams](location-of-data-in-teams.md).
