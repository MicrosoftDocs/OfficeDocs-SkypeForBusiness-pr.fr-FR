...
- Créez et partagez des applications économiques et spécialisées à l’aide d’un Studio **puissant Apps** Studio en établissant une connexion à vos données métiers stockées dans la nouvelle plate-forme de données sous-jacente (Project Oakdale), Microsoft 365 ou dans d’autres sources de données via les connecteurs.
