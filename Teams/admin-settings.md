...
Pour en savoir plus, [consultez Gérer les applications dans Teams.](manage-apps.md)
...
- Simplifiez l’expérience utilisateur, en particulier lorsque vous commencez à déployer Teams au sein de votre organisation.
...
Les stratégies de configuration d’application vous personnalisationnt pour vos utilisateurs. Vous choisissez les applications que vous voulez épingler à la barre de l’application dans les clients Teams et dans l’ordre dans lequel elles apparaissent, sur les clients web, de bureau et mobiles.
...
- Épinglez de manière sélective les principales fonctionnalités de Teams, telles que conversation, équipes et appels. Cette action permet de s’assurer que les utilisateurs participent à des activités spécifiques dans Teams.
