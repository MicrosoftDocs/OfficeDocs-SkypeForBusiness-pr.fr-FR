...
Pour valider le coupage à l’aide des options SIP entrantes, utilisez l’interface de gestion SBC et voyez que le SBC envoie une réponse aux messages OPTIONS reçus à partir du routage direct et que le code de réponse envoyé est 200 OK.
