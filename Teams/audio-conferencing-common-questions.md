...
Oui, les participants peuvent appeler à l’international et inviter d’autres appelants à une réunion Skype Entreprise ou Microsoft Teams. Consultez [Appeler depuis](dialing-out-from-a-teams-meeting-so-other-people-can-join-it.md) une réunion Microsoft Teams pour que d’autres personnes y participent ou faire un appel sortant d’une réunion Skype Entreprise Online pour que d’autres personnes y [participent.](/SkypeForBusiness/audio-conferencing-in-office-365/dialing-out-from-a-meeting-so-other-people-can-join-it)
  
## <a name="how-does-a-skype-for-business-or-microsoft-teams-user-schedule-a-meeting-with-audio-conferencing-meeting-details"></a>Comment un utilisateur de Skype Entreprise ou de Microsoft Teams planifiera-t-il une réunion avec les détails de la réunion Audioconférence ?

Lorsqu’un utilisateur est affecté à une licence **d’audioconférence** et qu’il crée une réunion Skype Entreprise ou Microsoft Teams dans Outlook ou Outlook sur le Web, les numéros de téléphone et les ID de conférence rendez-vous sont ajoutés automatiquement à l’invitation à la réunion.
