...
|**Fonctionnalité**|**Détails**|
|:-----|:-----|
|Pour quelles capitales ou villes principales est-il possible d'obtenir des numéros payants ?  <br/> | <ul><li>Bruges<li>  Bruxelles <li>Charleroi <li>  Gand <li>  Liège <li>  Namur </ul> |
