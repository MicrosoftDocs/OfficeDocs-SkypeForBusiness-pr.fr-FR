...
---
# <a name="availability-in-luxembourg"></a>Disponibilité au Luxembourg
...
Voici les services Microsoft 365 et Office 365 pour Skype entreprise et Microsoft teams disponible pour le Luxembourg.
...
Si les offres d’appels ne sont pas disponibles à l’achat, pensez à utiliser [le routage direct du système téléphonique](../direct-routing-landing-page.md). Le routage direct vous permet d’utiliser le système téléphonique avec presque tous les opérateurs.
   
## <a name="toll-and-toll-free-numbers-for-services"></a>Numéros payants et gratuits pour les services

|**Fonctionnalité**|**Details**|
|:-----|:-----|
|Pour quelles capitales ou villes principales est-il possible d'obtenir des numéros payants ?  <br/> |Luxembourg  <br/> |
