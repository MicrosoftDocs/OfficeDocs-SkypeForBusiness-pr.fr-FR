...
- Phone System
- Calling Plans
description: Voici les services Office 365 pour Skype Entreprise et Microsoft Teams disponibles en Suisse.
...
> [!NOTE]
> Vous pouvez obtenir des numéros de **SERVICE** en Suisse pour les utiliser avec les conférences, la surveillance automatique et les files d’attente d’appels, mais vous ne pouvez pas obtenir de numéros d’**UTILISATEUR**, car les forfaits d’appels ne sont pas disponibles.

[Recherchez un autre pays ou une autre région](country-and-region-availability-for-audio-conferencing-and-calling-plans.md), ou obtenez des informations sur la disponibilité des pays et des régions pour les forfaits d’audioconférences et d’appels.

Voici les services Office 365 pour Skype Entreprise et Microsoft Teams disponibles en Suisse.
