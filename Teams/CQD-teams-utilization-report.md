...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report1.png)
...
1. À droite des dropdowns de slicer, le nombre d’appels par type de média est décomposé en vue interne/externe au cours des 30 derniers jours. Nous pouvons voir via la capture d’écran ci-dessus qu’il y a davantage d’appels en provenance d’emplacements organisationnels extérieurs, ce qui est logique dans l’environnement global actuel.
  ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report2.png)
...
1. À droite de la zone du nombre de types de médias, nous avons le nombre d’appels mensuels par type de média au cours des 90 derniers jours. Chaque colonne et chaque type de média peut être survolé pour afficher le nombre de mois précédent ou de mois en cours à ce jour, afin de fournir des informations sur la tendance d’utilisation.
  ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report3.png)
...
1. Le graphique du milieu fonctionne comme le graphique de 90 jours. Toutefois, il fournit un affichage de l’utilisation quotidienne pour les 30 derniers jours et permet à un utilisateur de cliquer avec le bouton droit et d’descendre dans les détails pour un jour spécifique.
  ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report4.png)
...
Dans la section inférieure gauche de la page, vous trouverez un tableau fournissant les valeurs totales de chaque type de média au cours de l’année précédente. 
    ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report5.png)
    ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report6.png)   
...
À droite du tableau, un graphique à barres affiche les clients les plus utilisés (appels/flux) au cours des 30 derniers jours.
   ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report7.png)
...
Le dernier ensemble de graphiques pour cette page affiche chaque type de média individuellement, avec une répartition montrant l’utilisation des conférences et P2P. Les graphiques ci-dessous indiquent qu’il y a un nombre d’utilisation des conférences considérablement plus élevé que P2P.
  ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report8.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report9.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report10.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report11.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report12.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report13.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report14.png)
  ...
  1.  Le tableau sous le graphique affiche les mesures pour cette heure. Celui-ci peut être trié sur n’importe quel en-tête de colonne . toutefois, nous nous intéressent à la recherche de domaines problématiques.  
    ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report15.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report24.png)

![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report25.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report26.png)
...
1.  Dans la page Récapitulatif du nombre d’appels, recherchez une région spécifique dans la table.
  ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report16.png)

2.  Sélectionnez la ligne pour qui vous avez besoin d’informations supplémentaires sur la région.
  ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report17.png)
...
3.  Les tendances de données montrent un nombre important de minutes utilisées sur le réseau interne, avec une utilisation P2P beaucoup plus importante.
  ![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report18.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report19.png)
...
![Capture d’écran : Teams d’utilisation des données.](media/CQD-teams-utilization-report20.png)
