...
- Calling Plans
- seo-marvel-apr2020
description: Découvrez comment obtenir et gérer les numéros de téléphone des utilisateurs (abonnés) et des services (gratuits et gratuits) Microsoft Teams pour votre organisation.
...
- [Obtention de nouveaux numéros de téléphone d'utilisateur dans le Microsoft Teams d'administration.](../getting-phone-numbers-for-your-users.md#get-new-phone-numbers-for-your-users)
...
### <a name="letters-of-authorization-loas-to-transferport-existing-phone-numbers-from-another-service-provider-to-microsoft-teams"></a>Lettres d'autorisation pour transférer/transférer des numéros de téléphone existants d'un autre fournisseur de services vers Microsoft Teams

Si vous devez transférer ou transférer vos numéros de téléphone existants, vous devez télécharger, remplir et nous envoyer une lettre d'autorisation qui nous autorise à demander et transférer, en votre nom, les numéros existants d'un autre fournisseur de services vers Microsoft Teams.

Si vous disposez actuellement des informations suivantes auprès d'un autre opérateur, envoyez-nous un **LOA** :

- Numéros d'utilisateurs (abonnés).
- Des numéros de service (gratuits) pour des ponts de conférence audio, des postes de service automatique ou des files d'attente d'appels.
...
Une fois votre LOA **remplie** et signée, contactez notre service [PSTN Service Desk](./contact-pstn-service-desk.md) pour que nous pouvons vous aider.
