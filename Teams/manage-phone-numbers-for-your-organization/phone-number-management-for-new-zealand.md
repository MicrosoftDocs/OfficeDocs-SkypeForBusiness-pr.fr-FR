...
ms.locfileid: "54278143"
---
# <a name="phone-number-management-for-new-zealand"></a>Téléphone de nombre pour la Nouvelle-Zélande

[!INCLUDE [preview-feature](../includes/preview-feature.md)]

Utilisez ce tableau pour trouver des informations sur la obtention et la gestion des numéros de téléphone en Nouvelle-Zélande Microsoft Teams.
...
|Obtenez les numéros de téléphone qui nous sont transférés.  <br/> | Téléchargez ce formulaire. <br/>[Lettre d’autorisation pour la Nouvelle-Zélande (tous les nombres) (v.1.0) (en-nz)](https://download.microsoft.com/download/e/6/7/e67f46ef-e1cd-4e70-a5cc-f53fd74285aa/letter-of-authorization-(loa)-for-new-zealand-(all-numbers)-(v1.0)-(en-nz).pdf) <br/> <br/>Renseignez-le et [contactez PTSN pour obtenir des instructions](contact-pstn-service-desk.md). <br/><br>Le transfert des numéros peut prendre de une à six semaines dans ce marché selon la complexité du port.<br/><br/>Ces numéros ne peuvent pas être utilisés pour les conférences pour le moment.  |
