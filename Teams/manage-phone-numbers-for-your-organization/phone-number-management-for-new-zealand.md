...
|Obtenez les numéros de téléphone qui nous sont transférés.  <br/> | Téléchargez ce formulaire. <br/>[Lettre d’autorisation (LOA) pour la Nouvelle-Zélande (tous les numéros) (v.1.0) (en-nz)](https://download.microsoft.com/download/e/6/7/e67f46ef-e1cd-4e70-a5cc-f53fd74285aa/LOA-EN-NZ-TN.pdf) <br/> <br/>Renseignez-le et [contactez le service TNS pour obtenir des instructions](contact-tns-service-desk.md). <br/><br>Le transfert de numéros peut prendre une à six semaines sur ce marché en fonction de la complexité du port.<br/><br/>Ces numéros ne peuvent pas être utilisés pour les conférences pour l’instant.  |
