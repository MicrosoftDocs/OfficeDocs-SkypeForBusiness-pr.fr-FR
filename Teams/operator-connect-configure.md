...
>[!IMPORTANT]
>**Adresses de secours :** Téléphone numéros associés aux adresses de secours sont gérés par votre opérateur. Une fois que vous avez créé des adresses d’urgence dans le Teams d’administration, votre opérateur attribue des numéros de téléphone à ces adresses d’urgence. Pour modifier les adresses d’urgence et les numéros de téléphone qui leur sont affectés, contactez votre opérateur.
...
2. **Assurez-vous d’être en Teams mode uniquement.** Pour vérifier si votre organisation est en mode Teams uniquement, dans le Centre d’administration Teams, consultez les paramètres à l’échelle de l’organisation > Teams **mise à niveau.** Pour vérifier si un utilisateur est en mode Teams uniquement, allez dans Utilisateurs **et** sélectionnez un compte d’utilisateur. Dans **l’onglet** Compte, sous Teams mise à **niveau,** vérifiez que votre mode de coexistence est Teams seul.
