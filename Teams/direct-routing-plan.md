...
Supposons que vous vouliez utiliser un nouveau nom de domaine. Par exemple, votre client a contoso.com nom de domaine enregistré dans votre client et vous souhaitez utiliser sbc1.sip.contoso.com. Avant de pouvoir coupler un SBC avec le sbc1.sip.contoso.com nom, vous devez inscrire le nom de domaine dans sip.contoso.com domaines dans votre client. Si vous essayez d'apparier un SBC avec sbc1.sip.contoso.com avant d'enregistrer le nom de domaine, le message d'erreur suivant s'agit : « Impossible d'utiliser le domaine « sbc1.sip.contoso.com » car il n'a pas été configuré pour ce client. »
