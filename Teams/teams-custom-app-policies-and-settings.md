...
3. Activer ou désactiver **l’utilisateur peut télécharger des applications personnalisées**.
...
- [Gérer les stratégies de permissions pour les applications dans Microsoft Teams](teams-app-permission-policies.md)
