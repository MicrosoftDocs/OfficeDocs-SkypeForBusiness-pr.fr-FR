...
* Sur le web, lors de la collecte d’informations supplémentaires sur une application, consultez les détails d’une application spécifique sur son lien [Sécurité et conformité des applications Microsoft Teams](/microsoft-365-app-certification/teams/teams-apps). Vous pouvez également cliquer sur le lien d’attestation Publisher dans le Centre d’administration Microsoft Teams.
