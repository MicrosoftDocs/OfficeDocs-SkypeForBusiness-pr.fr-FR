---
title: Outils & ateliers - Planifiez, livrez, & adoptez Teams
author: SerdarSoysal
ms.author: serdars
manager: serdars
ms.topic: article
...
- [Comment déployer Teams](./deploy-overview.md)
    ...
    Suivez le chemin recommandé pour déployer des Teams.


- [Formation Teams technique pour les enseignants](itadmin-readiness.md)

    Utilisez ces ressources de formation technique pour vous informer, donner des cours à d’autres personnes ou exécuter des ateliers.
...
[Formation Teams](training-microsoft-teams-landing-page.md)

[Préparation à Microsoft Teams pour les administrateurs informatiques](ITAdmin-readiness.md)

[Outils pour l’adoption](adopt-tools-and-downloads.md)

[Skype Entreprise’atelier Teams de planification de la mise à niveau](https://www.microsoft.com/microsoft-365/partners/intelligentcommunications/skype-for-business-teams)

[Déplacer des utilisateurs de l’environnement local vers Teams](/skypeforbusiness/hybrid/move-users-from-on-premises-to-teams)
