...
La possibilité d'assurer un routage automatique vers le point de réponse de sécurité publique approprié varie selon le pays d'utilisation de l'utilisateur de Teams.
...
| Cloud | Disponibilité |
| :------------|:-------|
| World Wide Multi Tenant | Disponible sur tous les clients Teams |
| GCC | Disponible sur tous les clients Teams |
| GCCH | Disponible sur le bureau Teams |
| DoD | Pending |
