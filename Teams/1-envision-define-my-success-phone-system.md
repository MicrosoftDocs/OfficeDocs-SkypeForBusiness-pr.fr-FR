...
Cet article fournit une vue d’ensemble des exigences relatives à la définition du succès du déploiement du système téléphonique avec des plans d’appels pour votre organisation. En définissant correctement le résultat, vous pouvez mesurer les résultats à mesure que vous progressez dans le cadre de votre déploiement et vérifier que vous avez obtenu les résultats que vous souhaitez.

<!--ENDOFSECTION-->

## <a name="define-business-use-cases-for-phone-system-with-calling-plans"></a>Définir des cas d’utilisation professionnelle pour le système téléphonique avec les offres d’appels

Les organisations peuvent utiliser un système téléphonique avec des plans d’appel pour moderniser leur lieu de travail en permettant aux utilisateurs de passer des appels téléphoniques professionnels depuis leurs ordinateurs et appareils mobiles.

La modernisation de l’espace de travail peut faire partie d’un certain nombre de scénarios: une implémentation de travail basée sur une activité, une mise à niveau d’Office importante, une mise à jour de déploiement d’Office, une mise hors service d’une solution de succursale privée héritée (PBX), la conclusion d’un téléphone commuté public contrat du fournisseur de services de réseau (RTC), etc.

Pour commencer, les parties prenantes de Project doivent définir des cas d’utilisation professionnelle prenant en charge l’implémentation du système téléphonique avec des plans d’appels.

Les cas d’utilisation pour les entreprises sont destinés à définir et à documenter les résultats de l’entreprise mesurables et à inclure les éléments suivants:
...
> |**Comment la technologie peut surmonter ces difficultés**<br>Le système téléphonique avec des plans d’appels permettra à l’ordinateur personnel d’un utilisateur de recevoir et de passer des appels téléphoniques sur le réseau de données en tirant parti de l’application Microsoft teams native. Cela évite de déployer et de mettre à jour les téléphones de bureau, et ouvre la possibilité de mettre en réseau le système PBX existant, car le service téléphonique peut être acheminé via le Cloud sur le réseau sans dépendance sur un système téléphonique traditionnel.|
> |**Résultats de l’entreprise attendus et mesurables**<br>Le retrait des exigences de maintenance ou la désactivation de la version PBX et des téléphones de bureau prérequis entraînent une réduction de 20% sur les dépenses de service de téléphonie mensuelles. Le système téléphonique doté de forfaits d’appels simplifie la gestion des espaces de travail Office, ce qui permet à contoso d’étendre ses opérations en établissant de nouvelles succursales avec un minimum de coûts de téléphonie.|
...
-   **Étendue de l’Organisation:** L’implémentation du système téléphonique avec des plans d’appel peut englober l’ensemble de votre organisation ou simplement des unités commerciales spécifiques.
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Points de décision|<ul><li>Quels sont les cas d’utilisation pour les entreprises du système téléphonique avec des plans d’appels qui peuvent être identifiés au sein de votre organisation?</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Étapes suivantes|<ul><li>Documentez tous les cas d’utilisation pour les entreprises du système téléphonique avec des plans d’appels pour votre organisation.</li></ul>|

<!--ENDOFSECTION-->

## <a name="identify-key-stakeholders"></a>Identifier les parties prenantes clés

Les cas d’utilisation professionnels définis lors de l’étape précédente incluent une étendue d’organisation pour le système téléphonique avec la mise en œuvre des plans d’appels. En fonction de cela, vous pouvez effectuer la matrice complète des parties prenantes pour inclure les personnes appropriées dans le projet.
...
> |Propriétaire de service|<ul><li>Être responsable du fonctionnement du système téléphonique avec service d’appels, le tout vers le haut.</li><li>Êtes propriétaire du système téléphonique avec service de plans d’appel.</li></ul>|TBA|
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Points de décision|<ul><li>Qui remplira chaque rôle d’intervenant clé de votre organisation?</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Étapes suivantes|<ul><li>Documentez toutes les principales parties prenantes et communiquez les responsabilités et les attentes du rôle à chaque individu affecté.</li></ul>|
...
> [!TIP]
> Voici un exemple de OKRs approprié au système téléphonique avec la mise en œuvre des plans d’appel:
> <br>
> 
...
> |---------|---------|---------|
> |Déploiement d’un système téléphonique avec des plans d’appels dans les bureaux de succursales européens à la fin de l’exercice 2018|FY18Q3: déploiement du système téléphonique avec les offres d’appels dans le Bureau de Londres|Concevoir<ul><li>Créer un plan de réussite</li><li>Créer un plan d’implémentation technique détaillé</li></ul><p>Intégrer<ul><li>Exécuter le plan de réussite</li><li>Exécuter le plan d’implémentation technique</li></ul>|
...
Vous devez identifier les risques d’entreprise dans le cadre de cette activité et définir un plan d’atténuation pour chaque risque identifié. Capturez ces informations dans un registre de risques.
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Points de décision|<ul><li>Qu’est-ce que votre organisation&#39;s OKRs et KSIs?</li><li>Quels risques avez-vous identifiés dans le cadre de l’implémentation de l’audioconférence au sein de votre organisation? Quels sont les plans d’atténuation pour les risques identifiés?</li></ul>|
|<img src="media/audio_conferencing_image9.png" />|Étapes suivantes|<ul><li>Documentez le OKRs, KSIs, puis créez le registre de risques.</li></ul>|
...
|         |         |         |
|---------|---------|---------|
|<img src="media/audio_conferencing_image7.png" />|Points de décision|<ul><li>Décider s’il est nécessaire de disposer d’un Comité de direction pour votre organisation.</li></ul>|
...
Vous trouverez des instructions détaillées supplémentaires sur la façon d’utiliser un Comité d’orientation approprié dans le Guide du Comité d’orientation disponible [ici](https://docs.microsoft.com/MicrosoftTeams/envision-steering-committee-complete-guide).
