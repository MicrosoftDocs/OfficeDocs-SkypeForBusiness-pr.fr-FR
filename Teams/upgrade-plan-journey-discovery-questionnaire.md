---
title: 'Microsoft Teams mise | Évaluation de l’environnement, questions sur la découverte'
author: SerdarSoysal
ms.author: serdars
manager: serdars
ms.topic: article
...
> | [Existe-t-il des SBE qui appuient le routage direct](direct-routing-plan.md#supported-session-border-controllers-sbcs) pour vos bureaux qui sont dans le cadre de cette initiative ? <br>Si c’est le cas, notez les détails de la colonne Commentaires.| <input type="checkbox"> Oui <br/> <input type="checkbox"> Non ||
