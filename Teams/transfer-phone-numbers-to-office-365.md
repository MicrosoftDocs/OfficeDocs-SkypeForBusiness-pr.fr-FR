...
Il est facile de transférer vos numéros de téléphone de votre fournisseur de services actuel vers Microsoft Teams. Lorsque vous transférez vos numéros de téléphone vers Teams, Microsoft deviendra votre fournisseur de services et vous facturera ces numéros de téléphone.
  
Avant de commencer à transférer des numéros de téléphone, nous vous conseillons de passer en revue les informations contenues dans [transfert des numéros de téléphone questions fréquentes](transferring-phone-numbers-common-questions.md). Si vous disposez de numéros de service pour les ponts de conférence rendez-vous, les standards automatiques ou d’autres numéros de service, les numéros de téléphone gratuits ou dont vous avez plus de 999, vous devez transférer des numéros de téléphone dans Teams, reportez-vous à [la rubrique gestion des numéros de téléphone pour votre Organisation](manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) pour télécharger les formulaires appropriés et nous les envoyer.
...
## <a name="how-to-create-a-port-order-and-transfer-your-phone-numbers-to-teamss"></a>Création d’une demande de transfert et transfert de vos numéros de téléphone vers l’équipe
<a name="bk_LNPcountries_1"> </a>

  > [!NOTE]
  > Si vous disposez de numéros de service pour les ponts de conférence rendez-vous, les standards automatiques ou d’autres numéros de service, les numéros de téléphone gratuits ou dont vous avez accès à des numéros de téléphone d’utilisateurs 999, consultez [la rubrique gérer les numéros de téléphone pour votre société](manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md) pour sélectionner le pays ou la région correct et télécharger les formulaires appropriés et nous les envoyer.
...
2. Dans le volet de navigation de gauche, sélectionnez **Voix** > **Commandes de transfert** > cliquez sur **Ajouter**.

3. Dans la page **Demande de transfert de nouveaux numéros locaux**, lisez les informations, puis cliquez sur **Commençons**.

4. Dans la page **Informations sur le compte**, entrez les informations ci-dessous, puis cliquez sur **Suivant**:
 ...
 **Que faire si le traitement de ma demande est trop long ?** Nous voulons que le portage de numéros soit un processus simple et rapide. Si votre commande prend plus de temps que vous ne l’imaginez et que le statut n’est toujours pas affiché dans le centre d’administration de Skype entreprise, ouvrez un ticket de support et spécifiez l’ID de la demande de transfert.
