...
ms.reviewer: rowille
audience: admin
description: Évaluez régulièrement les opportunités d’amélioration du service Teams, surveillez la feuille de Teams en cas d’améliorations intéressantes des fonctionnalités.
f1.keywords:
- NOCSH
...
Cet article donne une vue d’ensemble des conditions requises pour 100% des services vocaux cloud pour votre organisation. En assurent la surveillance continue des fonctionnalités de service vocal dans le cloud, vous êtes sûr d’offrir le plus de valeurs possible à votre organisation.
