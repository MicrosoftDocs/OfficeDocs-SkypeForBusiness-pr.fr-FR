...
<span data-ttu-id="b17a6-112">Si le propriétaire de l’équipe ne renouvelle pas l’équipe et qu’il n’y a plus d’activités sur l’équipe jusqu’à la fin de la stratégie d’expiration, l’équipe est placée dans un état « supprimé (e) », ce qui signifie qu’elle peut être restaurée dans les 30 prochains jours.</span><span class="sxs-lookup"><span data-stu-id="b17a6-112">If the team owner doesn't renew the team and there is no further activity on the team until the end of the expiration policy, the team is put in a "soft-deleted" state, which means it can be restored within the next 30 days.</span></span>

## <a name="team-auto-renewal"></a><span data-ttu-id="b17a6-113">Renouvellement automatique d’équipe</span><span class="sxs-lookup"><span data-stu-id="b17a6-113">Team auto-renewal</span></span>

<span data-ttu-id="b17a6-114">Il peut arriver que le propriétaire d’une équipe ne parvient pas à renouveler son équipe, car il a oublié de le renouveler ou était absent lorsque le renouvellement est échu.</span><span class="sxs-lookup"><span data-stu-id="b17a6-114">There can be times when a team owner is unable to renew the team perhaps because they forgot to renew or were away when renewal was due.</span></span> <span data-ttu-id="b17a6-115">Dans ces scénarios, une équipe en cours d’utilisation peut être supprimée en raison de stratégies d’expiration qui s’appliquent à l’équipe.</span><span class="sxs-lookup"><span data-stu-id="b17a6-115">In these scenarios, a team in active use can get deleted because of expiration policies that apply to the team.</span></span>  

<span data-ttu-id="b17a6-116">Pour éviter toute suppression accidentelle, le renouvellement automatique est activé automatiquement pour une équipe dans la stratégie d’expiration du groupe.</span><span class="sxs-lookup"><span data-stu-id="b17a6-116">To prevent accidental deletion, auto-renewal is automatically enabled for a team in the group expiration policy.</span></span> <span data-ttu-id="b17a6-117">Lorsque la stratégie d’expiration du groupe est configurée, n’importe quelle équipe ayant au moins une visite de canal depuis n’importe quel membre de l’équipe avant sa date d’expiration est automatiquement renouvelée sans aucune intervention manuelle du propriétaire de l’équipe.</span><span class="sxs-lookup"><span data-stu-id="b17a6-117">When the group expiration policy is set up, any team that has at least one channel visit from any team member before its expiration date is automatically renewed without any manual intervention from the team owner.</span></span>

## <a name="known-issues"></a><span data-ttu-id="b17a6-118">Problèmes connus</span><span class="sxs-lookup"><span data-stu-id="b17a6-118">Known issues</span></span>

<span data-ttu-id="b17a6-119">**La date d’expiration de l’équipe et du groupe sous-jacent ne correspondent pas**</span><span class="sxs-lookup"><span data-stu-id="b17a6-119">**Expiration date of team and underlying group don't match**</span></span>

<span data-ttu-id="b17a6-120">Avant le renouvellement d’une équipe, le groupe qui recule l’équipe est d’abord renouvelé.</span><span class="sxs-lookup"><span data-stu-id="b17a6-120">Before a team is renewed, the group that backs the team is renewed first.</span></span> <span data-ttu-id="b17a6-121">Dans le cadre du renouvellement, une nouvelle date d’expiration est définie dans le groupe pour une date ultérieure.</span><span class="sxs-lookup"><span data-stu-id="b17a6-121">As part of renewal, a new expiry date is set on the group for a future date.</span></span> <span data-ttu-id="b17a6-122">Cette nouvelle date risque de ne pas être visible immédiatement dans Teams.</span><span class="sxs-lookup"><span data-stu-id="b17a6-122">This new date may not be immediately visible in Teams.</span></span> <span data-ttu-id="b17a6-123">La synchronisation peut durer jusqu’à 24 heures. Si vous voyez une différence entre la date d’expiration d’une équipe et son groupe sous-jacent, attendez 24 heures avant de rechercher une assistance supplémentaire.</span><span class="sxs-lookup"><span data-stu-id="b17a6-123">It can take up to 24 hours to sync. If you see a discrepancy between the expiry date for a team and its underlying group, wait 24 hours before seeking further support.</span></span>
