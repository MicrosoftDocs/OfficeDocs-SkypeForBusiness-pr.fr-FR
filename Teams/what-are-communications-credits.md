...
- Appel sortant d’une réunion audioconférence sur votre téléphone mobile avec l’application Microsoft Teams ou Skype Entreprise installée sur les destinations qui ne sont pas déjà incluses dans votre abonnement.
...
Si vous vous demandez quel est le coût des appels pour les forfaits d’appels, consultez la Système téléphonique [Cloud](https://go.microsoft.com/fwlink/p/?LinkId=799523) pour les appels vocaux (faites défiler vers le bas jusqu’à « Voir les tarifs pour l’endroit où vous voulez appeler »).
