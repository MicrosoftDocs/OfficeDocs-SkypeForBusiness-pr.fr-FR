...
ms.locfileid: "61306119"
---
# <a name="configure-accounts-for-microsoft-teams-rooms"></a>Configurer des comptes pour Salles Microsoft Teams
 
Lisez cette rubrique pour en savoir plus Salles Microsoft Teams comment elle s’intègre à Exchange et Skype Entreprise.
  
Cette rubrique présente la création de comptes utilisés par les Salles Microsoft Teams dans Microsoft Exchange et Skype Entreprise. Votre infrastructure peut correspondre à l’une des configurations suivantes :
...
Si vous avez déjà un compte de boîte aux lettres de ressources créé pour l’espace sur lequel vous installez Salles Microsoft Teams, vous pouvez changer ce compte en un salles Teams ressource. Une fois que c’est fait, il vous suffit de vous Salles Microsoft Teams à l’Salles Microsoft Teams ce compte.
...
|Activation par mot de passe  <br/> |Le compte de ressource doit être activé avec un mot de passe ou ne peut pas s’authentifier auprès Microsoft Teams, Exchange ou Skype Entreprise Server. L’expiration du mot de passe doit être désactivée sur tous salles Teams de ressources.   <br/> |
