...
Si vous préférez utiliser l’interface utilisateur Microsoft 365 ou Office 365'Windows PowerShell, certaines étapes peuvent être effectuées manuellement. Voir [Créer un compte d’appareil à](/surface-hub/create-a-device-account-using-office-365)Microsoft 365 ou Office 365.
