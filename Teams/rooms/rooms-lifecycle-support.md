...
- **Phase de maintenance et de mise à jour critique** \- Lorsque vous exécutez la dernière version de l’application Salles Microsoft Teams, vous recevez des mises à jour régulières qui contiennent des mises à jour de sécurité *et* de maintenance.
...
- LTSB (Enterprise Long-term Servicing Branch) / Long Term Servicing Channel (LTSC) de Windows 10 Enterprise
...
|Version  |Date de disponibilité   |État de prise en charge des salles Microsoft Teams   |Version minimale de l’application Salles Microsoft Teams | Build du système d’exploitation recommandé  |
|:---  |:---       |:---                                  |:---     |:---     |
...
Lorsque vous utilisez une version prise en charge de Windows 10, vous obtenez toujours les dernières mises à jour de l’application Salles Microsoft Teams.  
