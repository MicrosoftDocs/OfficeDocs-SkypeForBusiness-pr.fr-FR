...
> [!NOTE]
> Les salles de Microsoft teams fonctionneront uniquement dans un environnement Microsoft teams ou Skype entreprise correctement configuré pour lequel les comptes de périphériques sont correctement configurés comme décrit dans la rubrique [déploiement de salles Microsoft teams](rooms-deploy.md).
...
2. Placez la console en mode administrateur (voir [mode administrateur et gestion des appareils](rooms-operations.md#AdminMode)).
