...
ms.collection:
- M365-collaboration
description: Découvrez les problèmes connus pour les Salles Microsoft Teams, notamment les mises à jour, l’interface utilisateur, le matériel et les limitations et les comportements attendus.
...
La première ligne est marquée comme aperçu dans le s’il s’affiche à l’avant de la salle. D’autres fonctionnalités et améliorations seront ajoutées à l’avenir. La limitation suivante s’applique à l’adresse après la publication :

- La mise en page avant affiche jusqu’à 4 participants vidéo sur un affichage unique Avant de salle. Il affiche jusqu’à 9 vidéos sur deux fronts de salle. Ces participants sont choisis parmi les derniers intervenants actifs.

- La ligne frontale nécessite des écrans de 1080p avec une mise à l’échelle de 100 %. Si la taille de police sur l’écran avant de la salle est trop petite ou trop grande pour qu’une [](rooms-operations.md#change-scale-and-resolution) salle en soit besoin, voir Modifier l’échelle et la résolution pour que la face avant de la salle ajuste vos paramètres d’affichage.
