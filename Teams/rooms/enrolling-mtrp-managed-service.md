...
description: Découvrez comment inscrire des Salles Microsoft Teams dans le Salles Microsoft Teams Premium géré.
f1keywords: ''
...
---
# <a name="enroll-a-device-in-the-microsoft-teams-rooms-premium-managed-service"></a>Inscrire un appareil dans le service géré Salles Microsoft Teams Premium service
...
## <a name="enroll-a-teams-rooms-device"></a>Inscrire un salles Teams appareil
 ...
 Pour inscrire un périphérique dans le service géré salles Teams Premium, voir Installation des [logiciels du périphérique de surveillance.](monitor-software-installation-guide.md)
