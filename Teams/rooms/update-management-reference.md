---
title: Salles Microsoft Teams de référence
author: donnah007
...
![Capture d’écran du résumé de la pile de logiciels](../media/update-management-006.jpg)

Pour garantir une expérience de réunion positive quotidiennement  dans chaque salle, il est important de normaliser chaque logiciel en cours d’exécution sur chacune des salles et de déployer les correctifs dans les salles en fonction de la configuration. Il est également courant de voir les clients configurer leur propre processus de validation pour avoir confiance sur les correctifs en attente en vérifiant qu’il résout réellement un problème qu’ils rencontrent ou en prévisualisation des fonctionnalités pour préparer l’organisation à la modification.  
