...
- Une inscription d’autorisation de base ou une inscription OAuth. Pour plus d’informations, voir [Créer des informations d’identification](https://developer.servicenow.com/dev.do#!/learn/learning-plans/rome/servicenow_application_developer/app_store_learnv2_rest_rome_creating_credentials) dans ServiceNow.
- Instance ServiceNow, ainsi que son nom d’hôte d’instance et URI d’API
...
- **short_description**: Le champ de description court dans ServiceNow est une brève valeur alphanumérique de 160 caractères qui fournit un résumé de l’incident. La description courte est équivalente à la description de l’incident dans salles Teams Premium’entreprise.
