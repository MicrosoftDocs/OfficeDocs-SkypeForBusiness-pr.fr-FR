...
ms.locfileid: "62015214"
---
# <a name="deploy-no-loc-textmicrosoft-teams-rooms-monitoring-with-no-loc-textazure-monitor"></a>Surveillance :::no-loc text="Microsoft Teams Rooms"::: du déploiement avec :::no-loc text="Azure Monitor":::
...
Vous devez configurer pour collecter les journaux requis pour surveiller l’état de :::no-loc text="Log Analytics"::: l’appareil et de :::no-loc text="Microsoft Teams Rooms"::: l’application. :::no-loc text="Microsoft Teams Rooms"::: utilisez le journal **:::no-loc text="Skype Room System":::** des événements.
...
Déployez l’agent sur les périphériques de test en utilisant les instructions fournies :::no-loc text="Microsoft Monitoring"::: Connecter sur le service [ :::no-loc text="Windows"::: :::no-loc text="Log Analytics"::: dans :::no-loc text="Azure"::: ](/azure/azure-monitor/platform/agent-windows). Cet article fournit des informations détaillées sur les étapes à suivre pour déployer l’Agent, des instructions pour obtenir :::no-loc text="Microsoft Monitoring"::: :::no-loc text="Windows"::: :::no-loc text="Log Analytics":::  * **l’ID**** d’espace de travail _ et :::no-loc text="Microsoft Teams Rooms"::: :::no-loc text="Azure Monitor"::: la clé :::no-loc text="Log Analytics"::: primaire _ pour connecter les appareils à votre déploiement, et des instructions pour vérifier la connectivité de l’agent à une instance.
...
4.  Générer un problème matériel et vérifier que les événements requis sont :::no-loc text="Azure Log Analytics"::: connectés.
    1.  Débranchez l’un des périphériques sur le système de :::no-loc text="Microsoft Teams Rooms"::: test. Cela peut être l’affichage de la caméra, du haut-parleur, du microphone ou de la salle avant
...
Si vous créez vos appareils pour la première fois, vous souhaitez peut-être inclure les étapes de configuration de l’agent dans le cadre du :::no-loc text="Microsoft Teams Rooms"::: :::no-loc text="Microsoft Monitoring"::: processus de création. Pour plus d’informations, voir [Installer l’agent à l’aide de la ligne de commande.](/azure/azure-monitor/platform/agent-windows#install-the-agent-using-the-command-line)
...
7.  :::no-loc text="Microsoft Teams Rooms"::: devraient installer et configurer :::no-loc text="Microsoft Monitoring"::: l’agent avec le deuxième redémarrage.
