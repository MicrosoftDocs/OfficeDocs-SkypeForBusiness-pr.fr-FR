...
| `<CoordinatedMeetings>` | `<TrustedAccounts>`                       |           | Il s’agit d’une liste d’UPN séparés par des virgules pour chaque appareil salles Teams ou Surface Hub à partir duquel l’appareil doit accepter les demandes de participation à une réunion ou à partir desquels les demandes de participation à une réunion doivent être envoyées.<br>Valeurs acceptées : chaîne                                                                                                                                                                                                                                                                                                                         |
