...
Microsoft Teams permet aux utilisateurs d’épingler et de recadrer les vidéos et de passer de la visualisation du contenu partagé pendant une réunion à celle des personnes qui y participent, ce qui peut être utile aux personnes malentendantes qui lisent sur les façons qu’il utilisent un interprète en langue des signes. Les utilisateurs peuvent également envoyer des messages audio et utiliser la technologie de dictée contrôleur par Microsoft Windows pour convertir la parole en texte, ce qui peut aider les personnes malvoyantes et malentendantes à communiquer avec les autres participants à la réunion.

En outre, la fonction de conversation des équipes de Microsoft Teams est compatible avec un grand éventail de technologies d’assistance, notamment les lecteurs d’écran, les logiciels de dictée, le contrôle visuel (sous Windows 10), le contrôle vocal (sous iOS et Android), les agrandisseurs d’écran et les logiciels d’accès sous (iOS et Android).
