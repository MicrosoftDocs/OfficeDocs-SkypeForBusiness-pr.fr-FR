...
Les grandes entreprises sont souvent impliquées dans procédure juridiques avec sanctions élevées et doivent soumettre toutes les informations stockées électroniquement (Electronically Stored Information - ESI).
