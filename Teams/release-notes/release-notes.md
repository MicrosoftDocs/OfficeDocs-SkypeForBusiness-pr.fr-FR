...
### <a name="remote-provisioning-and-sign-in-for-teams-android-devices"></a>Mise en service à distance et inscription pour les appareils Android teams

Les administrateurs informatiques peuvent mettre en service et se connectent à distance sur un appareil Teams Android. Pour mettre en service un appareil à distance, l’administrateur doit télécharger les ID MAC des appareils en cours de mise en service et créer un code de vérification. L’ensemble du processus peut être accompli à distance à partir du Centre d’administration Teams. [En savoir plus](../devices/remote-provision-remote-login.md).
...
Teams est en cours d’exécution même lorsque vous êtes hors connexion ou dans des conditions de faible bande passante. Teams enregistre tous vos messages non envoyés pour les conversations existantes (pendant 24 heures) et les envoie dès que vous vous remettreez en ligne. [En savoir plus](../connectivity-issues.md).
...
Pour que les utilisateurs clients peuvent accéder à l’application, le module ajout de réunion Microsoft Teams pour Google Workspace doit être activé par un administrateur Teams. [En savoir plus](../google-workspace-addon-teams.md).
...
### <a name="get-started-with-teams-in-healthcare"></a>Commencer à travailler avec Teams dans le secteur des soins de santé
...
Les écrans Microsoft Teams sont une catégorie d’appareils Teams tout-en-un dédiés qui offrent un écran tactile connecté et une expérience mains libres optimisée par Cortana. [En savoir plus](../devices/teams-displays.md).

## <a name="october-22-2020"></a>22 octobre 2020

### <a name="manage-skype-for-business-settings-for-your-users"></a>Gérer les paramètres de Skype Entreprise pour vos utilisateurs

Vous pouvez gérer les paramètres de Skype Entreprise pour les utilisateurs de Skype Entreprise dans votre organisation dans le Centre d’administration Microsoft Teams.  Sous l’onglet Skype Entreprise, sur la page des détails de l’utilisateur. À partir de là, vous pouvez gérer les paramètres d’accès externe et de réunion pour des utilisateurs individuels. [En savoir plus](../skype-for-business-settings.md).
...
Vous pouvez gérer les fonctionnalités de Skype Entreprise pour les utilisateurs de Skype Entreprise dans votre organisation dans le Centre d’administration Microsoft Teams. Allez dans **les paramètres à l’échelle de**  >  **l’organisation Skype Entreprise.** À partir de là, vous pouvez gérer la diffusion de réunion Skype, les notifications de présence et les notifications mobiles. [En savoir plus](../skype-for-business-settings.md).
...
Dans la page Gérer les applications du Centre  d’administration Microsoft Teams, vous pouvez utiliser le bouton Ajouter à une équipe pour installer une application dans une équipe. [En savoir plus](../manage-apps.md).
...
### <a name="teams-integration-with-android-contacts"></a>Intégration de Teams aux contacts Android

Appelez en utilisant Teams directement par le biais de votre téléphone Android.
...
Si vous disposez d’un ou plusieurs appareils Salles Microsoft Teams ou Surface Hub dans une salle de réunion, vous pouvez configurer des réunions coordonnées. Les réunions coordonnées vous permet de configurer vos appareils Salles d’équipe et Surface Hub de façon à ce que, lorsque vous rejoignez une réunion sur un appareil, les autres appareils de la salle soient également joints à la même réunion. [En savoir plus](../rooms/coordinated-meetings.md).

### <a name="tagging-by-shift"></a>Balisage par shift

Cette fonctionnalité permet aux personnes de se voir automatiquement attribuer des balises qui correspondent à leur planning et au nom du groupe de shifts dans l’application Shifts de Teams. [En savoir plus](../manage-tags.md).
...
Les utilisateurs de Teams peuvent désormais gérer, créer et gérer leurs listes directement à l’aide de l’onglet de l’application Listes. L’application Listes fonctionne sur tous les clients Teams et permet la collaboration et la communication autour d’éléments de liste. [En savoir plus](../manage-lists-app.md).
...
L’affichage seul permet à jusqu’à 20 000 participants à l’écoute seule de participer à une réunion dans laquelle l’organisateur dispose d’une licence pour la référence SKU du module de communication avancée.1 Il s’agit d’une fonctionnalité d’aperçu ou de publication anticipée. [En savoir plus](https://docs.microsoft.com/MicrosoftTeams/limits-specifications-teams-preview#meetings-and-calls).

## <a name="july-28-2020"></a>28 juillet 2020

### <a name="create-your-own-teams-template"></a>Créer votre propre modèle Teams

Vous pouvez désormais utiliser des modèles de la console d’administration pour créer votre propre modèle Teams ou créer un modèle Teams à partir de modèles existants. [En savoir plus](../get-started-with-teams-templates-in-the-admin-console.md).
...
### <a name="ndi-out-for-teams-meetings"></a>NDI-out pour les réunions Teams

Nous avons ajouté la possibilité d’activer NDI-Out à une réunion Teams. NDI-Out permet d’utiliser l’audio et la vidéo d’une réunion à l’aide d’outils de production vidéo. [En savoir plus](../use-ndi-in-meetings.md).
...
Les étiquettes de sensibilité permettent aux administrateurs Teams de réguler l’accès au contenu d’organisation sensible créé lors de la collaboration au sein d’équipes. [En savoir plus](../sensitivity-labels.md).
...
### <a name="teams-filter-option"></a>Option de filtre Teams
