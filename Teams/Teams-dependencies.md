...
Pour plus d’informations sur le contrôle de qui peut ajouter des invités, voir [Déléguer des invitations pour la collaboration B2B Azure Active Directory](https://docs.microsoft.com/fr-FR/azure/active-directory/b2b/delegate-invitations)
