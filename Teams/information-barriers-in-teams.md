...
Le rôle de gestion de la conformité de l'organisation est responsable de la gestion des stratégies de l'organisation. Pour plus d'informations sur ce rôle, voir Autorisations dans le Centre de conformité [Microsoft 365.](/office365/securitycompliance/permissions-in-the-security-and-compliance-center)
...
- **Invités dans Teams -** Les stratégies DE l'ORGANISATION S'appliquent également aux invités dans Teams. Si les invités doivent être utilisables dans la liste d'adresses globale de votre organisation, voir Gérer l'accès invité dans les groupes [Microsoft 365.](/microsoft-365/admin/create-groups/manage-guest-access-in-groups) Une fois que les invités sont découvrons, vous pouvez [définir les stratégies de l'organisation.](/office365/securitycompliance/information-barriers-policies)
...
Lorsqu'une équipe est créée, un site SharePoint est mis en service et associé à Microsoft Teams pour l'expérience de fichiers. Les stratégies de barrière de l'information ne sont pas honorées sur ce site SharePoint et les fichiers par défaut. Pour permettre l'obstacle de l'information dans SharePoint et OneDrive, suivez les recommandations et les étapes qui permettent d'utiliser les barrières de l'information dans [une rubrique SharePoint.](/sharepoint/information-barriers#enable-sharepoint-and-onedrive-information-barriers-in-your-organization)
...
- **Nombre maximal de segments autorisés dans** un client : chaque client peut configurer jusqu'à 100 segments lors de la configuration de stratégies de l'organisation de l'organisation. Il n'y a pas de limite au nombre de stratégies qui peuvent être configurées.
...
- Pour configurer les stratégies de l'organisation, voir [Définir les stratégies pour les obstacles à l'information.](/office365/securitycompliance/information-barriers-policies)
...
- La fonctionnalité est disponible dans notre cloud public. En janvier 2021, nous avons déployé les barrières de l'information dans le cloud du cloud gcc.
