...
Utilisez *l’cmdlet Set-UnifiedGroup* avec le paramètre *InformationBarrierMode* correspondant au mode que vous voulez utiliser pour vos segments. Les listes de valeurs autorisées pour le *paramètre InformationBarrierMode* sont *Ouvertes* et *implicites.*
