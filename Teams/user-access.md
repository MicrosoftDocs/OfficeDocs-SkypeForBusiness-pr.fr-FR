...
Vous gérez l’accès Teams utilisateur en attribuant ou en supprimant une Microsoft Teams de produit. À l’exception de Teams anonymes, chaque utilisateur de votre organisation doit avoir une licence Teams licence pour pouvoir utiliser Teams. Vous pouvez attribuer une licence Teams utilisateurs à de nouveaux utilisateurs en cas de création de comptes d’utilisateur ou à des utilisateurs ayant déjà des comptes.
