...
# <a name="perform-your-upgrade-to-teams"></a>Effectuer la mise à niveau pour les équipes

Choisissez votre parcours de mise à niveau en fonction de votre déploiement actuel de Skype pour les entreprises :

- [Mise à niveau à partir de Skype pour les entreprises en ligne aux équipes](https://aka.ms/SkypeToTeams-UpgradeOnline)
- [Mise à niveau à partir de Skype pour un environnement hybride Business équipes](https://aka.ms/SkypeToTeams-UpgradeHybrid)
- [Mise à niveau à partir de Skype pour l’entreprise locale aux équipes](https://aka.ms/SkypeToTeams-UpgradeOnPrem)
