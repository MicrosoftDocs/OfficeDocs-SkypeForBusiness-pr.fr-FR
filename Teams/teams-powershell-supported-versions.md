...
- Modifications associées
  - Mises à jour de Get-CsOnlineUser & Get-CsOnlineVoiceUser dans TPM 3.x.x et versions ultérieures : plus d’informations dans [Get-CsOnlineUser](/powershell/module/skype/get-csonlineuser) & [Get-CsOnlineVoiceUser](/powershell/module/skype/get-csonlinevoiceuser) (billet du Centre de messages – MC340774).
