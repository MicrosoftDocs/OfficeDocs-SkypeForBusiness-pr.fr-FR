...
---
# <a name="powershell-script-sample---reset-the-autostart-setting-in-teams"></a><span data-ttu-id="1f757-103">Exemple de script PowerShell - Réinitialiser le paramètre de démarrage automatique dans Teams</span><span class="sxs-lookup"><span data-stu-id="1f757-103">PowerShell script sample - Reset the autostart setting in Teams</span></span>

<span data-ttu-id="1f757-104">Utilisez ce script pour réinitialiser le paramètre de démarrage automatique de Teams par utilisateur.</span><span class="sxs-lookup"><span data-stu-id="1f757-104">Use this script to reset the Teams autostart setting on a per-user basis.</span></span> <span data-ttu-id="1f757-105">Cela inclut toutes les valeurs définies par l’utilisateur ou l’application Teams.</span><span class="sxs-lookup"><span data-stu-id="1f757-105">This includes any values set by the user or the Teams app.</span></span> <span data-ttu-id="1f757-106">Par défaut, Teams démarre automatiquement lorsqu’un utilisateur se connecte à son ordinateur après l’installation.</span><span class="sxs-lookup"><span data-stu-id="1f757-106">By default, Teams automatically starts when a user logs in to their computer after it's installed.</span></span>

<span data-ttu-id="1f757-107">Si vous avez déjà déployé Teams et que vous voulez définir le paramètre Empêcher Microsoft Teams de démarrer automatiquement après [l’installation,](../msi-deployment.md#use-group-policy-recommended) vous devez désactiver le démarrage automatique de Teams, vous devez d’abord définir le paramètre de stratégie de groupe sur la valeur que vous voulez, puis exécuter ce script.</span><span class="sxs-lookup"><span data-stu-id="1f757-107">If you've already deployed Teams and want to set the [Prevent Microsoft Teams from starting automatically after installation Group Policy setting](../msi-deployment.md#use-group-policy-recommended) to disable Teams autostart, you'll need to first set the Group Policy setting to the value you want, and then run this script.</span></span>

<span data-ttu-id="1f757-108">Une fois Teams démarré pour un utilisateur, les paramètres de démarrage automatique ne peuvent pas être désactivés à l’aide d’une stratégie de groupe.</span><span class="sxs-lookup"><span data-stu-id="1f757-108">After Teams is started for a user, the autostart settings can't be disabled by using Group Policy.</span></span>

## <a name="sample-script"></a><span data-ttu-id="1f757-109">Exemple de script</span><span class="sxs-lookup"><span data-stu-id="1f757-109">Sample script</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1f757-110">Sujets associés</span><span class="sxs-lookup"><span data-stu-id="1f757-110">Related topics</span></span>

- [<span data-ttu-id="1f757-111">Installer Teams avec MSI</span><span class="sxs-lookup"><span data-stu-id="1f757-111">Install Teams using MSI</span></span>](../msi-deployment.md)
- [<span data-ttu-id="1f757-112">Déployer Teams avec les applications Microsoft 365 pour les entreprises</span><span class="sxs-lookup"><span data-stu-id="1f757-112">Deploy Teams with Microsoft 365 Apps for enterprise</span></span>](https://docs.microsoft.com/deployoffice/teams-install)
