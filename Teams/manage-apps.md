...
Pour télécharger une nouvelle application personnalisée, **sélectionnez Télécharger** charger le package d’application. L’application n’est pas mise en évidence une fois téléchargée. Vous devez donc effectuer une recherche dans la liste des applications sur la page Gérer les applications pour la trouver.
