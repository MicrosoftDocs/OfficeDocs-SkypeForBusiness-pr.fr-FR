...
Les fonctionnalités de partage d’appel et d’appel de groupe de Microsoft Teams permet aux utilisateurs de partager leurs appels entrants avec des collègues afin que leurs collègues peuvent répondre à des appels qui se produisent alors que l’utilisateur n’est pas disponible.
...
Les utilisateurs doivent avoir une licence Microsoft Teams Système téléphonique pour configurer et utiliser le partage d’appels et le regroupement d’appels. Pour plus d’informations sur le modèle de licence, consultez les informations dont vous [obtenez Système téléphonique.](https://docs.microsoft.com/MicrosoftTeams/here-s-what-you-get-with-phone-system)
