...
> [!NOTE]
> Si vous ne parvient pas à télécharger l’application dans votre client de production à des fins de [](#upload) validation, même pour vous-même ou des utilisateurs de confiance, vous pouvez ignorer cette étape et suivre les étapes de la section Télécharger et configurer et gérer pour publier l’application nonvalidée dans le magasin d’applications de votre organisation. [](#set-up-and-manage) Ensuite, limitez l’accès à cette application uniquement à vous-même et aux utilisateurs de confiance. Ces utilisateurs peuvent ensuite obtenir l’application à partir du magasin d’applications de votre organisation pour effectuer une validation. Une fois l’application validée, utilisez les mêmes stratégies d’autorisation pour ouvrir l’accès à l’application et la déployer en production.
