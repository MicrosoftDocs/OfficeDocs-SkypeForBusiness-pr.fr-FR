...
### <a name="server-client-tab-and-client-client-tabs"></a>Server-Client'onglets Client-Client tabulations
...
> [!NOTE]
> À l’donné d’un flux, si l’un des deux points de terminaison est connecté à un réseau WiFi, il est classé comme Étant en WiFi dans le même rapport.
