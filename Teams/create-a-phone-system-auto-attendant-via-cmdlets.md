---
title: Créer un standard automatique via des applets de commande
author: CarolynRowe
ms.author: crowe
manager: serdars
...
Le flux d’appel du standard automatique suivant est généré :

![Diagramme du flux d’appel du standard automatique en cours de génération avec des applets de commande.](media/create-a-phone-system-auto-attendant-via-cmdlets.png)

Informations de configuration supplémentaires :

- Standard automatique : Contoso Main
  - Opérateur : Adele Vance
  - Activer les entrées vocales : désactivée
  - Recherche dans l’annuaire : Aucun
  - Vacances:
    - 1er janvier 2022
    - 24 décembre 2022
    - 25 décembre 2022

- Standard automatique : Numérotation contoso par nom
  - Opérateur : Adele Vance
  - Fuseau horaire : UTC
  - Langue : Anglais US
  - Activer les entrées vocales : activé
  - Message d’accueil : Aucun
  - Menu : TTS, « Indiquez ou entrez le nom de la personne que vous souhaitez joindre. Pour revenir au menu précédent, appuyez sur 9 »
  - Recherche d’annuaire : Numérotation par nom
  - Portée de numérotation : Membres du support & des ventes
...
## <a name="get-operator-information"></a>Obtenir des informations sur l’opérateur
...
## <a name="dial-by-name-auto-attendant---resource-account-creation"></a>Numérotation par nom - Création d’un compte de ressource

**Remarque** : création d’un compte de ressource ici afin qu’il puisse être référencé sur le standard automatique principal. Le standard automatique Dial By Name réel sera créé ultérieurement.
...
## <a name="contoso-main-menu-auto-attendant"></a>Standard automatique du menu principal de Contoso

### <a name="create-holiday-schedules"></a>Créer des planifications de congés
...
### <a name="create-address-fax-and-email-information-prompt"></a>Créer une adresse, une télécopie et une invite d’informations Email
...
### <a name="create-holiday-prompts-and-menu-options"></a>Créer des invites de congés et des options de menu
...
### <a name="create-after-hours-schedules"></a>Créer des planifications après les heures de travail
...
### <a name="create-after-hours-prompts-and-menu-options"></a>Créer des invites after hours et des options de menu
...
### <a name="create-auto-attendant"></a>Créer un standard automatique
...
Remarque : l’emplacement d’utilisation affecté au numéro de téléphone doit correspondre à l’emplacement d’utilisation affecté au compte de ressource.
...
## <a name="dial-by-name-auto-attendant---completion"></a>Numérotation par nom - Saisie semi-automatique
...
### <a name="assign-resource-account"></a>Attribuer un compte de ressource
