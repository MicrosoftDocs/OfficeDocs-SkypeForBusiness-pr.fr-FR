...
Vous pouvez contrôler qui peut télécharger des applications personnalisées sur Teams’application **personnalisées.** [Les paramètres et stratégies d’application](teams-custom-app-policies-and-settings.md) personnalisées sont gérés par le biais Microsoft Teams d’administration.
