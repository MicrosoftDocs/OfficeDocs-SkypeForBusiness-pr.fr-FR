...
> [!IMPORTANT]
> L'utilisation de Microsoft 365 d'expiration des groupes nécessite Azure Active Directory Premium licences P1 pour chaque utilisateur unique qui est membre d'un ou plusieurs Microsoft 365 groupes.
