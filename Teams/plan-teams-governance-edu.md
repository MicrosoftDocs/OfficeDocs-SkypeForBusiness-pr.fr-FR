...
[L’API Microsoft Graph (bêta)](/graph/api/resources/teams-api-overview) peut :
...
Pour plus d’informations sur Teams [stratégies,](enable-features-office-365.md)voir Gérer Microsoft Teams de votre organisation.
