...
1. Dans la barre de navigation gauche du centre Microsoft Teams d’administration, cliquez sur **Analyse & rapports d’utilisation** >  **des rapports**. Dans **l’onglet Afficher les rapports**, sous **Rapport**, sélectionnez Teams **l’utilisation des événements en direct**.
...
Si votre organisation est activée pour la [ruche](https://www.hivestreaming.com/partners/integration-partners/microsoft/) eCDN ou l’eCDN [Kollective](https://kollective.com) , vous pouvez obtenir des données d’analyse des participants supplémentaires en cliquant sur le lien du rapport partenaire.
