...
|**[EHR](#ehr)**     |Indique le nombre Teams visites intégrées par ehr effectuées à partir de votre système EHR.         |  
...
1. Dans le navigation gauche du centre d Microsoft Teams d’administration, sélectionnez **Analyse & rapports** >  **d’utilisation des rapports**. Sous **l’onglet Afficher les rapports** , sous **Rapport**, sélectionnez **Utilisation des visites virtuelles**.
...
>
>Si vous voulez désactiver le rapport pour votre organisation, vous pouvez le faire dans Paramètres coin  supérieur droit de la page.
...
- [Visites virtuelles avec Teams - Intégration à l’intégration à l’intégration EHR](../expand-teams-across-your-org/healthcare/ehr-admin-cerner.md)
