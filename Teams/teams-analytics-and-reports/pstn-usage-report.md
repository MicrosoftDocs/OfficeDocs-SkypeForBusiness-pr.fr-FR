...
> | 2 | Nom d’affichage | `nvarchar(128)` | Nom d’un utilisateur ou d’un robot d’appel (par exemple, File d’attente d’appels ou Standard automatique) tel que Microsoft 365 centre d’administration |
