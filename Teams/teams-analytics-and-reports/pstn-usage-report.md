...
> | 10 | Numéro de l’appelant | `nvarchar(32)` | Numéro de l’utilisateur ou du robot ayant effectué l’appel. Lors de l’appel entrant à un utilisateur d’équipe, il sera un utilisateur PSTN, en sortant d’un Teams l’appel sera le Teams d’utilisateur |
