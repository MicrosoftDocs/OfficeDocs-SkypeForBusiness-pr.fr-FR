...
> | 9 | Durée (secondes) | `int` | Durée de l’appel (de l’invitation à la fin de l’appel ou de l’échec). Pour le forwarding d’appel, la durée inclut une sonnerie dans la file d’attente d’appels. |
