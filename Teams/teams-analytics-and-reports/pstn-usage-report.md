...
1. Dans la barre de navigation gauche du centre Microsoft Teams d’administration, cliquez sur **Analyse & rapports d’utilisation** >  **des rapports**. Sous **l’onglet Afficher les** rapports, sous **Rapport**, sélectionnez **Rapport d’utilisation PSTN**.
...
- Appel depuis un numéro autre qu’E.164. Un utilisateur d’un PBX tiers interconnecté avec le routage direct appelle un Teams utilisateur. Dans ce cas, le numéro d’appelant peut être n’importe quel numéro autre qu’E.164, par exemple +1001. 
