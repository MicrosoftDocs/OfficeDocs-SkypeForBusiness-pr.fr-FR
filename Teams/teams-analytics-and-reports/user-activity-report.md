...
|**6**   | Chacune des mesures représentées dans un graphique au niveau du client. Filtrez ce que vous voyez sur le graphique en sélectionnant un élément dans la légende. Sélectionnez **Messages de canal,** **Messages de réponse,**  **Messages de** conversation ou Réunions organisées pour voir les informations **liées** à chacun d’eux. La modification de cette sélection ne modifie pas les informations du tableau lui-même. |
