...
Pour anonymisation des données Teams rapport d’activité des utilisateurs, vous devez être administrateur général. Cela masquera les informations identifiables (à l’aide de hèses MD5) telles que le nom d’affichage, le courrier électronique et AAD ID dans le rapport et leur exportation.
