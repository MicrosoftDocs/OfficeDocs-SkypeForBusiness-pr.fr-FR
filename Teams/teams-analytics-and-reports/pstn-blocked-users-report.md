...
Dans la barre de navigation gauche du centre Microsoft Teams d’administration, cliquez sur **Analyse & rapports d’utilisation** >  **des rapports**. Sous **l’onglet Afficher les rapports** , sous **Rapport**, sélectionnez **Utilisateurs PSTN** bloqués, puis cliquez sur **Exécuter le rapport**.
