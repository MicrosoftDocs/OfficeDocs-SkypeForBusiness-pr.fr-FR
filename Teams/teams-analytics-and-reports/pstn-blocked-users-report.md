...
![Rapport sur le blocage d’utilisateurs PSTN dans le Centre d’administration](../media/teams-reports-pstn-blocked-users-with-callouts.png "Capture d’écran du rapport sur le blocage d’utilisateurs PSTN dans le Centre d’administration Microsoft Teams avec des appels numéroés")
