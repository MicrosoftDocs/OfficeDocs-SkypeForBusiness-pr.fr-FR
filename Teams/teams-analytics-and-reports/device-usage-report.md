...
Pour anonymisation des données Teams rapport d’utilisation des appareils, vous devez être administrateur général. Cela a pour effet de masquer les informations identifiables telles que le nom d’affichage, l’adresse de courrier AAD dans le rapport et leur exportation.
