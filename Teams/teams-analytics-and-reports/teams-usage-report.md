...
2. Dans **Plage de dates**, sélectionnez une plage puis cliquez sur **Exécuter le rapport**.
    ...
    ![Capture d’écran du Teams d’utilisation de l’ordinateur dans Teams d’administration avec des appels](../media/teams-reports-teams-usage-with-callouts1.png "Capture d’écran du Teams d’utilisation de l’ordinateur dans Teams d’administration avec des appels")
