...
2. Dans **Plage de dates**, sélectionnez une plage puis cliquez sur **Exécuter le rapport**.
    ...
    ![Capture d’écran du Teams d’utilisation de l’Teams dans le Centre d’administration Teams des appels](../media/teams-reports-teams-usage-with-callouts.png "Capture d’écran du Teams d’utilisation de l’Teams dans le Centre d’administration Teams des appels")
