...
Les organisateurs de la réunion peuvent afficher et télécharger un rapport présence sur une réunion. Recherchez ce rapport dans le volet **participants** de la réunion en cliquant sur la flèche de téléchargement, comme illustré ci-dessous. Vous pouvez télécharger le rapport en tant que. Fichier CSV (format texte).
