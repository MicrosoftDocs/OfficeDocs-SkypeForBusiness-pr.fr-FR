...
2. Sélectionnez **Rapports**, puis choisissez **d’afficher les noms d’utilisateur, de groupe et de site masqués dans tous les rapports**. Ce paramètre est appliqué à la fois aux rapports d’utilisation dans Centre d'administration Microsoft 365 ainsi qu’au Centre d’administration Teams.
