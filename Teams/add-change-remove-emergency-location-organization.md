...
Quelle que soit [l’option de connectivité RTC](pstn-connectivity.md) que vous choisissez&mdash;, les plans d’appel Microsoft, l’opérateur Connect ou les emplacements d’urgence de routage&mdash;direct peuvent être associés à un numéro de téléphone.
