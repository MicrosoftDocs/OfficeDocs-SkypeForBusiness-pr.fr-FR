---
title: Créer une file d’attente d’appels Microsoft Teams Système téléphonique - Didacticiel pour les petites entreprises
author: CarolynRowe
ms.author: crowe
manager: serdars
ms.reviewer: dobro
...
- Phone System
description: Découvrez comment configurer des files d’attente d’appels pour les petites et moyennes entreprises dans Microsoft Teams Système téléphonique.
ms.openlocfilehash: 8856d447d9197be4833d95fa6262bee1832b4b44
ms.sourcegitcommit: e86e3824c300c24e022d5cb1848338278a5a96a8
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 03/03/2022
ms.locfileid: "63053073"
---
# <a name="create-a-call-queue---small-and-medium-business-tutorial"></a>Créer une file d’attente d’appels - Didacticiel pour les petites et moyennes entreprises
...
Obtenez des [Microsoft Teams Téléphone licences Standard - Utilisateur](../teams-add-on-licensing/virtual-user.md) virtuel si vous ne les avez pas encore. Obtenez une file d’attente pour chaque file d’attente d’appels et chaque traitement automatique que vous prévoyez de configurer. Ces licences sont gratuites. Nous vous suggérons donc d’en obtenir quelques supplémentaires si vous décidez de modifier votre installation ultérieurement.
...
> [Étape 2 : gestion des comptes de >](/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?tabs=resource-account#steps)

### <a name="step-2---resource-accounts"></a>[Étape 2 : comptes de ressources](#tab/resource-account)

Chaque file d’attente d’appels que vous créez nécessite un compte de ressource. Ce compte est similaire à un compte d’utilisateur, sauf qu’il est associé à un moyen de service automatique ou à une file d’attente d’appels au lieu d’une personne. Dans cette étape, nous allons créer le compte, lui attribuer une licence *utilisateur virtuel Microsoft Teams Téléphone Standard- Virtual*, puis l’utiliser pour commencer à créer la file d’attente d’appels.
...
### <a name="step-3---call-agents"></a>[Étape 3 : appeler des agents](#tab/call-agents)
...
### <a name="step-4---call-routing"></a>[Étape 4 : routage des appels](#tab/call-routing)
...
### <a name="step-5---call-overflow"></a>[Étape 5 : dépassement de capacité d’appel](#tab/call-overflow)
...
### <a name="step-6---call-timeout"></a>[Étape 6 : délai d’appel](#tab/call-timeout)
...
Cela termine la configuration de votre file d’attente d’appels. Vous pouvez ensuite configurer [un attendant automatique](set-up-auto-attendant.md).
