...
> [!div class="nextstepaction"]
> [Étape 4 : gestion des comptes de >](https://review.docs.microsoft.com/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?branch=mikeplum-smb-voice&tabs=call-routing#steps)
...
> [!div class="nextstepaction"]
> [Étape 5 : dépassement de capacité d'>](https://review.docs.microsoft.com/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?branch=mikeplum-smb-voice&tabs=call-overflow#steps)
...
> [!div class="nextstepaction"]
> [Étape 6 : délai d'>](https://review.docs.microsoft.com/microsoftteams/business-voice/create-a-phone-system-call-queue-smb?branch=mikeplum-smb-voice&tabs=call-timeout#steps)
