---
title: Vérifier votre connexion Internet pour obtenir une Teams Téléphone’aide d’un forfait d’appels
author: dstrome
ms.author: dstrome
manager: serdars
ms.topic: article
...
ms.locfileid: "61766917"
---
# <a name="check-your-internet-connection-for-teams-phone"></a>Vérifiez que vous avez une connexion Internet Teams Téléphone

Teams Téléphone est la technologie de Microsoft qui permet d’activer les fonctionnalités téléphoniques au sein d’Microsoft Teams l’Microsoft 365 cloud. Chaque appareil qui utilise Microsoft Teams et Teams Téléphone doit être connecté à Internet.

Pour obtenir la meilleure Teams Téléphone expérience utilisateur, vous avez besoin d’une connexion Internet haut débit qui peut prendre en charge le nombre maximal d’appels téléphoniques que votre organisation peut passer à un moment quelconque. Vous devez également vous assurer que les ordinateurs de votre réseau peuvent accéder Microsoft 365 services.

Vous n’avez pas besoin d’Teams Téléphone de licence pour suivre ces étapes.

## <a name="check-your-internet-connection-speed"></a>Vérifier la vitesse de votre connexion Internet

Cet article vous aide à déterminer si votre connexion Internet est assez rapide pour le nombre de personnes qui doivent effectuer des appels téléphoniques. Vous fournirez des informations sur votre organisation et récupérerez un rapport qui indique la quantité de votre connexion Internet utilisée par les utilisateurs Teams et Teams Téléphone.
...
* Combien de personnes utiliseront Teams Téléphone de votre bureau
* Combien de personnes utiliseront Teams Téléphone principalement à partir d’un emplacement distant tel qu’un bureau à domicile

### <a name="enter-your-information-into-the-network-planner"></a>Entrer vos informations dans le Planificateur de réseau

Procédez comme suit :

1. Dans un navigateur, allez à [https://admin.teams.microsoft.com](https://admin.teams.microsoft.com). Connectez-vous à l’aide d’un compte disposant des autorisations d’administrateur général. Le compte que vous avez utilisé pour vous inscrire à Microsoft 365 ou Office 365 dispose de ces autorisations.
...
Lorsque vous sélectionnez **Générer un rapport,** Microsoft 365 ou Office 365 crée un rapport.

Sous la **colonne** Impact  et sur Office 365 ligne, ce nombre indique la quantité de connexion internet que Teams et Teams Téléphone utilisera. Il est recommandé que ce nombre ne soit pas supérieur à 30 % de la vitesse totale de votre connexion Internet. Par exemple, si votre connexion Internet est de *60* Mbits/s, les Teams et Teams Téléphone ne doivent pas utiliser plus *de 18 Mbits/s.*

Utilisez cette équation pour déterminer la vitesse minimale de votre connexion Internet : <*le nombre d> / 0,3.*  

Imaginons que le nombre d’impacts *soit de 4,6875 Mbits/s.* Pour calculer la vitesse minimale d’une connexion Internet, le calcul serait *de 4,6875 /0,3 = 15,6.* Dans ce cas, la vitesse de connexion Internet doit être d’au moins *15,6 Mbits/s.*

Si Teams et Teams Téléphone utilisent plus de 30 % de la vitesse totale de votre connexion Internet, le nombre **d’impact** apparaît en rouge. Dans ce cas, vous devrez peut-être mettre à niveau votre connexion Internet.

![Avertissement de vitesse de connexion.](../media/network-planner-report-speed-warning.png)

>[!NOTE]
> L’impact sur la bande passante fourni par le Planificateur réseau n’est qu’une estimation. Il est recommandé [](../cqd-what-is-call-quality-dashboard.md) d’utiliser le tableau de bord de qualité des appels pour surveiller de façon active l’expérience utilisateur pour les appels audio et vidéo avec des Microsoft Teams au sein de votre organisation.
