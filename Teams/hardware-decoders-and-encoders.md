...
Microsoft prend en charge tous les décodeurs et les encodeurs à l’exception de ceux répertoriés dans cet article.

## <a name="hardware-decoder-driver-recommendations---intel"></a>Recommandations en matière de pilote de décodeur matériel - Intel
...
## <a name="hardware-decoder-driver-recommendations---nvidia"></a>Recommandations de pilote de décodeur matériel - Nvidia
