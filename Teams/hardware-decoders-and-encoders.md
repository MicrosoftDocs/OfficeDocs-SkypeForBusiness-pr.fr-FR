...
## <a name="hardware-decoder-driver-recommendations---intel"></a>Recommandations en matière de pilotes de décodeurs matériels-Intel

Les combinaisons de systèmes d’exploitation, de modèles et de pilotes suivants ne sont pas activées pour l’accélération matérielle en raison de différents problèmes de pilotes.
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [0.0.0.0]-[8.15.10.2753] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [9.17.10.2867] - [9.17.10.4459] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 |0x1616 | [9.18.7.9] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [10.18.10.3431] - [10.18.10.4425] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [10.18.14.4280] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses |[10.18.15.4281] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses |[20.19.15.4390] - [20.19.15.4444] |
|Windows 10 | ses | [21.20.16.4541] |
|Windows 10 | ses | [22.20.16.4811] |
|Windows 10 | ses | [24.20.100.6293] |

## <a name="hardware-decoder-driver-recommendations---nvidia"></a>Recommandations en matière de pilotes de décodeurs matériels-NVIDIA
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [8.17.11.9745], [8.17.12.5738] |
...
Pour les systèmes d’exploitation anciens, seules les Device_ids suivantes sont activées pour l’accélération matérielle.
...
|Système d’exploitation           | Modèle (Device_id) | Pilote/plage |
|---------------------------|-------------------|--------------|
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [0.0.0.0]-[25.20.15017.1009] |

## <a name="hardware-encoder-driver-recommendations---intel"></a>Recommandations relatives aux pilotes du codeur matériel-Intel

Les combinaisons de systèmes d’exploitation, de modèles et de pilotes suivants ne sont pas activées pour l’accélération matérielle en raison de différents problèmes de pilotes.

|Système d’exploitation           | Modèle (Device_id) | Pilote/plage |
|---------------------------|-------------------|--------------|
|Windows 7 | ses | [8.15.10.2200] - [8.15.10.2600] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [8.15.10.2653] - [8.15.10.2827] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [9.14.3.1176] - [9.14.3.1177] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [9.17.10.2800] - [9.17.10.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [9.18.10.3222] |
|Windows 7 | ses | [9.18.10.3234] |
|Windows 7 | ses | [9.18.10.3272] |
|Windows 7 | ses | [10.18.10.3242] - [10.18.10.9999] |
|Windows 8/Windows 8.1 ou Windows 10 | ses | [10.18.10.0000] - [10.18.10.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [10.18.14.4153] - [10.18.14.4161] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [10.18.14.4264] |
|Windows 7 | ses | [10.18.14.4578] |
|Windows 7 | ses | [10.18.14.4889] |
|Windows 7 | ses | [10.18.14.5057] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [20.19.15.4300] - [20.19.15.4444] |
|Windows 7 | ses | [20.19.15.4474] |

## <a name="hardware-encoder-driver-recommendations---nvidia"></a>Recommandations relatives aux pilotes du codeur matériel-NVIDIA

Les combinaisons de systèmes d’exploitation, de modèles et de pilotes suivants ne sont pas activées pour l’accélération matérielle en raison de différents problèmes de pilotes.

|Système d’exploitation           | Modèle (Device_id) | Pilote/plage |
|---------------------------|-------------------|--------------|
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [0.0.0.0]-[21.21.13.7848] |

## <a name="hardware-encoder-driver-recommendations---amd"></a>Recommandations en matière de pilotes de codeur matériel-AMD
...
|Windows 7 | ses | [0.0.0.0]-[16.199.9999.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | ses | [15.21.0.0] - [16.199.9999.9999] |
