...
![Capture d’écran des données de session de l’utilisateur d’analyse des appels.](media/real-time-telemetry.png)
...
|Fréquence d’images (vidéo) |Images par secondes |360p ou meilleure : 25-30 FPS <br/> 270p ou une valeur inférieure : 7-15 FPS |Pour les flux vidéo sortants, la fréquence d’images (FPS) est le nombre d’images par seconde de vidéo que le client envoie. Les valeurs inférieures aux valeurs prévues peuvent indiquer des contraintes de ressources système, une bande passante réseau insuffisante ou des périphériques de capture vidéo non connectés. Les différentes résolutions ont différentes plages de fps acceptables. |
