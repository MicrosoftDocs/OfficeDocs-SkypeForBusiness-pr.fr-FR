...
- **Routage direct :** Option permettant d’accéder à PSTN pour les utilisateurs disposant d’un compte Skype entreprise en ligne ou d’une licence Microsoft teams via le client Microsoft Teams. L’SBC est connecté au proxy SIP dans Microsoft 365 ou Office 365, sans nécessiter de logiciel local de la part de Microsoft.
