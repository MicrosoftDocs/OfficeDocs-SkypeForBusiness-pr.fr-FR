...
> [!NOTE]
> [Les canaux partagés](shared-channels.md) sont pris en charge par les stratégies de rétention.
...
Vous pouvez configurer très efficacement une stratégie de rétention unique pour tous les messages Teams. Ou, pour un contrôle plus précis, vous pouvez :

- Disposez de stratégies de rétention distinctes pour les conversations privées (conversations 1:1 ou 1:many), les messages des canaux standard ou les messages des canaux privés.

- Appliquez les stratégies uniquement à des utilisateurs ou équipes spécifiques de votre organisation. Pour les conversations Teams et les canaux privés, vous pouvez sélectionner les utilisateurs auxquels la stratégie s’applique. Pour les conversations Teams, vous pouvez sélectionner les équipes auxquels la stratégie s’applique.

Par exemple, pour les messages de canal standard : créez une stratégie de rétention pour des équipes spécifiques de votre organisation et configurez cette stratégie avec une action de suppression après 1 an. Ensuite, créez une autre stratégie de rétention pour les messages de canal standard pour toutes les autres équipes et configurez cette stratégie avec une action de suppression après 3 ans.

## <a name="create-and-manage-retention-policies-for-teams"></a>Créer et gérer des stratégies de rétention pour Teams

Pour créer ou modifier une stratégie de rétention pour les messages Teams, utilisez les instructions de la [stratégie de rétention pour les emplacements Teams](/microsoft-365/compliance/create-retention-policies#retention-policy-for-teams-locations).
...
:::image type="content" source="media/retention-policies-image2.png" alt-text="Les utilisateurs dans Teams expliquant les messages sont supprimés à la suite d’une stratégie de rétention Teams.":::
...
:::image type="content" source="media/retention-policies-image3.png" alt-text="Capture d’écran du canal avant rétention.":::
...
- Résolution des problèmes : [les messages dans les applications Teams et Yammer sont supprimés de manière inattendue par les stratégies de rétention](/microsoftteams/troubleshoot/teams-im-presence/messages-unexpectedly-deleted-retention-policy)
