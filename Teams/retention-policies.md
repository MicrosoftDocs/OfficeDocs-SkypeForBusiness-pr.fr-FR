...
ms.service: msteams
audience: admin
description: Utilisez des stratégies de rétention pour les Microsoft Teams afin de conserver les messages que votre organisation doit se conformer aux stratégies internes, réglementations du secteur ou aux obligations légales, et pour supprimer les messages qui sont considérés comme ayant une responsabilité ou qui n’ont pas de valeur juridique.
...
Pour en savoir plus sur les solutions de rétention dans Microsoft 365, voir En savoir plus sur les stratégies [de rétention et les étiquettes de rétention.](/microsoft-365/compliance/retention)

Les utilisateurs soumis à une stratégie de rétention Teams doivent avoir une licence appropriée, telle que Office 365 E3 ou Office 365 A3. Pour consulter d’autres options de gestion des licences pour ces stratégies de rétention, voir la [section](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#information-governance) Gouvernance des informations d’Microsoft 365 conseils en matière de gestion des licences & [conformité.](/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-tenantlevel-services-licensing-guidance/microsoft-365-security-compliance-licensing-guidance#information-governance) Pour en savoir plus sur les licences Teams, voir [Microsoft Teams description du service.](/office365/servicedescriptions/teams-service-description)

## <a name="how-teams-retention-policies-support-retain-and-delete-actions"></a>Prise en Teams des stratégies de rétention pour conserver et supprimer des actions

Si vous configurez une stratégie Teams rétention pour conserver les conversations ou les messages de canal, les utilisateurs peuvent toujours modifier et supprimer leurs messages dans leur Teams messagerie. Bien que les utilisateurs ne voient plus leurs messages pré-modifiés ou supprimés dans Teams, les données de ces messages sont stockées dans un emplacement sécurisé conçu pour les recherches eDiscovery par les administrateurs de conformité. La suppression définitive de ces données ne se produit pas avant la fin de la période de rétention configurée, ni si une autre stratégie de rétention est configurée pour conserver ces données ou si elle est soumise à une conservation [eDiscovery.](/microsoft-365/compliance/retention#when-to-use-retention-policies-and-retention-labels-or-ediscovery-holds)

Lorsqu’une stratégie de rétention est configurée pour supprimer des conversations et des messages de canal, ces messages peuvent être supprimés automatiquement. Si les messages sont toujours affichés dans l’application Teams, ils disparaissent et les utilisateurs sont informés qu’une stratégie de rétention les a [supprimés.](#end-user-experience) Si les messages étaient précédemment soumis à une action de rétention et ont été modifiés ou supprimés par des utilisateurs, ces messages sont désormais supprimés de l’emplacement sécurisé et ne sont plus renvoyés dans les recherches eDiscovery.

Pour plus d’informations sur le fonctionnement de ces stratégies en fonction de votre configuration de stratégie et des actions de l’utilisateur, et sur les données de message incluses et exclues pour les stratégies de rétention Teams, voir En savoir plus sur la rétention pour [Microsoft Teams.](/microsoft-365/compliance/retention-policies-teams) Cette page explique également pourquoi vous pouvez parfois être retardé lorsque des stratégies de rétention suppriment des messages. Par exemple, les messages peuvent être visibles aux utilisateurs dans l’application Teams jusqu’à 7 jours après la période d’expiration que vous avez configurée dans la stratégie de rétention.
...
- En cas de conflit entre la rétention et la suppression du même contenu, le contenu est toujours conservé dans l’emplacement sécurisé afin qu’il reste accessible dans la découverte électronique pour les administrateurs de conformité.
    
    Ce principe s’applique également aux messages qui font l’objet de la découverte électronique pour des raisons légales ou professionnelles.

- En cas de conflit de durée de conservation du même contenu, il est conservé à l’emplacement sécurisé pendant la période de rétention la plus longue.
...
Par exemple, pour les messages de canal, vous pouvez appliquer une stratégie de rétention à des équipes spécifiques de votre organisation, et cette stratégie est configurée avec une action de suppression après 1 an. Appliquez ensuite une autre stratégie de rétention à toutes les autres équipes. Cette stratégie est configurée avec une action de suppression au bout de 3 ans.

## <a name="create-and-manage-retention-policies-for-teams"></a>Créer et gérer des stratégies de rétention pour Teams

Pour créer ou modifier une stratégie de rétention pour Teams conversations et les messages de canal, utilisez les instructions de la stratégie de rétention [pour Teams emplacements.](/microsoft-365/compliance/create-retention-policies#retention-policy-for-teams-locations)
