...
f1.keywords:
- NOCSH
description: Lisez cet article pour découvrir comment utiliser des périphériques analogiques avec Microsoft Teams Système téléphonique routage direct.
ms.openlocfilehash: e3de63de032d2caf06993ac0a08b624feb5a5b42
ms.sourcegitcommit: 79dfda39db208cf943d0f7b4906883bb9d034281
ms.translationtype: MT
ms.contentlocale: fr-FR
ms.lasthandoff: 02/09/2022
ms.locfileid: "62457384"
---
# <a name="how-to-use-analog-devices-with-direct-routing"></a>Comment utiliser des dispositifs analogiques avec un routage direct

Cet article décrit comment utiliser des périphériques analogiques avec un routage direct. Pour connecter des périphériques analogiques au routage direct, vous devez utiliser un adaptateur téléphonique analogique (ATA), qui doit être pris en charge par le fournisseur de contrôleur de bordure de session certifié (SBC). 
...
## <a name="step-3-create-a-voice-route-and-associate-it-with-the-pstn-usage"></a>Étape 3 : créer un itinéraire vocal et l’associer à l’utilisation PSTN
