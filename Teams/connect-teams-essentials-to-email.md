...
2. Sous le menu de navigation de gauche, dans la section **Stratégies** de collaboration & messagerie  >  **électronique, & stratégies** de menace contre le courrier  >    >   indésirable dans la section Stratégies
...
5. Sous **Les règles de forwardage,** activez la condition de forwardage automatique. Le **forwarding** est activé et enregistrez vos modifications.
...
Pour que l’accès au calendrier fonctionne pour vos boîtes aux lettres locaux[Teams,](https://techcommunity.microsoft.com/t5/exchange-team-blog/configuring-teams-calendar-access-for-exchange-on-premises/ba-p/1484009) suivez les instructions fournies lors de la configuration de l’accès au calendrier pour les boîtes aux lettres Exchange locaux - Microsoft Tech Community

Pour déployer Salles Microsoft Teams dans un environnement hybride avec Exchange en local, visitez la Salles Microsoft Teams Déployer avec Exchange en [local - Microsoft Teams | Microsoft Docs](rooms/with-exchange-on-premises.md)
...
4. Lorsque vous y êtes invité, **sélectionnez Ne pas Microsoft 365 configurer DNS.**
...
9. Dans le panneau de navigation sur la gauche, sélectionnez **Configurer**  >  **les domaines**

10. À l’aide de la case à cocher, sélectionnez votre domaine non-Microsoft existant (par exemple : JohannaL@contosolandscapting2.m365master.com) dans les listes de domaines actuelles.
...
3. Dans le **volet Configurer les bases,** remplissez les informations de base de l’utilisateur, puis sélectionnez **Suivant.**
...
Pour ajouter plusieurs utilisateurs en même temps, suivez les étapes recommandées de la page Ajouter des utilisateurs et attribuer des licences - Microsoft 365 [administrateur | Microsoft Docs](/microsoft-365/admin/add-users/add-users?view=o365-worldwide&preserve-view=true)
...
2. Ajouter un itinéraire pour une Office 365
    ...
    - Allez sur la console d’administration de Google à <https://admin.google.com> l’adresse )
...
3. Configurer l’itinéraire vers Office 365
    ...
    - Accéder aux **applications**  >  **Google Workspace**  >  **-**  >  **Routage** Gmail
...
5. Accéder aux **applications**  >  **Google Workspace** Conformité  >  **Gmail**  >  
...
10. Sous **Expressions,** **sélectionnez Ajouter** xi. Sous **Paramètre d’ajout,** sélectionnez **Correspondance de contenu avancé**
...
15. Dans la zone Si les expressions ci-dessus correspondent, dans le champ **Suivant,** > modifier le **message** et vérifier le filtre anti-courrier indésirable pour **ce message** sous Courrier **indésirable.**
...
3. Sous **Centres d’administration,** **sélectionnez Exchange** pour ouvrir le centre Exchange’administration dans un nouvel onglet.

4. Dans le **Exchange** navigation gauche du Centre d’administration, sélectionnez   >  **Connecteurs** de flux de courrier, ouvrez le menu dépassement de capacité (...) et sélectionnez Ajouter un connecteur
...
1. Utilisez le **Administration Microsoft 365 Center pour** mettre à jour chaque boîte aux lettres ou vous pouvez utiliser un script **PowerShell,** tel que le suivant :
...
1. Vous pouvez configurer cette règle dans le Centre **Exchange’administration ou** **PowerShell.** Vous pouvez utiliser l’exemple **PowerShell** suivant pour créer la règle :
...
1. Suivez les instructions de[l’instruction Ajouter des utilisateurs et attribuer des licences](/microsoft-365/admin/add-users/add-users?view=o365-worldwide&preserve-view=true) pour ajouter plusieurs utilisateurs
