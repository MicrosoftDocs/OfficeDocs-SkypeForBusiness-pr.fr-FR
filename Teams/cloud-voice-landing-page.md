...
Vous souhaitez peut-être une solution plus simple &mdash; Teams Téléphone’aide de Forfait d’appels. Il s’agit de la solution microsoft dans le cloud qui fournit des fonctionnalités de Exchange de branche privée (PBX) et des appels vers le réseau téléphonique commuté (PSTN), comme illustré dans le diagramme suivant. Avec cette solution, Microsoft est votre opérateur PSTN.

![Le diagramme 1 montre les Teams Téléphone’aide d’un plan d’appels.](media/voice-solutions-simple.png)
...
Cet article présente les éléments clés Teams Téléphone fonctionnalités principales, ainsi que les décisions de déploiement que vous devrez prendre en compte :
...
Pour plus d’informations sur Teams Téléphone fonctionnalités de contrôle et la manière de configurer Teams Téléphone, consultez les articles suivants :

- [Voici ce que vous obtenez avec Teams Téléphone](here-s-what-you-get-with-phone-system.md)
- [Configurer des Teams Téléphone dans votre organisation](setting-up-your-phone-system.md)<br>
...
Teams Téléphone fournit des fonctionnalités PBX complètes pour votre organisation. Toutefois, pour permettre aux utilisateurs de passer des appels en dehors de votre organisation, vous devez vous Teams Téléphone au réseau téléphonique public commuté (PSTN). Pour vous Teams Téléphone au réseau PSTN, vous pouvez choisir l’une des options suivantes :

- [**Teams Téléphone’aide d’un forfait d’appels.**](pstn-connectivity.md#teams-phone-with-calling-plan) Une solution all-in-the-cloud avec Microsoft comme opérateur PSTN.

- [**Teams Téléphone avec votre propre opérateur PSTN à l’aide de l’opérateur Connecter.**](operator-connect-plan.md) Avec l’Connecter opérateur, si votre opérateur existant participe au programme Connecter de l’opérateur Microsoft, il peut gérer le service de mise à niveau des appels R TEAMS. Pour plus d’informations sur les avantages et les exigences de la Connecter opérateur, voir la [Connecter.](operator-connect-plan.md)

- [**Teams Téléphone avec votre propre opérateur PSTN en**](pstn-connectivity.md#teams-phone-with-direct-routing) utilisant le routage direct pour connecter votre environnement local à Teams.
...
- [Étude de cas de migration vocale dans Contoso](voice-case-study-overview.md)<br>
  ...
  - [Teams Téléphone options de connectivité PSTN](voice-case-study-phone-system.md)
