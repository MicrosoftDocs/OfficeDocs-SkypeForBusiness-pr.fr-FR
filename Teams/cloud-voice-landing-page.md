...
| :------------|:-------|
| [**Système téléphonique**](#phone-system) | Technologie microsoft permettant d’activer le contrôle d’appel et les fonctionnalités PBX (Private Branch Exchange) dans le cloud Microsoft 365 avec Microsoft Teams. |
...
> [!Important]
> Cet article traite des solutions vocales avec Microsoft Teams. Bien que les solutions avec Skype Entreprise Online soient toujours disponibles (comme décrit dans les solutions téléphoniques [Microsoft),](/SkypeForBusiness/hybrid/msft-telephony-solutions)il est important de savoir que Skype Entreprise Online sera retiré le 31 juillet 2021.  Après cette date, le service Skype Entreprise Online ne sera plus accessible. Par ailleurs, la connectivité PSTN entre votre environnement local, que ce soit par le biais de Skype Entreprise Server ou de la version Cloud Connector et de Skype Entreprise Online ne sera plus prise en &mdash; &mdash; charge. Cet article présente les solutions vocales Teams et la façon dont vous pouvez connecter votre réseau téléphonique local, le cas échéant, à Teams à l’aide du routage direct.
...
### <a name="phone-system-with-calling-plan"></a>Phone System avec forfait d’appels 
...
![Diagramme 5 10 du système téléphonique avec routage direct](media/voice-solution-with-direct-routing.png)
...
- Vous pouvez configurer l’interopérabilité entre vos équipements téléphoniques tels qu’un PBX tiers et des appareils &mdash; analogiques &mdash; et le système téléphonique Microsoft.
